...
All notable changes to @ralphschuler/screeps-chemistry will be documented in this file.
...
- ChemistryManager for reaction planning
- LabConfigManager for lab coordination
- Reaction chain calculation
- Boost management system
- Just-in-time production with dynamic targets
- War/eco mode adjustment
