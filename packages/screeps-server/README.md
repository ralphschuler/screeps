...
- Pull requests run strict real-server smoke tests with seeded runtime scenarios (default 15 minutes / 10,000 ticks).
...
- default, construction, remote-mining, defense-hostile, defense-hard-invader, spawnless-siege, and alliance-safety scenario assertions
