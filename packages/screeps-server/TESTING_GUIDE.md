...
- `spawnless-siege` (seeds an owned RCL5 recovery room without a spawn or tower, a safe second helper room, five military helpers distributed across two rooms, a spawn site, and hard hostile pressure; verifies defense/refuel signals, one atomic cross-room release before fallback trickling, and bounded pressure resolution)
