...
return o > 0 && console.log("[Alliance] Filtered ".concat(o, " allied structures from hostile detection in ").concat(null === (t = e[0]) || void 0 === t ? void 0 : t.room.name)), 
r;
...
var o = Qn("guard"), n = Qn("ranger"), a = Zn(o), i = Zn(n), s = (a.avgDps + i.avgDps) / 2, c = (a.avgCost + i.avgCost) / 2;
t = null != t ? t : s, r = null != r ? r : c;
}
return t <= 0 && (t = 300, r = 1300), Math.ceil(e / t) * r;
}(c), A = function(e) {
return 0 === e ? 0 : e < Yn ? 1 : e < Vn ? 2 : 3;
}(s);
...
var Xn = {
guard: [ zn([ TOUGH, ATTACK, ATTACK, MOVE, MOVE, MOVE ]), zn([ TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ]), zn([ TOUGH, TOUGH, TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ]), zn([ TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, RANGED_ATTACK, RANGED_ATTACK, HEAL, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ]) ],
ranger: [ zn([ TOUGH, RANGED_ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE ]), zn([ TOUGH, TOUGH, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE ]), zn([ TOUGH, TOUGH, TOUGH, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ]), zn([ TOUGH, TOUGH, TOUGH, TOUGH, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ]) ]
};

function Qn(e) {
return i([], a(Xn[e]), !1).sort(function(e, t) {
...
var ea = [ STRUCTURE_SPAWN, STRUCTURE_STORAGE, STRUCTURE_TERMINAL, STRUCTURE_TOWER, STRUCTURE_LAB, STRUCTURE_FACTORY, STRUCTURE_POWER_SPAWN, STRUCTURE_NUKER, STRUCTURE_OBSERVER ], ta = [ STRUCTURE_SPAWN, STRUCTURE_TOWER, STRUCTURE_STORAGE ], ra = {
...
void 0 === o && (o = {});
var C = r(r({}, ra), o), S = oa.get(e.name);
...
var N = la(A, k.value.pos, e.name, C.maxPathOps);
try {
...
if (_) {
N = la(A, _.pos, e.name, C.maxPathOps);
try {
...
if (x && O >= 6) {
N = la(A, x.pos, e.name, C.maxPathOps);
try {
...
N = la(t, W.value.pos, e.name, C.maxPathOps);
try {
...
if (_) {
N = la(t, _.pos, e.name, C.maxPathOps);
try {
...
return oa.set(e.name, j), ge.debug("Calculated road network for ".concat(e.name, ": ").concat(w.size, " positions"), {
...
for (var u = n(c), m = u.next(); !m.done; m = u.next()) {
var p = m.value;
ma(p.pos, t) && s.add("".concat(p.pos.x, ",").concat(p.pos.y));
}
} catch (e) {
r = {
error: e
...
for (var d = n(l), f = d.next(); !f.done; f = d.next()) {
var y = f.value;
ma(y.pos, t) && s.add("".concat(y.pos.x, ",").concat(y.pos.y));
}
} catch (e) {
a = {
error: e
...
return n !== ga.NONE || o ? (o ? (r = o).level = n : (r = {
level: n,
startedAt: Game.time,
assistanceRequested: !1,
boostsAllocated: !1,
lastEscalation: 0
}, this.emergencyStates.set(e.name, r)), n === ga.NONE ? (o && (ge.info("Emergency resolved in ".concat(e.name), {
subsystem: "Defense"
...
return a.length > 0 && i >= 2 || r.length >= 5 && 0 === n.guards && 0 === n.rangers ? ga.HIGH : t.danger >= 2 && i >= 1 ? ga.MEDIUM : t.danger >= 1 ? ga.LOW : ga.NONE;
}, e.prototype.executeEmergencyResponse = function(e, t, r) {
r.level !== ga.HIGH && r.level !== ga.CRITICAL || r.assistanceRequested || this.requestDefenseAssistance(e, t) && (r.assistanceRequested = !0), 
...
this.transfersThisTick = 0, this.config = r(r({}, wa), e);
}
return e.prototype.run = function() {
var e, t, r, o;
...
}(), ba = new Oa, _a = fe("CreepContext"), Ua = ((Ra = {})[STRUCTURE_SPAWN] = 100, 
Ra[STRUCTURE_EXTENSION] = 90, Ra[STRUCTURE_TOWER] = 80, Ra[STRUCTURE_RAMPART] = 75, 
Ra[STRUCTURE_WALL] = 70, Ra[STRUCTURE_STORAGE] = 70, Ra[STRUCTURE_CONTAINER] = 60, 
Ra[STRUCTURE_ROAD] = 30, Ra), xa = new Map;
...
function ka(e) {
return void 0 === e._repairTargets && (Aa(e), e._repairTargets = e.allStructures.filter(function(e) {
...
return xa.set(e.name, r), r;
}(o);
void 0 === a.working && (a.working = e.store.getUsedCapacity() > 0, _a.debug("".concat(e.name, " initialized working=").concat(a.working, " from carry state"), {
creep: e.name
}));
...
get containers() {
return void 0 === (e = i)._containers && (Aa(e), e._containers = e.allStructures.filter(function(e) {
return e.structureType === STRUCTURE_CONTAINER;
})), e._containers;
var e;
},
get depositContainers() {
return void 0 === (e = i)._depositContainers && (Aa(e), e._depositContainers = e.allStructures.filter(function(e) {
return e.structureType === STRUCTURE_CONTAINER;
...
var Ia, Pa = {}, Ga = function() {
if (Ia) return Pa;
Ia = 1, Object.defineProperty(Pa, "__esModule", {
value: !0
});
...
return Pa.CachingStrategies = di, Pa.CoordListSerializer = mi, Pa.CoordSerializer = ui, 
Pa.Keys = Yi, Pa.MoveTargetListSerializer = si, Pa.MoveTargetSerializer = ii, Pa.NumberSerializer = Ca, 
Pa.PositionListSerializer = li, Pa.PositionSerializer = ci, Pa.adjacentWalkablePositions = Ci, 
Pa.blockSquare = function(e) {
ts(e.roomName).blockedSquares.add(Ha(e));
}, Pa.cachePath = ps, Pa.cachedPathKey = us, Pa.calculateAdjacencyMatrix = vi, Pa.calculateAdjacentPositions = Ri, 
Pa.calculateNearbyPositions = Ei, Pa.calculatePositionsAtRange = Ti, Pa.cleanAllCaches = pi, 
Pa.clearCachedPath = Os, Pa.compressPath = e => {
const t = [], r = e[0];
if (!r) return "";
let o = r;
...
}, Pa.config = ga, Pa.decompressPath = e => {
let t = Wa(e.slice(0, 2));
const r = [ t ], o = Da.decode(e.slice(2));
for (const e of o) t = ei(t, e), r.push(t);
return r;
}, Pa.fastRoomPosition = Ma, Pa.fixEdgePosition = hi, Pa.follow = function(e, t) {
e.move(t), t.pull(e), function(e, t) {
const r = ts(e.pos.roomName);
r.pullers.add(e.id), r.pullees.add(t.id);
}(t, e);
}, Pa.followPath = ys, Pa.fromGlobalPosition = Ja, Pa.generatePath = Ji, Pa.getCachedPath = ds, 
Pa.getMoveIntents = ts, Pa.getRangeTo = $a, Pa.globalPosition = Za, Pa.isExit = yi, 
Pa.isPositionWalkable = Si, Pa.move = ls, Pa.moveByPath = function(e, t, r) {
var o, n, a, i;
...
}, Pa.moveTo = bs, Pa.normalizeTargets = gi, Pa.offsetRoomPosition = Na, Pa.packCoord = Ka, 
Pa.packCoordList = Va, Pa.packPos = Ha, Pa.packPosList = ja, Pa.packRoomName = oi, 
Pa.packRoomNames = ti, Pa.posAtDirection = ei, Pa.preTick = function() {
pi(), function() {
...
}, Pa.reconcileTraffic = function(e) {
for (const t of [ ...$i.keys() ]) Game.rooms[t] && cs(t, e);
_a.with(Ca).set(as, Game.time);
}, Pa.reconciledRecently = is, Pa.resetCachedPath = fs, Pa.roomNameFromCoords = Qa, 
Pa.roomNameToCoords = Xa, Pa.sameRoomPosition = ka, Pa.unpackCoord = Ya, Pa.unpackCoordList = qa, 
Pa.unpackPos = Wa, Pa.unpackPosList = za, Pa.unpackRoomName = ni, Pa.unpackRoomNames = ri, 
Pa;
}();
...
var Da = fe("ActionExecutor"), Fa = "#ffaa00", Ba = "#ffffff", Ha = "#ff0000", Wa = "#00ff00", Ka = "#0000ff";

function Ya(e, t, r) {
var o, n;
if (!t || !t.type) return Da.warn("".concat(e.name, " received invalid action, clearing state")), 
void delete r.memory.state;
var a = function(e, t) {
return t;
}(0, t);
t.type !== a.type && Da.debug("".concat(e.name, " opportunistic action: ").concat(t.type, " → ").concat(a.type)), 
"idle" === a.type ? Da.warn("".concat(e.name, " (").concat(r.memory.role, ") executing IDLE action")) : Da.debug("".concat(e.name, " (").concat(r.memory.role, ") executing ").concat(a.type));
var i = !1;
switch (a.type) {
case "harvest":
i = Va(e, function() {
...
case "rangedHeal":
e.rangedHeal(a.target), Ga.moveTo(e, a.target, {
visualizePathStyle: {
stroke: Wa
}
}) === ERR_NO_PATH && (i = !0);
...
e.pos.isEqualTo(a.position) || Ga.moveTo(e, a.position) === ERR_NO_PATH && (i = !0);
break;
...
case "idle":
if (Ga.isExit(e.pos)) {
l = new RoomPosition(25, 25, e.pos.roomName), Ga.moveTo(e, l, {
priority: 2
});
break;
}
...
i && (delete r.memory.state, Ga.clearCachedPath(e), Ut(e)), function(e) {
...
return s !== OK && Da.info("Movement attempt returned non-OK result", {
room: e.pos.roomName,
creep: e.name,
meta: {
...
}(e, n, r, a), (i === ERR_FULL || i === ERR_NOT_ENOUGH_RESOURCES || i === ERR_INVALID_TARGET) && (Da.info("Clearing state after action error", {
room: e.pos.roomName,
creep: e.name,
meta: {
action: null != n ? n : "rangeAction",
...
var qa, ja, za, Xa = fe("StateMachine");
...
var a;
}(n, e)) Xa.info("State completed, evaluating new action", {
...
if (i) return i;
Xa.info("State reconstruction failed, re-evaluating behavior", {
room: e.creep.pos.roomName,
creep: e.creep.name,
meta: {
action: n.action,
...
} else n && (Xa.info("State invalid, re-evaluating behavior", {
room: e.creep.pos.roomName,
creep: e.creep.name,
meta: r({
action: n.action,
...
}(s), Xa.info("Committed new state action", {
room: e.creep.pos.roomName,
creep: e.creep.name,
meta: {
action: s.type,
...
})) : Xa.info("Behavior returned idle action", {
room: e.creep.pos.roomName,
creep: e.creep.name,
meta: {
role: e.memory.role
}
}), s) : (Xa.warn("Behavior returned invalid action, defaulting to idle", {
room: e.creep.pos.roomName,
creep: e.creep.name,
meta: {
role: e.memory.role
...
(qa = {})[FIND_SOURCES] = 5e3, qa[FIND_MINERALS] = 5e3, qa[FIND_DEPOSITS] = 100, 
qa[FIND_STRUCTURES] = 50, qa[FIND_MY_STRUCTURES] = 50, qa[FIND_HOSTILE_STRUCTURES] = 20, 
qa[FIND_MY_SPAWNS] = 100, qa[FIND_MY_CONSTRUCTION_SITES] = 20, qa[FIND_CONSTRUCTION_SITES] = 20, 
qa[FIND_CREEPS] = 5, qa[FIND_MY_CREEPS] = 5, qa[FIND_HOSTILE_CREEPS] = 3, qa[FIND_DROPPED_RESOURCES] = 5, 
qa[FIND_TOMBSTONES] = 10, qa[FIND_RUINS] = 10, qa[FIND_FLAGS] = 50, qa[FIND_NUKES] = 20, 
qa[FIND_POWER_CREEPS] = 10, qa[FIND_MY_POWER_CREEPS] = 10, function(e) {
e[e.CRITICAL = 0] = "CRITICAL", e[e.HIGH = 1] = "HIGH", e[e.MEDIUM = 2] = "MEDIUM", 
e[e.LOW = 3] = "LOW";
}(za || (za = {}));

var $a, ei = {
bucketThresholds: (ja = {}, ja[za.CRITICAL] = 0, ja[za.HIGH] = 2e3, ja[za.MEDIUM] = 5e3, 
ja[za.LOW] = 8e3, ja),
defaultMaxCpu: 5,
logExecution: !1
}, ti = function() {
...
totalTasks: 0,
tasksByPriority: (t = {}, t[za.CRITICAL] = 0, t[za.HIGH] = 0, t[za.MEDIUM] = 0, 
t[za.LOW] = 0, t),
executedThisTick: 0,
skippedThisTick: 0,
deferredThisTick: 0,
cpuUsed: 0
}, this.config = r(r({}, ei), e);
}
...
if (d.priority !== za.CRITICAL && s < this.config.bucketThresholds[d.priority]) {
...
var e, t, r;
this.stats.totalTasks = this.tasks.size, this.stats.tasksByPriority = ((e = {})[za.CRITICAL] = 0, 
e[za.HIGH] = 0, e[za.MEDIUM] = 0, e[za.LOW] = 0, e);
try {
...
}(), ri = (($a = global)._computationScheduler || ($a._computationScheduler = new ti), 
$a._computationScheduler), oi = new Map;
...
var o, a;
if (0 === t.length) return null;
if (1 === t.length) return ii(e, t[0], r), t[0];
var i = ni(e.room.name), s = null, c = 1 / 0, l = 1 / 0;
try {
...
function ii(e, t, r) {
var o = ni(e.room.name), n = "".concat(r, ":").concat(t.id), a = o.assignments.get(n) || [];
...
function ui() {
for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
return di() + fi() + '<div class="module-help">'.concat(e.map(mi).join(""), "</div>");
}

var mi = function(e) {
var t = e.api.map(pi).join("");
return '<div class="module-container">\n    <div class="module-info">\n      <span class="module-title">'.concat(ci(e.name, "yellow"), '</span>\n      <span class="module-describe">').concat(ci(e.describe, "green"), '</span>\n    </div>\n    <div class="module-api-list">').concat(t, "</div>\n  </div>").replace(/\n/g, "");
}, pi = function(e) {
var t = [];
e.describe && t.push(ci(e.describe, "green")), e.params && t.push(e.params.map(function(e) {
return "  - ".concat(ci(e.name, "blue"), ": ").concat(ci(e.desc, "green"));
}).map(function(e) {
return '<div class="api-content-line">'.concat(e, "</div>");
}).join(""));
var r = e.params ? e.params.map(function(e) {
return ci(e.name, "blue");
}).join(", ") : "", o = ci(e.functionName, "yellow") + (e.commandType ? "" : "(".concat(r, ")"));
t.push(o);
var n = t.map(function(e) {
return '<div class="api-content-line">'.concat(e, "</div>");
}).join(""), a = "".concat(e.functionName).concat(Game.time);
return '\n  <div class="api-container">\n    <label for="'.concat(a, '">').concat(e.title, " ").concat(ci(e.functionName, "yellow", !0), '</label>\n    <input id="').concat(a, '" type="checkbox" />\n    <div class="api-content">').concat(n, "</div>\n  </div>\n  ").replace(/\n/g, "");
}, di = function() {
...
}, yi = fe("EnergyCollection");

function gi(e) {
if (e.droppedResources.length > 0) {
var t = _t(e.creep, e.droppedResources, "energy_drop", 5);
if (t) return yi.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") selecting dropped resource at ").concat(t.pos)), 
{
type: "pickup",
target: t
};
...
if (r.length > 0) {
var o = ai(e.creep, r, "energy_container");
if (o) return yi.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") selecting container ").concat(o.id, " at ").concat(o.pos, " with ").concat(o.store.getUsedCapacity(RESOURCE_ENERGY), " energy")), 
{
type: "withdraw",
target: o,
resourceType: RESOURCE_ENERGY
};
if (yi.warn("".concat(e.creep.name, " (").concat(e.memory.role, ") found ").concat(r.length, " containers but distribution returned null, falling back to closest")), 
a = e.creep.pos.findClosestByRange(r)) return yi.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") using fallback container ").concat(a.id, " at ").concat(a.pos)), 
{
type: "withdraw",
target: a,
resourceType: RESOURCE_ENERGY
...
if (e.storage && e.storage.store.getUsedCapacity(RESOURCE_ENERGY) > 0) return yi.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") selecting storage at ").concat(e.storage.pos)), 
{
type: "withdraw",
target: e.storage,
resourceType: RESOURCE_ENERGY
...
if (n.length > 0) {
var a, i = ai(e.creep, n, "energy_source");
if (i) return yi.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") selecting source ").concat(i.id, " at ").concat(i.pos)), 
{
type: "harvest",
target: i
};
if (yi.warn("".concat(e.creep.name, " (").concat(e.memory.role, ") found ").concat(n.length, " sources but distribution returned null, falling back to closest")), 
a = e.creep.pos.findClosestByRange(n)) return yi.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") using fallback source ").concat(a.id, " at ").concat(a.pos)), 
{
type: "harvest",
target: a
};
}
return yi.warn("".concat(e.creep.name, " (").concat(e.memory.role, ") findEnergy returning idle - no energy sources available")), 
{
type: "idle"
};
}
...
}(), Ri = new vi, Ei = fe("LarvaWorkerBehavior");

function Ti(e) {
if (Za(e)) {
Ei.debug("".concat(e.creep.name, " larvaWorker working with ").concat(e.creep.store.getUsedCapacity(RESOURCE_ENERGY), " energy"));
var t = hi(e);
if (t) return Ei.debug("".concat(e.creep.name, " larvaWorker delivering via ").concat(t.type)), 
t;
var r = function(e) {
var t, r = Ri.getSwarmState(e.room.name);
...
if (e.prioritizedSites.length > 0) return Ei.debug("".concat(e.creep.name, " larvaWorker building site")), 
{
type: "build",
target: e.prioritizedSites[0]
};
...
if (e.isEmpty) return Ei.warn("".concat(e.creep.name, " larvaWorker idle (empty, working=true, no targets) - this indicates a bug")), 
{
type: "idle"
};
Ei.debug("".concat(e.creep.name, " larvaWorker has energy but no targets, switching to collection mode")), 
Ja(e);
}
return gi(e);
}

var Ci = fe("HarvesterBehavior"), Si = fe("HaulerBehavior"), wi = {
larvaWorker: Ti,
...
}(e), Ci.debug("".concat(e.creep.name, " harvester assigned to source ").concat(null == t ? void 0 : t.id))), 
!t) return Ci.warn("".concat(e.creep.name, " harvester has no source to harvest")), 
{
type: "idle"
};
...
if (a) return Ci.debug("".concat(e.creep.name, " harvester transferring to container ").concat(a.id)), 
{
type: "transfer",
target: a,
resourceType: RESOURCE_ENERGY
...
return i ? (Ci.debug("".concat(e.creep.name, " harvester transferring to link ").concat(i.id)), 
{
type: "transfer",
target: i,
resourceType: RESOURCE_ENERGY
}) : (Ci.debug("".concat(e.creep.name, " harvester dropping energy on ground")), 
{
type: "drop",
resourceType: RESOURCE_ENERGY
});
...
hauler: function(e) {
var t, r = Za(e);
if (Si.debug("".concat(e.creep.name, " hauler state: working=").concat(r, ", energy=").concat(e.creep.store.getUsedCapacity(RESOURCE_ENERGY), "/").concat(e.creep.store.getCapacity())), 
r) {
...
if (a.length > 0 && (c = _t(e.creep, a, "hauler_spawn", 10))) return Si.debug("".concat(e.creep.name, " hauler delivering to spawn ").concat(c.id)), 
{
type: "transfer",
target: c,
resourceType: RESOURCE_ENERGY
...
if (e.isEmpty) return Si.warn("".concat(e.creep.name, " hauler idle (empty, working=true, no targets)")), 
{
type: "idle"
};
Si.debug("".concat(e.creep.name, " hauler has energy but no targets, switching to collection mode")), 
Ja(e);
}
...
if (d.length > 0) {
var f = ai(e.creep, d, "energy_container");
if (f) return Si.debug("".concat(e.creep.name, " hauler withdrawing from container ").concat(f.id, " with ").concat(f.store.getUsedCapacity(RESOURCE_ENERGY), " energy")), 
{
type: "withdraw",
target: f,
resourceType: RESOURCE_ENERGY
};
Si.warn("".concat(e.creep.name, " hauler found ").concat(d.length, " containers but distribution returned null, falling back to closest"));
var y = e.creep.pos.findClosestByRange(d);
if (y) return Si.debug("".concat(e.creep.name, " hauler using fallback container ").concat(y.id)), 
{
type: "withdraw",
target: y,
resourceType: RESOURCE_ENERGY
...
var g = ai(e.creep, e.mineralContainers, "mineral_container");
if (g) {
...
Si.warn("".concat(e.creep.name, " hauler found ").concat(e.mineralContainers.length, " mineral containers but distribution returned null, falling back to closest"));
...
}))) return Si.debug("".concat(e.creep.name, " hauler using fallback mineral container ").concat(v.id)), 
{
type: "withdraw",
target: v,
resourceType: h
...
return e.storage && e.storage.store.getUsedCapacity(RESOURCE_ENERGY) > 0 ? (Si.debug("".concat(e.creep.name, " hauler withdrawing from storage")), 
{
type: "withdraw",
target: e.storage,
resourceType: RESOURCE_ENERGY
}) : (Si.warn("".concat(e.creep.name, " hauler idle (no energy sources found)")), 
{
type: "idle"
});
},
...
var t = Za(e), r = e.memory.targetRoom, o = e.memory.homeRoom;
if (!r || r === o) return {
type: "idle"
};
if (e.nearbyEnemies && e.hostiles.length > 0) {
...
function Oi(e) {
var t;
return (null !== (t = wi[e.memory.role]) && void 0 !== t ? t : Ti)(e);
}

var bi = fe("MilitaryBehaviors"), _i = "patrol";
...
var s = Ui(e.room), c = xi(e.creep, s);
if (c) return {
type: "moveTo",
target: c
};
...
var u = Ui(e.room), m = xi(e.creep, u);
return m ? {
type: "moveTo",
target: m
} : {
...
var d = ki(e, "siegeUnit");
if (d) return d;
var f = Ui(e.room), y = xi(e.creep, f);
return y ? {
type: "moveTo",
target: y
} : {
...
var c = Ui(e.room), l = xi(e.creep, c);
if (l) return {
type: "moveTo",
target: l
};
...
if (!t) return ki(e, "harasser (no target)") || {
type: "idle"
};
if (e.room.name !== t) return {
type: "moveToRoom",
...
var s = ki(e, "harasser (no targets)");
if (s) return s;
var c = Ui(e.room), l = xi(e.creep, c);
return l ? {
type: "moveTo",
...
function Hi(e) {
var t;
return (null !== (t = Bi[e.memory.role]) && void 0 !== t ? t : Ii)(e);
}
...
function Vi(e) {
var t;
return (null !== (t = Yi[e.memory.role]) && void 0 !== t ? t : Ki)(e);
}
...
function zi(e) {
var t = Ri.getEmpire();
if (Ga.isExit(e.creep.pos)) return ji(e.room.name);
...
return i ? e.creep.pos.getRangeTo(i) <= 3 ? (qi(e.room, t), e.memory.lastExploredRoom = e.room.name, 
delete e.memory.targetRoom, {
type: "idle"
}) : {
type: "moveTo",
target: i
} : (qi(e.room, t), e.memory.lastExploredRoom = e.room.name, delete e.memory.targetRoom, 
{
type: "idle"
});
}
...
function Qi(e) {
var t;
return (null !== (t = Xi[e.memory.role]) && void 0 !== t ? t : zi)(e);
}
...
switch (t.type) {
case "usePower":
(t.target ? e.usePower(t.power, t.target) : e.usePower(t.power)) === ERR_NOT_IN_RANGE && t.target && Ga.moveTo(e, t.target);
break;

case "moveTo":
Ga.moveTo(e, t.target);
break;
...
case "renewSelf":
e.renew(t.spawn) === ERR_NOT_IN_RANGE && Ga.moveTo(e, t.spawn);
break;

case "enableRoom":
(null === (r = e.room) || void 0 === r ? void 0 : r.controller) && e.enableRoom(e.room.controller) === ERR_NOT_IN_RANGE && Ga.moveTo(e, e.room.controller);
}
}(e, function(e) {
...
return e.structureType === STRUCTURE_SPAWN && !Wi(e, PWR_DISRUPT_SPAWN);
})[0];
if (u) return {
type: "usePower",
...
return e.structureType === STRUCTURE_TOWER && !Wi(e, PWR_DISRUPT_TOWER);
})[0];
if (m) return {
type: "usePower",
...
filter: function(e) {
return e.structureType === STRUCTURE_TOWER && !Wi(e, PWR_OPERATE_TOWER);
},
...
return e.structureType === STRUCTURE_TERMINAL && !Wi(e, PWR_DISRUPT_TERMINAL);
});
if (R) return {
type: "usePower",
...
var t = e;
return null !== t.spawning && !Wi(t, PWR_OPERATE_SPAWN);
});
if (r) return {
type: "usePower",
...
}, 0) > 1e3 && e.storage && e.storage.store.getUsedCapacity(RESOURCE_ENERGY) > 1e4 && !Wi(e.storage, PWR_OPERATE_EXTENSION)) return {
type: "usePower",
...
return 0 === e.cooldown && e.mineralType && !Wi(e, PWR_OPERATE_LAB);
});
if (n) return {
type: "usePower",
...
if (t.includes(PWR_OPERATE_FACTORY) && e.ops >= 100 && e.factory && 0 === e.factory.cooldown && !Wi(e.factory, PWR_OPERATE_FACTORY)) return {
type: "usePower",
power: PWR_OPERATE_FACTORY,
target: e.factory
};
if (t.includes(PWR_OPERATE_STORAGE) && e.ops >= 100 && e.storage && e.storage.store.getUsedCapacity() > .85 * e.storage.store.getCapacity() && !Wi(e.storage, PWR_OPERATE_STORAGE)) return {
type: "usePower",
...
var $i = new Set([ "harvester", "upgrader", "mineralHarvester", "depositHarvester", "factoryWorker", "labTech", "builder" ]), es = {
...
function ts(e) {
var t;
return null !== (t = es[e]) && void 0 !== t ? t : Ur.MEDIUM;
}
...
var t = e.memory.role, r = ts(t), o = "creep:".concat(e.name);
Vr.registerProcess({
id: o,
...
if (!t.targetId) return !1;
var r = Game.getObjectById(t.targetId);
return !(!r || !Ji(r) || !e.pos.inRangeTo(r.pos, 3) || "upgrade" === t.action && 0 === e.store.getUsedCapacity(RESOURCE_ENERGY) || "withdraw" === t.action && 0 === e.store.getFreeCapacity(RESOURCE_ENERGY));
}(e, r);
...
if (!t.targetId) return !1;
var r = Game.getObjectById(t.targetId);
return !(!r || !Ji(r) || !e.pos.isNearTo(r.pos) || 0 === e.store.getFreeCapacity());
}(e, r);
...
if (!t.targetId) return !1;
var r = Game.getObjectById(t.targetId);
return !(!r || !Ji(r) || !e.pos.inRangeTo(r.pos, 3) || 0 === e.store.getUsedCapacity(RESOURCE_ENERGY));
}(e, r);
...
if (l) {
var u = ts(l.memory.role), m = null !== (r = Ur[u]) && void 0 !== r ? r : "UNKNOWN";
...
function e(e) {
void 0 === e && (e = {}), this.trackers = new Map, this.config = r(r({}, ns), e);
}
...
var i, s, c = cs[e], l = null !== (i = n[STRUCTURE_TOWER]) && void 0 !== i ? i : 0, u = null !== (s = n[STRUCTURE_LAB]) && void 0 !== s ? s : 0;
...
var r, o, n, a, i, s, c, l, u, m, p, d, f = this.getStructureCounts(t), y = null !== (o = null === (r = t.controller) || void 0 === r ? void 0 : r.level) && void 0 !== o ? o : 0, g = cs[e.colonyLevel], h = g.requiresLabs && y >= 6, v = h ? null !== (n = g.minLabCount) && void 0 !== n ? n : 3 : 0, R = g.requiresFactory && y >= 7, E = g.requiresTerminal && y >= 6, T = g.requiresStorage && y >= 4, C = g.requiresPowerSpawn && y >= 7, S = g.requiresObserver && y >= 8, w = g.requiresNuker && y >= 8;
e.missingStructures = {
...
}(), ds = new ms, fs = new ps, ys = new Map, gs = function() {
function e() {}
return e.prototype.updateThreatAssessment = function(e, t, r) {
var o, s, c, l, u, m;
if (Game.time % 5 == 0) {
var p = r.spawns.length + r.towers.length, d = ys.get(e.name);
...
if (g > t.danger) {
if (ss.updateDangerFromThreat(t, y.threatScore, y.dangerLevel), t.clusterId) {
var h = Qe.getCluster(t.clusterId);
h && ss.diffuseDangerToCluster(e.name, y.threatScore, h.memberRooms);
}
...
if (!fs.isCombatPosture(t.posture) && (o = r.pos.findClosestByRange(FIND_STRUCTURES, {
filter: function(e) {
return e.hits < .8 * e.hitsMax && e.structureType !== STRUCTURE_WALL && e.structureType !== STRUCTURE_RAMPART;
}
}))) return r.repair(o), "continue";
if (!fs.isCombatPosture(t.posture) && 0 === c.length) {
var n = $n(null !== (s = null === (i = e.controller) || void 0 === i ? void 0 : i.level) && void 0 !== s ? s : 1, t.danger), a = r.pos.findClosestByRange(FIND_STRUCTURES, {
filter: function(e) {
...
x: 1,
y: 2
} ], !1), a(Ts(ws, 3, [ "north", "south", "east", "west" ])), !1), [ {
x: 3,
y: 3
}, {
x: 4,
...
x: 1,
y: 2
} ], !1), a(Ts(bs, 3, [ "north", "south", "east", "west" ])), !1),
ramparts: Es([ {
x: 0,
y: 0,
structureType: STRUCTURE_SPAWN
...
var S = new RoomPosition(T, C, e.name), w = Ms(e, S, t);
if (w.fits) {
...
function Ns(e, t) {
var r, o = vs(t), n = {}, s = e.structures.filter(function(e) {
...
var Ps = [ STRUCTURE_EXTENSION, STRUCTURE_ROAD, STRUCTURE_TOWER, STRUCTURE_LAB, STRUCTURE_LINK, STRUCTURE_FACTORY, STRUCTURE_OBSERVER, STRUCTURE_NUKER, STRUCTURE_POWER_SPAWN, STRUCTURE_EXTRACTOR ], Gs = new Set(Ps);
...
if (!(d = function(e) {
return function(e) {
return e >= 7 ? Us : e >= 5 ? _s : e >= 3 ? Os : Ss;
}(e);
}(u))) return;
p = m.pos;
}
if (d && p) {
if (!fs.isCombatPosture(t.posture)) {
...
filter: function(e) {
return Gs.has(e.structureType) && (!0 === e.my || e.structureType === STRUCTURE_ROAD);
}
});
try {
...
var o, s, c, l, u, m, p, d, f, y, g, h, v, R, E = null !== (y = null === (f = e.controller) || void 0 === f ? void 0 : f.level) && void 0 !== y ? y : 1, T = Ns(r, E), C = e.getTerrain(), S = [];
if (E >= 6) {
var w = e.find(FIND_MINERALS);
if (w.length > 0) {
var O = w[0];
...
var s = na(e, t), c = e.getTerrain(), l = e.find(FIND_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_ROAD;
}
...
if (t < 2) return l;
var u = function(e, t) {
var r = e.find(FIND_MY_STRUCTURES), o = t < 4 ? ta : ea;
...
enableTowers: !0,
enableProcessing: !0
}, qs = new Map, js = function() {
function e(e, t) {
void 0 === t && (t = {}), this.roomName = e, this.config = r(r({}, Vs), t);
}
...
return qs.set(e.name, o), o;
}(i);
if (this.config.enablePheromones && Game.time % 5 == 0 && ss.updateMetrics(i, s), 
hs.updateThreatAssessment(i, s, {
spawns: c.spawns,
towers: c.towers
}), Ta.assess(i, s), Sa.checkSafeMode(i, s), this.config.enableEvolution && (ds.updateEvolutionStage(s, i, e), 
ds.updateMissingStructures(s, i)), fs.updatePosture(s), this.config.enablePheromones && ss.updatePheromones(s, i), 
this.config.enableTowers && hs.runTowerControl(i, s, c.towers), this.config.enableConstruction && fs.allowsBuilding(s.posture)) {
var l = null !== (o = null === (r = i.controller) || void 0 === r ? void 0 : r.level) && void 0 !== o ? o : 1, u = Fs.getConstructionInterval(l);
Game.time % u === 0 && Fs.runConstruction(i, s, c.constructionSites, c.spawns);
}
this.config.enableProcessing && Game.time % 5 == 0 && Ys.runResourceProcessing(i, s, {
factory: c.factory,
...
for (var f = n(l), y = f.next(); !y.done; y = f.next()) {
var g = y.value;
this.nodes.has(g.name) || this.nodes.set(g.name, new js(g.name));
}
} catch (t) {
e = {
error: t
...
this.nodes.has(e.name) || this.nodes.set(e.name, new js(e.name));
...
var a = Game.rooms[o];
r.add(o);
var i = "room:".concat(o), s = Vr.getProcess(i), c = Qs(a), l = Zs(a);
...
var t, r = Qs(e), o = Zs(e), n = "room:".concat(e.name), a = this.getRoomIndex(e.name), i = Js(e, r, a);
Vr.registerProcess({
id: n,
...
var o, n = "room:".concat(e.name), a = this.getRoomIndex(e.name), i = Js(e, t, a);
...
var u = l.value, m = Game.rooms[u];
if (m) {
var p = Qs(m), d = null !== (r = Ur[p]) && void 0 !== r ? r : "UNKNOWN";
...
}(), ic = fe("SS2TerminalComms"), sc = function() {
function e() {}
...
if (!p) {
ic.warn("Missing packet in multi-packet message", {
meta: {
packetId: m,
messageId: s.msgId,
sender: i.sender.username
...
sender: i.sender.username,
message: d
}), this.messageBuffers.delete(c), this.saveStateToMemory(), ic.info("Received complete multi-packet message from ".concat(i.sender.username), {
meta: {
messageId: s.msgId,
packets: u.length,
totalSize: d.length,
...
return r.length > 0 && ic.debug("Processed ".concat(Game.market.incomingTransactions.length, " terminal transactions, completed ").concat(r.length, " messages")), 
r;
...
return i ? (this.queuePackets(e.id, t, r, o, a, i), ic.info("Queued ".concat(a.length, " packets for multi-packet message"), {
meta: {
terminalId: e.id,
messageId: i,
packets: a.length,
...
}), OK) : (ic.error("Failed to extract message ID from first packet"), ERR_INVALID_ARGS);
...
ic.debug("Queue processing stopped due to CPU budget limit (".concat(5, " CPU)"));
break;
}
...
ic.info("Completed sending multi-packet message", {
meta: {
messageId: h,
...
} else g === ERR_NOT_ENOUGH_RESOURCES ? ic.warn("Not enough resources to send packet, will retry next tick", {
meta: {
queueKey: p,
resource: d.resourceType,
amount: d.amount
}
}) : (ic.error("Failed to send packet: ".concat(g, ", removing queue item"), {
meta: {
queueKey: p,
result: g
}
}), s.push(p));
} else ic.warn("No packet at index ".concat(d.nextPacketIndex, ", removing queue item"), {
meta: {
queueKey: p
}
}), s.push(p);
}
} else ic.warn("Terminal not found for queue item, removing from queue", {
meta: {
queueKey: p,
...
return i > 0 && ic.debug("Sent ".concat(i, " queued packets this tick")), i;
...
ic.warn("Queue item timed out after ".concat(i - p.queuedAt, " ticks"), {
meta: {
messageId: d,
queueKey: m,
...
var s = a(i.value, 2), c = s[0], l = s[1];
r - l.receivedAt > this.MESSAGE_TIMEOUT && (ic.warn("Message timed out", {
meta: {
messageId: l.msgId,
sender: l.sender
}
...
return ic.error("Error parsing JSON", {
meta: {
error: String(e)
}
}), null;
...
}(), cc = dr("NativeCallsTracker");

function lc(e, t, r) {
var o = e[t];
if (o && !o.__nativeCallsTrackerWrapped) {
var n = Object.getOwnPropertyDescriptor(e, t);
if (n && !1 === n.configurable) cc.warn("Cannot wrap method - property is not configurable", {
meta: {
methodName: t
}
}); else try {
...
function e(e) {
void 0 === e && (e = {}), this.config = r(r({}, gc), e);
}
...
var n = uc.getSwarmState(r.toRoom);
...
function Tc(e, t) {
var r = function(e) {
var t, r = Math.min(3, Math.max(1, e.urgency)), o = null !== (t = Rc[r]) && void 0 !== t ? t : Rc[2];
return {
...
}(t), o = "defense_".concat(t.roomName, "_").concat(Game.time), n = Ec(e, t.roomName), a = {
id: o,
type: "defense",
members: [],
rallyRoom: n,
...
(dc = {})[RESOURCE_CATALYZED_GHODIUM_ALKALIDE] = 300, dc[RESOURCE_CATALYZED_UTRIUM_ACID] = 300, 
dc[RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE] = 300, (fc = {})[RESOURCE_CATALYZED_GHODIUM_ALKALIDE] = 600, 
fc[RESOURCE_CATALYZED_UTRIUM_ACID] = 600, fc[RESOURCE_CATALYZED_KEANIUM_ALKALIDE] = 300, 
fc[RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE] = 600, (yc = {})[RESOURCE_CATALYZED_GHODIUM_ALKALIDE] = 900, 
yc[RESOURCE_CATALYZED_UTRIUM_ACID] = 600, yc[RESOURCE_CATALYZED_ZYNTHIUM_ACID] = 900, 
yc[RESOURCE_CATALYZED_KEANIUM_ALKALIDE] = 600, yc[RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE] = 900;
...
var m = Game.rooms[u];
if (m && m.storage) {
var p = uc.getSwarmState(u);
if (p) {
var d = m.storage.store.getUsedCapacity(RESOURCE_ENERGY) - Oc(u, p.danger);
d > r && d > s && (s = d, i = u);
}
}
}
...
switch (e) {
case "harasser":
return Lc([ MOVE, ATTACK ], o, [ MOVE, ATTACK ]);

case "soldier":
return Lc([ TOUGH, MOVE, ATTACK, MOVE, ATTACK ], o, [ TOUGH, MOVE, ATTACK ]);

case "ranger":
return Lc([ TOUGH, MOVE, RANGED_ATTACK ], o, [ MOVE, RANGED_ATTACK ]);

case "healer":
return Lc([ TOUGH, MOVE, HEAL ], o, [ MOVE, HEAL ]);

case "siegeUnit":
return Lc([ TOUGH, MOVE, WORK ], o, [ TOUGH, MOVE, WORK ]);
...
function Bc(e) {
e.lastUpdate = Game.time;
var t = uc.getCluster(e.clusterId);
...
function e(e) {
void 0 === e && (e = {}), this.lastRun = new Map, this.config = r(r({}, Kc), e);
}
return e.prototype.run = function() {
var e = uc.getClusters();
for (var t in e) {
var r = e[t];
...
var l = Hc(e, new RoomPosition(s, c, e.name), "defense");
l.score > 0 && n.push(l);
}
}
...
var i = a.value, s = uc.getSwarmState(i);
if (s) {
var c = Oc(i, s.danger);
...
var m = u.value, p = uc.getSwarmState(m);
if (p && p.metrics) {
...
var t = Array.from(Fc.values()).filter(function(t) {
...
var a, i;
void 0 === n && (n = {});
var s = r(r({}, Ac), n), c = [], l = uc.getEmpire(), u = l.knownRooms || {}, m = new Set(l.warTargets || []);
for (var p in u) {
var d = u[p];
...
if (!(Game.time - y < 5e3)) {
var g = Mc(d, f, m.has(p), s), h = "neutral";
...
if (0 !== o.length) {
var n = o[0];
xc(e, n.doctrine) ? function(e, t, r) {
if (!function(e) {
var t = (uc.getEmpire().knownRooms || {})[e];
...
var o = (uc.getEmpire().knownRooms || {})[t], n = null != r ? r : Uc(t, {
...
if (!xc(e, n)) return ge.warn("Cannot launch ".concat(n, " operation on ").concat(t, " - insufficient resources"), {
subsystem: "Offensive"
}), null;
...
return n;
}(0, o), a = "".concat(r, "_").concat(t, "_").concat(Game.time), i = Ec(e, t), s = .3;
...
var r = t.id;
if (Pc.has(r)) ge.debug("Squad ".concat(r, " already forming"), {
...
var i = $s.NORMAL;
"siege" === t.type ? i = $s.HIGH : "defense" === t.type && (i = $s.EMERGENCY);
var s = function(r, a) {
for (var s = 0; s < a; s++) {
var c = Gc(r, 0, e.energyCapacityAvailable);
...
var e, t, r = Game.time;
try {
for (var o = n(Pc.entries()), i = o.next(); !i.done; i = o.next()) {
...
try {
for (var r = n(Fc.entries()), o = r.next(); !o.done; o = r.next()) {
var i = a(o.value, 2);
i[0], Bc(i[1]);
}
} catch (t) {
...
("complete" === c.state || "failed" === c.state) && l > 5e3 && (Fc.delete(s), ge.debug("Cleaned up operation ".concat(s), {
subsystem: "Offensive"
}));
}
} catch (t) {
...
var t = "cluster_".concat(e), r = uc.getCluster(t, e);
...
m && m.storage && m.storage.store.getUsedCapacity(RESOURCE_ENERGY) < 1e4 && bc(e, u.roomName, 2e4);
}
}
} catch (e) {
t = {
...
var jc, zc, Xc, Qc, Zc, Jc, $c, el, tl, rl, ol, nl, al, il = function() {
function e(e) {
void 0 === e && (e = {}), this.config = r(r({}, qc), e);
}
return e.prototype.run = function() {
var e, t;
if (!(Game.cpu.bucket < this.config.minBucket)) {
...
return e.role === Wc.SOURCE;
}), n = r.filter(function(e) {
return e.role === Wc.CONTROLLER;
}), a = r.filter(function(e) {
return e.role === Wc.STORAGE;
});
...
if (E.role === Wc.CONTROLLER && E.link.store.getUsedCapacity(RESOURCE_ENERGY) < this.config.controllerLinkMaxEnergy) {
h = E;
break;
}
if (E.role !== Wc.STORAGE) !h && E.link.store.getFreeCapacity(RESOURCE_ENERGY) > this.config.transferThreshold && (h = E); else if (E.link.store.getUsedCapacity(RESOURCE_ENERGY) < this.config.storageLinkReserve) {
h = E;
break;
}
}
...
if (a && e.pos.getRangeTo(a) <= 2) return Wc.CONTROLLER;
if (i && e.pos.getRangeTo(i) <= 2) return Wc.STORAGE;
try {
for (var c = n(s), l = c.next(); !l.done; l = c.next()) {
var u = l.value;
if (e.pos.getRangeTo(u) <= 2) return Wc.SOURCE;
}
} catch (e) {
t = {
error: e
...
return e.role === Wc.CONTROLLER || e.role === Wc.STORAGE;
});
return n && a;
...
sellThresholds: (jc = {}, jc[RESOURCE_ENERGY] = 5e5, jc[RESOURCE_HYDROGEN] = 2e4, 
jc[RESOURCE_OXYGEN] = 2e4, jc[RESOURCE_UTRIUM] = 2e4, jc[RESOURCE_LEMERGIUM] = 2e4, 
jc[RESOURCE_KEANIUM] = 2e4, jc[RESOURCE_ZYNTHIUM] = 2e4, jc[RESOURCE_CATALYST] = 2e4, 
jc),
buyThresholds: (zc = {}, zc[RESOURCE_ENERGY] = 1e5, zc[RESOURCE_HYDROGEN] = 5e3, 
zc[RESOURCE_OXYGEN] = 5e3, zc[RESOURCE_UTRIUM] = 5e3, zc[RESOURCE_LEMERGIUM] = 5e3, 
zc[RESOURCE_KEANIUM] = 5e3, zc[RESOURCE_ZYNTHIUM] = 5e3, zc[RESOURCE_CATALYST] = 5e3, 
zc),
...
function e(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = r(r({}, cl), e);
}
return e.prototype.run = function() {
...
function e(e) {
void 0 === e && (e = {}), this.transferQueue = [], this.config = r(r({}, dl), e);
}
...
e.length < 2 || (pl.clearOldCache(), this.cleanTransferQueue(), this.checkEmergencyTransfers(e), 
...
var m = pl.findOptimalRoute(u.name, t.name, c.config.emergencyEnergyAmount);
...
var b = pl.findOptimalRoute(e.name, l, w);
if (b) {
...
Game.time % 10 == 0 && ul.sellSurplusFromTerminal(e.name, T, w) && fr.info("Sold ".concat(w, " ").concat(T, " from ").concat(e.name, " terminal via market"), {
subsystem: "Terminal"
});
}
}
...
var o = pl.findOptimalRoute(t.room.name, e.room.name, r);
if (!o) return "continue";
var n = o.cost / r;
...
var c = pl.getNextHop(t.route, t.fromRoom);
c && (s = c);
}
...
}, hl = ((Xc = {})[RESOURCE_UTRIUM_BAR] = ((Qc = {})[RESOURCE_UTRIUM] = 500, Qc[RESOURCE_ENERGY] = 200, 
Qc), Xc[RESOURCE_LEMERGIUM_BAR] = ((Zc = {})[RESOURCE_LEMERGIUM] = 500, Zc[RESOURCE_ENERGY] = 200, 
Zc), Xc[RESOURCE_ZYNTHIUM_BAR] = ((Jc = {})[RESOURCE_ZYNTHIUM] = 500, Jc[RESOURCE_ENERGY] = 200, 
Jc), Xc[RESOURCE_KEANIUM_BAR] = (($c = {})[RESOURCE_KEANIUM] = 500, $c[RESOURCE_ENERGY] = 200, 
$c), Xc[RESOURCE_GHODIUM_MELT] = ((el = {})[RESOURCE_GHODIUM] = 500, el[RESOURCE_ENERGY] = 200, 
el), Xc[RESOURCE_OXIDANT] = ((tl = {})[RESOURCE_OXYGEN] = 500, tl[RESOURCE_ENERGY] = 200, 
tl), Xc[RESOURCE_REDUCTANT] = ((rl = {})[RESOURCE_HYDROGEN] = 500, rl[RESOURCE_ENERGY] = 200, 
rl), Xc[RESOURCE_PURIFIER] = ((ol = {})[RESOURCE_CATALYST] = 500, ol[RESOURCE_ENERGY] = 200, 
ol), Xc[RESOURCE_BATTERY] = ((nl = {})[RESOURCE_ENERGY] = 600, nl), Xc), vl = ((al = {})[RESOURCE_BATTERY] = 10, 
al[RESOURCE_UTRIUM_BAR] = 5, al[RESOURCE_LEMERGIUM_BAR] = 5, al[RESOURCE_ZYNTHIUM_BAR] = 5, 
al[RESOURCE_KEANIUM_BAR] = 5, al[RESOURCE_GHODIUM_MELT] = 4, al[RESOURCE_OXIDANT] = 3, 
al[RESOURCE_REDUCTANT] = 3, al[RESOURCE_PURIFIER] = 3, al), Rl = function() {
function e(e) {
void 0 === e && (e = {}), this.config = r(r({}, gl), e);
}
return e.prototype.run = function() {
var e, t;
if (!(Game.cpu.bucket < this.config.minBucket)) {
...
var o, i, s, c, l, u = [];
try {
for (var m = n(Object.entries(hl)), p = m.next(); !p.done; p = m.next()) {
...
var _ = null !== (l = vl[g]) && void 0 !== l ? l : 1, U = _ * v * (1 - b / this.config.outputBufferAmount);
u.push({
commodity: g,
priority: _,
score: U
...
var t, r;
try {
for (var o = n(Object.keys(hl)), a = o.next(); !a.done; a = o.next()) {
var i = a.value;
...
var t, r, o, i, s, c, l;
try {
var u = JSON.parse(e), m = Sl(JSON.stringify(u.d));
...
function e(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = r(r({}, Ml), e), this.interShardMemory = {
version: 1,
shards: {},
globalTargets: {
targetPowerLevel: 0
...
this.interShardMemory.shards[a] || (this.interShardMemory.shards[a] = Cl(a));
}, e.prototype.run = function() {
...
var o = kl[e.role], n = t === r ? Game.cpu.bucket : e.health.bucketLevel;
...
var t = wl(this.interShardMemory);
if (t.length > Ul) {
_r.warn("InterShardMemory size exceeds limit: ".concat(t.length, "/").concat(Ul), {
subsystem: "Shard"
}), this.trimInterShardMemory();
var r = wl(this.interShardMemory);
return r.length > Ul ? (_r.error("InterShardMemory still too large after trim: ".concat(r.length, "/").concat(Ul), {
subsystem: "Shard"
...
var i = a(o.value, 2), s = i[0], c = i[1];
c.health && "number" == typeof c.health.lastUpdate || (this.interShardMemory.shards[s] = Cl(s)), 
...
lastSync: 0,
checksum: 0
}, this.interShardMemory.shards[n] = Cl(n), _r.info("Recreated InterShardMemory with current shard only", {
subsystem: "Shard"
});
} catch (e) {
var a = e instanceof Error ? e.message : String(e);
...
var e, t, r = wl(this.interShardMemory).length, o = r / Ul * 100, a = Game.time - this.interShardMemory.lastSync, i = r < 92160 && a < 500, s = 0;
try {
...
var e, t, o = wl(this.interShardMemory).length, a = wl(r(r({}, this.interShardMemory), {
tasks: [],
globalTargets: {
targetPowerLevel: 0
}
...
size: o,
limit: Ul,
percent: Math.round(o / Ul * 1e4) / 100,
breakdown: {
shards: a,
tasks: i,
portals: s,
...
}, o([ (bl.LOW, function(e, t, r) {}) ], e.prototype, "run", null), o([ function(e) {
return e;
} ], e);
}(), Il = new Nl, Pl = function() {
function e() {
...
var a = Il.getActiveTransferTasks();
try {
for (var i = n(a), s = i.next(); !s.done; s = i.next()) {
var c = s.value;
...
var t = Il.getOptimalPortalRoute(e.targetShard);
if (t) {
...
Il.updateTaskProgress(e.taskId, t);
...
e.priority >= 80 ? _l.HIGH : e.priority >= 50 ? _l.NORMAL : _l.LOW;
...
if (0 === t.length) return e.status = "failed", void Il.updateTaskProgress(e.taskId, e.transferred, "failed");
t.filter(function(t) {
...
0 === t.length && (e.status = "complete", e.transferred = e.amount, Il.updateTaskProgress(e.taskId, 100, "complete"), 
Il.recordPortalTraversal(e.portalRoom, e.targetShard, !0), _r.info("Transfer request ".concat(e.taskId, " completed"), {
subsystem: "CrossShardTransfer"
}));
...
function e(e) {
void 0 === e && (e = {}), this.config = r(r({}, Wl), e);
}
...
criticalResourceThresholds: (xl = {}, xl[RESOURCE_GHODIUM] = 5e3, xl),
enabled: !0
}, Zl = function() {
function e(e, t) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = r(r({}, Ql), e), this.memoryAccessor = t;
}
...
function e(e, t) {
void 0 === e && (e = {}), this.config = r(r({}, Jl), e), this.memoryAccessor = t;
}
return e.prototype.setMemoryAccessor = function(e) {
this.memoryAccessor = e;
}, e.prototype.run = function() {
...
}, tu = 1e7, ru = 5e6, ou = ((Al = {})[STRUCTURE_SPAWN] = 15e3, Al[STRUCTURE_TOWER] = 5e3, 
Al[STRUCTURE_STORAGE] = 3e4, Al[STRUCTURE_TERMINAL] = 1e5, Al[STRUCTURE_LAB] = 5e4, 
Al[STRUCTURE_NUKER] = 1e5, Al[STRUCTURE_POWER_SPAWN] = 1e5, Al[STRUCTURE_OBSERVER] = 8e3, 
Al[STRUCTURE_EXTENSION] = 3e3, Al[STRUCTURE_LINK] = 5e3, Al);
...
var d = new RoomPosition(25, 25, e), f = lu(e, d, t);
...
i.estimatedDamage = tu + ru * l, i.estimatedValue = .01 * i.estimatedDamage;
}
return i;
}
...
try {
for (var m = n(u), p = m.next(); !p.done; p = m.next()) {
var d = p.value.structure, f = Math.abs(d.pos.x - t.x), y = Math.abs(d.pos.y - t.y), g = 0 === Math.max(f, y) ? tu : ru;
d.hits <= g ? (i.estimatedDamage += d.hits, i.threatenedStructures.push("".concat(d.structureType, "-").concat(d.pos.x, ",").concat(d.pos.y)), 
i.estimatedValue += uu(d)) : i.estimatedDamage += g;
}
} catch (e) {
o = {
error: e
...
var pu = function() {
function e(e, t) {
void 0 === e && (e = {}), this.nukerReadyLogged = new Set, this.config = r(r({}, eu), e), 
...
}(t, this.config, this.getSwarmState, iu), function(e, t, r, o) {
var n, a;
...
y.siegeSquadId || g <= t.siegeCoordinationWindow && g > 0 && mu(y, p, o) && ge.info("Siege squad deployment coordinated with nuke on ".concat(y.targetRoom, ", ") + "impact in ".concat(g, " ticks"), {
subsystem: "Nuke"
});
}
} catch (e) {
...
var h = new RoomPosition(25, 25, d.roomName), v = cu(d.roomName, h, e), R = lu(d.roomName, h, e);
...
var i = a.value;
if (!i.evacuationTriggered && nu(i)) {
var s = Game.rooms[i.roomName];
if (s) {
var c = this.getSwarmState(i.roomName);
c && (au(s, i, c), i.evacuationTriggered = !0);
}
}
}
} catch (e) {
...
try {
for (var y = n(du), g = y.next(); !g.done; g = y.next()) {
var h = g.value;
if (!(h.cost <= o)) break;
f = h;
}
...
function e(e) {
void 0 === e && (e = {}), this.coordinator = new pu(r(r({}, yu), e), {
getEmpire: function() {
return Qe.getEmpire();
},
...
function r(t) {
return void 0 === t && (t = {}), e.call(this, t, new hu) || this;
}
...
function e(e) {
void 0 === e && (e = {}), this.config = r(r({}, wu), e);
}
return e.prototype.run = function() {
var e, t, r, o, a, i = Object.values(Game.rooms).filter(function(e) {
var t;
...
var r, o, a = ca(e, t), i = a.get(e.name);
...
role: "larvaWorker",
family: "economy",
bodies: [ ku([ WORK, CARRY ], 150), ku([ WORK, CARRY, MOVE ], 200), ku([ WORK, WORK, CARRY, CARRY, MOVE, MOVE ], 400), ku([ WORK, WORK, WORK, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE ], 600), ku([ WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 800) ],
priority: 100,
maxPerRoom: 3,
remoteRole: !1
},
...
role: "harvester",
family: "economy",
bodies: [ ku([ WORK, WORK, MOVE ], 250), ku([ WORK, WORK, WORK, WORK, MOVE, MOVE ], 500), ku([ WORK, WORK, WORK, WORK, WORK, MOVE, MOVE, MOVE ], 700), ku([ WORK, WORK, WORK, WORK, WORK, WORK, MOVE, MOVE, MOVE ], 800), ku([ WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, MOVE, MOVE, MOVE, MOVE ], 1e3) ],
priority: 95,
maxPerRoom: 2,
remoteRole: !1
},
...
role: "hauler",
family: "economy",
bodies: [ ku([ CARRY, CARRY, MOVE, MOVE ], 200), ku([ CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 400), ku([ CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 800), ku(i(i([], a(Array(16).fill(CARRY)), !1), a(Array(16).fill(MOVE)), !1), 1600) ],
priority: 90,
maxPerRoom: 2,
remoteRole: !0
},
...
role: "upgrader",
family: "economy",
bodies: [ ku([ WORK, CARRY, MOVE ], 200), ku([ WORK, WORK, WORK, CARRY, MOVE, MOVE ], 450), ku([ WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 1e3), ku([ WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 1700) ],
priority: 60,
maxPerRoom: 2,
remoteRole: !1
},
...
role: "builder",
family: "economy",
bodies: [ ku([ WORK, CARRY, MOVE, MOVE ], 250), ku([ WORK, WORK, WORK, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 650), ku([ WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 1400) ],
priority: 70,
maxPerRoom: 2,
remoteRole: !1
},
...
role: "queenCarrier",
family: "economy",
bodies: [ ku([ CARRY, CARRY, CARRY, CARRY, MOVE, MOVE ], 300), ku([ CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE ], 450), ku([ CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 600) ],
priority: 85,
maxPerRoom: 1,
remoteRole: !1
},
...
family: "economy",
bodies: [ ku([ WORK, WORK, WORK, WORK, CARRY, MOVE, MOVE ], 550), ku([ WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, MOVE, MOVE, MOVE ], 850) ],
priority: 40,
maxPerRoom: 1,
remoteRole: !1
},
...
role: "labTech",
family: "economy",
bodies: [ ku([ CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 400), ku([ CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 600) ],
priority: 35,
maxPerRoom: 1,
remoteRole: !1
},
...
family: "economy",
bodies: [ ku([ WORK, WORK, CARRY, MOVE, MOVE, MOVE ], 400), ku([ WORK, WORK, WORK, WORK, WORK, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 750), ku([ WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 1050), ku([ WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 1600) ],
priority: 85,
maxPerRoom: 6,
remoteRole: !0
},
...
role: "remoteHauler",
family: "economy",
bodies: [ ku([ CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 400), ku([ CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 800), ku(i(i([], a(Array(16).fill(CARRY)), !1), a(Array(16).fill(MOVE)), !1), 1600) ],
priority: 80,
maxPerRoom: 6,
remoteRole: !0
},
...
family: "economy",
bodies: [ ku([ CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 400), ku([ CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 600), ku([ CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 800) ],
priority: 90,
maxPerRoom: 4,
remoteRole: !1
},
...
family: "economy",
bodies: [ ku(i(i([], a(Array(4).fill(CARRY)), !1), a(Array(4).fill(MOVE)), !1), 400), ku(i(i([], a(Array(8).fill(CARRY)), !1), a(Array(8).fill(MOVE)), !1), 800), ku(i(i([], a(Array(12).fill(CARRY)), !1), a(Array(12).fill(MOVE)), !1), 1200), ku(i(i([], a(Array(16).fill(CARRY)), !1), a(Array(16).fill(MOVE)), !1), 1600) ],
priority: 85,
maxPerRoom: 6,
remoteRole: !0
},
...
role: "guard",
family: "military",
bodies: [ ku([ TOUGH, ATTACK, ATTACK, MOVE, MOVE, MOVE ], 310), ku([ TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 620), ku([ TOUGH, TOUGH, TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 1070), ku([ TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, RANGED_ATTACK, RANGED_ATTACK, HEAL, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 1740) ],
priority: 65,
maxPerRoom: 4,
remoteRole: !1
},
...
role: "remoteGuard",
family: "military",
bodies: [ ku([ TOUGH, ATTACK, MOVE, MOVE ], 190), ku([ TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE ], 500), ku([ TOUGH, TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 880) ],
priority: 65,
maxPerRoom: 2,
remoteRole: !0
},
...
role: "healer",
family: "military",
bodies: [ ku([ HEAL, MOVE, MOVE ], 350), ku([ TOUGH, HEAL, HEAL, MOVE, MOVE, MOVE ], 620), ku([ TOUGH, TOUGH, HEAL, HEAL, HEAL, HEAL, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 1240), ku([ TOUGH, TOUGH, TOUGH, TOUGH, HEAL, HEAL, HEAL, HEAL, HEAL, HEAL, HEAL, HEAL, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 2640) ],
priority: 55,
maxPerRoom: 1,
remoteRole: !1
},
...
role: "soldier",
family: "military",
bodies: [ ku([ ATTACK, ATTACK, MOVE, MOVE ], 260), ku([ ATTACK, ATTACK, ATTACK, ATTACK, MOVE, MOVE, MOVE, MOVE ], 520), ku([ TOUGH, TOUGH, TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, RANGED_ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 1340) ],
priority: 50,
maxPerRoom: 1,
remoteRole: !1
},
...
role: "siegeUnit",
family: "military",
bodies: [ ku([ WORK, WORK, MOVE, MOVE ], 300), ku([ TOUGH, TOUGH, WORK, WORK, WORK, WORK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 620), ku([ TOUGH, TOUGH, TOUGH, TOUGH, WORK, WORK, WORK, WORK, WORK, WORK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 1040) ],
priority: 30,
maxPerRoom: 1,
remoteRole: !1
},
...
role: "ranger",
family: "military",
bodies: [ ku([ TOUGH, RANGED_ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE ], 360), ku([ TOUGH, TOUGH, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE ], 570), ku([ TOUGH, TOUGH, TOUGH, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 1040), ku([ TOUGH, TOUGH, TOUGH, TOUGH, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 1480) ],
priority: 60,
maxPerRoom: 4,
remoteRole: !1
},
...
role: "harasser",
family: "military",
bodies: [ ku([ TOUGH, ATTACK, RANGED_ATTACK, MOVE, MOVE ], 320), ku([ TOUGH, TOUGH, ATTACK, ATTACK, RANGED_ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE ], 640), ku([ TOUGH, TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, HEAL, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 1200) ],
priority: 40,
maxPerRoom: 1,
remoteRole: !1
},
...
role: "claimer",
family: "utility",
bodies: [ ku([ CLAIM, MOVE ], 650), ku([ CLAIM, CLAIM, MOVE, MOVE ], 1300) ],
priority: 50,
maxPerRoom: 3,
remoteRole: !0
},
...
role: "engineer",
family: "utility",
bodies: [ ku([ WORK, CARRY, MOVE, MOVE ], 250), ku([ WORK, WORK, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 500) ],
priority: 55,
maxPerRoom: 2,
remoteRole: !1
},
...
role: "remoteWorker",
family: "utility",
bodies: [ ku([ WORK, WORK, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 500), ku([ WORK, WORK, WORK, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 750) ],
priority: 45,
maxPerRoom: 4,
remoteRole: !0
},
...
role: "powerHarvester",
family: "power",
bodies: [ ku([ TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 2300), ku([ TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 3e3) ],
priority: 30,
maxPerRoom: 2,
remoteRole: !0
},
...
role: "powerCarrier",
family: "power",
bodies: [ ku(i(i([], a(Array(20).fill(CARRY)), !1), a(Array(20).fill(MOVE)), !1), 2e3), ku(i(i([], a(Array(25).fill(CARRY)), !1), a(Array(25).fill(MOVE)), !1), 2500) ],
priority: 25,
maxPerRoom: 2,
remoteRole: !0
}
...
var Gu = new Map, Lu = -1, Du = null;

function Fu(e, t) {
var r, o;
void 0 === t && (t = !1), Lu === Game.time && Du === Game.creeps || (Gu.clear(), 
Lu = Game.time, Du = Game.creeps);
var n = t ? "".concat(e, "_active") : e, a = Gu.get(n);
...
try {
for (var u = n(l), m = u.next(); !m.done; m = u.next()) {
var p = m.value, d = Bu(e, t, p), f = Game.rooms[p];
if (d < ("remoteHarvester" === t ? f ? Tt(f).length : 2 : "remoteHauler" === t && f ? fu(e, p, Tt(f).length, null !== (c = null === (s = Game.rooms[e]) || void 0 === s ? void 0 : s.energyCapacityAvailable) && void 0 !== c ? c : 800).recommendedHaulers : 2)) return p;
}
} catch (e) {
o = {
error: e
...
if ("remoteHarvester" === t || "remoteHauler" === t) return null !== Hu(e, t, r);
if ("remoteWorker" === t) {
if (0 === (p = null !== (s = r.remoteAssignments) && void 0 !== s ? s : []).length) return !1;
var m = function(e, t) {
Lu === Game.time && Du === Game.creeps || (Gu.clear(), Lu = Game.time, Du = Game.creeps);
var r = "".concat(e, ":").concat(t), o = Gu.get(r);
...
if (h.length > 0 && Bu(e, t, y) < Math.min(u.maxPerRoom, Math.ceil(h.length / 2))) return !0;
}
}
} catch (e) {
a = {
...
var v = null !== (l = Fu(e).get(t)) && void 0 !== l ? l : 0, R = u.maxPerRoom;
...
if (u) {
var m = e.energyCapacityAvailable, p = e.energyAvailable, d = 0 === Yu(Fu(e.name, !0)), f = d ? p : m;
...
var y = Fu(e.name, !0), g = Fu(e.name, !1), h = null !== (i = y.get("larvaWorker")) && void 0 !== i ? i : 0, v = null !== (s = y.get("harvester")) && void 0 !== s ? s : 0;
ge.info("BOOTSTRAP MODE: ".concat(Yu(y), " active energy producers ") + "(".concat(h, " larva, ").concat(v, " harvest), ").concat(Yu(g), " total. ") + "Energy: ".concat(p, "/").concat(m), {
subsystem: "spawn",
room: e.name
});
}
...
var R = function(e, t, r) {
var o, a, i;
if (0 === Yu(Fu(e, !0))) return ge.info("Bootstrap: Spawning larvaWorker (emergency - no active energy producers)", {
subsystem: "spawn",
room: e
}), "larvaWorker";
var s = Fu(e, !1), c = Vu(t);
...
if (!(_ = Nu[R])) return;
var E = ju(_, f);
if (E && p >= E.cost) ; else if (!(E = ju(_, p))) return void ge.info("Bootstrap: No affordable body for ".concat(R, " (available: ").concat(p, ", min needed: ").concat(null !== (l = null === (c = _.bodies[0]) || void 0 === c ? void 0 : c.cost) && void 0 !== l ? l : "unknown", ")"), {
subsystem: "spawn",
room: e.name
});
var T = zu(R);
...
var w = function(e, t) {
var r, o, i, s, c = Fu(e.name), l = function(e) {
switch (e) {
case "eco":
return {
harvester: 1.5,
...
try {
for (var m = n(Object.entries(Nu)), p = m.next(); !p.done; p = m.next()) {
var d = a(p.value, 2), f = d[0], y = d[1];
if (Ku(e.name, f, t)) {
var g = y.priority, h = null !== (i = l[f]) && void 0 !== i ? i : .5, v = Pu(f, t.pheromones), R = Iu(e, t, f), E = null !== (s = c.get(f)) && void 0 !== s ? s : 0, T = (g + R) * h * v * (y.maxPerRoom > 0 ? Math.max(.1, 1 - E / y.maxPerRoom) : .1);
u.push({
role: f,
score: T
});
...
!function(e, t, r, o, n) {
void 0 === o && (o = za.MEDIUM), ri.register({
id: e,
interval: t,
execute: r,
priority: o,
maxCpu: n,
skippable: o !== za.CRITICAL
});
}(e, t, r, o, n);
}
}, am = new tm({
...
}, om), im = new rm(om, nm, am), sm = function() {
function e() {
...
!function(e, t) {
am.precacheRemoteRoutes(e, t);
}(e, t);
}, e;
}(), mm = new Zu(new sm, new cm, new lm, new um), pm = {
lowBucketThreshold: 2e3,
...
new dm, (em = {})[FIND_STRUCTURES] = {
lowBucket: 100,
normal: 50,
highBucket: 20
}, em[FIND_MY_STRUCTURES] = {
lowBucket: 100,
normal: 50,
highBucket: 20
}, em[FIND_HOSTILE_STRUCTURES] = {
lowBucket: 50,
normal: 20,
highBucket: 10
}, em[FIND_SOURCES_ACTIVE] = {
lowBucket: 1e4,
normal: 5e3,
highBucket: 1e3
}, em[FIND_SOURCES] = {
...
normal: 100,
highBucket: 50
}, em[FIND_MY_CONSTRUCTION_SITES] = {
lowBucket: 50,
normal: 20,
highBucket: 10
}, em[FIND_CONSTRUCTION_SITES] = {
lowBucket: 50,
normal: 20,
highBucket: 10
}, em[FIND_CREEPS] = {
...
normal: 5,
highBucket: 3
}, em[FIND_HOSTILE_CREEPS] = {
lowBucket: 10,
normal: 3,
highBucket: 1
}, em[FIND_DROPPED_RESOURCES] = {
lowBucket: 20,
normal: 5,
highBucket: 3
}, em[FIND_TOMBSTONES] = {
...
normal: 100,
highBucket: 50
}, em[FIND_HOSTILE_SPAWNS] = {
lowBucket: 100,
normal: 50,
highBucket: 20
}, em[FIND_HOSTILE_CONSTRUCTION_SITES] = {
lowBucket: 50,
normal: 20,
highBucket: 10
}, em[FIND_NUKES] = {
...
normal: 20,
highBucket: 10
}, em[FIND_POWER_CREEPS] = {
lowBucket: 20,
normal: 10,
highBucket: 5
}, em[FIND_MY_POWER_CREEPS] = {
lowBucket: 20,
normal: 10,
highBucket: 5
}, em[FIND_HOSTILE_POWER_CREEPS] = {
lowBucket: 20,
normal: 10,
highBucket: 5
}, em[FIND_EXIT_TOP] = {
...
var fm = new Dt({}, Qe), ym = new Wt({}, Qe), gm = !1, hm = !1;

function vm() {
var e, t;
hm && Game.time % 10 != 0 || fr.info("SwarmBot loop executing at tick ".concat(Game.time), {
subsystem: "SwarmBot",
meta: {
...
if (e && !1 === e.configurable) cc.warn("Cannot wrap PathFinder.search - property is not configurable"); else {
...
cc.warn("Failed to wrap PathFinder.search", {
meta: {
error: String(e)
}
});
...
}(), lc(e = Creep.prototype, "moveTo", "moveTo"), lc(e, "move", "move"), lc(e, "harvest", "harvest"), 
lc(e, "transfer", "transfer"), lc(e, "withdraw", "withdraw"), lc(e, "build", "build"), 
lc(e, "repair", "repair"), lc(e, "upgradeController", "upgradeController"), lc(e, "attack", "attack"), 
lc(e, "rangedAttack", "rangedAttack"), lc(e, "heal", "heal"), lc(e, "dismantle", "dismantle"), 
lc(e, "say", "say")), function(e, t, r) {
...
}(Vr, Qe, ss), mm.initializePathCacheEvents(), im.initialize(za.MEDIUM), Ae.initialize(), 
_u.initialize(), hm = !0), Vr.updateFromCpuConfig(nt().cpu), gm || (fr.info("Registering all processes with kernel...", {
...
}(xu, yl, El, sl, Xl, fo, bu, ul, vu, Eu, gu, Ho, qo, _u, Fl, Po, Vc, ba, fa), fr.info("Registered ".concat(Vr.getProcesses().length, " processes with kernel"), {
subsystem: "ProcessRegistry"
}), Vr.initialize(), gm = !0), Un.startTick(), "critical" === Vr.getBucketMode() && Game.time % 10 == 0 && fr.warn("CRITICAL: CPU bucket at ".concat(Game.cpu.bucket, ", continuing normal processing"), {
subsystem: "SwarmBot"
}), Au.clear(), xa.clear(), kr.startTick();
var r, o = "_ownedRooms", a = "_ownedRoomsTick", i = global, s = i[o], c = i[a];
s && c === Game.time ? r = s : (r = Object.values(Game.rooms).filter(function(e) {
var t;
return null === (t = e.controller) || void 0 === t ? void 0 : t.my;
}), i[o] = r, i[a] = Game.time), Ga.preTick(), Qe.initialize(), Un.measureSubsystem("processSync", function() {
os.syncCreepProcesses(), tc.syncRoomProcesses();
...
for (var o = n(Object.values(Game.rooms)), a = o.next(); !a.done; a = o.next()) {
var i = a.value;
(null === (r = i.controller) || void 0 === r ? void 0 : r.my) && Xu(i, Qe.getOrInitSwarmState(i.name));
}
} catch (t) {
e = {
error: t
...
}), Ga.reconcileTraffic(), Vr.hasCpuBudget() && Un.measureSubsystem("scheduledTasks", function() {
var e;
e = Math.max(0, Game.cpu.limit - Game.cpu.getUsed()), ri.run(e);
...
function e() {}
return e.prototype.status = function() {
var e, t, r = null !== (t = null === (e = Game.shard) || void 0 === e ? void 0 : e.name) && void 0 !== t ? t : "shard0", o = _u.getCurrentShardState();
...
return t.includes(e) ? (_u.setShardRole(e), "Shard role set to: ".concat(e.toUpperCase())) : "Invalid role: ".concat(e, ". Valid roles: ").concat(t.join(", "));
}, e.prototype.portals = function(e) {
var t, r, o, a, i, s = null !== (a = null === (o = Game.shard) || void 0 === o ? void 0 : o.name) && void 0 !== a ? a : "shard0", c = _u.getCurrentShardState();
...
var r, o = _u.getOptimalPortalRoute(e, t);
...
return n.includes(e) ? (_u.createTask(e, t, r, o), "Created ".concat(e, " task to ").concat(t).concat(r ? "/".concat(r) : "", " (priority: ").concat(o, ")")) : "Invalid task type: ".concat(e, ". Valid types: ").concat(n.join(", "));
}, e.prototype.transferResource = function(e, t, r, o, n) {
return void 0 === n && (n = 50), _u.createResourceTransferTask(e, t, r, o, n), "Created resource transfer task:\n" + "  ".concat(o, " ").concat(r, " → ").concat(e, "/").concat(t, "\n") + "  Priority: ".concat(n);
}, e.prototype.transfers = function() {
var e, t, r = Gl.getActiveRequests();
...
var e, t, r = _u.getCurrentShardState();
...
var e, t, r, o = _u.getActiveTransferTasks();
...
return _u.forceSync(), "InterShardMemory sync forced. Check logs for results.";
}, o([ vr({
name: "shard.status",
...
params: e.metadata.usage ? Cm(e.metadata.usage) : void 0
};
});
return ui({
name: e,
...
return ui.apply(void 0, i([], a(o), !1));
}();
}, e.prototype.spawnForm = function(e) {
return Game.rooms[e] ? li.form("spawnCreep", [ {
type: "select",
name: "role",
label: "Role:",
options: [ {
...
}) : ci("Room ".concat(e, " not found or not visible"), "red", !0);
}, e.prototype.roomControl = function(e) {
var t = Game.rooms[e];
if (!t) return ci("Room ".concat(e, " not found or not visible"), "red", !0);
...
r += '<div style="margin-bottom: 10px;">', r += ci("Energy: ".concat(t.energyAvailable, "/").concat(t.energyCapacityAvailable), "green") + "<br>", 
t.controller && (r += ci("Controller Level: ".concat(t.controller.level, " (").concat(t.controller.progress, "/").concat(t.controller.progressTotal, ")"), "blue") + "<br>"), 
r += "</div>", r += li.button({
...
return li.form("configureLogging", [ {
type: "select",
name: "level",
label: "Log Level:",
options: [ {
...
return li.form("configureVisualization", [ {
type: "select",
name: "mode",
...
return e += ci("✓ Success message", "green", !0) + "\n", e += ci("⚠ Warning message", "yellow", !0) + "\n", 
e += ci("✗ Error message", "red", !0) + "\n", e += ci("ℹ Info message", "blue", !0) + "\n", 
(e += "\nNormal text: " + ci("colored text", "green") + " normal text\n") + "Bold text: " + ci("important", null, !0) + "\n";
}, o([ vr({
name: "uiHelp",
...
var Sm = new oc, wm = new Rm, Om = new nc, bm = new En, _m = new rc, Um = new ac, xm = dr("Main");

!function(e) {
void 0 === e && (e = !1);
var t = function() {
hr.initialize(), Rr(Sm), Rr(wm), Rr(Om), Rr(bm), Rr(_m), Rr(Um), Rr(hn), Rr(vn), 
Rr(Rn), Rr(Tm), Rr(Or), Rr(go), Rr(Do), global.tooangel = Go;
var e = global;
e.botConfig = {
getConfig: nt,
updateConfig: at
