...
function D() {
return M || (M = 1, e = G, t = G.exports, function(r) {
...
function x(e) {
var t, r, o, n, a, i, s, l, m, p, f, g, v, E, T, S = [];
for (g = (e = R(e)).length, t = 128, r = 0, a = 72, i = 0; i < g; ++i) (f = e[i]) < 128 && S.push(y(f));
...
E = u - p, S.push(y(C(p + T % E, 0))), l = d(T / E);
...
function F() {
return k ? U : (k = 1, U = TypeError);
}

var B, W, j, V, K, H, q, Y, z, X, Q, J, $, Z, ee, te, re, oe, ne, ae, ie, se, ce, ue, le, me, pe, fe, de, ye, he, ge, ve, Re, Ee, Te, Se, Ce, we, be, xe, Oe, _e, Ae, Ne, Me, Ue, ke, Pe, Ie, Ge, Le, De, Fe, Be, We, je, Ve, Ke, He, qe, Ye, ze, Xe, Qe, Je, $e, Ze, et, tt, rt, ot, nt, at, it, st, ct, ut, lt, mt, pt, ft, dt, yt, ht, gt, vt, Rt, Et, Tt, St, Ct, wt = S(Object.freeze({
__proto__: null,
default: {}
}));
...
var k = wt, P = k.custom, I = H(P) ? P : null, G = {
__proto__: null,
double: '"',
single: "'"
}, L = {
...
function V(e) {
return "[object Array]" === z(e) && j(e);
}
function K(e) {
return "[object RegExp]" === z(e) && j(e);
}
function H(e) {
...
var R = !Y(g, "customInspect") || g.customInspect;
...
return n.lastIndex = 0, D(h.call(h.call(e, n, "\\$1"), /[\x00-\x1f]/g, J), "single", t);
}
function J(e) {
...
for (var c in e) Y(e, c) && (r && String(Number(c)) === c && c < e.length || _ && a["$" + c] instanceof Symbol || (R.call(/[^\w$]/, c) ? o.push(t(c, e) + ": " + t(e[c], e)) : o.push(c + ": " + t(e[c], e))));
...
function xt() {
return H ? K : (H = 1, K = Object);
}

function Ot() {
return Y ? q : (Y = 1, q = Error);
}
...
function At() {
return J ? Q : (J = 1, Q = RangeError);
}

function Nt() {
return Z ? $ : (Z = 1, $ = ReferenceError);
}
...
function Lt() {
return fe ? pe : (fe = 1, pe = Math.pow);
}

function Dt() {
return ye ? de : (ye = 1, de = Math.round);
}
...
function Ht() {
return Me ? Ne : (Me = 1, Ne = "undefined" != typeof Reflect && Reflect.getPrototypeOf || null);
}

function qt() {
return ke ? Ue : (ke = 1, Ue = xt().getPrototypeOf || null);
}
...
if (He) return Ke;
He = 1;
var e = zt(), t = Qt(), r = Xt(), o = Ve ? je : (Ve = 1, je = "undefined" != typeof Reflect && Reflect && Reflect.apply);
return Ke = o || e.call(r, t);
}();
...
var e;
tt = 1;
var t = xt(), r = Ot(), o = _t(), n = At(), a = Nt(), i = Mt(), s = F(), c = Ut(), u = kt(), l = Pt(), m = It(), p = Gt(), f = Lt(), d = Dt(), y = Bt(), h = Function, g = function(e) {
try {
return h('"use strict"; return (' + e + ").constructor;")();
} catch (e) {}
}, v = jt(), R = Vt(), E = function() {
throw new s;
}, T = v ? function() {
try {
return E;
...
}() : E, S = Kt()(), C = Zt(), w = qt(), b = Ht(), x = Qt(), O = Xt(), _ = {}, A = "undefined" != typeof Uint8Array && C ? C(Uint8Array) : e, N = {
__proto__: null,
...
}, P = zt(), I = er(), G = P.call(O, Array.prototype.concat), L = P.call(x, Array.prototype.splice), D = P.call(O, String.prototype.replace), B = P.call(O, String.prototype.slice), W = P.call(O, RegExp.prototype.exec), j = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, V = /\\(\\)?/g, K = function(e, t) {
var r, o = e;
if (I(k, o) && (o = "%" + (r = k[o])[0] + "%"), I(N, o)) {
var n = N[o];
...
var o = [];
return D(e, j, function(e, t, r, n) {
o[o.length] = r ? D(n, V, "$1") : t || e;
}), o;
...
if (ot) return rt;
ot = 1;
var e = tr(), t = Jt(), r = t([ e("%String.prototype.indexOf%") ]);
...
w.set(o, _);
var W = e();
W.set(m, w), s(U, r(D, B, i, c, u, p, f, d, "comma" === i && S && a(x) ? null : y, h, g, v, R, E, T, S, C, W));
}
}
return U;
};
...
var M = A[x];
if (M && !M.match(u)) {
for (var U = "", k = 0, P = M.length; k < P; k++) M.charCodeAt(k) > 127 ? U += "x" : U += M[k];
if (!U.match(u)) {
...
if (!m[T]) for (x = 0, N = i.length; x < N; x++) {
var B = i[x];
if (-1 !== v.indexOf(B)) {
...
var j = v.indexOf("#");
-1 !== j && (this.hash = v.substr(j), v = v.slice(0, j));
var V = v.indexOf("?");
if (-1 !== V ? (this.search = v.substr(V), this.query = v.substr(V + 1), o && (this.query = d.parse(this.query)), 
...
return P.normalize = d, P.join = y, P.relative = function(t, r) {
...
if (yr) return x;
yr = 1;
const e = N(), t = lr(), r = fr().ArraySet, o = function() {
if (dr) return hr;
dr = 1;
const e = lr();
...
var Ar, Nr, Mr, Ur = {}, kr = (Nr || (Nr = 1, b.SourceMapGenerator = gr().SourceMapGenerator, 
b.SourceMapConsumer = function() {
if (br) return Rr;
br = 1;
const e = lr(), t = Tr(), r = fr().ArraySet;
N();
...
function Vr(e, t) {
Ir.level <= Mr.DEBUG && Fr(jr("DEBUG", e, t));
}

function Kr(e, t) {
Ir.level <= Mr.INFO && Fr(jr("INFO", e, t));
}

function Hr(e, t) {
Ir.level <= Mr.WARN && Fr(jr("WARN", e, t));
}

function qr(e, t) {
Ir.level <= Mr.ERROR && Fr(jr("ERROR", e, t));
}

function Yr(e, t, r) {
if (!Ir.cpuLogging) return t();
var o = Game.cpu.getUsed(), n = t(), a = Game.cpu.getUsed() - o;
return Vr("".concat(e, ": ").concat(a.toFixed(3), " CPU"), r), n;
}
...
var c = f(s.value, 2), u = c[0], l = c[1];
void 0 !== l.ttl && l.ttl !== $r && Game.time - l.lastModified > l.ttl ? a++ : (r.entries.set(u, {
value: l.value,
...
var u = f(c.value, 2), l = u[0], m = u[1];
void 0 !== m.ttl && m.ttl !== $r && Game.time - m.lastModified > m.ttl && (n.entries.delete(l), 
i++);
}
} catch (t) {
e = {
...
try {
for (var d = p(Object.entries(a.data)), y = d.next(); !y.done; y = d.next()) {
var h = f(y.value, 2), g = (l = h[0], h[1]);
void 0 !== g.ttl && g.ttl !== $r && Game.time - g.lastModified > g.ttl && (delete a.data[l], 
i++);
}
} catch (e) {
r = {
...
}(), ro = new to, oo = "errorMapper_sourceMapData", no = "errorMapper_sourceMapAvailable";
...
if (!1 === ro.get(no)) return this._consumer = null, this._sourceMapAvailable = !1, 
null;
try {
var t = ro.get(oo);
if (!t) {
...
this._consumer = null, this._sourceMapAvailable = !1, ro.set(no, !1, 1 / 0), null;
} else t = r;
ro.set(oo, t, 1 / 0);
}
try {
this._consumer = new kr.SourceMapConsumer(t), this._sourceMapAvailable = !0, ro.set(no, !0, 1 / 0);
} catch (e) {
console.log("SourceMapConsumer requires async initialization - source maps disabled"), 
this._consumer = null, this._sourceMapAvailable = !1, ro.set(no, !1, 1 / 0);
}
} catch (e) {
this._consumer = null, this._sourceMapAvailable = !1, ro.set(no, !1, 1 / 0);
}
...
var r;
this.commands.has(e.name) && Jr.warn('Command "'.concat(e.name, '" is already registered, overwriting'), {
...
handler: t
}), Jr.debug('Registered command "'.concat(e.name, '"'), {
subsystem: "CommandRegistry"
});
}, e.prototype.unregister = function(e) {
var t = this.commands.delete(e);
return t && Jr.debug('Unregistered command "'.concat(e, '"'), {
subsystem: "CommandRegistry"
}), t;
...
try {
for (var d = p(i), y = d.next(); !y.done; y = d.next()) {
var h = f(y.value, 2), g = (l = h[0], h[1]);
...
try {
return o.handler.apply(o, d([], f(t), !1));
} catch (t) {
var n = t instanceof Error ? t.message : String(t);
return Jr.error('Error executing command "'.concat(e, '": ').concat(n), {
subsystem: "CommandRegistry"
}), "Error: ".concat(n);
}
...
var f = m.value, d = s.get(f);
if (d && 0 !== d.length) {
c.push("--- ".concat(f, " ---"));
try {
for (var y = (r = void 0, p(d)), h = y.next(); !h.done; h = y.next()) {
...
this.commandsExposed = !0, Jr.debug("Exposed ".concat(this.commands.size, " commands to global scope"), {
subsystem: "CommandRegistry"
});
}
o.help = function(e) {
...
}), this.initialized = !0, Jr.info("Command registry initialized", {
subsystem: "CommandRegistry"
}));
}, e.prototype.enableLazyLoading = function(e) {
this.lazyLoadEnabled = !0, this.registrationCallback = e, Jr.info("Console commands lazy loading enabled", {
subsystem: "CommandRegistry"
});
}, e.prototype.triggerLazyLoad = function() {
!this.commandsRegistered && this.registrationCallback && (Jr.debug("Lazy loading console commands on first access", {
subsystem: "CommandRegistry"
...
try {
for (var n = p(co), a = n.next(); !a.done; a = n.next()) {
var i = a.value;
if (fo(i.target, o)) {
var s = e[i.methodName];
if ("function" == typeof s) {
var c = s.bind(e);
lo.register(i.metadata, c), Jr.debug('Registered decorated command "'.concat(i.metadata.name, '"'), {
subsystem: "CommandRegistry"
});
}
}
...
var yo, ho, go = {
"hostile.detected": io.CRITICAL,
"nuke.detected": io.CRITICAL,
"safemode.activated": io.CRITICAL,
"structure.destroyed": io.HIGH,
"hostile.cleared": io.HIGH,
"creep.died": io.HIGH,
"energy.critical": io.HIGH,
"spawn.emergency": io.HIGH,
"posture.change": io.HIGH,
"spawn.completed": io.NORMAL,
"rcl.upgrade": io.NORMAL,
"construction.complete": io.NORMAL,
"remote.lost": io.NORMAL,
"squad.formed": io.NORMAL,
"squad.dissolved": io.NORMAL,
"market.transaction": io.LOW,
"pheromone.update": io.LOW,
"cluster.update": io.LOW,
"expansion.candidate": io.LOW,
"powerbank.discovered": io.LOW,
"cpu.spike": io.BACKGROUND,
"bucket.modeChange": io.BACKGROUND
}, vo = {
maxEventsPerTick: 50,
maxQueueSize: 200,
...
handlersInvoked: 0,
eventsCoalesced: 0
}, this.tickEvents = new Map, this.config = l(l({}, vo), e);
}
...
var c = {
handler: t,
priority: null !== (o = r.priority) && void 0 !== o ? o : io.NORMAL,
...
}), this.handlers.set(e, u), this.config.enableLogging && Jr.debug('EventBus: Registered handler for "'.concat(e, '" (id: ').concat(c.id, ")"), {
subsystem: "EventBus"
}), function() {
return s.off(e, c.id);
};
...
var s = l(l({}, t), {
tick: Game.time
}), c = null !== (n = null !== (o = r.priority) && void 0 !== o ? o : go[e]) && void 0 !== n ? n : io.NORMAL, u = null !== (a = r.immediate) && void 0 !== a ? a : c >= io.CRITICAL, m = null === (i = r.allowCoalescing) || void 0 === i || i;
...
this.stats.eventsEmitted++, this.config.enableLogging && Jr.debug('EventBus: Emitting "'.concat(e, '" (priority: ').concat(c, ", immediate: ").concat(String(u), ")"), {
subsystem: "EventBus"
});
var d = Game.cpu.bucket;
u || d >= this.config.lowBucketThreshold ? this.processEvent(e, s) : d >= this.config.criticalBucketThreshold ? this.queueEvent(e, s, c) : c >= io.CRITICAL ? this.processEvent(e, s) : (this.stats.eventsDropped++, 
...
try {
for (var d = p(c), y = d.next(); !y.done; y = d.next()) {
var h = y.value;
this.off(e, h);
}
} catch (e) {
...
return e.event.priority < io.HIGH;
}).sort(function(e, t) {
...
spawn: {
bodyCosts: (yo = {}, yo[MOVE] = 50, yo[WORK] = 100, yo[CARRY] = 50, yo[ATTACK] = 80, 
yo[RANGED_ATTACK] = 150, yo[HEAL] = 250, yo[CLAIM] = 600, yo[TOUGH] = 10, yo),
minCreepCounts: {
harvester: 2,
hauler: 2,
upgrader: 1,
...
if (e.tickModulo < 0) throw Jr.error('Kernel: Cannot register process "'.concat(e.name, '" - tickModulo must be non-negative (got ').concat(e.tickModulo, ")"), {
subsystem: "Kernel"
}), new Error("Invalid tickModulo: ".concat(e.tickModulo, " (must be >= 0)"));
if (void 0 !== e.tickOffset && e.tickOffset >= e.tickModulo) throw Jr.error('Kernel: Cannot register process "'.concat(e.name, '" - tickOffset (').concat(e.tickOffset, ") must be less than tickModulo (").concat(e.tickModulo, ")"), {
subsystem: "Kernel"
...
id: e.id,
name: e.name,
priority: null !== (o = e.priority) && void 0 !== o ? o : ho.MEDIUM,
frequency: i,
...
this.processes.set(e.id, p), this.queueDirty = !0, Jr.debug('Kernel: Registered process "'.concat(p.name, '" (').concat(p.id, ") with interval ").concat(m, " (base: ").concat(c, ", jitter: ").concat(l > 0 ? "+" : "").concat(l, ")"), {
subsystem: "Kernel"
});
}, t.prototype.unregisterProcess = function(e) {
var t = this.processes.delete(e);
return t && (this.queueDirty = !0, Jr.debug("Kernel: Unregistered process ".concat(e), {
subsystem: "Kernel"
})), t;
...
this.initialized || (Jr.info("Kernel initialized with ".concat(this.processes.size, " processes"), {
subsystem: "Kernel"
}), this.initialized = !0);
}, t.prototype.updateBucketMode = function() {
var e, t = Game.cpu.bucket;
if ((e = t < this.config.criticalBucketThreshold ? "critical" : t < this.config.lowBucketThreshold ? "low" : t > this.config.highBucketThreshold ? "high" : "normal") !== this.bucketMode && (Jr.info("Kernel: Bucket mode changed from ".concat(this.bucketMode, " to ").concat(e, " (bucket: ").concat(t, ")"), {
subsystem: "Kernel"
}), this.bucketMode = e), Game.time % 100 == 0 && ("low" === this.bucketMode || "critical" === this.bucketMode)) {
var r = this.processes.size;
Jr.info("Bucket ".concat(this.bucketMode.toUpperCase(), " mode: ").concat(t, "/10000 bucket. ") + "Running all ".concat(r, " processes normally (bucket mode is informational only)"), {
subsystem: "Kernel"
});
}
}, t.prototype.validateConfig = function() {
this.config.criticalBucketThreshold >= this.config.lowBucketThreshold && (Jr.warn("Kernel: Adjusting critical bucket threshold ".concat(this.config.criticalBucketThreshold, " to stay below low threshold ").concat(this.config.lowBucketThreshold), {
subsystem: "Kernel"
}), this.config.criticalBucketThreshold = Math.max(0, this.config.lowBucketThreshold - 1)), 
this.config.lowBucketThreshold >= this.config.highBucketThreshold && (Jr.warn("Kernel: Adjusting high bucket threshold ".concat(this.config.highBucketThreshold, " to stay above low threshold ").concat(this.config.lowBucketThreshold), {
subsystem: "Kernel"
...
Jr.info("Adaptive budgets updated: rooms=".concat(r, ", bucket=").concat(o, ", ") + "high=".concat(t.high.toFixed(3), ", medium=").concat(t.medium.toFixed(3), ", low=").concat(t.low.toFixed(3)), {
subsystem: "Kernel"
});
}
}
...
Jr.debug('Kernel: Process "'.concat(e.name, '" suspended (').concat(r, " ticks remaining)"), {
subsystem: "Kernel"
});
}
return !1;
...
e.stats.suspensionReason = null, Jr.info('Kernel: Process "'.concat(e.name, '" automatically resumed after suspension. ') + "Previous reason: ".concat(o, ". Consecutive errors: ").concat(e.stats.consecutiveErrors), {
subsystem: "Kernel",
processId: e.id
...
if (a < e.interval) return Game.time % 100 == 0 && e.priority >= ho.HIGH && Jr.debug('Kernel: Process "'.concat(e.name, '" skipped (interval: ').concat(a, "/").concat(e.interval, " ticks)"), {
subsystem: "Kernel"
}), !1;
}
return !0;
...
Jr.error('Kernel: Process "'.concat(e.name, '" error: ').concat(r), {
subsystem: "Kernel"
}), t instanceof Error && t.stack && Jr.error(t.stack, {
subsystem: "Kernel"
});
...
e.state = "suspended", Jr.error('Kernel: Process "'.concat(e.name, '" permanently suspended after ').concat(o, " consecutive failures"), {
subsystem: "Kernel",
processId: e.id
...
e.state = "suspended", Jr.warn('Kernel: Process "'.concat(e.name, '" suspended for ').concat(n, " ticks after ").concat(o, " consecutive failures"), {
subsystem: "Kernel",
processId: e.id,
meta: {
...
s > this.config.budgetWarningThreshold && Game.time % this.config.budgetWarningInterval === 0 && Jr.warn('Kernel: Process "'.concat(e.name, '" exceeded CPU budget: ').concat(a.toFixed(3), " > ").concat(i.toFixed(3), " (").concat((100 * s).toFixed(0), "%)"), {
subsystem: "Kernel"
});
}, t.prototype.run = function() {
if (this.updateBucketMode(), this.updateAdaptiveBudgets(), this.tickCpuUsed = 0, 
this.skippedProcessesThisTick = 0, Eo.processQueue(), this.queueDirty && (this.rebuildProcessQueue(), 
Jr.info("Kernel: Rebuilt process queue with ".concat(this.processQueue.length, " processes"), {
subsystem: "Kernel"
})), 0 !== this.processQueue.length) {
Game.time % 10 == 0 && Jr.info("Kernel: Running ".concat(this.processQueue.length, " registered processes"), {
subsystem: "Kernel"
});
...
r = this.processQueue.length - e - t, Jr.warn("Kernel: CPU budget exhausted after ".concat(e, " processes. ").concat(r, " processes deferred to next tick. Used: ").concat(Game.cpu.getUsed().toFixed(2), "/").concat(this.getCpuLimit().toFixed(2)), {
subsystem: "Kernel"
});
break;
}
...
Eo.logStats());
} else Jr.warn("Kernel: No processes registered in queue", {
subsystem: "Kernel"
});
}, t.prototype.logStats = function(e, t, r, o) {
var n = Game.cpu.bucket, a = (n / 1e4 * 100).toFixed(1), i = Game.cpu.getUsed(), s = this.getCpuLimit();
if (Jr.info("Kernel: ".concat(e, " ran, ").concat(t, " skipped (interval: ").concat(r, ", CPU: ").concat(o, "), ") + "CPU: ".concat(i.toFixed(2), "/").concat(s.toFixed(2), " (").concat((i / s * 100).toFixed(1), "%), bucket: ").concat(n, "/10000 (").concat(a, "%), mode: ").concat(this.bucketMode), {
subsystem: "Kernel"
}), t > 10) {
...
c.length > 0 && Jr.warn("Kernel: Top skipped processes: ".concat(c.map(function(e) {
...
return !!t && (t.state = "suspended", Jr.info('Kernel: Suspended process "'.concat(t.name, '"'), {
subsystem: "Kernel"
}), !0);
...
return t.stats.suspensionReason = null, Jr.info('Kernel: Manually resumed process "'.concat(t.name, '". ') + "Previous reason: ".concat(r, ". Consecutive errors: ").concat(t.stats.consecutiveErrors), {
subsystem: "Kernel",
processId: e
}), this.emit("process.recovered", {
processId: t.id,
...
}, 0), n = e.length > 0 ? o / e.length : 0, a = d([], f(e), !1).sort(function(e, t) {
...
Jr.info("Kernel: Reset all process statistics", {
subsystem: "Kernel"
});
...
this.updateConfig(xo(e));
}, t.prototype.on = function(e, t, r) {
return void 0 === r && (r = {}), Eo.on(e, t, r);
}, t.prototype.once = function(e, t, r) {
return void 0 === r && (r = {}), Eo.once(e, t, r);
}, t.prototype.emit = function(e, t, r) {
void 0 === r && (r = {}), Eo.emit(e, t, r);
...
return Eo.hasHandlers(e);
}, t.prototype.getEventBus = function() {
return Eo;
}, t;
}(), Ao = new _o(xo(Co().cpu)), No = function() {
function e(e) {
...
try {
for (var d = p(i), y = d.next(); !y.done; y = d.next()) l = y.value, delete a.data[l];
} catch (e) {
o = {
error: e
};
...
return n || (n = "memory" === r ? new Mo(e) : new No(e), this.stores.set(o, n)), 
n;
...
var d = f.keys();
try {
for (var y = (n = void 0, p(d)), h = y.next(); !h.done; h = y.next()) {
...
var t, r, o, n, a, i, s, c;
if (e) {
var u = this.getStats(e), l = "".concat(e, ":heap"), m = "".concat(e, ":memory"), f = null !== (i = null === (a = this.stores.get(l)) || void 0 === a ? void 0 : a.size()) && void 0 !== i ? i : 0, d = null !== (c = null === (s = this.stores.get(m)) || void 0 === s ? void 0 : s.size()) && void 0 !== c ? c : 0, y = (h = u.hits + u.misses) > 0 ? u.hits / h : 0;
return {
hits: u.hits,
misses: u.misses,
hitRate: y,
...
function Do(e, t, r, o) {
void 0 === o && (o = {});
var n = Lo(e, t), a = Room.serializePath(r);
ko.set(n, a, {
namespace: Go,
ttl: o.ttl,
maxSize: 1e3
...
var Fo = "roomFind", Bo = ((Po = {})[FIND_SOURCES] = 5e3, Po[FIND_MINERALS] = 5e3, 
Po[FIND_DEPOSITS] = 100, Po[FIND_STRUCTURES] = 50, Po[FIND_MY_STRUCTURES] = 50, 
Po[FIND_HOSTILE_STRUCTURES] = 20, Po[FIND_MY_SPAWNS] = 100, Po[FIND_MY_CONSTRUCTION_SITES] = 20, 
Po[FIND_CONSTRUCTION_SITES] = 20, Po[FIND_CREEPS] = 5, Po[FIND_MY_CREEPS] = 5, Po[FIND_HOSTILE_CREEPS] = 3, 
Po[FIND_DROPPED_RESOURCES] = 5, Po[FIND_TOMBSTONES] = 10, Po[FIND_RUINS] = 10, Po[FIND_FLAGS] = 50, 
Po[FIND_NUKES] = 20, Po[FIND_POWER_CREEPS] = 10, Po[FIND_MY_POWER_CREEPS] = 10, 
Po);
...
namespace: Fo,
ttl: null !== (n = null !== (o = null == r ? void 0 : r.ttl) && void 0 !== o ? o : Bo[t]) && void 0 !== n ? n : 20,
compute: function() {
...
function jo(e) {
return Wo(e, FIND_SOURCES);
}

function Vo(e, t) {
return t ? Wo(e, FIND_MY_STRUCTURES, {
filter: function(e) {
return e.structureType === t;
},
filterKey: t
}) : Wo(e, FIND_MY_STRUCTURES);
}

function Ko(e, t) {
return void 0 === t && (t = !0), Wo(e, t ? FIND_MY_CONSTRUCTION_SITES : FIND_CONSTRUCTION_SITES);
}

function Ho(e, t) {
return t ? Wo(e, FIND_DROPPED_RESOURCES, {
filter: function(e) {
return e.resourceType === t;
},
filterKey: t
}) : Wo(e, FIND_DROPPED_RESOURCES);
}
...
function zo(e, t, r, o) {
if (void 0 === o && (o = 10), 0 === t.length) return Xo(e, r), null;
if (1 === t.length) return t[0];
var n = Yo(e.name, r), a = ko.get(n, {
namespace: qo,
ttl: o
});
if (a) {
...
role: "hauler",
family: "economy",
bodies: [ $o([ CARRY, CARRY, MOVE, MOVE ], 200), $o([ CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 400), $o([ CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 800), $o(d(d([], f(Array(16).fill(CARRY)), !1), f(Array(16).fill(MOVE)), !1), 1600) ],
priority: 90,
maxPerRoom: 2,
remoteRole: !0
},
...
role: "remoteHauler",
family: "economy",
bodies: [ $o([ CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 400), $o([ CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 800), $o(d(d([], f(Array(16).fill(CARRY)), !1), f(Array(16).fill(MOVE)), !1), 1600) ],
priority: 80,
maxPerRoom: 6,
remoteRole: !0
},
...
family: "economy",
bodies: [ $o(d(d([], f(Array(4).fill(CARRY)), !1), f(Array(4).fill(MOVE)), !1), 400), $o(d(d([], f(Array(8).fill(CARRY)), !1), f(Array(8).fill(MOVE)), !1), 800), $o(d(d([], f(Array(12).fill(CARRY)), !1), f(Array(12).fill(MOVE)), !1), 1200), $o(d(d([], f(Array(16).fill(CARRY)), !1), f(Array(16).fill(MOVE)), !1), 1600) ],
priority: 85,
maxPerRoom: 6,
remoteRole: !0
},
...
role: "powerCarrier",
family: "power",
bodies: [ $o(d(d([], f(Array(20).fill(CARRY)), !1), f(Array(20).fill(MOVE)), !1), 2e3), $o(d(d([], f(Array(25).fill(CARRY)), !1), f(Array(25).fill(MOVE)), !1), 2500) ],
priority: 25,
maxPerRoom: 2,
remoteRole: !0
}
...
var tn, rn, on, nn = Qr("MemoryMonitor"), an = 2097152, sn = new (function() {
function e() {
this.lastCheckTick = 0, this.lastStatus = "normal";
}
return e.prototype.checkMemoryUsage = function() {
var e = RawMemory.get().length, t = e / an, r = "normal";
t >= .9 ? r = "critical" : t >= .8 && (r = "warning"), r !== this.lastStatus && ("critical" === r ? (Game.notify("CRITICAL: Memory at ".concat((100 * t).toFixed(1), "% (").concat(this.formatBytes(e), "/").concat(this.formatBytes(an), ")")), 
nn.error("Memory usage critical", {
meta: {
used: e,
limit: an,
percentage: t
}
})) : "warning" === r ? nn.warn("Memory usage warning", {
meta: {
used: e,
limit: an,
percentage: t
}
}) : nn.info("Memory usage normal", {
meta: {
used: e,
limit: an,
percentage: t
...
t.deadCreeps = this.pruneDeadCreeps(), t.eventLogs = this.pruneEventLogs(20), t.staleIntel = this.pruneStaleIntel(cn), 
...
var a = 0, i = Game.time - cn;
for (var r in t.knownRooms) {
var s = t.knownRooms[r];
s.lastSeen < i && !s.isHighway && !s.hasPortal && a++;
}
a > 50 && e.push("".concat(a, " stale intel entries (older than ").concat(cn, " ticks)"));
}
var c = 0;
...
for (var t = mn[e], r = t.start; r <= t.end; r++) if (!this.isSegmentLoaded(r) || this.getSegmentSize(r) < 92160) return r;
return t.start;
...
var u = c.value;
if (!i || "object" != typeof i || !(u in i)) return Jr.warn("Memory path not found for migration", {
subsystem: "MemorySegmentManager",
meta: {
memoryPath: e,
segmentId: t,
...
return l && Jr.info("Successfully migrated data to segment", {
subsystem: "MemorySegmentManager",
meta: {
memoryPath: e,
segmentId: t,
...
return a;
}(), null != rn ? rn.exports = on : "undefined" != typeof angular && null != angular && angular.module("LZString", []).factory("LZString", function() {
return on;
})), dn.exports), hn = function() {
function e() {}
return e.prototype.compress = function(e, t) {
void 0 === t && (t = 1);
var r = JSON.stringify(e), o = r.length, n = yn.compressToUTF16(r);
return {
compressed: n,
originalSize: o,
...
try {
var t = "string" == typeof e ? e : e.compressed, r = yn.decompressFromUTF16(t);
...
var u = fn.suggestSegmentForType("HISTORICAL_INTEL");
if (!fn.isSegmentLoaded(u)) return fn.requestSegment(u), void Jr.info("Segment not loaded, migration will continue next tick", {
subsystem: "MemoryMigrations",
meta: {
segmentId: u
}
});
if (!fn.writeSegment(u, "historicalIntel", a)) return void Jr.error("Failed to write historical intel to segment", {
subsystem: "MemoryMigrations",
meta: {
segmentId: u
}
...
if (t) {
var r = t, o = r.portals;
if (o && !gn.isCompressed(o)) {
var n = gn.compressPortalMap(o);
...
if (o) {
var n = gn.compressMarketHistory(o), a = fn.suggestSegmentForType("MARKET_HISTORY");
if (!fn.isSegmentLoaded(a)) return fn.requestSegment(a), void Jr.info("Segment not loaded, migration will continue next tick", {
subsystem: "MemoryMigrations",
meta: {
segmentId: a
}
});
fn.writeSegment(a, "priceHistory", n) ? (delete r.priceHistory, Jr.info("Migrated market history to segments", {
subsystem: "MemoryMigrations",
meta: {
originalSize: n.originalSize,
compressedSize: n.compressedSize,
...
var e, t, r, o = Memory, n = null !== (r = o.memoryVersion) && void 0 !== r ? r : 0, a = vn.filter(function(e) {
return e.version > n;
});
if (0 !== a.length) {
...
var c = s.value;
try {
Jr.info("Running migration v".concat(c.version, ": ").concat(c.description), {
subsystem: "MigrationRunner"
}), c.migrate(Memory), o.memoryVersion = c.version, Jr.info("Migration v".concat(c.version, " complete"), {
subsystem: "MigrationRunner"
});
} catch (e) {
Jr.error("Migration v".concat(c.version, " failed"), {
subsystem: "MigrationRunner",
meta: {
error: String(e)
}
...
return 0 === vn.length ? 0 : Math.max.apply(Math, d([], f(vn.map(function(e) {
return e.version;
})), !1));
...
}(), En = new Rn, Tn = "empire", Sn = "clusters", Cn = function() {
function e() {
...
En.runMigrations(), this.ensureEmpireMemory(), this.ensureClustersMemory(), Game.time - this.lastCleanupTick >= 10 && (this.cleanDeadCreeps(), 
this.lastCleanupTick = Game.time), Game.time - this.lastPruningTick >= 100 && (ln.pruneAll(), 
this.lastPruningTick = Game.time), Game.time - this.lastMonitoringTick >= 50 && (sn.checkMemoryUsage(), 
...
var r = Memory;
ro.set(e, r[Tn], $r), t = r[Tn];
}
return t;
}, e.prototype.getClusters = function() {
var e = "memory:".concat(Sn), t = ro.get(e);
if (!t) {
this.ensureClustersMemory();
var r = Memory;
ro.set(e, r[Sn], $r), t = r[Sn];
}
return t;
...
var S = T.value;
S.type === ATTACK && l++, S.type === RANGED_ATTACK && m++, S.type === HEAL && f++, 
S.type === WORK && d++;
}
} catch (e) {
o = {
...
Jr.info("Defender analysis for ".concat(e.name, ": ").concat(s.guards, " guards, ").concat(s.rangers, " rangers, ").concat(s.healers, " healers (urgency: ").concat(s.urgency, "x) - ").concat(s.reasons.join(", ")), {
subsystem: "Defense"
}), s;
}
...
var n = bn(e), a = xn(e), i = n.guards - a.guards + (n.rangers - a.rangers);
if (i <= 0) return !1;
...
var n = wn.getCluster(t.clusterId);
...
try {
for (var y = p(Un), h = y.next(); !h.done; h = y.next()) {
var g = h.value;
if (!(g.cost <= o)) break;
d = g;
}
...
return Jr.debug("Remote hauler calculation: ".concat(e, " -> ").concat(t, " (").concat(r, " sources, ").concat(l, " rooms away) - RT: ").concat(m, " ticks, E/tick: ").concat(f, ", Min: ").concat(R, ", Rec: ").concat(E, ", Cap: ").concat(d.capacity), {
...
var Pn, In = ((Mn = {})[MOVE] = 50, Mn[WORK] = 100, Mn[CARRY] = 50, Mn[ATTACK] = 80, 
Mn[RANGED_ATTACK] = 150, Mn[HEAL] = 250, Mn[CLAIM] = 600, Mn[TOUGH] = 10, Mn);
...
var c = f(s.value, 2), u = c[0], l = c[1].spawnId, m = Game.getObjectById(l);
...
try {
for (var d = p(a), y = d.next(); !y.done; y = d.next()) u = y.value, e.inProgress.delete(u);
} catch (e) {
o = {
error: e
};
...
return d([], f(this.getQueue(e).requests), !1);
...
Jr.warn("Spawn request failed: ".concat(u.role, " in ").concat(e, " (error: ").concat(l, ")"), {
subsystem: "SpawnQueue"
}));
}
} catch (e) {
...
return e.priority >= Pn.EMERGENCY;
});
...
return e.priority >= Pn.HIGH && e.priority < Pn.EMERGENCY;
}).length,
normal: t.requests.filter(function(e) {
return e.priority >= Pn.NORMAL && e.priority < Pn.HIGH;
}).length,
low: t.requests.filter(function(e) {
return e.priority < Pn.NORMAL;
}).length,
...
var t, r, o, n, a, i, s;
try {
var c = JSON.parse(e), u = Bn(JSON.stringify(c.d));
if (c.c !== u) return Jr.warn("InterShardMemory checksum mismatch", {
...
var t, r = f(e.sp.split(","), 2), o = r[0], n = r[1];
return {
sourceRoom: e.sr,
sourcePos: {
...
return Jr.error("Failed to deserialize InterShardMemory: ".concat(String(e)), {
subsystem: "InterShard"
}), null;
}
}
...
id: c.options.id,
name: c.options.name,
priority: null !== (o = c.options.priority) && void 0 !== o ? o : ho.MEDIUM,
...
execute: l
}), Jr.debug('Registered decorated process "'.concat(c.options.name, '" (').concat(c.options.id, ")"), {
...
function e(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = l(l({}, Zn), e), this.interShardMemory = {
version: 1,
shards: {},
globalTargets: {
targetPowerLevel: 0
...
if (r) {
var o = jn(r);
o && (this.interShardMemory = o, Jr.debug("Loaded InterShardMemory", {
subsystem: "Shard"
}));
}
} catch (e) {
var n = e instanceof Error ? e.message : String(e);
Jr.error("Failed to load InterShardMemory: ".concat(n), {
subsystem: "Shard"
});
}
var a = null !== (t = null === (e = Game.shard) || void 0 === e ? void 0 : e.name) && void 0 !== t ? t : "shard0";
this.interShardMemory.shards[a] || (this.interShardMemory.shards[a] = Fn(a));
...
try {
for (var y = (o = void 0, p(d)), h = y.next(); !h.done; h = y.next()) {
...
}), l = Game.cpu.getUsed() / Game.cpu.limit, m = l < .5 ? "low" : l < .75 ? "medium" : l < .9 ? "high" : "critical", f = u.length > 0 ? u.reduce(function(e, t) {
var r, o;
...
Jr.info("Processing colonize task: ".concat(r, " from ").concat(e.sourceShard), {
subsystem: "Shard"
});
...
e.status = "active";
var r = null !== (t = e.targetRoom) && void 0 !== t ? t : "unknown";
Jr.info("Processing reinforce task: ".concat(r, " from ").concat(e.sourceShard), {
subsystem: "Shard"
});
}, e.prototype.handleTransferTask = function(e) {
e.status = "active", Jr.info("Processing transfer task from ".concat(e.sourceShard), {
subsystem: "Shard"
});
...
e.status = "active";
var r = null !== (t = e.targetRoom) && void 0 !== t ? t : "unknown";
Jr.info("Processing evacuate task: ".concat(r, " to ").concat(e.targetShard), {
subsystem: "Shard"
});
...
Jr.info("Discovered portal in ".concat(e, " to ").concat(n, "/").concat(a), {
subsystem: "Shard"
});
}
}
...
"frontier" === o.role && n.roomCount >= 3 && n.avgRCL >= 5 && (i = "core", Jr.info("Transitioning from frontier to core shard", {
subsystem: "Shard"
})), "war" === o.role && n.warIndex < 20 && (i = n.economyIndex > 70 && n.roomCount >= 3 ? "resource" : n.roomCount >= 2 ? "core" : "frontier", 
Jr.info("War ended, transitioning to ".concat(i), {
subsystem: "Shard"
})), i !== o.role && (o.role = i, Jr.info("Auto-assigned shard role: ".concat(i), {
subsystem: "Shard"
}));
}
...
var o = ea[e.role], n = t === r ? Game.cpu.bucket : e.health.bucketLevel;
...
try {
for (var f = p(s), d = f.next(); !d.done; d = f.next()) {
var y = i[E = d.value];
if (y) {
...
S && Game.cpu.setShardLimits(g) === OK && Jr.info("Updated shard CPU limits: ".concat(JSON.stringify(g)), {
subsystem: "Shard"
});
}
} catch (e) {
var C = e instanceof Error ? e.message : String(e);
Jr.debug("Could not set shard limits: ".concat(C), {
subsystem: "Shard"
});
}
...
e.valid || (Jr.warn("InterShardMemory validation failed: ".concat(e.errors.join(", ")), {
subsystem: "Shard"
}), this.repairInterShardMemory());
var t = Wn(this.interShardMemory);
if (t.length > Vn) {
Jr.warn("InterShardMemory size exceeds limit: ".concat(t.length, "/").concat(Vn), {
subsystem: "Shard"
}), this.trimInterShardMemory();
var r = Wn(this.interShardMemory);
return r.length > Vn ? (Jr.error("InterShardMemory still too large after trim: ".concat(r.length, "/").concat(Vn), {
subsystem: "Shard"
...
Jr.error("Failed to sync InterShardMemory: ".concat(o), {
subsystem: "Shard"
...
var n = f(o.value, 2), a = n[0], i = n[1];
i.health && "number" == typeof i.health.lastUpdate || (this.interShardMemory.shards[a] = Fn(a)), 
...
Jr.info("Repaired InterShardMemory structure", {
subsystem: "Shard"
});
...
try {
var r = InterShardMemory.getLocal();
if (!r) return void Jr.warn("InterShardMemory verification failed: no data present", {
subsystem: "Shard"
});
var o = jn(r);
if (!o) return void Jr.warn("InterShardMemory verification failed: deserialization failed", {
subsystem: "Shard"
});
var n = null !== (t = null === (e = Game.shard) || void 0 === e ? void 0 : e.name) && void 0 !== t ? t : "shard0";
o.shards[n] || Jr.warn("InterShardMemory verification failed: current shard ".concat(n, " not found"), {
subsystem: "Shard"
});
} catch (e) {
var a = e instanceof Error ? e.message : String(e);
Jr.warn("InterShardMemory verification failed: ".concat(a), {
subsystem: "Shard"
});
}
...
var e, t;
try {
Jr.info("Attempting InterShardMemory recovery", {
subsystem: "Shard"
});
var r = InterShardMemory.getLocal();
if (r) {
var o = jn(r);
if (o) return this.interShardMemory = o, void Jr.info("Recovered InterShardMemory from storage", {
subsystem: "Shard"
});
}
var n = null !== (t = null === (e = Game.shard) || void 0 === e ? void 0 : e.name) && void 0 !== t ? t : "shard0";
...
lastSync: 0,
checksum: 0
}, this.interShardMemory.shards[n] = Fn(n), Jr.info("Recreated InterShardMemory with current shard only", {
subsystem: "Shard"
});
} catch (e) {
var a = e instanceof Error ? e.message : String(e);
Jr.error("InterShardMemory recovery failed: ".concat(a), {
subsystem: "Shard"
});
}
...
}).slice(0, 10), Jr.warn("Emergency trim applied to InterShardMemory", {
subsystem: "Shard"
}));
...
if (o) {
var n = o.health;
Jr.info("Shard ".concat(r, " (").concat(o.role, "): ") + "".concat(n.roomCount, " rooms, RCL ").concat(n.avgRCL, ", ") + "CPU: ".concat(n.cpuCategory, ", Eco: ").concat(n.economyIndex, "%, War: ").concat(n.warIndex, "%"), {
subsystem: "Shard"
});
}
...
r && (s.targetRoom = r), this.interShardMemory.tasks.push(s), Jr.info("Created inter-shard task: ".concat(e, " to ").concat(t), {
subsystem: "Shard"
});
...
var t, r, o = null !== (r = null === (t = Game.shard) || void 0 === t ? void 0 : t.name) && void 0 !== r ? r : "shard0", n = this.interShardMemory.shards[o];
n && (n.role = e, Jr.info("Set shard role to: ".concat(e), {
subsystem: "Shard"
}));
...
this.interShardMemory.tasks.push(c), Jr.info("Created resource transfer task: ".concat(o, " ").concat(r, " to ").concat(e, "/").concat(t), {
subsystem: "Shard"
});
...
t && (t.status = "failed", t.updatedAt = Game.time, Jr.info("Cancelled task ".concat(e), {
subsystem: "Shard"
}));
}, e.prototype.getSyncStatus = function() {
var e, t, r = Wn(this.interShardMemory).length, o = r / Vn * 100, n = Game.time - this.interShardMemory.lastSync, a = r < 92160 && n < 500, i = 0;
try {
...
Jr.info("Forcing InterShardMemory sync with validation", {
subsystem: "Shard"
}), this.syncInterShardMemory();
}, e.prototype.getMemoryStats = function() {
var e, t, r = Wn(this.interShardMemory).length, o = Wn(l(l({}, this.interShardMemory), {
tasks: [],
globalTargets: {
targetPowerLevel: 0
}
...
}, m([ zn("empire:shard", "Shard Manager", {
priority: ho.LOW,
interval: 100,
minBucket: 0,
cpuBudget: .02
}) ], e.prototype, "run", null), m([ Qn() ], e);
...
this.memory.requests[e.id] = o, Jr.info("Created transfer request: ".concat(e.resourceAmount, " ").concat(e.resourceType, " from ").concat(r, " to ").concat(e.targetShard, "/").concat(e.targetRoom), {
subsystem: "CrossShardTransfer"
});
} else Jr.warn("No room with sufficient ".concat(e.resourceType, " for transfer"), {
subsystem: "CrossShardTransfer"
});
} else Jr.warn("No portal found to ".concat(e.targetShard, ", cannot create transfer request"), {
subsystem: "CrossShardTransfer"
});
}
...
if (o >= r) return e.status = "gathering", void Jr.info("Transfer request ".concat(e.taskId, " moving to gathering phase"), {
subsystem: "CrossShardTransfer"
});
...
return void Jr.error("Failed to optimize body for crossShardCarrier: ".concat(String(e)), {
subsystem: "CrossShardTransfer"
});
}
var c = 50 * a.parts.filter(function(e) {
return e === CARRY;
}).length, u = Math.ceil(i / c), l = Math.min(u, 3), m = Pn.NORMAL;
m = e.priority >= 80 ? Pn.HIGH : e.priority >= 50 ? Pn.NORMAL : Pn.LOW;
for (var p = 0; p < l; p++) {
var f = {
...
Dn.addRequest(d), Jr.info("Requested spawn of crossShardCarrier for transfer ".concat(e.taskId, " (").concat(p + 1, "/").concat(l, ")"), {
subsystem: "CrossShardTransfer"
});
}
Jr.debug("Transfer request ".concat(e.taskId, " needs ").concat(i, " carry capacity, requested ").concat(l, " carriers"), {
subsystem: "CrossShardTransfer"
});
} else Jr.warn("Source room ".concat(e.sourceRoom, " not available for spawning carriers"), {
subsystem: "CrossShardTransfer"
});
...
}) && (e.status = "moving", Jr.info("Transfer request ".concat(e.taskId, " moving to portal"), {
subsystem: "CrossShardTransfer"
})) : e.status = "queued";
...
}).length > 0 && (e.status = "transferring", Jr.info("Transfer request ".concat(e.taskId, " reached portal, transferring"), {
subsystem: "CrossShardTransfer"
}));
...
ra.recordPortalTraversal(e.portalRoom, e.targetShard, !0), Jr.info("Transfer request ".concat(e.taskId, " completed"), {
subsystem: "CrossShardTransfer"
}));
...
r && !r.assignedCreeps.includes(t) && (r.assignedCreeps.push(t), Jr.info("Assigned creep ".concat(t, " to transfer request ").concat(e), {
subsystem: "CrossShardTransfer"
}));
...
}(), na = new oa, aa = new Map, ia = -1, sa = null;

function ca(e, t) {
var r, o;
void 0 === t && (t = !1), ia === Game.time && sa === Game.creeps || (aa.clear(), 
ia = Game.time, sa = Game.creeps);
var n = t ? "".concat(e, "_active") : e, a = aa.get(n);
...
var m = l.value, f = ua(e, t, m), d = Game.rooms[m];
if (f < ("remoteHarvester" === t ? d ? jo(d).length : 2 : "remoteHauler" === t && d ? kn(e, m, jo(d).length, null !== (s = null === (i = Game.rooms[e]) || void 0 === i ? void 0 : i.energyCapacityAvailable) && void 0 !== s ? s : 800).recommendedHaulers : 2)) return m;
}
} catch (e) {
o = {
error: e
...
var u = 1 / 0, l = [];
try {
for (var m = p(c), f = m.next(); !f.done; f = m.next()) {
var d = f.value, y = ua(o, e, d);
y < u ? (u = y, l = [ d ]) : y === u && l.push(d);
}
} catch (e) {
n = {
error: e
...
if ("remoteHarvester" === t || "remoteHauler" === t) return null !== la(e, t, r);
if ("remoteWorker" === t) {
if (0 === (m = null !== (i = r.remoteAssignments) && void 0 !== i ? i : []).length) return !1;
var l = function(e, t) {
ia === Game.time && sa === Game.creeps || (aa.clear(), ia = Game.time, sa = Game.creeps);
var r = "".concat(e, ":").concat(t), o = aa.get(r);
...
try {
for (var f = p(m), d = f.next(); !d.done; d = f.next()) {
var y = d.value, h = Game.rooms[y];
if (h) {
var g = Wo(h, FIND_HOSTILE_CREEPS).filter(function(e) {
return e.body.some(function(e) {
return e.type === ATTACK || e.type === RANGED_ATTACK || e.type === WORK;
});
});
if (g.length > 0 && ua(e, t, y) < Math.min(u.maxPerRoom, Math.ceil(g.length / 2))) return !0;
}
}
} catch (e) {
n = {
...
var v = null !== (c = ca(e).get(t)) && void 0 !== c ? c : 0, R = u.maxPerRoom;
if ("upgrader" === t && r.clusterId && (null == (_ = wn.getCluster(r.clusterId)) ? void 0 : _.focusRoom) === e) {
var E = Game.rooms[e];
...
if ("claimer" === t) {
var S = wn.getEmpire(), C = Object.values(Game.rooms).filter(function(e) {
var t;
return null === (t = e.controller) || void 0 === t ? void 0 : t.my;
...
try {
for (var f = p(c), d = f.next(); !d.done; d = f.next()) {
var y = m(d.value);
...
var _;
if (!(_ = wn.getCluster(r.clusterId)) || !_.resourceRequests || 0 === _.resourceRequests.length) return !1;
...
if (c) {
var u = e.energyCapacityAvailable, l = e.energyAvailable, m = 0 === fa(ca(e.name, !0)), d = m ? l : u;
if (m && l < 150 && (Jr.warn("WORKFORCE COLLAPSE: ".concat(l, " energy available, need 150 to spawn minimal larvaWorker. ") + "Room will recover once energy reaches 150.", {
subsystem: "spawn",
room: e.name
}), Ao.emit("spawn.emergency", {
roomName: e.name,
energyAvailable: l,
message: "Critical workforce collapse - waiting for energy to spawn minimal creep",
source: "SpawnManager"
})), ya(e.name, e) && Game.time % 10 == 0) {
var y = ca(e.name, !0), h = ca(e.name, !1), g = null !== (n = y.get("larvaWorker")) && void 0 !== n ? n : 0, v = null !== (a = y.get("harvester")) && void 0 !== a ? a : 0;
Jr.info("BOOTSTRAP MODE: ".concat(fa(y), " active energy producers ") + "(".concat(g, " larva, ").concat(v, " harvest), ").concat(fa(h), " total. ") + "Energy: ".concat(l, "/").concat(u), {
subsystem: "spawn",
room: e.name
});
}
...
var o, n, a;
if (0 === fa(ca(e, !0))) return Jr.info("Bootstrap: Spawning larvaWorker (emergency - no active energy producers)", {
subsystem: "spawn",
room: e
}), "larvaWorker";
var i = ca(e, !1), s = da(t);
Jr.info("Bootstrap: Checking ".concat(s.length, " roles in order"), {
subsystem: "spawn",
room: e,
meta: {
totalCreeps: i.size,
...
if (m < l.minCount) {
var f = pa(e, l.role, r, !0);
if (Jr.info("Bootstrap: Role ".concat(l.role, " needs spawning (current: ").concat(m, ", min: ").concat(l.minCount, ", needsRole: ").concat(f, ")"), {
subsystem: "spawn",
room: e
}), f) return l.role;
Jr.warn("Bootstrap: Role ".concat(l.role, " blocked by needsRole check (current: ").concat(m, "/").concat(l.minCount, ")"), {
subsystem: "spawn",
room: e
});
}
} else Jr.info("Bootstrap: Skipping ".concat(l.role, " (condition not met)"), {
subsystem: "spawn",
room: e
});
}
...
if (!(O = en[R])) return;
var E = ha(O, d);
if (E && l >= E.cost) ; else if (!(E = ha(O, l))) return void Jr.info("Bootstrap: No affordable body for ".concat(R, " (available: ").concat(l, ", min needed: ").concat(null !== (s = null === (i = O.bodies[0]) || void 0 === i ? void 0 : i.cost) && void 0 !== s ? s : "unknown", ")"), {
subsystem: "spawn",
room: e.name
});
var T = ga(R);
...
if (S === OK) Jr.info("BOOTSTRAP SPAWN: ".concat(R, " (").concat(T, ") with ").concat(E.parts.length, " parts, cost ").concat(E.cost, ". Recovery in progress."), {
subsystem: "spawn",
room: e.name
}), Ao.emit("spawn.completed", {
roomName: e.name,
creepName: T,
role: R,
cost: E.cost,
...
Jr.warn("BOOTSTRAP SPAWN FAILED: ".concat(R, " (").concat(T, ") - ").concat(C, ". Body: ").concat(E.parts.length, " parts, cost: ").concat(E.cost, ", available: ").concat(l), {
subsystem: "spawn",
room: e.name,
meta: {
errorCode: S,
...
var w = function(e, t) {
var r, o, n, a, i = ca(e.name), s = function(e) {
switch (e) {
case "eco":
return {
harvester: 1.5,
...
try {
for (var u = p(Object.entries(en)), l = u.next(); !l.done; l = u.next()) {
var m = f(l.value, 2), d = m[0], y = m[1];
if (pa(e.name, d, t)) {
var h = y.priority, g = null !== (n = s[d]) && void 0 !== n ? n : .5, v = Nn(d, t.pheromones), R = An(e, t, d), E = null !== (a = i.get(d)) && void 0 !== a ? a : 0, T = (h + R) * g * v * (y.maxPerRoom > 0 ? Math.max(.1, 1 - E / y.maxPerRoom) : .1);
c.push({
role: d,
score: T
});
...
memory: _
})) === OK) return void Ao.emit("spawn.completed", {
roomName: e.name,
creepName: T,
role: R,
cost: A.cost,
...
void Jr.warn("Spawn failed for ".concat(R, ": ").concat(C, ". Body: ").concat(A.parts.length, " parts, cost: ").concat(A.cost), {
subsystem: "spawn",
room: e.name,
meta: {
errorCode: S,
...
w.length > 0 && Game.time % 20 == 0 ? Jr.info("Waiting for energy: ".concat(w.length, " roles need spawning, waiting for optimal bodies. ") + "Energy: ".concat(l, "/").concat(u), {
subsystem: "spawn",
room: e.name,
meta: {
...
}) : 0 === w.length && Game.time % 100 == 0 && Jr.info("No spawns needed: All roles fully staffed. Energy: ".concat(l, "/").concat(u), {
subsystem: "spawn",
room: e.name,
meta: {
energyAvailable: l,
energyCapacity: u,
activeCreeps: ca(e.name, !0).size
}
});
}
}
...
var Ra = Qr("CreepContext"), Ea = (($n = {})[STRUCTURE_SPAWN] = 100, $n[STRUCTURE_EXTENSION] = 90, 
$n[STRUCTURE_TOWER] = 80, $n[STRUCTURE_RAMPART] = 75, $n[STRUCTURE_WALL] = 70, $n[STRUCTURE_STORAGE] = 70, 
$n[STRUCTURE_CONTAINER] = 60, $n[STRUCTURE_ROAD] = 30, $n), Ta = new Map;
...
var r, o, n = null !== (r = Ea[e.structureType]) && void 0 !== r ? r : 50;
return (null !== (o = Ea[t.structureType]) && void 0 !== o ? o : 50) - n;
})), e._prioritizedSites;
}
...
return Ta.set(e.name, o), o;
}(n);
void 0 === a.working && (a.working = e.store.getUsedCapacity() > 0, Ra.debug("".concat(e.name, " initialized working=").concat(a.working, " from carry state"), {
creep: e.name
}));
...
get containers() {
return void 0 === (e = i)._containers && (Sa(e), e._containers = e.allStructures.filter(function(e) {
return e.structureType === STRUCTURE_CONTAINER;
})), e._containers;
var e;
},
get depositContainers() {
return void 0 === (e = i)._depositContainers && (Sa(e), e._depositContainers = e.allStructures.filter(function(e) {
return e.structureType === STRUCTURE_CONTAINER;
...
var xa, Oa = {}, _a = function() {
if (xa) return Oa;
xa = 1, Object.defineProperty(Oa, "__esModule", {
value: !0
});
...
}, ye = de, he = U, ge = u, ve = B, Re = j, Ee = TypeError, Te = {
exports: {}
...
var Ae = Te.exports, Ne = Ae, Me = function(e, t) {
return Ne[e] || (Ne[e] = t || {});
}, Ue = I, ke = Object, Pe = function(e) {
return ke(Ue(e));
}, Ie = Pe, Ge = S({}.hasOwnProperty), Le = Object.hasOwn || function(e, t) {
return Ge(Ie(e), t);
}, De = S, Fe = 0, Be = Math.random(), We = De(1..toString), je = function(e) {
return "Symbol(" + (void 0 === e ? "" : e) + ")_" + We(++Fe + Be, 36);
}, Ve = Me, Ke = Le, He = je, qe = ne, Ye = ae, ze = r.Symbol, Xe = Ve("wks"), Qe = Ye ? ze.for || ze : ze && ze.withoutSetter || He, Je = function(e) {
return Ke(Xe, e) || (Xe[e] = qe && Ke(ze, e) ? ze[e] : Qe("Symbol." + e)), Xe[e];
}, $e = u, Ze = j, et = le, tt = TypeError, rt = Je("toPrimitive"), ot = le, nt = function(e) {
var t = function(e, t) {
...
return ot(t) ? t : t + "";
}, at = j, it = r.document, st = at(it) && at(it.createElement), ct = function(e) {
...
}), St = j, Ct = String, wt = TypeError, bt = function(e) {
if (St(e)) return e;
throw new wt(Ct(e) + " is not an object");
}, xt = a, Ot = lt, _t = Tt, At = bt, Nt = nt, Mt = TypeError, Ut = Object.defineProperty, kt = Object.getOwnPropertyDescriptor, Pt = "enumerable", It = "configurable", Gt = "writable";
...
exports: {}
}, Wt = a, jt = Le, Vt = Function.prototype, Kt = Wt && Object.getOwnPropertyDescriptor, Ht = {
CONFIGURABLE: jt(Vt, "name") && (!Wt || Wt && Kt(Vt, "name").configurable)
}, qt = B, Yt = Ae, zt = S(Function.toString);
qt(Yt.inspectSource) || (Yt.inspectSource = function(e) {
return zt(e);
});
var Xt, Qt, Jt, $t = Yt.inspectSource, Zt = B, er = r.WeakMap, tr = Zt(er) && /native code/.test(String(er)), rr = je, or = Me("keys"), nr = function(e) {
...
}, Rr = S, Er = n, Tr = B, Sr = Le, Cr = a, wr = Ht.CONFIGURABLE, br = $t, xr = vr.enforce, Or = vr.get, _r = String, Ar = Object.defineProperty, Nr = Rr("".slice), Mr = Rr("".replace), Ur = Rr([].join), kr = Cr && !Er(function() {
...
var Gr = Bt.exports, Lr = B, Dr = Et, Fr = Gr, Br = we, Wr = {}, jr = Math.ceil, Vr = Math.floor, Kr = Math.trunc || function(e) {
var t = +e;
return (t > 0 ? Vr : jr)(t);
}, Hr = function(e) {
var t = +e;
...
}, Oo = bo.data = {}, _o = bo.NATIVE = "N", Ao = bo.POLYFILL = "P", No = bo, Mo = r, Uo = o.f, ko = Ft, Po = function(e, t, r, o) {
o || (o = {});
...
return "Array" === Fo(e);
}, Wo = TypeError, jo = x, Vo = S, Ko = function(e) {
if ("Function" === jo(e)) return Vo(e);
...
}) ? vn : gn, En = Bo, Tn = Rn, Sn = j, Cn = Je("species"), wn = Array, bn = function(e, t) {
...
var Mn = {}, Un = io, kn = so, Pn = Object.keys || function(e) {
return Un(e, kn);
...
var Wn, jn = H("document", "documentElement"), Vn = bt, Kn = Mn, Hn = so, qn = ar, Yn = jn, zn = ct, Xn = "prototype", Qn = "script", Jn = nr("IE_PROTO"), $n = function() {}, Zn = function(e) {
return "<" + Qn + ">" + e + "</" + Qn + ">";
}, ea = function(e) {
e.write(Zn("")), e.close();
...
void 0 !== r && Game.time >= r && (Na.delete(t), delete e[t]);
}
}
}, Ma = (e, t, r = 1 / 0) => {
...
return o;
}, Ka = e => qa([ e ]), Ha = e => Ya(e)[0], qa = e => Da.encode(e.map(e => e.x << 6 | e.y)), Ya = e => Da.decode(e).map(e => {
const t = {
x: (4032 & e) >> 6,
y: 63 & e
};
...
return t;
}), za = e => e.map(e => ja(e)).join(""), Xa = e => {
var t;
return null === (t = e.match(/.{1,2}/g)) || void 0 === t ? void 0 : t.map(e => Va(e));
}, Qa = e => {
...
key: "mts",
serialize(e) {
if (void 0 !== e) return `${ja(e.pos)}${ii.encode(e.range)}`;
},
deserialize(e) {
if (void 0 !== e) return {
pos: Va(e.slice(0, 2)),
...
const hi = e => 0 === e.x || 0 === e.y || 49 === e.x || 49 === e.y, gi = Ma((e, t = !0, r = !1) => {
let o = `${t}${r}`;
...
function Ai(e) {
xi(e) && !Na.get(_i(e)) && Na.with(li).set(_i(e), [ ...Game.rooms[e].find(FIND_SOURCES), ...Game.rooms[e].find(FIND_MINERALS) ].map(e => e.pos));
}
...
let n = "";
for (let e = 0; e < o.length; e += 3) n += ji.encode(parseInt(o.slice(e, e + 3), 16));
...
var r;
const o = null !== (r = Na.with(li).get(_i(e))) && void 0 !== r ? r : [];
...
const o = Object.assign(Object.assign({}, ha.DEFAULT_MOVE_OPTS), r), n = Ma((e, t) => e + t, (e, t) => {
var r;
...
for (const t of e.targets) {
const r = ja(t), o = null !== (a = i.targets.get(r)) && void 0 !== a ? a : new Map;
i.targets.set(r, o), o.set(e.creep.id, e);
}
e.targets.length && e.targets[0].isEqualTo(e.creep.pos) && i.prefersToStay.add(ja(e.creep.pos));
}
function ns(e, t, r) {
var o, n, a;
...
const o = ja(e.creep.pos), a = [ ...null !== (u = null === (c = p.targets.get(o)) || void 0 === c ? void 0 : c.values()) && void 0 !== u ? u : [] ].filter(t => t !== e && t.targets.length < 2), i = a.find(e => !e.resolved && (null == r ? void 0 : r.isEqualTo(e.creep.pos)) && !p.pullers.has(e.creep.id));
...
function fs(e, t, r, o) {
var n;
const a = Object.assign(Object.assign({}, ha.DEFAULT_MOVE_OPTS), o), i = null !== (n = a.cache) && void 0 !== n ? n : Na, s = gi(r, null == o ? void 0 : o.keepTargetInRoom, null == o ? void 0 : o.flee);
...
function ds(e, t) {
var r;
return (null !== (r = null == t ? void 0 : t.cache) && void 0 !== r ? r : Na).with(li).get(ms(e));
}
function ys(e, t) {
var r;
(null !== (r = null == t ? void 0 : t.cache) && void 0 !== r ? r : Na).delete(ms(e));
}
function hs(e, t, r) {
var o, n, a, i;
const s = (null !== (o = null == r ? void 0 : r.cache) && void 0 !== o ? o : Na).with(li).get(ms(t));
...
return Oa.CachingStrategies = di, Oa.CoordListSerializer = pi, Oa.CoordSerializer = mi, 
Oa.Keys = Hi, Oa.MoveTargetListSerializer = ci, Oa.MoveTargetSerializer = si, Oa.NumberSerializer = Ca, 
Oa.PositionListSerializer = li, Oa.PositionSerializer = ui, Oa.adjacentWalkablePositions = Ci, 
Oa.blockSquare = function(e) {
rs(e.roomName).blockedSquares.add(ja(e));
}, Oa.cachePath = fs, Oa.cachedPathKey = ms, Oa.calculateAdjacencyMatrix = Ri, Oa.calculateAdjacentPositions = Ei, 
Oa.calculateNearbyPositions = Ti, Oa.calculatePositionsAtRange = Si, Oa.cleanAllCaches = fi, 
Oa.clearCachedPath = xs, Oa.compressPath = e => {
const t = [], r = e[0];
if (!r) return "";
let o = r;
...
return ja(r) + Fa.encode(t);
}, Oa.config = ha, Oa.decompressPath = e => {
let t = Va(e.slice(0, 2));
const r = [ t ], o = Fa.decode(e.slice(2));
for (const e of o) t = ti(t, e), r.push(t);
return r;
}, Oa.fastRoomPosition = Pa, Oa.fixEdgePosition = vi, Oa.follow = function(e, t) {
e.move(t), t.pull(e), function(e, t) {
const r = rs(e.pos.roomName);
r.pullers.add(e.id), r.pullees.add(t.id);
}(t, e);
}, Oa.followPath = hs, Oa.fromGlobalPosition = Za, Oa.generatePath = Zi, Oa.getCachedPath = ds, 
Oa.getMoveIntents = rs, Oa.getRangeTo = ei, Oa.globalPosition = $a, Oa.isExit = hi, 
Oa.isPositionWalkable = wi, Oa.move = ls, Oa.moveByPath = function(e, t, r) {
var o, n, a, i;
...
}, Oa.moveTo = Os, Oa.normalizeTargets = gi, Oa.offsetRoomPosition = Ga, Oa.packCoord = Ka, 
Oa.packCoordList = qa, Oa.packPos = ja, Oa.packPosList = za, Oa.packRoomName = ni, 
Oa.packRoomNames = ri, Oa.posAtDirection = ti, Oa.preTick = function() {
fi(), function() {
...
}, Oa.reconcileTraffic = function(e) {
for (const t of [ ...es.keys() ]) Game.rooms[t] && us(t, e);
Na.with(Ca).set(is, Game.time);
}, Oa.reconciledRecently = ss, Oa.resetCachedPath = ys, Oa.roomNameFromCoords = Ja, 
Oa.roomNameToCoords = Qa, Oa.sameRoomPosition = Ia, Oa.unpackCoord = Ha, Oa.unpackCoordList = Ya, 
Oa.unpackPos = Va, Oa.unpackPosList = Xa, Oa.unpackRoomName = ai, Oa.unpackRoomNames = oi, 
Oa;
}(), Aa = Qr("TargetAssignmentManager"), Na = new Map;
...
var t, r, o, n = wn.getSwarmState(e.name);
...
return Na.set(e.name, r), Aa.debug("Calculated fresh assignments for ".concat(e.name), {
meta: {
...
function e(e) {
void 0 === e && (e = {}), this.config = l(l({}, Ga), e);
}
...
if (Game.time - r.createdAt > t.config.requestTimeout) return Jr.debug("Resource request from ".concat(r.fromRoom, " to ").concat(r.toRoom, " expired"), {
subsystem: "ResourceSharing"
}), !1;
if (r.delivered >= r.amount) return Jr.info("Resource transfer completed: ".concat(r.delivered, " ").concat(r.resourceType, " from ").concat(r.fromRoom, " to ").concat(r.toRoom), {
subsystem: "ResourceSharing"
}), !1;
if (!e.memberRooms.includes(r.toRoom) || !e.memberRooms.includes(r.fromRoom)) return !1;
if (Game.rooms[r.toRoom]) {
var o = wn.getSwarmState(r.toRoom);
if (o && 0 === o.metrics.energyNeed) return Jr.debug("Resource request from ".concat(r.fromRoom, " to ").concat(r.toRoom, " no longer needed"), {
subsystem: "ResourceSharing"
}), !1;
}
return !0;
...
var u = wn.getSwarmState(s);
if (u) {
var l = e.focusRoom === s, m = this.calculateRoomEnergy(c), f = m.energyAvailable, d = m.energyCapacity, y = this.calculateEnergyNeed(c, f, u, l), h = 0;
l ? h = 0 : f > this.config.surplusEnergyThreshold && (h = f - this.config.mediumEnergyThreshold);
var g = 0;
...
if (n && i <= 3) {
var m = Math.min(t.needsAmount, n.canProvide), f = {
toRoom: t.roomName,
fromRoom: n.roomName,
...
e.resourceRequests.push(f), Jr.info("Created resource transfer: ".concat(m, " energy from ").concat(n.roomName, " to ").concat(t.roomName, " (priority ").concat(f.priority, ", distance ").concat(i, ")"), {
subsystem: "ResourceSharing"
}), n.canProvide -= m;
}
}, s = this;
...
o.delivered += r, Jr.debug("Updated transfer progress: ".concat(o.delivered, "/").concat(o.amount, " from ").concat(o.fromRoom, " to ").concat(o.toRoom), {
subsystem: "ResourceSharing"
});
}
}, e;
...
function Wa(e, t) {
var r = function(e) {
var t, r = Math.min(3, Math.max(1, e.urgency)), o = null !== (t = Fa[r]) && void 0 !== t ? t : Fa[2];
return {
...
}(t), o = "defense_".concat(t.roomName, "_").concat(Game.time), n = Ba(e, t.roomName), a = {
id: o,
type: "defense",
members: [],
rallyRoom: n,
...
return Jr.info("Created defense squad ".concat(o, " for ").concat(t.roomName, ": ") + "".concat(r.guards, "G/").concat(r.rangers, "R/").concat(r.healers, "H rally at ").concat(n), {
subsystem: "Squad"
}), a;
}
...
if ("gathering" === e.state && t > 300) return Jr.warn("Squad ".concat(e.id, " timed out during formation (").concat(t, " ticks)"), {
subsystem: "Squad"
}), !0;
if (0 === e.members.length && t > 50) return Jr.info("Squad ".concat(e.id, " has no members, dissolving"), {
subsystem: "Squad"
}), !0;
...
if (r) {
var o = Game.rooms[r];
if (o && 0 === o.find(FIND_HOSTILE_CREEPS).length && t > 100) return Jr.info("Squad ".concat(e.id, " mission complete, no more hostiles"), {
subsystem: "Squad"
}), !0;
}
}
...
return Game.creeps[e];
}), e.members.length < t && Jr.debug("Squad ".concat(e.id, " lost ").concat(t - e.members.length, " members"), {
subsystem: "Squad"
});
...
}) && (e.state = "moving", Jr.info("Squad ".concat(e.id, " gathered, moving to ").concat(o), {
subsystem: "Squad"
}));
break;
...
}) && (e.state = "attacking", Jr.info("Squad ".concat(e.id, " reached ").concat(o, ", engaging"), {
subsystem: "Squad"
}));
break;

case "attacking":
Game.time - e.createdAt > 50 && r.length < 3 && (e.state = "retreating", Jr.warn("Squad ".concat(e.id, " retreating - heavy casualties"), {
subsystem: "Squad"
}));
break;
...
r.every(function(t) {
return t.room.name === e.rallyRoom;
}) && (e.state = "dissolving", Jr.info("Squad ".concat(e.id, " retreated to ").concat(e.rallyRoom, ", dissolving"), {
subsystem: "Squad"
}));
}
}
...
(ka = {})[RESOURCE_CATALYZED_GHODIUM_ALKALIDE] = 300, ka[RESOURCE_CATALYZED_UTRIUM_ACID] = 300, 
ka[RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE] = 300, (Pa = {})[RESOURCE_CATALYZED_GHODIUM_ALKALIDE] = 600, 
Pa[RESOURCE_CATALYZED_UTRIUM_ACID] = 600, Pa[RESOURCE_CATALYZED_KEANIUM_ALKALIDE] = 300, 
Pa[RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE] = 600, (Ia = {})[RESOURCE_CATALYZED_GHODIUM_ALKALIDE] = 900, 
Ia[RESOURCE_CATALYZED_UTRIUM_ACID] = 600, Ia[RESOURCE_CATALYZED_ZYNTHIUM_ACID] = 900, 
Ia[RESOURCE_CATALYZED_KEANIUM_ALKALIDE] = 600, Ia[RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE] = 900;
...
var l = Game.rooms[u];
if (l && l.storage) {
var m = wn.getSwarmState(u);
if (m) {
var f = l.storage.store.getUsedCapacity(RESOURCE_ENERGY) - Ha(u, m.danger);
f > r && f > i && (i = f, a = u);
}
}
}
...
if (!a) return Jr.warn("No available energy source for emergency routing to ".concat(t, " (need ").concat(r, ")"), {
subsystem: "MilitaryPool"
}), {
success: !1
};
var d = Game.rooms[a], y = Game.rooms[t];
return (null == d ? void 0 : d.terminal) && (null == y ? void 0 : y.terminal) ? d.terminal.send(RESOURCE_ENERGY, r, t) === OK ? (Jr.info("Emergency energy routed: ".concat(r, " from ").concat(a, " to ").concat(t), {
subsystem: "MilitaryPool"
}), {
success: !0,
sourceRoom: a
...
success: !1
} : (Jr.info("Creating hauler transfer request: ".concat(r, " energy from ").concat(a, " to ").concat(t), {
subsystem: "MilitaryPool"
...
function za(e, t) {
var r, o, n, a;
if (!t) return Jr.debug("No intel for ".concat(e, ", defaulting to harassment"), {
subsystem: "Doctrine"
}), "harassment";
...
return u >= 20 || c >= 7 ? (Jr.info("Selected SIEGE doctrine for ".concat(e, " (threat: ").concat(u, ")"), {
subsystem: "Doctrine"
}), "siege") : u >= 10 || c >= 5 ? (Jr.info("Selected RAID doctrine for ".concat(e, " (threat: ").concat(u, ")"), {
subsystem: "Doctrine"
}), "raid") : (Jr.info("Selected HARASSMENT doctrine for ".concat(e, " (threat: ").concat(u, ")"), {
subsystem: "Doctrine"
}), "harassment");
}
...
var m = l.storage, f = l.terminal;
m && (i += m.store.energy), f && (i += f.store.energy);
}
}
} catch (e) {
r = {
...
var d = i >= a.minEnergy;
return d || Jr.debug("Cannot launch ".concat(t, ": insufficient energy (").concat(i, "/").concat(a.minEnergy, ")"), {
subsystem: "Doctrine"
}), d;
}
...
function ti(e, t, r) {
for (var o = d([], f(e), !1), n = e.reduce(function(e, t) {
return e + Za[t];
}, 0), a = r.reduce(function(e, t) {
return e + Za[t];
}, 0); n + a <= t && o.length < 50; ) o.push.apply(o, d([], f(r), !1)), n += a;
return o.slice(0, 50);
}
...
var t = wn.getCluster(e.clusterId);
if (!t) return e.state = "failed", void Jr.error("Cluster ".concat(e.clusterId, " not found for operation ").concat(e.id), {
subsystem: "Offensive"
});
switch (e.state) {
case "forming":
...
}) && (e.state = "executing", Jr.info("Operation ".concat(e.id, " entering execution phase"), {
subsystem: "Offensive"
})), Game.time - e.createdAt > 1e3 && (e.state = "failed", Jr.warn("Operation ".concat(e.id, " formation timed out"), {
subsystem: "Offensive"
}));
}(e);
break;
...
if (Va(o), ja(o)) {
Jr.info("Squad ".concat(r, " dissolving, operation ").concat(e.id, " may complete"), {
subsystem: "Offensive"
});
...
}).length && (e.state = "complete", Jr.info("Operation ".concat(e.id, " complete"), {
subsystem: "Offensive"
}));
}(e, t);
}
...
var u = e.find(FIND_HOSTILE_CREEPS);
if (u.length > 0) {
var l = Math.min.apply(Math, d([], f(u.map(function(e) {
...
function t(e) {
void 0 === e && (e = {}), this.lastRun = new Map, this.config = l(l({}, ai), e);
}
return t.prototype.run = function() {
var e = wn.getClusters();
for (var t in e) {
var r = e[t];
...
var o = e instanceof Error ? e.message : String(e);
Jr.error("Cluster ".concat(t, " error: ").concat(o), {
subsystem: "Cluster"
});
}
}
...
var u = ni(e, new RoomPosition(s, c, e.name), "defense");
u.score > 0 && n.push(u);
}
}
...
o && (e.rallyPoints.push(o), Jr.debug("Created defense rally point for ".concat(t, " at ").concat(o.x, ",").concat(o.y), {
...
var a = n.value, i = wn.getSwarmState(a);
if (i) {
var s = Ha(a, i.danger);
s > 0 && Game.time % 100 == 0 && Jr.debug("Military energy reservation for ".concat(a, ": ").concat(s, " (danger ").concat(i.danger, ")"), {
subsystem: "MilitaryPool"
});
}
}
...
a > 1 && Game.time % 50 == 0 && Jr.debug("Cluster ".concat(t.id, " tick: ").concat(a.toFixed(2), " CPU"), {
subsystem: "Cluster"
});
...
var l = u.value, m = wn.getSwarmState(l);
if (m) {
o += m.metrics.energyHarvested, n += m.metrics.energySpawning + m.metrics.energyConstruction + m.metrics.energyRepair, 
a += 25 * m.danger;
var f = Game.rooms[l];
(null == f ? void 0 : f.storage) ? i += f.storage.store.getUsedCapacity(RESOURCE_ENERGY) / f.storage.store.getCapacity() * 100 : i += m.metrics.energyHarvested > 0 ? 50 : 0, 
s++;
}
}
} catch (e) {
...
try {
for (var m = p(l), f = m.next(); !f.done; f = m.next()) {
var d = f.value;
...
Jr.debug("Transferred ".concat(S, " ").concat(t, " from ").concat(v.room.name, " to ").concat(T.room.name), {
subsystem: "Cluster"
});
break;
}
...
if (t.length >= 2) Jr.debug("Cluster ".concat(e.id, " at max operations (").concat(t.length, ")"), {
subsystem: "Offensive"
}); else {
var r = function(e, t, r, o) {
var n, a;
void 0 === o && (o = {});
var i = l(l({}, Qa), o), s = [], c = wn.getEmpire(), u = c.knownRooms, m = new Set(c.warTargets);
for (var p in u) {
var f = u[p];
...
if (!(Game.time - y < 5e3)) {
var h = Ja(f, d, m.has(p), i), g = "neutral";
...
var R = s.slice(0, 3);
return R.length > 0 && Jr.info("Found ".concat(R.length, " attack targets for cluster ").concat(e.id, ": ") + R.map(function(e) {
...
if (0 !== r.length) {
var o = r[0];
Xa(e, o.doctrine) ? function(e, t, r) {
if (!function(e) {
var t = wn.getEmpire().knownRooms[e];
return t ? !(Game.time - t.lastSeen > 5e3 && (Jr.warn("Intel for ".concat(e, " is stale (").concat(Game.time - t.lastSeen, " ticks old)"), {
subsystem: "AttackTarget"
}), 1)) : (Jr.warn("No intel for target ".concat(e), {
subsystem: "AttackTarget"
}), !1);
}(t)) return Jr.warn("Invalid target ".concat(t), {
subsystem: "Offensive"
}), null;
var o = wn.getEmpire().knownRooms[t], n = null != r ? r : za(t, {
...
if (!Xa(e, n)) return Jr.warn("Cannot launch ".concat(n, " operation on ").concat(t, " - insufficient resources"), {
subsystem: "Offensive"
}), null;
...
return n;
}(0, o), a = "".concat(r, "_").concat(t, "_").concat(Game.time), i = Ba(e, t), s = .3;
...
return Jr.info("Created ".concat(r, " squad ").concat(a, " for ").concat(t, ": ") + "".concat(n.guards, "G/").concat(n.rangers, "R/").concat(n.healers, "H/").concat(n.siegeUnits, "S rally at ").concat(i), {
subsystem: "Squad"
}), c;
...
var r = t.id;
if (ei.has(r)) Jr.debug("Squad ".concat(r, " already forming"), {
...
var i = Pn.NORMAL;
"siege" === t.type ? i = Pn.HIGH : "defense" === t.type && (i = Pn.EMERGENCY);
var s = function(r, a) {
...
switch (e) {
case "harasser":
return ti([ MOVE, ATTACK ], o, [ MOVE, ATTACK ]);

case "soldier":
return ti([ TOUGH, MOVE, ATTACK, MOVE, ATTACK ], o, [ TOUGH, MOVE, ATTACK ]);

case "ranger":
return ti([ TOUGH, MOVE, RANGED_ATTACK ], o, [ MOVE, RANGED_ATTACK ]);

case "healer":
return ti([ TOUGH, MOVE, HEAL ], o, [ MOVE, HEAL ]);

case "siegeUnit":
return ti([ TOUGH, MOVE, WORK ], o, [ TOUGH, MOVE, WORK ]);
...
Dn.addRequest(l), o.spawnRequests.add(l.id);
}, c = 0; c < a; c++) s(c);
};
...
}(s, t, o, i), Jr.info("Started forming squad ".concat(r, ": ").concat(JSON.stringify(a)), {
subsystem: "SquadFormation"
})) : Jr.warn("Rally room ".concat(t.rallyRoom, " not visible for squad ").concat(r), {
subsystem: "SquadFormation"
});
}
}(0, c), i.state = "forming", s = t, Memory.lastAttacked || (Memory.lastAttacked = {}), 
Memory.lastAttacked[s] = Game.time, Jr.info("Marked ".concat(s, " as attacked at tick ").concat(Game.time), {
subsystem: "AttackTarget"
}), Jr.info("Launched ".concat(n, " operation ").concat(a, " on ").concat(t, " with squad ").concat(c.id), {
subsystem: "Offensive"
});
}(e, o.roomName, o.doctrine) : Jr.info("Cluster ".concat(e.id, " cannot launch ").concat(o.doctrine, " doctrine (insufficient resources)"), {
subsystem: "Offensive"
});
} else Jr.debug("No attack targets found for cluster ".concat(e.id), {
subsystem: "Offensive"
});
}
}
...
var e, t, r = Game.time;
try {
for (var o = p(ei.entries()), n = o.next(); !n.done; n = o.next()) {
var a = f(n.value, 2), i = a[0], s = r - a[1].formationStarted;
s > 500 && (Jr.warn("Squad ".concat(i, " formation timed out after ").concat(s, " ticks"), {
subsystem: "SquadFormation"
}), ei.delete(i));
}
} catch (t) {
...
try {
for (var r = p(ri.entries()), o = r.next(); !o.done; o = r.next()) {
var n = f(o.value, 2);
n[0], oi(n[1]);
}
} catch (t) {
...
try {
for (var r = p(ri.entries()), o = r.next(); !o.done; o = r.next()) {
var n = f(o.value, 2), a = n[0], i = n[1], s = Game.time - i.createdAt;
("complete" === i.state || "failed" === i.state) && s > 5e3 && (ri.delete(a), Jr.debug("Cleaned up operation ".concat(a), {
subsystem: "Offensive"
}));
}
} catch (t) {
...
8 === (null === (n = null == l ? void 0 : l.controller) || void 0 === n ? void 0 : n.level) && (Jr.info("Focus room ".concat(e.focusRoom, " reached RCL 8, selecting next room"), {
subsystem: "Cluster"
}), e.focusRoom = void 0), l || (Jr.warn("Focus room ".concat(e.focusRoom, " no longer valid, selecting new focus"), {
subsystem: "Cluster"
}), e.focusRoom = void 0);
}
if (!e.focusRoom) {
...
}), e.focusRoom = m[0].roomName, Jr.info("Selected ".concat(e.focusRoom, " (RCL ").concat(m[0].rcl, ") as focus room for upgrading"), {
subsystem: "Cluster"
});
}
}
}, t.prototype.createCluster = function(e) {
var t = "cluster_".concat(e), r = wn.getCluster(t, e);
if (!r) throw new Error("Failed to create cluster for ".concat(e));
return Jr.info("Created cluster ".concat(t, " with core room ").concat(e), {
subsystem: "Cluster"
}), r;
}, t.prototype.addRoomToCluster = function(e, t, r) {
void 0 === r && (r = !1);
var o = wn.getCluster(e);
o ? r ? o.remoteRooms.includes(t) || (o.remoteRooms.push(t), Jr.info("Added remote room ".concat(t, " to cluster ").concat(e), {
subsystem: "Cluster"
})) : o.memberRooms.includes(t) || (o.memberRooms.push(t), Jr.info("Added member room ".concat(t, " to cluster ").concat(e), {
subsystem: "Cluster"
})) : Jr.error("Cluster ".concat(e, " not found"), {
subsystem: "Cluster"
});
...
var t = Game.time - e.createdAt;
if (t > 500) return Jr.debug("Defense request for ".concat(e.roomName, " expired (").concat(t, " ticks old)"), {
subsystem: "Cluster"
}), !1;
var r = Game.rooms[e.roomName];
return !(!r || 0 === r.find(FIND_HOSTILE_CREEPS).length && (Jr.info("Defense request for ".concat(e.roomName, " resolved - no more hostiles"), {
subsystem: "Cluster"
}), 1));
});
try {
...
u && u.storage && u.storage.store.getUsedCapacity(RESOURCE_ENERGY) < 1e4 && qa(e, c.roomName, 2e4);
}
}
} catch (e) {
t = {
...
try {
for (var f = p(e.memberRooms), d = f.next(); !d.done; d = f.next()) m(d.value);
} catch (e) {
o = {
error: e
};
...
var s = d([], f(e.defenseRequests), !1).sort(function(e, t) {
...
if (w && O || b && _ || x && A) {
var N = Game.map.getRoomLinearDistance(g, m.roomName);
c.push({
creep: S,
room: v,
distance: N,
...
for (var M = m.guardsNeeded + m.rangersNeeded + m.healersNeeded, U = Math.min(M, c.length), k = 0; k < U; k++) {
var P = c[k];
P && (P.creep.memory.assistTarget = m.roomName, m.assignedCreeps.push(P.creep.name), 
Jr.info("Assigned ".concat(P.creep.name, " (").concat(P.creep.memory.role, ") from ").concat(P.room.name, " to assist ").concat(m.roomName, " (distance: ").concat(P.distance, ")"), {
subsystem: "Cluster"
...
function ui(e) {
var t, r, o = wn.getEmpire(), n = 0, a = di(e);
try {
for (var i = p(a), s = i.next(); !s.done; s = i.next()) {
var c = s.value, u = o.knownRooms[c];
u && (u.owner && !hi(u.owner) && (n += 30), u.threatLevel >= 2 && (n += 10 * u.threatLevel), 
...
var i = 10 * r.sources, s = 50 * a * 2, c = (650 + 450 * r.sources) / (1500 / s) / s, u = 5e3 * r.sources + 50 * a * 300, l = u / 5e4, m = i * (null !== (n = [ 0, .1, .3, .6 ][r.threatLevel]) && void 0 !== n ? n : 0), p = i - c - l - m, f = c + l, d = f > 0 ? p / f : 0, y = function(e) {
...
function t(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = l(l({}, Ti), e);
}
return t.prototype.run = function() {
var t = this, r = Game.cpu.getUsed(), o = wn.getEmpire();
...
Game.time % 100 == 0 && Jr.info("Empire tick completed in ".concat(n.toFixed(2), " CPU"), {
subsystem: "Empire"
});
...
var l = u.value;
(d = e.knownRooms[l.name]) && d.owner !== s && (d.owner = s, Jr.info("Updated room intel for ".concat(l.name, " - now owned by ").concat(s), {
subsystem: "Empire"
}));
}
} catch (e) {
...
m.sort(function(e, t) {
return t.score - e.score;
}), e.claimQueue = m.slice(0, 10), m.length > 0 && Game.time % 100 == 0 && Jr.info("Expansion queue updated: ".concat(m.length, " candidates, top score: ").concat(m[0].score), {
subsystem: "Empire"
});
}
}, t.prototype.scoreExpansionCandidate = function(e, t) {
var r = 0;
2 === e.sources ? r += 40 : 1 === e.sources && (r += 20), r += ci(e.mineralType);
var o = this.getMinDistanceToOwned(e.name, t);
return o > this.config.maxExpansionDistance ? 0 : (r -= 5 * o, r -= ui(e.name), 
r -= 15 * e.threatLevel, r += li(e.terrain), mi(e.name) && (r += 10), r += pi(e.name), 
e.controllerLevel > 0 && !e.owner && (r += 2 * e.controllerLevel), r += fi(e.name, t, o), 
...
var e = wn.getEmpire().claimQueue.filter(function(e) {
return !e.claimed;
});
return e.length > 0 ? e[0] : null;
}, t.prototype.markExpansionClaimed = function(e) {
var t = wn.getEmpire().claimQueue.find(function(t) {
return t.roomName === e;
});
...
try {
for (var s = p(a), c = s.next(); !c.done; c = s.next()) {
var u = gi(c.value.name, this.config.maxRoomDiscoveryDistance);
try {
for (var l = (o = void 0, p(u)), m = l.next(); !m.done; m = l.next()) {
var f = m.value;
if (i >= this.config.maxRoomsToDiscoverPerTick) return void Jr.debug("Reached discovery limit of ".concat(this.config.maxRoomsToDiscoverPerTick, " rooms per tick"), {
subsystem: "Empire"
});
...
i > 0 && Jr.info("Discovered ".concat(i, " nearby rooms for scouting"), {
subsystem: "Empire"
});
}
}
...
if (Game.time % 50 == 0) {
var e = wn.getClusters(), t = Object.values(Game.rooms).filter(function(e) {
var t;
return null === (t = e.controller) || void 0 === t ? void 0 : t.my;
}), r = function(r) {
...
o.metrics.economyIndex = Math.round((u + l) / 2), o.metrics.economyIndex < 40 && Game.time % 500 == 0 && Jr.warn("Cluster ".concat(r, " economy index low: ").concat(o.metrics.economyIndex, " - consider rebalancing"), {
subsystem: "Empire"
});
};
for (var o in e) r(o);
...
var m = 1 / 0, f = null;
try {
for (var d = (o = void 0, p(s)), y = d.next(); !y.done; y = d.next()) {
...
if (f) {
var v = l.decayTick - Game.time, R = 50 * m * 2 + l.power / 2, E = v > 1.5 * R && m <= 5 && l.power >= 1e3 && (null !== (i = null === (a = f.controller) || void 0 === a ? void 0 : a.level) && void 0 !== i ? i : 0) >= 7;
E || Game.time % 500 != 0 ? E && Game.time % 500 == 0 && Jr.info("Profitable power bank in ".concat(l.roomName, ": ") + "power=".concat(l.power, ", distance=").concat(m, ", timeRemaining=").concat(v), {
subsystem: "Empire"
}) : Jr.debug("Power bank in ".concat(l.roomName, " not profitable: ") + "power=".concat(l.power, ", distance=").concat(m, ", timeRemaining=").concat(v, ", ") + "requiredTime=".concat(R.toFixed(0)), {
subsystem: "Empire"
});
}
}
...
}, m([ zn("empire:manager", "Empire Manager", {
priority: ho.MEDIUM,
interval: 30,
minBucket: 0,
cpuBudget: .05
...
try {
for (var u = p(c), l = u.next(); !l.done; l = u.next()) {
var m = l.value, f = wn.getSwarmState(m.name);
if (f && !((null !== (i = null === (a = m.controller) || void 0 === a ? void 0 : a.level) && void 0 !== i ? i : 0) < this.config.minRclForRemotes)) {
var d = null !== (s = f.remoteAssignments) && void 0 !== s ? s : [], y = this.validateRemoteAssignments(d, e, m.name), h = this.calculateRemoteCapacity(m, f);
if (y.length < h) {
var g = this.findRemoteCandidates(m.name, e, y), v = h - y.length, R = g.slice(0, v);
try {
for (var E = (o = void 0, p(R)), T = E.next(); !T.done; T = E.next()) {
var S = T.value;
y.includes(S) || (y.push(S), Jr.info("Assigned remote room ".concat(S, " to ").concat(m.name), {
subsystem: "Expansion"
}));
}
} catch (e) {
...
var o = 0;
return 2 === e.sources ? o += 40 : 1 === e.sources && (o += 20), o += ci(e.mineralType), 
o -= 5 * t, o -= ui(e.name), o -= 15 * e.threatLevel, o += li(e.terrain), mi(e.name) && (o += 10), 
o += pi(e.name), e.controllerLevel > 0 && !e.owner && (o += 2 * e.controllerLevel), 
o + fi(e.name, r, t);
...
u.targetRoom = o.roomName, u.task = "claim", Jr.info("Assigned claim target ".concat(o.roomName, " to ").concat(c.name), {
subsystem: "Expansion"
}), o.claimed = !0, a = !0;
break;
}
...
try {
for (var u = p(i), l = u.next(); !l.done; l = u.next()) {
var m = l.value, f = Game.map.getRoomLinearDistance(m.name, e);
f < c && (c = f, s = m);
}
} catch (e) {
r = {
...
if (s) {
var d = wn.getSwarmState(s.name);
d && "defensive" !== d.posture && "evacuate" !== d.posture && d.danger < 2 && "expand" !== d.posture && (d.posture = "expand", 
Jr.info("Set ".concat(s.name, " to expand posture for claiming ").concat(e, " (distance: ").concat(c, ")"), {
subsystem: "Expansion"
}));
}
}
...
var u = c.homeRoom;
if (u) {
var l = wn.getSwarmState(u);
if (null === (n = null == l ? void 0 : l.remoteAssignments) || void 0 === n ? void 0 : n.length) try {
for (var m = (r = void 0, p(l.remoteAssignments)), f = m.next(); !f.done; f = m.next()) {
var d = f.value;
if (!this.hasReserverAssigned(d)) {
c.targetRoom = d, c.task = "reserve", Jr.info("Assigned reserve target ".concat(d, " to ").concat(s.name), {
subsystem: "Expansion"
});
break;
}
...
var a = n[0];
Jr.info("Next expansion target: ".concat(a.roomName, " (score: ").concat(a.score, ", cluster bonus: ").concat(a.clusterScore - a.score, ", distance: ").concat(a.distanceToCluster, ")"), {
subsystem: "Expansion"
});
}
return n[0];
...
u && (u.owner && !hi(u.owner) && n.push("Hostile player ".concat(u.owner, " in ").concat(c)), 
...
return function(e) {
var t, r, o = wn.getEmpire(), n = di(e), a = new Set;
try {
for (var i = p(n), s = i.next(); !s.done; s = i.next()) {
var c = s.value, u = o.knownRooms[c];
(null == u ? void 0 : u.owner) && !hi(u.owner) && a.add(u.owner);
}
} catch (e) {
t = {
error: e
...
subsystem: "Expansion"
}), i.removeFromClaimQueue(e, t.roomName), "continue") : (Jr.warn("Expansion to ".concat(t.roomName, " timed out after ").concat(r, " ticks"), {
subsystem: "Expansion"
...
if ((null == s ? void 0 : s.owner) && s.owner !== i.getMyUsername()) return Jr.warn("".concat(t.roomName, " claimed by ").concat(s.owner, " before we could claim it"), {
subsystem: "Expansion"
...
return l < 2e4 ? (Jr.warn("Cancelling expansion to ".concat(t.roomName, " due to low energy (avg: ").concat(l, ")"), {
subsystem: "Expansion"
...
c.task = void 0, Jr.info("Cleared target for ".concat(s.name, " due to expansion cancellation"), {
subsystem: "Expansion"
}));
}
} catch (e) {
...
}, _i = 1e7, Ai = 5e6, Ni = ((Ri = {})[STRUCTURE_SPAWN] = 15e3, Ri[STRUCTURE_TOWER] = 5e3, 
Ri[STRUCTURE_STORAGE] = 3e4, Ri[STRUCTURE_TERMINAL] = 1e5, Ri[STRUCTURE_LAB] = 5e4, 
Ri[STRUCTURE_NUKER] = 1e5, Ri[STRUCTURE_POWER_SPAWN] = 1e5, Ri[STRUCTURE_OBSERVER] = 8e3, 
Ri[STRUCTURE_EXTENSION] = 3e3, Ri[STRUCTURE_LINK] = 5e3, Ri), Mi = function() {
function e(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.nukerReadyLogged = new Set, this.config = l(l({}, Oi), e);
}
return e.prototype.run = function() {
...
launched: !1,
launchTick: 0
}), Jr.info("Nuke candidate: ".concat(a, " (score: ").concat(i.score, ") - ").concat(i.reasons.join(", ")), {
subsystem: "Nuke"
}));
}
} catch (t) {
...
var t = 0, r = [], o = wn.getEmpire().knownRooms[e];
if (!o) return {
roomName: e,
score: 0,
reasons: [ "No intel" ]
...
if (i.length > 0) {
var s = Math.min.apply(Math, d([], f(i.map(function(t) {
return Game.map.getRoomLinearDistance(e, t.name);
})), !1));
t -= 2 * s, r.push("".concat(s, " rooms away"));
}
wn.getEmpire().warTargets.includes(e) && (t += 15, r.push("War target"));
...
if (!m.launched) {
try {
for (var f = (r = void 0, p(i)), d = f.next(); !d.done; d = f.next()) {
var y = d.value;
...
if (v < this.config.roiThreshold) Jr.warn("Skipping nuke launch on ".concat(m.roomName, ": ROI ").concat(v.toFixed(2), "x below threshold ").concat(this.config.roiThreshold, "x"), {
subsystem: "Nuke"
}); else {
...
a.nukeEconomics.lastLaunchTick = Game.time, Jr.warn("NUKE LAUNCHED from ".concat(y.room.name, " to ").concat(m.roomName, "! ") + "Impact in ".concat(this.config.nukeFlightTime, " ticks. ") + "Predicted damage: ".concat((g.estimatedDamage / 1e6).toFixed(1), "M hits, ") + "value: ".concat((g.estimatedValue / 1e3).toFixed(0), "k, ROI: ").concat(v.toFixed(2), "x"), {
subsystem: "Nuke"
});
var T = i.indexOf(y);
T > -1 && i.splice(T, 1);
...
Jr.error("Failed to launch nuke: ".concat(R), {
subsystem: "Nuke"
});
}
}
...
s.danger = 3, Jr.warn("INCOMING NUKE DETECTED in ".concat(r, "! ") + "Landing at (".concat(e.pos.x, ", ").concat(e.pos.y, "), impact in ").concat(e.timeToLand, " ticks. ") + "Source: ".concat(e.launchRoomName || "unknown", ". ") + "Threatened structures: ".concat(c.length), {
subsystem: "Nuke"
}), s.eventLog.push({
type: "nuke_incoming",
time: Game.time,
...
} else s.nukeDetected && (s.nukeDetected = !1, Jr.info("Nuke threat cleared in ".concat(r), {
subsystem: "Nuke"
}));
}, o = this;
...
var r = wn.getSwarmState(e.name);
r && (t.timeToLand < 5e3 ? (r.posture = "evacuate", Jr.warn("EVACUATION TRIGGERED for ".concat(e.name, ": Critical structures threatened by nuke!"), {
subsystem: "Nuke"
...
var e, t;
if (wn.getEmpire().objectives.warMode) for (var r in Game.rooms) {
var o = Game.rooms[r];
...
0 === i && 0 === s ? this.nukerReadyLogged.has(u) || (Jr.info("Nuker in ".concat(r, " is fully loaded and ready to launch"), {
subsystem: "Nuke"
...
o ? n.terminalManager.requestTransfer(o, e, t, r, this.config.terminalPriority) && Jr.info("Requested ".concat(r, " ").concat(t, " transfer from ").concat(o, " to ").concat(e, " for nuker"), {
subsystem: "Nuke"
...
var e, t, r, o, n, a, i, s = wn.getEmpire();
...
l.siegeSquadId || m <= this.config.siegeCoordinationWindow && m > 0 && this.deploySiegeSquadForNuke(l) && Jr.info("Siege squad deployment coordinated with nuke on ".concat(l.targetRoom, ", ") + "impact in ".concat(m, " ticks"), {
subsystem: "Nuke"
});
}
} catch (t) {
...
var f = wn.getClusters();
try {
for (var d = p(Object.values(f)), y = d.next(); !y.done; y = d.next()) {
var h = y.value;
...
r && !r.siegeSquadId && (r.siegeSquadId = e.id, Jr.info("Linked siege squad ".concat(e.id, " with nuke on ").concat(t), {
subsystem: "Nuke"
}));
};
try {
...
var t, r, o, n = wn.getClusters(), a = null;
try {
...
if (!a) return Jr.warn("Cannot deploy siege squad for nuke on ".concat(e.targetRoom, ": No clusters available"), {
subsystem: "Nuke"
}), !1;
var l = n[a.id];
if (!l) return !1;
...
var f = wn.getSwarmState(e.targetRoom);
...
return l.squads || (l.squads = []), l.squads.push(y), e.siegeSquadId = d, Jr.warn("SIEGE SQUAD DEPLOYED: Squad ".concat(d, " will coordinate with nuke on ").concat(e.targetRoom), {
subsystem: "Nuke"
}), !0;
...
return Math.min.apply(Math, d([], f(o), !1));
...
var e, t, r, o, n, a, i = wn.getEmpire();
...
var g = f(h.value, 2), v = g[0], R = g[1];
if (!(R.length < 2)) {
var E = R.map(function(e) {
return e.impactTick;
}), T = Math.min.apply(Math, d([], f(E), !1)), S = Math.max.apply(Math, d([], f(E), !1)) - T;
...
Jr.info("Nuke salvo ".concat(C, " coordinated: ").concat(R.length, " nukes on ").concat(v, ", impact spread: ").concat(S, " ticks"), {
subsystem: "Nuke"
});
} else Jr.warn("Nukes on ".concat(v, " not synchronized (spread: ").concat(S, " ticks > ").concat(this.config.salvoSyncWindow, ")"), {
subsystem: "Nuke"
});
}
}
...
if (!a) {
var i = wn.getEmpire().knownRooms[e];
if (i) {
var s = 5 * (i.towerCount || 0) + 10 * (i.spawnCount || 0) + 5;
n.estimatedDamage = _i + Ai * s, n.estimatedValue = .01 * n.estimatedDamage;
}
return n;
}
...
try {
for (var u = p(c), l = u.next(); !l.done; l = u.next()) {
var m = l.value.structure, f = Math.abs(m.pos.x - t.x), d = Math.abs(m.pos.y - t.y), y = 0 === Math.max(f, d) ? _i : Ai;
...
return Ni[e.structureType] || 1e3;
}, e.prototype.processCounterNukeStrategies = function() {
var e, t, r, o = wn.getEmpire();
...
var c = wn.getSwarmState(i.roomName);
...
Jr.warn("COUNTER-NUKE AUTHORIZED: ".concat(i.sourceRoom, " added to war targets for nuke retaliation"), {
subsystem: "Nuke"
}), Game.rooms) if (null === (r = Game.rooms[u].controller) || void 0 === r ? void 0 : r.my) {
var l = wn.getSwarmState(u);
l && (l.pheromones.war = Math.min(100, l.pheromones.war + 30));
}
} else Jr.warn("Counter-nuke desired against ".concat(i.sourceRoom, " but insufficient resources"), {
subsystem: "Nuke"
});
}
}
...
r.lastROI = n / o, r.nukesLaunched > 0 && r.nukesLaunched % 5 == 0 && Jr.info("Nuke economics: ".concat(r.nukesLaunched, " nukes, ROI: ").concat(null === (e = r.lastROI) || void 0 === e ? void 0 : e.toFixed(2), "x, ") + "Value destroyed: ".concat((r.totalValueDestroyed / 1e3).toFixed(0), "k"), {
subsystem: "Nuke"
});
}
}
...
function e(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = l(l({}, ki), e);
}
return e.prototype.run = function() {
...
if (i.energy < c + this.config.minEnergySurplus) return Jr.debug("Pixel buying: energy below surplus (".concat(i.energy, " < ").concat(c + this.config.minEnergySurplus, ")"), {
subsystem: "PixelBuying"
}), !1;
try {
for (var u = p(Object.entries(this.config.criticalResourceThresholds)), l = u.next(); !l.done; l = u.next()) {
var m = f(l.value, 2), d = m[0], y = m[1];
if ((R = null !== (n = i[d]) && void 0 !== n ? n : 0) < y) return Jr.debug("Pixel buying: ".concat(d, " below threshold (").concat(R, " < ").concat(y, ")"), {
subsystem: "PixelBuying"
}), !1;
}
} catch (t) {
...
var R, E = v.value;
if ((R = null !== (a = i[E]) && void 0 !== a ? a : 0) < this.config.minBaseMineralReserve) return Jr.debug("Pixel buying: ".concat(E, " below reserve (").concat(R, " < ").concat(this.config.minBaseMineralReserve, ")"), {
subsystem: "PixelBuying"
}), !1;
}
} catch (e) {
...
if (a.terminal.store[RESOURCE_ENERGY] < u) Jr.debug("Not enough energy for pixel transaction (need ".concat(u, ")"), {
subsystem: "PixelBuying"
}); else {
...
} else Jr.warn("Failed to purchase pixels: error code ".concat(l), {
subsystem: "PixelBuying"
});
}
}
...
}, m([ zn("empire:pixelBuying", "Pixel Buying Manager", {
priority: ho.IDLE,
interval: 200,
minBucket: 0,
cpuBudget: .01
...
function e(e) {
void 0 === e && (e = {}), this.config = l(l({}, Gi), e);
}
return e.prototype.run = function() {
...
return l({}, this.config);
}, m([ zn("empire:pixelGeneration", "Pixel Generation Manager", {
priority: ho.IDLE,
interval: 1,
minBucket: 0,
cpuBudget: .01
...
function e(e) {
void 0 === e && (e = {}), this.operations = new Map, this.lastScan = 0, this.config = l(l({}, Fi), e);
}
return e.prototype.run = function() {
...
var e, t, r = wn.getEmpire(), o = function(o) {
...
try {
for (var d = (a = void 0, p(m)), y = d.next(); !y.done; y = d.next()) f(y.value);
} catch (e) {
a = {
error: e
};
...
var o = wn.getEmpire(), n = Object.values(Game.rooms).filter(function(e) {
var t;
...
this.operations.set(e.roomName, l), e.active = !0, Jr.info("Started power bank operation in ".concat(e.roomName, " (").concat(e.power, " power, home: ").concat(n.name, ")"), {
subsystem: "PowerBank"
});
}
...
}, m([ zn("empire:powerBank", "Power Bank Harvesting", {
priority: ho.LOW,
interval: 50,
minBucket: 0,
cpuBudget: .02
...
c && u && s.processPower() === OK && Jr.debug("Processing power in ".concat(a.roomName, ": ").concat(a.reason), {
subsystem: "PowerCreep"
});
}
}
...
if (l || m) {
var f = (null !== (r = null == l ? void 0 : l.store.getUsedCapacity(RESOURCE_POWER)) && void 0 !== r ? r : 0) + (null !== (o = null == m ? void 0 : m.store.getUsedCapacity(RESOURCE_POWER)) && void 0 !== o ? o : 0), d = null !== (n = null == l ? void 0 : l.store.getUsedCapacity(RESOURCE_ENERGY)) && void 0 !== n ? n : 0, y = !1, h = "", g = 0;
...
return l.homeRoom = a, l.role = o, Jr.info("Power creep ".concat(e.name, " assigned as ").concat(o, " to ").concat(a), {
subsystem: "PowerCreep"
}), u;
...
var n = f(o.value, 2), a = n[0], i = n[1], s = Game.powerCreeps[a];
if (s && !(s.level >= this.gplState.currentLevel)) {
var c = this.selectNextPower(s, i);
if (c) {
var u = s.upgrade(c);
u === OK ? (Jr.info("Upgraded ".concat(s.name, " to level ").concat(s.level + 1, " with ").concat(c), {
subsystem: "PowerCreep"
}), i.level = s.level) : u !== ERR_NOT_ENOUGH_RESOURCES && Jr.warn("Failed to upgrade ".concat(s.name, ": ").concat(u), {
subsystem: "PowerCreep"
});
}
}
...
})[0]) && s.spawn(u) === OK && (Jr.info("Power creep ".concat(a, " spawned at ").concat(c.name), {
subsystem: "PowerCreep"
...
})[0]) && s.pos.getRangeTo(u) <= 1 && s.renew(u) === OK && Jr.debug("Power creep ".concat(a, " renewed"), {
subsystem: "PowerCreep"
});
}
}
...
}, m([ zn("empire:powerCreep", "Power Creep Management", {
priority: ho.LOW,
interval: 20,
minBucket: 0,
cpuBudget: .03
...
function Xi(e, t, r) {
var o, n, a, i, s, c, u, m, f, d, y, h, g, v, R, E, T;
void 0 === r && (r = {});
var S = l(l({}, Yi), r), C = zi.get(e.name);
if (C && Game.time - C.lastCalculated < S.recalculateInterval) return C;
var w = new Set, b = null !== (E = null === (R = e.controller) || void 0 === R ? void 0 : R.level) && void 0 !== E ? E : 0, x = e.find(FIND_SOURCES), O = e.controller, _ = e.storage, A = e.find(FIND_MINERALS)[0], N = null !== (T = null == _ ? void 0 : _.pos) && void 0 !== T ? T : t;
try {
for (var M = p(x), U = M.next(); !U.done; U = M.next()) {
var k = es(N, U.value.pos, e.name, S.maxPathOps);
try {
...
if (O) {
k = es(N, O.pos, e.name, S.maxPathOps);
try {
...
if (A && b >= 6) {
k = es(N, A.pos, e.name, S.maxPathOps);
try {
...
if (!_) {
try {
for (var W = p(x), j = W.next(); !j.done; j = W.next()) {
k = es(t, j.value.pos, e.name, S.maxPathOps);
try {
for (var V = (y = void 0, p(k)), K = V.next(); !K.done; K = V.next()) G = K.value, 
w.add("".concat(G.x, ",").concat(G.y));
} catch (e) {
y = {
error: e
...
try {
j && !j.done && (d = W.return) && d.call(W);
} finally {
if (f) throw f.error;
}
}
if (O) {
k = es(t, O.pos, e.name, S.maxPathOps);
try {
for (var H = p(k), q = H.next(); !q.done; q = H.next()) G = q.value, w.add("".concat(G.x, ",").concat(G.y));
} catch (e) {
g = {
error: e
};
...
return zi.set(e.name, Y), Jr.debug("Calculated road network for ".concat(e.name, ": ").concat(w.size, " positions"), {
...
function Zi(e, t, r) {
var o, n, a, i, s, c, u, m, f;
void 0 === r && (r = {});
var d = l(l({}, Yi), r), y = new Map;
...
var A = new RoomPosition(25, 25, T), N = PathFinder.search(v, {
pos: A,
range: 20
}, {
plainCost: 2,
...
if (!N.incomplete) try {
for (var M = (s = void 0, p(N.path)), U = M.next(); !U.done; U = M.next()) _ = U.value, 
...
function as(e) {
var t, r, o, n = wn.getSwarmState(e);
if (n) {
...
if (u) {
var l = os(u);
l.lost && l.reason && ns(e, c, l.reason);
}
}
} catch (e) {
t = {
...
function e(e) {
void 0 === e && (e = {}), this.config = l(l({}, is), e);
}
return e.prototype.run = function() {
...
try {
for (var i = p(a), s = i.next(); !s.done; s = i.next()) {
var c = s.value, u = wn.getSwarmState(c.name);
if (u) {
as(c.name);
var l = null !== (n = u.remoteAssignments) && void 0 !== n ? n : [];
if (0 !== l.length) {
try {
for (var m = (r = void 0, p(l)), f = m.next(); !f.done; f = m.next()) {
var d = f.value;
...
var r, o, n = Zi(e, t), a = n.get(e.name);
...
if (!i.has(d) && !s.has(d)) {
var y = f(d.split(","), 2), h = y[0], g = y[1], v = parseInt(h, 10), R = parseInt(g, 10);
...
u > 0 && Jr.debug("Placed ".concat(u, " remote road construction sites in ").concat(e.name), {
subsystem: "RemoteInfra"
});
}
}, e.prototype.getMyUsername = function() {
...
function e(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = l(l({}, us), e);
}
return e.prototype.run = function() {
...
Jr.info("Cross-shard intel: ".concat(g, " enemies tracked, ").concat(v, " high threat"), {
...
}, m([ zn("empire:crossShardIntel", "Cross-Shard Intel", {
priority: ho.LOW,
interval: 50,
minBucket: 0,
cpuBudget: .01
...
if (r) {
var o = new Set(d(d([], f(r.availableQuests), !1), f(e.availableQuests), !1));
...
function hs() {
var e;
return (null === (e = ys().reputation) || void 0 === e ? void 0 : e.value) || 0;
}
...
function vs(e) {
var t, r, o, n = ys(), a = (null === (t = n.reputation) || void 0 === t ? void 0 : t.lastRequestedAt) || 0;
...
if (l < 100) return Jr.warn("Insufficient energy for reputation request: ".concat(l, " < ").concat(100), {
subsystem: "TooAngel"
}), !1;
...
}).length < Rs.MAX_ACTIVE_QUESTS;
}

function Cs(e) {
return Rs.SUPPORTED_TYPES.includes(e);
}

function ws(e, t, r) {
var o, n;
if (!Ss()) return Jr.debug("Cannot accept more quests (at max capacity)", {
subsystem: "TooAngel"
}), !1;
...
if (l < Rs.MIN_APPLICATION_ENERGY) return Jr.warn("Insufficient energy for quest application: ".concat(l, " < ").concat(Rs.MIN_APPLICATION_ENERGY), {
subsystem: "TooAngel"
}), !1;
var m = {
type: "quest",
id: e,
action: "apply"
}, p = u.send(RESOURCE_ENERGY, Rs.MIN_APPLICATION_ENERGY, t, JSON.stringify(m));
...
function bs(e) {
var t = ys(), r = t.activeQuests[e.id];
...
try {
for (var f = p(l), d = f.next(); !d.done; d = f.next()) {
...
m.push(w), l.push(w.name), Jr.info("Assigned ".concat(w.name, " to quest ").concat(e.id, " (buildcs)"), {
subsystem: "TooAngel"
}), m.length >= 3)); T = E.next()) ;
} catch (e) {
o = {
...
var i = gs(a.description);
null !== i && (Jr.info("Received reputation update from TooAngel: ".concat(i), {
subsystem: "TooAngel"
}), r.reputation = {
value: i,
...
var a = n.value;
if (!a.order && a.description) {
var i = Es(a.description);
if (i) {
if (Jr.info("Received quest ".concat(i.id, ": ").concat(i.quest, " in ").concat(i.room, " (deadline: ").concat(i.end, ")"), {
subsystem: "TooAngel"
}), i.result) {
bs(i);
continue;
...
assignedCreeps: []
}, Cs(i.quest) || (Jr.warn("Received unsupported quest type: ".concat(i.quest), {
subsystem: "TooAngel"
...
subsystem: "TooAngel"
}), o.status = "failed", o.completedAt = Game.time) : "buildcs" === o.type ? xs(o) : (Jr.warn("Unsupported quest type for execution: ".concat(o.type), {
subsystem: "TooAngel"
}), o.status = "failed", o.completedAt = Game.time));
}
}(), function() {
var e = ys().activeQuests || {};
for (var t in e) {
var r = e[t];
r.deadline > 0 && Game.time >= r.deadline - Rs.DEADLINE_BUFFER && ("active" !== r.status && "applied" !== r.status || (Jr.warn("Quest ".concat(t, " expired (deadline: ").concat(r.deadline, ", current: ").concat(Game.time, ")"), {
subsystem: "TooAngel"
...
var c = s.value;
if (!o[c]) return Jr.info("Auto-applying for quest ".concat(c, " from ").concat(n), {
subsystem: "TooAngel"
}), void ws(c, n);
}
} catch (t) {
...
return n.join("\n");
}, m([ zn("empire:tooangel", "TooAngel Manager", {
priority: ho.LOW,
interval: 10
}) ], e.prototype, "run", null), m([ Qn() ], e);
}(), _s = new Os, As = {
...
function e(e) {
void 0 === e && (e = {}), this.trackers = new Map, this.config = l(l({}, As), e);
}
return e.prototype.getTracker = function(e) {
var t = this.trackers.get(e);
return t || (t = {
energyHarvested: new Ns(10),
energySpawning: new Ns(10),
energyConstruction: new Ns(10),
energyRepair: new Ns(10),
energyTower: new Ns(10),
controllerProgress: new Ns(10),
hostileCount: new Ns(5),
damageReceived: new Ns(5),
idleWorkers: new Ns(10),
lastControllerProgress: 0
}, this.trackers.set(e, t)), t;
}, e.prototype.updateMetrics = function(e, r) {
var o, n, a, i, s, c, u, l, m = this.getTracker(e.name), f = "sources_".concat(e.name), d = global[f];
d && d.tick === Game.time ? l = d.sources : (l = e.find(FIND_SOURCES), global[f] = {
sources: l,
tick: Game.time
});
var y = 0, h = 0;
...
if (l) {
var m = this.clamp(t / 10), f = l.pheromones.defense, d = .05 * Math.max(0, m - f);
l.pheromones.defense = this.clamp(f + d);
}
}
}
}
...
var d = f(m.value, 2), y = d[0], h = d[1], g = this.getNeighborRoomNames(y);
try {
...
var t = e.match(/^([WE])(\d+)([NS])(\d+)$/);
if (!t) return [];
var r = f(t, 5), o = r[1], n = r[2], a = r[3], i = r[4];
if (!(o && n && a && i)) return [];
...
var f = new Map;
try {
for (var d = p(t), y = d.next(); !y.done; y = d.next()) {
var h = y.value, g = [];
try {
...
return i.lastUpdate = Game.time, Jr.info("Set active reaction in ".concat(e, ": ").concat(t, " + ").concat(r, " -> ").concat(o), {
subsystem: "Labs"
}), !0;
...
r > 90 ? Jr.error("Memory usage critical: ".concat(r.toFixed(1), "% (").concat(e, "/").concat(t, " bytes)"), {
subsystem: "Memory"
}) : r > 75 && Jr.warn("Memory usage high: ".concat(r.toFixed(1), "% (").concat(e, "/").concat(t, " bytes)"), {
subsystem: "Memory"
});
...
var i = a.value, s = wn.getSwarmState(i.name);
s && o.set(i.name, s);
}
} catch (t) {
e = {
...
}, t.prototype.precacheRoomPaths = function() {}, m([ zn("core:memoryCleanup", "Memory Cleanup", {
priority: ho.LOW,
interval: 50,
cpuBudget: .01
}) ], t.prototype, "cleanupMemory", null), m([ Xn("core:memorySizeCheck", "Memory Size Check", {
interval: 100,
cpuBudget: .005
...
interval: 10,
cpuBudget: .02
}) ], t.prototype, "runPheromoneDiffusion", null), m([ zn("room:labConfig", "Lab Config Manager", {
priority: ho.LOW,
interval: 200,
cpuBudget: .01
}) ], t.prototype, "initializeLabConfigs", null), m([ Xn("room:pathCachePrecache", "Path Cache Precache (Disabled)", {
interval: 1e3,
cpuBudget: .01
}) ], t.prototype, "precacheRoomPaths", null), m([ Qn() ], t);
}(), Gs = new Is, Ls = Qr("NativeCallsTracker");

function Ds(t, r, o) {
var n = t[r];
if (n && !n.__nativeCallsTrackerWrapped) {
var a = Object.getOwnPropertyDescriptor(t, r);
if (a && !1 === a.configurable) Ls.warn("Cannot wrap method - property is not configurable", {
meta: {
methodName: r
}
}); else try {
...
var Fs = Qr("OpportunisticActions");

function Bs() {
return Game.cpu.bucket >= 2e3;
}

var Ws = Qr("CollectionPoint"), js = "collectionPoint";
...
namespace: js,
ttl: 500
}), Ws.info("Calculated new collection point at ".concat(i.x, ",").concat(i.y), e.name)) : (t.collectionPoint = void 0, 
ko.invalidate(e.name, js), Ws.warn("Failed to calculate collection point for room", e.name)), 
i;
}
...
var qs = Qr("ActionExecutor"), Ys = "#ffaa00", zs = "#ffffff", Xs = "#ff0000", Qs = "#00ff00", Js = "#0000ff";

function $s(e, t, r) {
var o, n;
if (!t || !t.type) return qs.warn("".concat(e.name, " received invalid action, clearing state")), 
...
if (e.pos.isNearTo(o)) return Fs.debug("".concat(e.name, " opportunistically picking up ").concat(o.amount, " energy at ").concat(o.pos)), 
{
type: "pickup",
target: o
};
...
return Fs.debug("".concat(e.name, " opportunistically transferring to ").concat(o.structureType, " at ").concat(o.pos)), 
{
type: "transfer",
target: o,
resourceType: RESOURCE_ENERGY
...
if (e.pos.isNearTo(o) && o.hits < .3 * o.hitsMax) return Fs.debug("".concat(e.name, " opportunistically repairing ").concat(o.structureType, " at ").concat(o.pos, " (").concat(o.hits, "/").concat(o.hitsMax, ")")), 
{
type: "repair",
target: o
};
...
t.type !== a.type && qs.debug("".concat(e.name, " opportunistic action: ").concat(t.type, " → ").concat(a.type)), 
"idle" === a.type ? qs.warn("".concat(e.name, " (").concat(r.memory.role, ") executing IDLE action")) : qs.debug("".concat(e.name, " (").concat(r.memory.role, ") executing ").concat(a.type));
var i = !1;
switch (a.type) {
case "harvest":
i = Zs(e, function() {
...
case "rangedHeal":
e.rangedHeal(a.target), _a.moveTo(e, a.target, {
visualizePathStyle: {
stroke: Qs
}
}) === ERR_NO_PATH && (i = !0);
...
e.pos.isEqualTo(a.position) || _a.moveTo(e, a.position) === ERR_NO_PATH && (i = !0);
break;
...
case "idle":
if (_a.isExit(e.pos)) {
u = new RoomPosition(25, 25, e.pos.roomName), _a.moveTo(e, u, {
priority: 2
});
break;
}
...
var m = Vs(l, wn.getOrInitSwarmState(l.name));
...
i && (delete r.memory.state, _a.clearCachedPath(e), Xo(e)), function(e) {
...
return s !== OK && qs.info("Movement attempt returned non-OK result", {
room: e.pos.roomName,
creep: e.name,
meta: {
...
f = 0, y <= 1 ? f = 10 * d : y <= 2 ? f = 4 * d : y <= 3 && (f = 1 * d), u.recordDamage(e.memory, f);
break;
...
}(e, n, r, a), (i === ERR_FULL || i === ERR_NOT_ENOUGH_RESOURCES || i === ERR_INVALID_TARGET) && (qs.info("Clearing state after action error", {
room: e.pos.roomName,
creep: e.name,
meta: {
action: null != n ? n : "rangeAction",
...
return o !== n && Qo(e.creep), n;
}

function tc(e) {
e.memory.working = !1, Qo(e.creep);
}

var rc = Qr("EnergyCollection");

function oc(e) {
if (e.droppedResources.length > 0) {
var r = zo(e.creep, e.droppedResources, "energy_drop", 5);
if (r) return rc.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") selecting dropped resource at ").concat(r.pos)), 
{
type: "pickup",
target: r
};
...
if (n) return rc.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") selecting container ").concat(n.id, " at ").concat(n.pos, " with ").concat(n.store.getUsedCapacity(RESOURCE_ENERGY), " energy")), 
{
type: "withdraw",
target: n,
resourceType: RESOURCE_ENERGY
};
if (rc.warn("".concat(e.creep.name, " (").concat(e.memory.role, ") found ").concat(o.length, " containers but distribution returned null, falling back to closest")), 
i = e.creep.pos.findClosestByRange(o)) return rc.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") using fallback container ").concat(i.id, " at ").concat(i.pos)), 
{
type: "withdraw",
target: i,
resourceType: RESOURCE_ENERGY
...
if (e.storage && e.storage.store.getUsedCapacity(RESOURCE_ENERGY) > 0) return rc.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") selecting storage at ").concat(e.storage.pos)), 
{
type: "withdraw",
target: e.storage,
resourceType: RESOURCE_ENERGY
};
var a = jo(e.room).filter(function(e) {
return e.energy > 0;
});
if (a.length > 0) {
var i, s = t.findDistributedTarget(e.creep, a, "energy_source");
if (s) return rc.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") selecting source ").concat(s.id, " at ").concat(s.pos)), 
{
type: "harvest",
target: s
};
if (rc.warn("".concat(e.creep.name, " (").concat(e.memory.role, ") found ").concat(a.length, " sources but distribution returned null, falling back to closest")), 
i = e.creep.pos.findClosestByRange(a)) return rc.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") using fallback source ").concat(i.id, " at ").concat(i.pos)), 
{
type: "harvest",
target: i
};
}
return rc.warn("".concat(e.creep.name, " (").concat(e.memory.role, ") findEnergy returning idle - no energy sources available")), 
{
type: "idle"
};
}
...
if (t.length > 0 && (n = zo(e.creep, t, "deliver_spawn", 5))) return {
type: "transfer",
target: n,
resourceType: RESOURCE_ENERGY
};
...
if (r.length > 0 && (n = zo(e.creep, r, "deliver_ext", 5))) return {
type: "transfer",
target: n,
resourceType: RESOURCE_ENERGY
};
...
if (o.length > 0 && (n = zo(e.creep, o, "deliver_tower", 10))) return {
type: "transfer",
target: n,
resourceType: RESOURCE_ENERGY
};
...
return a.length > 0 && (n = zo(e.creep, a, "deliver_cont", 10)) ? {
type: "transfer",
target: n,
resourceType: RESOURCE_ENERGY
} : null;
...
var ac = Qr("LarvaWorkerBehavior");

function ic(e) {
if (ec(e)) {
ac.debug("".concat(e.creep.name, " larvaWorker working with ").concat(e.creep.store.getUsedCapacity(RESOURCE_ENERGY), " energy"));
var t = nc(e);
if (t) return ac.debug("".concat(e.creep.name, " larvaWorker delivering via ").concat(t.type)), 
t;
var r = function(e) {
...
if (e.prioritizedSites.length > 0) return ac.debug("".concat(e.creep.name, " larvaWorker building site")), 
{
type: "build",
target: e.prioritizedSites[0]
};
...
if (e.isEmpty) return ac.warn("".concat(e.creep.name, " larvaWorker idle (empty, working=true, no targets) - this indicates a bug")), 
{
type: "idle"
};
ac.debug("".concat(e.creep.name, " larvaWorker has energy but no targets, switching to collection mode")), 
tc(e);
}
return oc(e);
}

var sc = Qr("HarvesterBehavior"), cc = Qr("HaulerBehavior"), uc = function() {
function e() {}
return e.prototype.getLabResourceNeeds = function(e) {
var t, r, o, n, a;
if (!Game.rooms[e]) return [];
var i = Ps.getConfig(e);
if (!i || !i.isValid) return [];
var s, c = [], u = Ps.getInputLabs(e), l = u.input1, m = u.input2;
...
var f = Ps.getBoostLabs(e), d = function(e) {
...
try {
for (var y = p(f), h = y.next(); !h.done; h = y.next()) d(h.value);
} catch (e) {
t = {
error: e
};
...
var t, r, o, n, a, i;
if (!Game.rooms[e]) return [];
var s = Ps.getConfig(e);
if (!s) return [];
var c = [], u = Ps.getOutputLabs(e);
try {
for (var l = p(u), m = l.next(); !m.done; m = l.next()) {
...
var h = Ps.getInputLabs(e), g = [ h.input1, h.input2 ].filter(function(e) {
return void 0 !== e;
}), v = function(e) {
var t = e.mineralType;
if (!t) return "continue";
...
Ps.clearActiveReaction(e), Jr.info("Cleared active reactions in ".concat(e), {
subsystem: "Labs"
});
}, e.prototype.setActiveReaction = function(e, t, r, o) {
var n = Ps.setActiveReaction(e, t, r, o);
return n && Jr.info("Set active reaction: ".concat(t, " + ").concat(r, " -> ").concat(o), {
subsystem: "Labs",
room: e
}), n;
}, e.prototype.runReactions = function(e) {
return Ps.runReactions(e);
}, e.prototype.hasAvailableBoostLabs = function(e) {
return Ps.getBoostLabs(e).length > 0;
}, e.prototype.prepareBoostLab = function(e, t) {
var r, o, n, a, i, s = Ps.getConfig(e);
if (!s) return null;
var c = Ps.getBoostLabs(e);
try {
...
if (s.unboostCreep(e) === OK) return Jr.info("Unboosted ".concat(e.name, ", recovered resources"), {
subsystem: "Labs",
room: t.name
}), !0;
}
...
Ps.initialize(e), Ps.loadFromMemory(e);
...
var t, r, o = (r = Ma((t = e.creep).room).harvesterToSource.get(t.id)) ? Game.getObjectById(r) : null;
if (o || (o = e.assignedSource), o || (o = function(e) {
var t, r, o, n, a, i, s = jo(e.room);
if (0 === s.length) return null;
var c, u = "sourceCounts_".concat(e.room.name), l = "sourceCounts_tick_".concat(e.room.name), m = global, f = m[u], d = m[l];
...
}(e), sc.debug("".concat(e.creep.name, " harvester assigned to source ").concat(null == o ? void 0 : o.id))), 
!o) return sc.warn("".concat(e.creep.name, " harvester has no source to harvest")), 
{
type: "idle"
};
...
if (i) return sc.debug("".concat(e.creep.name, " harvester transferring to container ").concat(i.id)), 
{
type: "transfer",
target: i,
resourceType: RESOURCE_ENERGY
...
return s ? (sc.debug("".concat(e.creep.name, " harvester transferring to link ").concat(s.id)), 
{
type: "transfer",
target: s,
resourceType: RESOURCE_ENERGY
...
hauler: function(e) {
var r, o = ec(e);
if (cc.debug("".concat(e.creep.name, " hauler state: working=").concat(o, ", energy=").concat(e.creep.store.getUsedCapacity(RESOURCE_ENERGY), "/").concat(e.creep.store.getCapacity())), 
o) {
...
if (i.length > 0 && (u = zo(e.creep, i, "hauler_spawn", 10))) return cc.debug("".concat(e.creep.name, " hauler delivering to spawn ").concat(u.id)), 
{
type: "transfer",
target: u,
resourceType: RESOURCE_ENERGY
...
if (s.length > 0 && (u = zo(e.creep, s, "hauler_ext", 10))) return {
type: "transfer",
target: u,
resourceType: RESOURCE_ENERGY
};
...
if (c.length > 0 && (u = zo(e.creep, c, "hauler_tower", 15))) return {
type: "transfer",
target: u,
resourceType: RESOURCE_ENERGY
};
...
if (l.length > 0 && (u = zo(e.creep, l, "hauler_cont", 15))) return {
type: "transfer",
target: u,
resourceType: RESOURCE_ENERGY
};
if (e.isEmpty) return cc.warn("".concat(e.creep.name, " hauler idle (empty, working=true, no targets)")), 
{
type: "idle"
};
cc.debug("".concat(e.creep.name, " hauler has energy but no targets, switching to collection mode")), 
tc(e);
}
if (e.droppedResources.length > 0 && (u = zo(e.creep, e.droppedResources, "hauler_drop", 5))) return {
type: "pickup",
target: u
};
...
if (m.length > 0) {
var p = zo(e.creep, m, "hauler_tomb", 10);
if (p) {
...
var f = Object.keys(p.store).find(function(e) {
...
if (d.length > 0) {
var y = t.findDistributedTarget(e.creep, d, "energy_container");
if (y) return cc.debug("".concat(e.creep.name, " hauler withdrawing from container ").concat(y.id, " with ").concat(y.store.getUsedCapacity(RESOURCE_ENERGY), " energy")), 
{
type: "withdraw",
target: y,
resourceType: RESOURCE_ENERGY
};
cc.warn("".concat(e.creep.name, " hauler found ").concat(d.length, " containers but distribution returned null, falling back to closest"));
var h = e.creep.pos.findClosestByRange(d);
if (h) return cc.debug("".concat(e.creep.name, " hauler using fallback container ").concat(h.id)), 
{
type: "withdraw",
target: h,
resourceType: RESOURCE_ENERGY
...
cc.warn("".concat(e.creep.name, " hauler found ").concat(e.mineralContainers.length, " mineral containers but distribution returned null, falling back to closest"));
...
}))) return cc.debug("".concat(e.creep.name, " hauler using fallback mineral container ").concat(R.id)), 
{
type: "withdraw",
target: R,
resourceType: v
...
return e.storage && e.storage.store.getUsedCapacity(RESOURCE_ENERGY) > 0 ? (cc.debug("".concat(e.creep.name, " hauler withdrawing from storage")), 
{
type: "withdraw",
target: e.storage,
resourceType: RESOURCE_ENERGY
}) : (cc.warn("".concat(e.creep.name, " hauler idle (no energy sources found)")), 
{
type: "idle"
});
},
...
if (o.length > 0 && (a = zo(e.creep, o, "builder_spawn", 5))) return {
type: "transfer",
target: a,
resourceType: RESOURCE_ENERGY
};
...
if (n.length > 0 && (a = zo(e.creep, n, "builder_ext", 5))) return {
type: "transfer",
target: a,
resourceType: RESOURCE_ENERGY
};
...
if (i.length > 0 && (a = zo(e.creep, i, "builder_tower", 10))) return {
type: "transfer",
target: a,
resourceType: RESOURCE_ENERGY
};
var s = (r = Ma((t = e.creep).room).builderToTarget.get(t.id)) ? Game.getObjectById(r) : null;
return s ? {
type: "build",
target: s
...
if (t.length > 0 && (l = zo(e.creep, t, "upgrader_spawn", 5))) return {
type: "transfer",
target: l,
resourceType: RESOURCE_ENERGY
};
...
if (r.length > 0 && (l = zo(e.creep, r, "upgrader_ext", 5))) return {
type: "transfer",
target: l,
resourceType: RESOURCE_ENERGY
};
...
return o.length > 0 && (l = zo(e.creep, o, "upgrader_tower", 10)) ? {
type: "transfer",
target: l,
resourceType: RESOURCE_ENERGY
} : e.room.controller ? {
...
tick: Game.time
}), u.length > 0 && (l = zo(e.creep, u, "upgrader_nearby", 30))) return {
type: "withdraw",
target: l,
resourceType: RESOURCE_ENERGY
};
...
if (m.length > 0 && (l = zo(e.creep, m, "upgrader_cont", 30))) return {
type: "withdraw",
target: l,
resourceType: RESOURCE_ENERGY
};
var p = jo(e.room).filter(function(e) {
return e.energy > 0;
});
if (p.length > 0) {
var f = zo(e.creep, p, "upgrader_source", 30);
if (f) return {
type: "harvest",
target: f
};
...
var t, r = Wo(e.room, FIND_MINERALS)[0];
if (!r) return {
type: "idle"
};
...
try {
for (var E = p(f), T = E.next(); !T.done; T = E.next()) {
...
return o !== n && (Qo(e.creep), delete e.memory.targetId), n;
}(e);
return t ? function(e) {
if (e.memory.targetId) {
...
var n = lc.getLabResourceNeeds(e.room.name);
...
var t, r = lc.getLabOverflow(e.room.name);
if (r.length > 0) {
r.sort(function(e, t) {
return t.priority - e.priority;
});
...
var a = lc.getLabResourceNeeds(e.room.name);
...
try {
for (var d = p(f), y = d.next(); !y.done; y = d.next()) {
var h = y.value;
...
var t = ec(e), r = e.memory.targetRoom, o = e.memory.homeRoom;
if (!r || r === o) return {
type: "idle"
};
if (e.nearbyEnemies && e.hostiles.length > 0) {
...
if (a.length > 0 && (p = zo(e.creep, a, "remoteHauler_spawn", 5))) return {
type: "transfer",
target: p,
resourceType: RESOURCE_ENERGY
};
...
if (i.length > 0 && (p = zo(e.creep, i, "remoteHauler_ext", 5))) return {
type: "transfer",
target: p,
resourceType: RESOURCE_ENERGY
};
...
if (s.length > 0 && (p = zo(e.creep, s, "remoteHauler_tower", 10))) return {
type: "transfer",
target: p,
resourceType: RESOURCE_ENERGY
};
...
return c.length > 0 && (p = zo(e.creep, c, "remoteHauler_cont", 10)) ? {
type: "transfer",
target: p,
resourceType: RESOURCE_ENERGY
...
var u = .3 * e.creep.store.getCapacity(RESOURCE_ENERGY), l = Wo(e.room, FIND_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_CONTAINER && e.store.getUsedCapacity(RESOURCE_ENERGY) >= u;
},
filterKey: "remoteContainers"
});
if (l.length > 0 && (p = zo(e.creep, l, "remoteHauler_remoteCont", 10))) return {
type: "withdraw",
target: p,
resourceType: RESOURCE_ENERGY
};
...
if (m.length > 0 && (p = zo(e.creep, m, "remoteHauler_remoteDrop", 3))) return {
type: "pickup",
target: p
};
if (0 === l.length) {
var p, f = Wo(e.room, FIND_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_CONTAINER;
},
filterKey: "containers"
});
if (f.length > 0 && (p = zo(e.creep, f, "remoteHauler_waitCont", 20)) && e.creep.pos.getRangeTo(p) > 2) return {
type: "moveTo",
target: p
};
}
...
target: i.storage,
resourceType: a
} : (s = Wo(i, FIND_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_CONTAINER && e.store.getUsedCapacity(a) > 0;
},
filterKey: "container_".concat(a)
})).length > 0 && (c = zo(e.creep, s, "interRoomCarrier_sourceCont", 10)) ? {
type: "withdraw",
target: c,
resourceType: a
} : {
...
function pc(e) {
var t;
return (null !== (t = mc[e.memory.role]) && void 0 !== t ? t : ic)(e);
}

var fc = Qr("MilitaryBehaviors"), dc = "patrol";
...
return r && e.creep.pos.getRangeTo(r) > 2 ? (fc.debug("".concat(e.creep.name, " ").concat(t, " moving to collection point at ").concat(r.x, ",").concat(r.y)), 
{
type: "moveTo",
target: r
}) : null;
...
var r = gc(e);
if (r) {
var n = e.creep.pos.getRangeTo(r), a = vc(e.creep, RANGED_ATTACK), i = vc(e.creep, ATTACK);
return a && n <= 3 ? {
type: "rangedAttack",
target: r
} : i && n <= 1 ? {
...
var s = gc(e);
if (s) return n = e.creep.pos.getRangeTo(s), a = vc(e.creep, RANGED_ATTACK), i = vc(e.creep, ATTACK), 
a && n <= 3 ? {
type: "rangedAttack",
target: s
} : i && n <= 1 ? {
...
var c = yc(e.room), u = hc(e.creep, c);
if (u) return {
type: "moveTo",
target: u
};
...
if (c.length > 0) {
var u = zo(e.creep, c, "healer_follow", 5);
if (u) return {
type: "moveTo",
target: u
};
}
var l = yc(e.room), m = hc(e.creep, l);
return m ? {
type: "moveTo",
target: m
} : {
...
var i = gc(e);
if (i) {
var s = e.creep.pos.getRangeTo(i), c = vc(e.creep, RANGED_ATTACK), u = vc(e.creep, ATTACK);
return c && s <= 3 ? {
type: "rangedAttack",
target: i
} : u && s <= 1 ? {
...
var m = yc(e.room), p = hc(e.creep, m);
if (p) return {
type: "moveTo",
target: p
};
var f = e.spawnStructures.filter(function(e) {
return e.structureType === STRUCTURE_SPAWN;
});
if (f.length > 0) {
var d = zo(e.creep, f, "soldier_spawn", 20);
...
if (c.length > 0) {
var u = zo(e.creep, c, "siege_wall", 10);
if (u) return {
type: "dismantle",
target: u
};
...
var m = Rc(e, "siegeUnit");
if (m) return m;
var p = yc(e.room), f = hc(e.creep, p);
return f ? {
type: "moveTo",
target: f
} : {
...
var u = yc(e.room), l = hc(e.creep, u);
if (l) return {
type: "moveTo",
target: l
};
...
if (m.length > 0) {
var p = zo(e.creep, m, "harasser_home_spawn", 20);
...
if (a) {
var i = e.creep.pos.getRangeTo(a), s = vc(e.creep, RANGED_ATTACK), c = vc(e.creep, ATTACK);
return s && i <= 3 ? {
type: "rangedAttack",
target: a
} : c && i <= 1 ? {
...
if (!t) return Rc(e, "harasser (no target)") || {
type: "idle"
};
if (e.room.name !== t) return {
type: "moveToRoom",
...
var s = Rc(e, "harasser (no targets)");
if (s) return s;
var c = yc(e.room), u = hc(e.creep, c);
return u ? {
type: "moveTo",
...
function _c(e) {
var t;
return (null !== (t = Oc[e.memory.role]) && void 0 !== t ? t : Tc)(e);
}

function Ac(e, r) {
var o, n, a, i, s, c, u, l = r.knownRooms, m = l[e.name], p = null !== (o = null == m ? void 0 : m.lastSeen) && void 0 !== o ? o : 0, f = Game.time - p;
if (m && f < 2e3) {
m.lastSeen = Game.time;
var d = t.safeFind(e, FIND_HOSTILE_CREEPS);
return m.threatLevel = d.length > 5 ? 3 : d.length > 2 ? 2 : d.length > 0 ? 1 : 0, 
...
function Mc(e) {
var t = wn.getEmpire();
if (_a.isExit(e.creep.pos)) return Nc(e.room.name);
...
var l = [];
try {
for (var m = p(Object.entries(u)), d = m.next(); !d.done; d = m.next()) {
var y = f(d.value, 2)[1];
if (!r || y !== r) {
...
return n ? e.creep.pos.getRangeTo(n) <= 3 ? (Ac(e.room, t), e.memory.lastExploredRoom = e.room.name, 
delete e.memory.targetRoom, {
type: "idle"
}) : {
type: "moveTo",
target: n
} : (Ac(e.room, t), e.memory.lastExploredRoom = e.room.name, delete e.memory.targetRoom, 
{
type: "idle"
});
}
...
if (r.length > 0) {
var o = zo(e.creep, r, "claimer_spawn", 20);
if (o) return {
type: "moveTo",
target: o
};
...
if (o.length > 0) {
var n = zo(e.creep, o, "engineer_critical", 5);
if (n) return {
type: "repair",
target: n
};
...
if (a.length > 0) {
var i = zo(e.creep, a, "engineer_infra", 5);
if (i) return {
type: "repair",
target: i
};
...
if (u.length > 0) {
var l = zo(e.creep, u, "engineer_rampart", 5);
if (l) return {
type: "repair",
target: l
};
...
if (m.length > 0) {
var p = zo(e.creep, m, "engineer_wall", 5);
if (p) return {
type: "repair",
target: p
};
...
if (f.length > 0) {
var d = zo(e.creep, f, "engineer_cont", 15);
if (d) return {
type: "withdraw",
target: d,
resourceType: RESOURCE_ENERGY
...
if (o.length > 0) {
var n = zo(e.creep, o, "remoteWorker_spawn", 5);
if (n) return {
type: "transfer",
target: n,
resourceType: RESOURCE_ENERGY
...
function kc(e) {
var t;
return (null !== (t = Uc[e.memory.role]) && void 0 !== t ? t : Mc)(e);
}
...
var r = Wo(e.room, FIND_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_POWER_BANK;
},
filterKey: "powerBank"
...
var o = Wo(e.room, FIND_MY_CREEPS, {
filter: function(e) {
...
var i = Wo(e.room, FIND_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_POWER_BANK;
},
filterKey: "powerBank"
...
function Lc(e) {
var t;
return (null !== (t = Gc[e.memory.role]) && void 0 !== t ? t : Ic)(e);
}

var Dc = Qr("StateMachine");
...
}(i), Dc.info("Committed new state action", {
room: e.creep.pos.roomName,
creep: e.creep.name,
meta: {
action: i.type,
...
}), i) : (Dc.warn("Behavior returned invalid action, defaulting to idle", {
room: e.creep.pos.roomName,
creep: e.creep.name,
meta: {
role: e.memory.role
...
try {
for (var f = p(Object.keys(e.powers)), d = f.next(); !d.done; d = f.next()) {
...
switch (t.type) {
case "usePower":
(t.target ? e.usePower(t.power, t.target) : e.usePower(t.power)) === ERR_NOT_IN_RANGE && t.target && _a.moveTo(e, t.target);
break;

case "moveTo":
_a.moveTo(e, t.target);
break;
...
case "renewSelf":
e.renew(t.spawn) === ERR_NOT_IN_RANGE && _a.moveTo(e, t.spawn);
break;

case "enableRoom":
(null === (r = e.room) || void 0 === r ? void 0 : r.controller) && e.enableRoom(e.room.controller) === ERR_NOT_IN_RANGE && _a.moveTo(e, e.room.controller);
}
}(e, function(e) {
...
var s = Wo(e.room, FIND_MY_CREEPS, {
filter: function(e) {
...
filter: function(e) {
return e.structureType === STRUCTURE_TOWER && !Pc(e, PWR_DISRUPT_TOWER);
}
})[0];
if (u) return {
type: "usePower",
...
var l = Wo(e.room, FIND_MY_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_TOWER && !Pc(e, PWR_OPERATE_TOWER);
},
...
var m = d(d([], f(e.spawns), !1), [ e.storage, e.terminal ], !1).filter(function(e) {
return void 0 !== e;
});
try {
...
return e.structureType === STRUCTURE_TERMINAL && !Pc(e, PWR_DISRUPT_TERMINAL);
});
if (E) return {
type: "usePower",
...
var t = e;
return null !== t.spawning && !Pc(t, PWR_OPERATE_SPAWN);
});
if (r) return {
type: "usePower",
...
}, 0) > 1e3 && e.storage && e.storage.store.getUsedCapacity(RESOURCE_ENERGY) > 1e4 && !Pc(e.storage, PWR_OPERATE_EXTENSION)) return {
type: "usePower",
power: PWR_OPERATE_EXTENSION,
target: e.storage
};
if (t.includes(PWR_OPERATE_TOWER) && e.ops >= 10 && Wo(e.room, FIND_HOSTILE_CREEPS).length > 0) {
var o = Wo(e.room, FIND_MY_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_TOWER && !Pc(e, PWR_OPERATE_TOWER);
},
filterKey: "towerNoEffect"
...
var n = e.labs.find(function(e) {
return 0 === e.cooldown && e.mineralType && !Pc(e, PWR_OPERATE_LAB);
});
if (n) return {
type: "usePower",
...
if (t.includes(PWR_OPERATE_FACTORY) && e.ops >= 100 && e.factory && 0 === e.factory.cooldown && !Pc(e.factory, PWR_OPERATE_FACTORY)) return {
type: "usePower",
power: PWR_OPERATE_FACTORY,
target: e.factory
};
if (t.includes(PWR_OPERATE_STORAGE) && e.ops >= 100 && e.storage && e.storage.store.getUsedCapacity() > .85 * e.storage.store.getCapacity() && !Pc(e.storage, PWR_OPERATE_STORAGE)) return {
type: "usePower",
power: PWR_OPERATE_STORAGE,
target: e.storage
};
if (t.includes(PWR_REGEN_SOURCE) && e.ops >= 100) {
var a = Wo(e.room, FIND_SOURCES, {
filter: function(e) {
...
var jc = new Set([ "harvester", "upgrader", "mineralHarvester", "depositHarvester", "factoryWorker", "labTech", "builder" ]), Vc = {
harvester: ho.CRITICAL,
queenCarrier: ho.CRITICAL,
hauler: ho.HIGH,
guard: ho.HIGH,
healer: ho.HIGH,
soldier: ho.HIGH,
...
harasser: ho.HIGH,
powerQueen: ho.HIGH,
powerWarrior: ho.HIGH,
larvaWorker: ho.HIGH,
builder: ho.MEDIUM,
upgrader: ho.MEDIUM,
interRoomCarrier: ho.MEDIUM,
scout: ho.MEDIUM,
claimer: ho.MEDIUM,
engineer: ho.MEDIUM,
remoteHarvester: ho.MEDIUM,
powerHarvester: ho.MEDIUM,
powerCarrier: ho.MEDIUM,
remoteHauler: ho.LOW,
remoteWorker: ho.LOW,
linkManager: ho.LOW,
terminalManager: ho.LOW,
mineralHarvester: ho.LOW,
labTech: ho.IDLE,
factoryWorker: ho.IDLE
};

function Kc(e) {
var t;
return null !== (t = Vc[e]) && void 0 !== t ? t : ho.MEDIUM;
}
...
var m = i < 5;
(o > 0 || n > 0 || Game.time % 10 == 0 || m) && Jr.info("CreepProcessManager: ".concat(r.size, " active, ").concat(a, " spawning, ").concat(i, " total (registered: ").concat(o, ", unregistered: ").concat(n, ")"), {
...
if ((Game.time % 10 == 0 || n) && Jr.info("Executing role for creep ".concat(t.name, " (").concat(r.role, ")"), {
subsystem: "CreepProcessManager",
creep: t.name
}), function(e) {
var t = e.memory;
if (!jc.has(t.role)) return !1;
var r = t.state;
...
if (!t.targetId) return !1;
var r = Game.getObjectById(t.targetId);
return !(!r || !Wc(r) || !e.pos.inRangeTo(r.pos, 3) || "upgrade" === t.action && 0 === e.store.getUsedCapacity(RESOURCE_ENERGY) || "withdraw" === t.action && 0 === e.store.getFreeCapacity(RESOURCE_ENERGY));
}(e, r);
...
if (!t.targetId) return !1;
var r = Game.getObjectById(t.targetId);
return !(!r || !Wc(r) || !e.pos.isNearTo(r.pos) || 0 === e.store.getFreeCapacity());
}(e, r);
...
if (!t.targetId) return !1;
var r = Game.getObjectById(t.targetId);
return !(!r || !Wc(r) || !e.pos.inRangeTo(r.pos, 3) || 0 === e.store.getUsedCapacity(RESOURCE_ENERGY));
}(e, r);
...
Jr.error("EXCEPTION in role execution for ".concat(t.name, " (").concat(s, "/").concat(i, "): ").concat(e), {
subsystem: "CreepProcessManager",
creep: t.name,
meta: {
error: String(e),
...
}), this.registeredCreeps.add(t.name), Jr.info("Registered creep process: ".concat(t.name, " (").concat(r, ") with priority ").concat(o), {
subsystem: "CreepProcessManager"
});
}, t.prototype.unregisterCreepProcess = function(e) {
var t = "creep:".concat(e);
Ao.unregisterProcess(t), this.registeredCreeps.delete(e), Jr.info("Unregistered creep process: ".concat(e), {
subsystem: "CreepProcessManager"
});
}, t.prototype.getMinBucketForPriority = function(e) {
return 0;
}, t.prototype.getCpuBudgetForPriority = function(e) {
return e >= ho.CRITICAL ? .012 : e >= ho.HIGH ? .01 : e >= ho.MEDIUM ? .008 : .006;
...
if (c) {
var u = Kc(c.memory.role), l = null !== (r = ho[u]) && void 0 !== r ? r : "UNKNOWN";
...
room: a,
subsystem: "Posture"
}), e.posture = o, Ao.emit("posture.change", {
roomName: a,
oldPosture: n,
newPosture: o,
...
try {
for (var f = p(r.structures), d = f.next(); !d.done; d = f.next()) {
...
try {
for (var m = p(c), f = m.next(); !f.done; f = m.next()) u += (N = f.value).pos.x, 
l += N.pos.y;
} catch (e) {
r = {
error: e
...
for (var d = Math.round(u / (c.length + 1)), y = Math.round(l / (c.length + 1)), h = null !== (i = t.minSpaceRadius) && void 0 !== i ? i : 7, g = [], v = 0; v <= 15; v++) {
for (var R = -v; R <= v; R++) for (var E = -v; E <= v; E++) if (!(Math.abs(R) !== v && Math.abs(E) !== v && v > 0)) {
var T = d + R, S = y + E;
if (!(T < h || T > 49 - h || S < h || S > 49 - h)) {
var C = new RoomPosition(T, S, e.name), w = su(e, C, t);
if (w.fits) {
...
function uu(e, t) {
var r, o = eu(t), n = {}, a = e.structures.filter(function(e) {
...
return d(d([], f(e), !1), f(a), !1);
}(a, i)), a;
}

function lu(e) {
return function(e) {
return e >= 7 ? nu : e >= 5 ? ou : e >= 3 ? ru : tu;
}(e);
}
...
for (var m = Math.round(i / (n.length + 1)), f = Math.round(s / (n.length + 1)), d = 0; d < 15; d++) for (var y = -d; y <= d; y++) for (var h = -d; h <= d; h++) if (Math.abs(y) === d || Math.abs(h) === d) {
var g = m + y, v = f + h;
if (!(g < 3 || g > 46 || v < 3 || v > 46) && iu(e, g, v)) {
...
var pu = [ STRUCTURE_EXTENSION, STRUCTURE_ROAD, STRUCTURE_TOWER, STRUCTURE_LAB, STRUCTURE_LINK, STRUCTURE_FACTORY, STRUCTURE_OBSERVER, STRUCTURE_NUKER, STRUCTURE_POWER_SPAWN, STRUCTURE_EXTRACTOR ], fu = new Set(pu);
...
return 0 === c.length && (n.boosted = !0, Jr.info("".concat(e.name, " fully boosted (all ").concat(i.boosts.length, " boosts applied)"), {
subsystem: "Boost"
}), !0);
...
if (!(u.length < 3)) {
var l = u.slice(2), m = new Set, f = [ a.getBoostConfig("soldier"), a.getBoostConfig("ranger"), a.getBoostConfig("healer"), a.getBoostConfig("siegeUnit") ].filter(function(e) {
...
var C = l[E];
(C.mineralType !== R || C.store[R] < 1e3) && Jr.debug("Lab ".concat(C.id, " needs ").concat(R, " for boosting"), {
subsystem: "Boost"
}), E++;
}
} catch (e) {
...
return Tu.set(e.name, o), o;
}

var wu = function() {
function r(e, t) {
void 0 === t && (t = {}), this.roomName = e, this.config = l(l({}, Eu), t);
}
...
var c = wn.getOrInitSwarmState(this.roomName);
if (this.config.enablePheromones && Game.time % 5 == 0 && Us.updateMetrics(s, c), 
...
Zc.updatePosture(c), this.config.enablePheromones && Us.updatePheromones(c, s), 
this.config.enableTowers && this.runTowerControl(s, c), this.config.enableConstruction && Zc.allowsBuilding(c.posture)) {
var u = Ru(null !== (a = null === (n = s.controller) || void 0 === n ? void 0 : n.level) && void 0 !== a ? a : 1) ? 5 : 10;
...
if (Game.time % 5 == 0) {
var g = Cu(e), v = g.spawns.length + g.towers.length, R = Su.get(this.roomName);
R && R.lastTick < Game.time && v < R.lastStructureCount && (g.spawns.length < R.lastSpawns.length && Ao.emit("structure.destroyed", {
roomName: this.roomName,
structureType: STRUCTURE_SPAWN,
structureId: "unknown",
source: this.roomName
}), g.towers.length < R.lastTowers.length && Ao.emit("structure.destroyed", {
roomName: this.roomName,
structureType: STRUCTURE_TOWER,
structureId: "unknown",
source: this.roomName
})), Su.set(this.roomName, {
lastStructureCount: v,
lastSpawns: d([], f(g.spawns), !1),
lastTowers: d([], f(g.towers), !1),
lastTick: Game.time
});
}
...
if (_ > r.danger) {
if (Us.updateDangerFromThreat(r, O.threatScore, O.dangerLevel), r.clusterId) {
var A = wn.getCluster(r.clusterId);
A && Us.diffuseDangerToCluster(e.name, O.threatScore, A.memberRooms);
}
wn.addRoomEvent(this.roomName, "hostileDetected", "".concat(E.length, " hostiles, danger=").concat(_, ", score=").concat(O.threatScore));
try {
for (var N = p(E), M = N.next(); !M.done; M = N.next()) C = M.value, Ao.emit("hostile.detected", {
roomName: this.roomName,
hostileId: C.id,
...
r.danger = _;
} else r.danger > 0 && (Ao.emit("hostile.cleared", {
roomName: this.roomName,
source: this.roomName
}), r.danger = 0);
if (Game.time % 10 == 0) {
var U = e.find(FIND_NUKES);
if (U.length > 0) {
if (!r.nukeDetected) {
Us.onNukeDetected(r);
var k = null !== (h = null === (y = U[0]) || void 0 === y ? void 0 : y.launchRoomName) && void 0 !== h ? h : "unidentified source";
wn.addRoomEvent(this.roomName, "nukeDetected", "".concat(U.length, " nuke(s) incoming from ").concat(k)), 
r.nukeDetected = !0;
try {
for (var P = p(U), I = P.next(); !I.done; I = P.next()) {
var G = I.value;
Ao.emit("nuke.detected", {
roomName: this.roomName,
nukeId: G.id,
...
if (!Zc.isCombatPosture(r.posture) && (n = t.pos.findClosestByRange(FIND_STRUCTURES, {
filter: function(e) {
return e.hits < .8 * e.hitsMax && e.structureType !== STRUCTURE_WALL && e.structureType !== STRUCTURE_RAMPART;
}
}))) return t.repair(n), "continue";
if (!Zc.isCombatPosture(r.posture) && 0 === u.length) {
...
try {
for (var f = p(c), d = f.next(); !d.done; d = f.next()) m(d.value);
} catch (e) {
n = {
error: e
};
...
var r, n, a, i = Cu(e), s = i.constructionSites;
if (!(s.length >= 10)) {
...
var h = null !== (a = null == y ? void 0 : y.blueprint) && void 0 !== a ? a : lu(c);
if (h && m) {
if (!Zc.isCombatPosture(t.posture)) {
...
var n, a, i, s, c, u, m;
void 0 === o && (o = []);
var f = null !== (u = null === (c = e.controller) || void 0 === c ? void 0 : c.level) && void 0 !== u ? u : 1, d = uu(r, f), y = e.getTerrain(), h = [], g = new Map;
try {
for (var v = p(d), R = v.next(); !R.done; R = v.next()) {
...
if (h.incomplete) Jr.warn("Incomplete path when calculating exit road for ".concat(f, " in ").concat(e.name, " (target exit: ").concat(y.x, ",").concat(y.y, "). Path length: ").concat(h.path.length), {
subsystem: "RoadNetwork"
}); else try {
...
try {
for (var U = p(M), k = U.next(); !k.done; k = U.next()) O = k.value, g.add(O);
} catch (e) {
c = {
error: e
};
...
for (var u = p(s), l = u.next(); !l.done; l = u.next()) {
var m = l.value;
rs(m.pos, t) && i.add("".concat(m.pos.x, ",").concat(m.pos.y));
}
} catch (e) {
r = {
error: e
...
filter: function(e) {
return fu.has(e.structureType) && (!0 === e.my || e.structureType === STRUCTURE_ROAD);
}
});
try {
for (var A = p(_), N = A.next(); !N.done; N = A.next()) {
var M = N.value, U = (C = "".concat(M.pos.x, ",").concat(M.pos.y), M.structureType), k = g.get(U);
k && k.has(C) || h.push({
structure: M,
...
var f = m.value, d = f.structure, y = f.reason;
if (c >= o) break;
d.destroy() === OK && (c++, Jr.info("Destroyed misplaced structure: ".concat(y), {
subsystem: "Blueprint",
room: d.room.name,
meta: {
...
wn.addRoomEvent(this.roomName, "structureDestroyed", "".concat(g, " misplaced ").concat(v, " destroyed for blueprint compliance"));
}
}
var R = {
sitesPlaced: 0,
...
if (c >= 2 && s.length < 8) {
var E = Ru(c) ? 5 : 3;
(R = o.placeRoadAwarePerimeterDefense(e, m, h.roads, c, E, t.remoteAssignments)).wallsRemoved > 0 && wn.addRoomEvent(this.roomName, "wallRemoved", "".concat(R.wallsRemoved, " wall(s) removed to allow road passage"));
}
var T = function(e, t, r) {
var o, n, a, i, s, c, u, l, m, y, h, g, v, R, E = null !== (y = null === (m = e.controller) || void 0 === m ? void 0 : m.level) && void 0 !== y ? y : 1, T = uu(r, E), S = e.getTerrain(), C = [];
if (E >= 6) {
...
var x = d(d([], f(T), !1), f(C), !1), O = 0, _ = e.find(FIND_MY_CONSTRUCTION_SITES), A = e.find(FIND_STRUCTURES);
if (_.length >= 10) return 0;
var N = {};
try {
for (var M = p(A), U = M.next(); !U.done; U = M.next()) {
var k = U.value.structureType;
N[k] = (null !== (h = N[k]) && void 0 !== h ? h : 0) + 1;
}
} catch (e) {
o = {
error: e
...
try {
for (var W = p(r.roads), j = W.next(); !j.done && "break" !== B(j.value); j = W.next()) ;
} catch (e) {
u = {
error: e
};
...
var a = Xi(e, t), i = e.getTerrain(), s = e.find(FIND_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_ROAD;
}
...
try {
for (var m = p(a.positions), d = m.next(); !d.done; d = m.next()) {
var y = d.value;
if (l >= 2) break;
if (n.length + l >= 10) break;
if (!c.has(y) && !u.has(y)) {
var h = f(y.split(","), 2), g = h[0], v = h[1], R = parseInt(g, 10), E = parseInt(v, 10);
...
(C = o.placeRampartsOnCriticalStructures(e, c, t.danger, w)).placed > 0 && wn.addRoomEvent(this.roomName, "rampartPlaced", "".concat(C.placed, " rampart(s) placed on critical structures"));
}
...
var t = wn.getSwarmState(e.name);
if (t) {
lc.initialize(e.name), vu.prepareLabs(e, t);
var r = hu.planReactions(e, t);
if (r) {
var o = {
product: r.product,
input1: r.input1,
...
if (lc.areLabsReady(e.name, o)) {
var n = Ps.getConfig(e.name), a = null == n ? void 0 : n.activeReaction;
a && a.input1 === r.input1 && a.input2 === r.input2 && a.output === r.product || lc.setActiveReaction(e.name, r.input1, r.input2, r.product), 
hu.executeReaction(e, r);
} else Jr.debug("Labs not ready for reaction: ".concat(r.input1, " + ").concat(r.input2, " -> ").concat(r.product), {
subsystem: "Labs",
room: e.name
});
}
...
var m = s.length;
try {
for (var d = p(s), y = d.next(); !y.done; y = d.next()) {
var h = y.value;
this.nodes.has(h.name) || this.nodes.set(h.name, new wu(h.name));
}
} catch (t) {
e = {
error: t
...
Jr.error("Error in room ".concat(S.roomName, ": ").concat(C), {
...
this.nodes.has(e.name) || this.nodes.set(e.name, new wu(e.name));
...
Jr.error("Error in room ".concat(e.name, ": ").concat(s), {
subsystem: "RoomManager",
room: e.name,
meta: {
stack: c
...
function Ou(e) {
var t, r, o;
return e.find(FIND_HOSTILE_CREEPS).length > 0 ? ho.CRITICAL : (null === (t = e.controller) || void 0 === t ? void 0 : t.my) ? ho.HIGH : "ralphschuler" === (null === (o = null === (r = e.controller) || void 0 === r ? void 0 : r.reservation) || void 0 === o ? void 0 : o.username) ? ho.MEDIUM : ho.LOW;
}
...
function Au(e, t, r) {
var o;
return t === ho.CRITICAL ? {
tickModulo: void 0,
tickOffset: void 0
} : t === ho.HIGH && (null === (o = e.controller) || void 0 === o ? void 0 : o.my) ? {
tickModulo: 5,
tickOffset: r % 5
} : t === ho.MEDIUM ? {
tickModulo: 10,
...
var n = Game.rooms[o];
r.add(o);
var a = "room:".concat(o), i = Ao.getProcess(a), s = Ou(n), c = _u(n);
...
var t, r = Ou(e), o = _u(e), n = "room:".concat(e.name), a = this.getRoomIndex(e.name), i = Au(e, r, a);
Ao.registerProcess({
id: n,
...
Jr.debug("Registered room process: ".concat(e.name, " with priority ").concat(r, " ").concat(s), {
subsystem: "RoomProcessManager"
});
}, e.prototype.updateRoomProcess = function(e, t, r) {
var o, n = "room:".concat(e.name), a = this.getRoomIndex(e.name), i = Au(e, t, a);
Ao.unregisterProcess(n), Ao.registerProcess({
id: n,
...
var s = i.tickModulo ? "mod=".concat(i.tickModulo, ", offset=").concat(i.tickOffset) : "every tick";
Jr.debug("Updated room process: ".concat(e.name, " priority=").concat(t, " budget=").concat(r, " (").concat(s, ")"), {
subsystem: "RoomProcessManager"
});
}, e.prototype.unregisterRoomProcess = function(e) {
var t = "room:".concat(e);
Ao.unregisterProcess(t), this.registeredRooms.delete(e), this.roomIndices.delete(e), 
Jr.debug("Unregistered room process: ".concat(e), {
subsystem: "RoomProcessManager"
});
...
var u = c.value, l = Game.rooms[u];
if (l) {
var m = Ou(l), f = null !== (r = ho[m]) && void 0 !== r ? r : "UNKNOWN";
a[f] = (null !== (o = a[f]) && void 0 !== o ? o : 0) + 1, (null === (n = l.controller) || void 0 === n ? void 0 : n.my) && i++;
}
}
} catch (t) {
e = {
...
return ko.invalidate(r, Go), null;
}
},
cachePath: Do,
...
}, Iu = new s.RemotePathCache(ku, Uu), Gu = new s.RemotePathScheduler(Uu, Pu, Iu);

new s.RemoteMiningMovement(Uu, ku, Iu, _a.moveTo);

var Lu = function() {
function e() {}
return e.prototype.get = function(e) {
return wn.getHeapCache().get(e);
}, e.prototype.set = function(e, t, r) {
wn.getHeapCache().set(e, t, r);
}, e;
}(), Du = function() {
function e() {
...
u.length > 0 && (Do(n.pos, c.pos, u), Do(c.pos, n.pos, u));
}
} catch (e) {
t = {
error: e
...
l.length > 0 && Do(n.pos, e.controller.pos, l);
}
}
}
}(e);
...
!function(e, t) {
Iu.precacheRemoteRoutes(e, t);
}(e, t);
}, e;
}();

new i.PortalManager(new Lu, new Du);

var ju, Vu = new i.PathCacheEventManager(new Du, new Fu, new Bu, new Wu), Ku = Qr("SS2TerminalComms"), Hu = function() {
function e() {}
...
var d = Game.getObjectById(m.terminalId);
if (d) {
if (!(d.cooldown > 0)) {
var y = m.packets[m.nextPacketIndex];
if (y) {
var h = d.send(m.resourceType, m.amount, m.targetRoom, y);
if (h === OK) {
...
try {
for (var d = p(a), y = d.next(); !y.done; y = d.next()) {
var h = y.value;
...
Jr.error("Task ".concat(a.name, " failed: ").concat(s), {
subsystem: "Scheduler"
});
}
var c = Game.cpu.getUsed() - i;
if (this.tickCpuUsed += c, !this.hasCpuBudget()) {
Jr.warn("CPU budget exhausted, skipping remaining tasks", {
subsystem: "Scheduler"
});
break;
}
...
new Yu, (ju = {})[FIND_STRUCTURES] = {
lowBucket: 100,
normal: 50,
highBucket: 20
}, ju[FIND_MY_STRUCTURES] = {
lowBucket: 100,
normal: 50,
highBucket: 20
}, ju[FIND_HOSTILE_STRUCTURES] = {
lowBucket: 50,
normal: 20,
highBucket: 10
}, ju[FIND_SOURCES_ACTIVE] = {
lowBucket: 1e4,
normal: 5e3,
highBucket: 1e3
}, ju[FIND_SOURCES] = {
...
normal: 100,
highBucket: 50
}, ju[FIND_MY_CONSTRUCTION_SITES] = {
lowBucket: 50,
normal: 20,
highBucket: 10
}, ju[FIND_CONSTRUCTION_SITES] = {
lowBucket: 50,
normal: 20,
highBucket: 10
}, ju[FIND_CREEPS] = {
...
normal: 5,
highBucket: 3
}, ju[FIND_HOSTILE_CREEPS] = {
lowBucket: 10,
normal: 3,
highBucket: 1
}, ju[FIND_DROPPED_RESOURCES] = {
lowBucket: 20,
normal: 5,
highBucket: 3
}, ju[FIND_TOMBSTONES] = {
...
normal: 100,
highBucket: 50
}, ju[FIND_HOSTILE_SPAWNS] = {
lowBucket: 100,
normal: 50,
highBucket: 20
}, ju[FIND_HOSTILE_CONSTRUCTION_SITES] = {
lowBucket: 50,
normal: 20,
highBucket: 10
}, ju[FIND_NUKES] = {
...
normal: 20,
highBucket: 10
}, ju[FIND_POWER_CREEPS] = {
lowBucket: 20,
normal: 10,
highBucket: 5
}, ju[FIND_MY_POWER_CREEPS] = {
lowBucket: 20,
normal: 10,
highBucket: 5
}, ju[FIND_HOSTILE_POWER_CREEPS] = {
lowBucket: 20,
normal: 10,
highBucket: 5
}, ju[FIND_EXIT_TOP] = {
...
var zu = new r.RoomVisualizer({}, wn), Xu = new r.MapVisualizer({}, wn), Qu = !1, Ju = !1;

function $u() {
var e, t;
if (Co().visualizations) {
var r = function() {
var e;
...
Jr.error("Visualization error in ".concat(a.name, ": ").concat(i), {
...
i = e instanceof Error ? e.message : String(e), Jr.error("Map visualization error: ".concat(i), {
subsystem: "visualizations"
});
}
}
...
function Zu() {
var r, a;
Ju && Game.time % 10 != 0 || Jr.info("SwarmBot loop executing at tick ".concat(Game.time), {
subsystem: "SwarmBot",
meta: {
systemsInitialized: Ju
}
}), Ju || (Lr({
level: (a = Co()).debug ? Mr.DEBUG : Mr.INFO,
cpuLogging: a.profiling,
enableBatching: !0,
maxBatchSize: 50
}), Jr.info("Bot initialized", {
subsystem: "SwarmBot",
meta: {
debug: a.debug,
...
if (t && !1 === t.configurable) Ls.warn("Cannot wrap PathFinder.search - property is not configurable"); else {
...
Ls.warn("Failed to wrap PathFinder.search", {
meta: {
error: String(e)
}
});
...
}(), Ds(r = Creep.prototype, "moveTo", "moveTo"), Ds(r, "move", "move"), Ds(r, "harvest", "harvest"), 
Ds(r, "transfer", "transfer"), Ds(r, "withdraw", "withdraw"), Ds(r, "build", "build"), 
Ds(r, "repair", "repair"), Ds(r, "upgradeController", "upgradeController"), Ds(r, "attack", "attack"), 
Ds(r, "rangedAttack", "rangedAttack"), Ds(r, "heal", "heal"), Ds(r, "dismantle", "dismantle"), 
Ds(r, "say", "say")), Ao.on("structure.destroyed", function(e) {
var t = wn.getSwarmState(e.roomName);
t && (Us.onStructureDestroyed(t, e.structureType), Jr.debug("Pheromone update: structure destroyed in ".concat(e.roomName), {
subsystem: "Pheromone",
room: e.roomName
}));
}), Ao.on("remote.lost", function(e) {
var t = wn.getSwarmState(e.homeRoom);
t && (Us.onRemoteSourceLost(t), Jr.info("Pheromone update: remote source lost for ".concat(e.homeRoom), {
subsystem: "Pheromone",
room: e.homeRoom
}));
}), Jr.info("Pheromone event handlers initialized", {
subsystem: "Pheromone"
}), Vu.initializePathCacheEvents(), Gu.initialize(t.TaskPriority.MEDIUM), ro.initialize(), 
ra.initialize(), Ju = !0), Ao.updateFromCpuConfig(Co().cpu), Qu || (Jr.info("Registering all processes with kernel...", {
subsystem: "ProcessRegistry"
}), function() {
for (var e, t, r = [], o = 0; o < arguments.length; o++) r[o] = arguments[o];
try {
for (var n = p(r), a = n.next(); !a.done; a = n.next()) Jn(a.value);
} catch (t) {
e = {
error: t
};
...
Jr.info("Registered decorated processes from ".concat(r.length, " instance(s)"), {
subsystem: "ProcessDecorators"
});
}(Gs, n.terminalManager, n.factoryManager, n.linkManager, Ci, xi, cs, n.marketManager, Ii, Di, Ui, Wi, qi, ra, ms, _s, si, o.evacuationManager, o.defenseCoordinator), 
Jr.info("Registered ".concat(Ao.getProcesses().length, " processes with kernel"), {
subsystem: "ProcessRegistry"
}), Ao.initialize(), Qu = !0), e.unifiedStats.startTick(), "critical" === Ao.getBucketMode() && Game.time % 10 == 0 && Jr.warn("CRITICAL: CPU bucket at ".concat(Game.cpu.bucket, ", continuing normal processing"), {
subsystem: "SwarmBot"
}), Na.clear(), Ta.clear(), Eo.startTick();
var i, s = "_ownedRooms", c = "_ownedRoomsTick", u = global, l = u[s], m = u[c];
l && m === Game.time ? i = l : (i = Object.values(Game.rooms).filter(function(e) {
var t;
return null === (t = e.controller) || void 0 === t ? void 0 : t.my;
}), u[s] = i, u[c] = Game.time), _a.preTick(), wn.initialize(), e.unifiedStats.measureSubsystem("processSync", function() {
qc.syncCreepProcesses(), Mu.syncRoomProcesses();
...
var a = n.value;
(null === (r = a.controller) || void 0 === r ? void 0 : r.my) && va(a, wn.getOrInitSwarmState(a.name));
}
} catch (t) {
e = {
error: t
...
Hu.processQueue();
}), Ao.hasCpuBudget() && e.unifiedStats.measureSubsystem("powerCreeps", function() {
!function() {
var e, t;
try {
for (var r = p(Object.values(Game.powerCreeps)), o = r.next(); !o.done; o = r.next()) {
var n = o.value;
void 0 !== n.ticksToLive && Bc(n);
}
} catch (t) {
e = {
error: t
...
}), Ao.hasCpuBudget() && e.unifiedStats.measureSubsystem("visualizations", function() {
$u();
}), _a.reconcileTraffic(), Ao.hasCpuBudget() && e.unifiedStats.measureSubsystem("scheduledTasks", function() {
var e = Math.max(0, Game.cpu.limit - Game.cpu.getUsed());
t.runScheduledTasks(e);
}), wn.persistHeapCache(), e.unifiedStats.collectProcessStats(Ao.getProcesses().reduce(function(e, t) {
return e.set(t.id, t), e;
}, new Map)), e.unifiedStats.collectKernelBudgetStats(Ao), e.unifiedStats.setSkippedProcesses(Ao.getSkippedProcessesThisTick()), 
e.unifiedStats.finalizeTick(), Jr.flush();
}

var el = function() {
function e() {}
return e.prototype.status = function(e) {
var t, r, o, n, a, i, s, c, u = Ps.getConfig(e);
...
l += "Lab Assignments:\n";
try {
for (var m = p(u.labs), f = m.next(); !f.done; f = m.next()) {
...
l += "  ".concat(d.role, ": ").concat(h, " (").concat(g, ") @ (").concat(d.pos.x, ",").concat(d.pos.y, ")\n");
}
} catch (e) {
t = {
error: e
...
var v = lc.getLabResourceNeeds(e);
if (v.length > 0) {
l += "\nResource Needs:\n";
try {
for (var R = p(v), E = R.next(); !E.done; E = R.next()) {
...
return lc.setActiveReaction(e, t, r, o) ? "Set active reaction: ".concat(t, " + ").concat(r, " → ").concat(o) : "Failed to set reaction (check lab configuration)";
}, e.prototype.clear = function(e) {
return lc.clearReactions(e), "Cleared active reactions in ".concat(e);
}, e.prototype.boost = function(e, t) {
var r, o, n = Game.rooms[e];
if (!n) return "Room ".concat(e, " not visible");
var a = vu.areBoostLabsReady(n, t), i = vu.getMissingBoosts(n, t), s = "=== Boost Status: ".concat(e, " / ").concat(t, " ===\n");
if (s += "Ready: ".concat(a, "\n"), i.length > 0) {
s += "\nMissing Boosts:\n";
try {
...
try {
for (var s = p(a), c = s.next(); !c.done; c = s.next()) {
var u = c.value, l = u.type === ORDER_BUY ? "BUY " : "SELL", m = u.price.toFixed(3), f = null !== (o = null === (r = u.remainingAmount) || void 0 === r ? void 0 : r.toString()) && void 0 !== o ? o : "?";
i += "".concat(l, " | ").concat(u.resourceType, " | ").concat(m, " | ").concat(f, " | ").concat(null !== (n = u.roomName) && void 0 !== n ? n : "N/A", "\n");
}
} catch (t) {
e = {
error: t
...
var e, t, r = Wi.getActiveOperations();
...
return qi.reassignPowerCreep(e, t) ? "Reassigned ".concat(e, " to ").concat(t) : "Failed to reassign ".concat(e, " (not found)");
...
}(), ol = new el, nl = new tl, al = new rl, il = function() {
function e() {}
...
var f = m.value, d = f.isStable ? "✓" : "✗", y = "⚠".repeat(f.threatRating), h = null !== (a = f.traversalCount) && void 0 !== a ? a : 0, g = Game.time - f.lastScouted;
...
var e, t, r = na.getActiveRequests();
...
category: "Shard"
}) ], e.prototype, "bestPortal", null), m([ mo({
...
category: "Shard"
}) ], e.prototype, "createTask", null), m([ mo({
...
category: "Shard"
}) ], e.prototype, "cpuHistory", null), m([ mo({
name: "shard.tasks",
description: "List all inter-shard tasks",
usage: "shard.tasks()",
examples: [ "shard.tasks()" ],
category: "Shard"
}) ], e.prototype, "tasks", null), m([ mo({
...
category: "Shard"
}) ], e.prototype, "syncStatus", null), m([ mo({
...
category: "Shard"
}) ], e.prototype, "memoryStats", null), m([ mo({
...
function e(e) {
void 0 === e && (e = {}), this.config = l(l({}, cl), e);
}
...
var o = ll.predictEnergyInTicks(r, t), n = "=== Energy Prediction: ".concat(e, " ===\n");
...
var r = ll.calculateEnergyIncome(t), o = "=== Energy Income: ".concat(e, " ===\n");
...
var t = Game.rooms[e];
if (!t) return "Room ".concat(e, " is not visible");
var r = ll.calculateEnergyConsumption(t), o = "=== Energy Consumption: ".concat(e, " ===\n");
...
var r = Game.rooms[e];
if (!r) return "Room ".concat(e, " is not visible");
var o = ll.getRecommendedSpawnDelay(r, t), n = r.energyAvailable;
...
var a = ll.predictEnergyInTicks(r, o);
...
category: "Economy"
}) ], e.prototype, "predictEnergy", null), m([ mo({
...
category: "Economy"
}) ], e.prototype, "showIncome", null), m([ mo({
...
category: "Economy"
}) ], e.prototype, "showConsumption", null), m([ mo({
...
category: "Economy"
}) ], e.prototype, "canAfford", null), m([ mo({
...
function e() {}
return e.prototype.status = function() {
var e, t, r, o, n, a, i, s, c, u, l = wn.getEmpire(), m = Object.values(Game.rooms).filter(function(e) {
var t;
return null === (t = e.controller) || void 0 === t ? void 0 : t.my;
}), f = (Game.gcl.progress / Game.gcl.progressTotal * 100).toFixed(1), d = Game.gcl.level - m.length, y = d > 0, h = l.objectives.expansionPaused, g = l.claimQueue.length, v = l.claimQueue.filter(function(e) {
return !e.claimed;
...
try {
for (var A = p(O), N = A.next(); !N.done; N = A.next()) _(b = N.value);
} catch (e) {
r = {
error: e
};
...
var M = new Map;
try {
for (var U = p(m), k = U.next(); !k.done; k = U.next()) {
...
return wn.getEmpire().objectives.expansionPaused = !0, "Expansion paused. Use expansion.resume() to re-enable.";
}, e.prototype.resume = function() {
return wn.getEmpire().objectives.expansionPaused = !1, "Expansion resumed.";
}, e.prototype.addRemote = function(e, t) {
return xi.addRemoteRoom(e, t) ? "Added remote ".concat(t, " to ").concat(e) : "Failed to add remote (check logs for details)";
}, e.prototype.removeRemote = function(e, t) {
return xi.removeRemoteRoom(e, t) ? "Removed remote ".concat(t, " from ").concat(e) : "Remote ".concat(t, " not found in ").concat(e);
}, e.prototype.clearQueue = function() {
var e = wn.getEmpire(), t = e.claimQueue.length;
...
category: "Empire"
}) ], e.prototype, "addRemote", null), m([ mo({
...
category: "Empire"
}) ], e.prototype, "removeRemote", null), m([ mo({
...
enable: function() {
return _s.enable(), "TooAngel integration enabled";
},
disable: function() {
return _s.disable(), "TooAngel integration disabled";
},
reputation: function() {
var e = hs();
...
return vs(e) ? "Reputation request sent".concat(e ? " from ".concat(e) : "") : "Failed to send reputation request (check logs for details)";
},
quests: function() {
var e, t = Ts(), r = [ "Active Quests:" ];
...
return ws(e, t, r) ? "Applied for quest ".concat(e).concat(r ? " from ".concat(r) : "") : "Failed to apply for quest (check logs for details)";
},
help: function() {
...
function e() {}
return e.prototype.status = function() {
var e = sn.checkMemoryUsage(), t = e.breakdown, r = "Memory Status: ".concat(e.status.toUpperCase(), "\n");
return r += "Usage: ".concat(sn.formatBytes(e.used), " / ").concat(sn.formatBytes(e.limit), " (").concat((100 * e.percentage).toFixed(1), "%)\n\n"), 
r += "Breakdown:\n", r += "  Empire:        ".concat(sn.formatBytes(t.empire), " (").concat((t.empire / t.total * 100).toFixed(1), "%)\n"), 
r += "  Rooms:         ".concat(sn.formatBytes(t.rooms), " (").concat((t.rooms / t.total * 100).toFixed(1), "%)\n"), 
r += "  Creeps:        ".concat(sn.formatBytes(t.creeps), " (").concat((t.creeps / t.total * 100).toFixed(1), "%)\n"), 
r += "  Clusters:      ".concat(sn.formatBytes(t.clusters), " (").concat((t.clusters / t.total * 100).toFixed(1), "%)\n"), 
(r += "  SS2 Queue:     ".concat(sn.formatBytes(t.ss2PacketQueue), " (").concat((t.ss2PacketQueue / t.total * 100).toFixed(1), "%)\n")) + "  Other:         ".concat(sn.formatBytes(t.other), " (").concat((t.other / t.total * 100).toFixed(1), "%)\n");
}, e.prototype.analyze = function(e) {
void 0 === e && (e = 10);
var t = sn.getLargestConsumers(e), r = ln.getRecommendations(), o = "Top ".concat(e, " Memory Consumers:\n");
return t.forEach(function(e, t) {
o += "".concat(t + 1, ". ").concat(e.type, ":").concat(e.name, " - ").concat(sn.formatBytes(e.size), "\n");
}), r.length > 0 ? (o += "\nRecommendations:\n", r.forEach(function(e) {
o += "- ".concat(e, "\n");
})) : o += "\nNo recommendations at this time.\n", o;
}, e.prototype.prune = function() {
var e = ln.pruneAll(), t = "Memory Pruning Complete:\n";
return t += "  Dead creeps removed:        ".concat(e.deadCreeps, "\n"), t += "  Event log entries removed:  ".concat(e.eventLogs, "\n"), 
t += "  Stale intel removed:        ".concat(e.staleIntel, "\n"), (t += "  Market history removed:     ".concat(e.marketHistory, "\n")) + "  Total bytes saved:          ".concat(sn.formatBytes(e.bytesSaved), "\n");
}, e.prototype.segments = function() {
var e, t, r = fn.getActiveSegments(), o = "Memory Segments:\n\n";
...
var t = fn.getSegmentSize(e);
return "".concat(e, ":").concat(sn.formatBytes(t));
});
o += " [".concat(a.join(", "), "]");
}
o += "\n";
...
try {
for (var a = p(Object.entries(mn)), i = a.next(); !i.done; i = a.next()) {
var s = f(i.value, 2);
n(s[0], s[1]);
}
} catch (t) {
...
var c = gn.getCompressionStats(n), u = "Compression Test for: ".concat(e, "\n");
return u += "  Original size:    ".concat(sn.formatBytes(c.originalSize), "\n"), 
u += "  Compressed size:  ".concat(sn.formatBytes(c.compressedSize), "\n"), u += "  Bytes saved:      ".concat(sn.formatBytes(c.bytesSaved), "\n"), 
(u += "  Compression ratio: ".concat((100 * c.ratio).toFixed(1), "%\n")) + "  Worth compressing: ".concat(c.ratio < .9 ? "YES" : "NO", "\n");
}, e.prototype.migrations = function() {
var e = En.getCurrentVersion(), t = En.getLatestVersion(), r = En.getPendingMigrations(), o = "Memory Migration Status:\n";
...
var e = En.getCurrentVersion();
En.runMigrations();
var t = En.getCurrentVersion();
...
return wn.initialize(), "Memory reset complete. All data cleared (main memory + 100 segments).";
}, m([ mo({
name: "memory.status",
...
return e ? function(e) {
var r = lo.getCommandsByCategory(), o = r.get(e);
...
params: e.metadata.usage ? gl(e.metadata.usage) : void 0
};
});
return t.createHelp({
name: e,
...
var e, r, o = lo.getCommandsByCategory(), n = [];
try {
for (var a = p(o), i = a.next(); !i.done; i = a.next()) {
var s = f(i.value, 2), c = s[0], u = s[1].map(function(e) {
var t, r = {
title: e.metadata.description,
functionName: e.metadata.name,
...
return t.createHelp.apply(void 0, d([], f(n), !1));
}();
...
var vl, Rl = Qr("VisualizationManager"), El = function() {
function e() {
...
return {
enabledLayers: Zo.Pheromones | Zo.Defense,
mode: "presentation",
layerCosts: {
pheromones: 0,
paths: 0,
...
case "debug":
this.config.enabledLayers = Zo.Pheromones | Zo.Paths | Zo.Traffic | Zo.Defense | Zo.Economy | Zo.Construction | Zo.Performance;
break;

case "presentation":
this.config.enabledLayers = Zo.Pheromones | Zo.Defense | Zo.Economy;
break;

case "minimal":
this.config.enabledLayers = Zo.Defense;
break;

case "performance":
this.config.enabledLayers = Zo.None;
}
this.saveConfig(), Rl.info("Visualization mode set to: ".concat(e));
}, e.prototype.updateFromFlags = function() {
var e, t, r = Game.flags, o = {
viz_pheromones: Zo.Pheromones,
viz_paths: Zo.Paths,
viz_traffic: Zo.Traffic,
viz_defense: Zo.Defense,
viz_economy: Zo.Economy,
viz_construction: Zo.Construction,
viz_performance: Zo.Performance
}, n = function(e, t) {
Object.values(r).some(function(t) {
return t.name === e;
}) && !a.isLayerEnabled(t) && (a.enableLayer(t), Rl.info("Enabled layer ".concat(Zo[t], " via flag")));
}, a = this;
try {
...
a > 10 && Rl.warn("Visualization using ".concat(a.toFixed(1), "% of CPU budget"));
...
category: "Logging"
}) ], e.prototype, "setLogLevel", null), m([ mo({
name: "toggleDebug",
...
return t.includes(e) ? (Tl.setMode(e), "Visualization mode set to: ".concat(e)) : "Invalid mode: ".concat(e, ". Valid modes: ").concat(t.join(", "));
...
Tl.toggleLayer(r);
var o = Tl.isLayerEnabled(r);
return "Layer ".concat(e, ": ").concat(o ? "enabled" : "disabled");
}, e.prototype.showVisPerf = function() {
var e, t, r = Tl.getPerformanceMetrics(), o = "=== Visualization Performance ===\n";
...
var e, t, r, o = Tl.getConfig(), n = "=== Visualization Configuration ===\n";
...
var c = f(s.value, 2), u = c[0], l = c[1], m = parseInt(u, 10), d = 0 !== (o.enabledLayers & m);
n += "  ".concat(l, ": ").concat(d ? "✓" : "✗", "\n");
}
} catch (e) {
t = {
...
return Tl.clearCache(e), e ? "Visualization cache cleared for room: ".concat(e) : "All visualization caches cleared";
}, m([ mo({
...
category: "Visualization"
}) ], e.prototype, "toggleVisualizations", null), m([ mo({
...
category: "Visualization"
}) ], e.prototype, "toggleVisualization", null), m([ mo({
...
category: "Visualization"
}) ], e.prototype, "toggleMapVisualization", null), m([ mo({
name: "showMapConfig",
description: "Show current map visualization configuration",
usage: "showMapConfig()",
examples: [ "showMapConfig()" ],
category: "Visualization"
}) ], e.prototype, "showMapConfig", null), m([ mo({
name: "setVisMode",
...
category: "Visualization"
}) ], e.prototype, "setVisMode", null), m([ mo({
name: "toggleVisLayer",
...
return ko.clear(Io), "Cache statistics reset";
}, t.prototype.roomFindCacheStats = function() {
var e = function() {
var e = ko.getCacheStats(Fo);
return {
rooms: 0,
totalEntries: e.size,
hits: e.hits,
...
return ko.clear(Fo), "Room.find() cache cleared and statistics reset";
...
m.push("  ".concat(N, ": ").concat(A.avg_cpu.toFixed(3), " CPU (calls: ").concat(A.calls, ")"));
}
} catch (e) {
a = {
error: e
...
if (l || "creep" === e) {
var M = u.creeps || {}, U = Object.values(M);
if (U.length > 0) {
m.push("=== Top Creeps by CPU (Top 10) ==="), y = U.sort(function(e, t) {
return t.cpu - e.cpu;
});
try {
...
try {
for (var f = p(c), d = f.next(); !d.done; d = f.next()) m = d.value, i += "  ".concat(m.target, ": ").concat(m.cpuUsed.toFixed(3), " CPU / ").concat(m.budgetLimit.toFixed(3), " limit (").concat((100 * m.percentUsed).toFixed(1), "%)\n");
} catch (e) {
o = {
error: e
};
...
try {
for (var f = p(c), d = f.next(); !d.done; d = f.next()) m = d.value, i += "  ".concat(m.target, ": ").concat(m.current.toFixed(3), " CPU (").concat(m.multiplier.toFixed(1), "x budget ").concat(m.baseline.toFixed(3), ")\n"), 
m.context && (i += "    Context: ".concat(m.context, "\n"));
} catch (e) {
o = {
error: e
...
try {
for (var l = p(u), m = l.next(); !m.done; m = l.next()) {
var f = m.value, d = e.unifiedStats.postureCodeToName(f.brain.postureCode);
...
category: "Statistics"
}) ], t.prototype, "resetCacheStats", null), m([ mo({
...
category: "Statistics"
}) ], t.prototype, "roomFindCacheStats", null), m([ mo({
...
try {
for (var m = p(n.unhealthyProcesses), f = m.next(); !f.done; f = m.next()) l = f.value, 
...
o += "-".repeat(100) + "\n";
var n = d([], f(r), !1).sort(function(e, t) {
return t.priority - e.priority;
});
try {
for (var a = p(n), i = a.next(); !i.done; i = a.next()) {
...
var e, t, r = Ao.getProcesses().filter(function(e) {
return "suspended" === e.state;
});
...
var t, r, o = Ao.getProcesses().filter(function(e) {
...
var a = d([], f(o), !1).sort(function(e, t) {
return t.priority - e.priority;
});
try {
for (var i = p(a), s = i.next(); !s.done; s = i.next()) {
...
category: "Kernel"
}) ], e.prototype, "showKernelStats", null), m([ mo({
name: "listProcesses",
description: "List all registered kernel processes",
usage: "listProcesses()",
examples: [ "listProcesses()" ],
category: "Kernel"
}) ], e.prototype, "listProcesses", null), m([ mo({
name: "suspendProcess",
...
category: "Kernel"
}) ], e.prototype, "showProcessHealth", null), m([ mo({
...
category: "Kernel"
}) ], e.prototype, "listCreepProcesses", null), m([ mo({
...
return lo.generateHelp();
}, e.prototype.commandHelp = function(e) {
return lo.generateCommandHelp(e);
}, m([ mo({
name: "listCommands",
...
category: "System"
}) ], e.prototype, "listCommands", null), m([ mo({
name: "commandHelp",
...
}(), _l = new Sl, Al = new Cl, Nl = new wl, Ml = new bl, Ul = new xl, kl = new Ol, Pl = {}, Il = {}, Gl = {};

function Ll() {
if (vl) return Gl;
vl = 1;
var e = Gl && Gl.__assign || function() {
return e = Object.assign || function(e) {
for (var t, r = 1, o = arguments.length; r < o; r++) for (var n in t = arguments[r]) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
return e;
}, e.apply(this, arguments);
}, t = Gl && Gl.__values || function(e) {
var t = "function" == typeof Symbol && Symbol.iterator, r = t && e[t], o = 0;
if (r) return r.call(e);
if (e && "number" == typeof e.length) return {
next: function() {
...
value: !0
}), Gl.FilterManager = void 0, Gl.createFilter = function(e) {
return new r(e);
};
var r = function() {
function r(e) {
...
if (Dl) return Bl;
Dl = 1;
var e = Bl && Bl.__awaiter || function(e, t, r, o) {
...
}, t = Bl && Bl.__generator || function(e, t) {
var r, o, n, a = {
label: 0,
sent: function() {
if (1 & n[0]) throw n[1];
...
value: !0
}), Bl.PerformanceAssert = Bl.MemoryTracker = Bl.CPUTracker = void 0, Bl.benchmark = function(r, o) {
...
return Bl.PerformanceAssert = n, Bl;
}

function jl() {
if (Fl) return Il;
Fl = 1;
var e = Il && Il.__awaiter || function(e, t, r, o) {
return new (r || (r = Promise))(function(n, a) {
function i(e) {
try {
c(o.next(e));
...
}, t = Il && Il.__generator || function(e, t) {
var r, o, n, a = {
label: 0,
sent: function() {
if (1 & n[0]) throw n[1];
...
value: !0
}), Il.TestRunner = void 0;
var o = Ll(), n = Wl(), a = function() {
function a() {
...
if (Vl) return Kl;
Vl = 1;
var e, t = Kl && Kl.__extends || (e = function(t, r) {
...
return Kl.AssertionError = r, Kl;
}

var ql, Yl, zl, Xl, Ql, Jl = {}, $l = {}, Zl = S(Object.freeze({
__proto__: null,
default: {}
})), em = S(Object.freeze({
__proto__: null,
default: {}
})), tm = {}, rm = {}, om = (Ql || (Ql = 1, function(e) {
var t = Pl && Pl.__createBinding || (Object.create ? function(e, t, r, o) {
void 0 === o && (o = r);
...
}), r = Pl && Pl.__exportStar || function(e, r) {
...
var o = new (jl().TestRunner);
e.testRunner = o;
var n = null;
r(Hl(), e), r(function() {
if (ql) return Jl;
ql = 1, Object.defineProperty(Jl, "__esModule", {
value: !0
}), Jl.Assert = void 0, Jl.expect = function(e) {
return {
toBe: function(r, o) {
...
}), r(Wl(), e), r(Ll(), e), r(function() {
if (Yl) return $l;
Yl = 1;
var e, t = $l && $l.__createBinding || (Object.create ? function(e, t, r, o) {
void 0 === o && (o = r);
var n = Object.getOwnPropertyDescriptor(t, r);
n && !("get" in n ? !t.__esModule : n.writable || n.configurable) || (n = {
enumerable: !0,
...
void 0 === o && (o = r), e[o] = t[r];
}), r = $l && $l.__setModuleDefault || (Object.create ? function(e, t) {
...
e.default = t;
}), o = $l && $l.__importStar || (e = function(t) {
...
value: !0
}), $l.ConsoleReporter = $l.JSONReporter = void 0;
var i = o(Zl), s = o(em), c = function() {
function e(e) {
...
return $l.ConsoleReporter = u, $l;
}(), e), r(function() {
if (zl) return tm;
zl = 1;
var e, t = tm && tm.__createBinding || (Object.create ? function(e, t, r, o) {
void 0 === o && (o = r);
var n = Object.getOwnPropertyDescriptor(t, r);
n && !("get" in n ? !t.__esModule : n.writable || n.configurable) || (n = {
enumerable: !0,
...
void 0 === o && (o = r), e[o] = t[r];
}), r = tm && tm.__setModuleDefault || (Object.create ? function(e, t) {
Object.defineProperty(e, "default", {
enumerable: !0,
value: t
});
...
e.default = t;
}), o = tm && tm.__importStar || (e = function(t) {
return e = Object.getOwnPropertyNames || function(e) {
var t = [];
for (var r in e) Object.prototype.hasOwnProperty.call(e, r) && (t[t.length] = r);
return t;
...
value: !0
}), tm.PersistenceManager = void 0;
var n = o(Zl), a = o(em), i = "1.0.0", s = function() {
function e(e, t) {
...
return tm.PersistenceManager = s, tm;
}(), e), r(function() {
if (Xl) return rm;
Xl = 1, Object.defineProperty(rm, "__esModule", {
value: !0
...
}(Pl)), Pl), nm = Qr("BasicGameStateTest");

om.describe("Game State Validation", function() {
om.it("should have access to Game object", function() {
om.Assert.isNotNullish(Game), om.Assert.isType(Game, "object");
}), om.it("should have access to Memory object", function() {
om.Assert.isNotNullish(Memory), om.Assert.isType(Memory, "object");
}), om.it("should track game time", function() {
om.Assert.isNotNullish(Game.time), om.Assert.isType(Game.time, "number"), om.Assert.greaterThan(Game.time, 0);
}), om.it("should have CPU monitoring available", function() {
om.Assert.isNotNullish(Game.cpu), om.Assert.isNotNullish(Game.cpu.limit), om.Assert.greaterThan(Game.cpu.limit, 0);
}), om.it("should track CPU usage", function() {
var e = Game.cpu.getUsed();
om.Assert.isType(e, "number"), om.Assert.greaterThanOrEqual(e, 0);
}), om.it("should have CPU bucket available", function() {
om.Assert.isNotNullish(Game.cpu.bucket), om.Assert.inRange(Game.cpu.bucket, 0, 1e4);
}), om.it("should have rooms object", function() {
om.Assert.isNotNullish(Game.rooms), om.Assert.isType(Game.rooms, "object");
}), om.it("should have valid room names", function() {
for (var e in Game.rooms) om.Assert.isType(e, "string"), om.Assert.isTrue(/^[WE]\d+[NS]\d+$/.test(e), "Invalid room name: ".concat(e));
});
}), om.describe("Memory Management", function() {
om.it("should allow reading from memory", function() {
var e = Object.keys(Memory);
om.Assert.isTrue(Array.isArray(e));
}), om.it("should allow writing to memory", function() {
var e = "_testIntegrationWrite";
Memory[e] = {
timestamp: Game.time
}, om.Assert.isNotNullish(Memory[e]), om.Assert.equal(Memory[e].timestamp, Game.time), 
delete Memory[e];
}), om.it("should have creeps memory structure", function() {
om.Assert.isNotNullish(Memory.creeps), om.Assert.isType(Memory.creeps, "object");
}), om.it("should clean up memory for missing creeps", function() {
for (var e in Memory.creeps) Game.creeps[e] || nm.debug("Found orphaned creep memory", {
meta: {
creepName: e
}
});
...
}), om.describe("Main Loop Export", function() {
om.it("should export a loop function", function() {
om.Assert.isType(typeof require("../main").loop, "function");
});
}), nm.info("Basic game state tests registered");

var am = Qr("SpawnSystemTest");

om.describe("Spawn Management", function() {
om.it("should have spawns object", function() {
om.Assert.isNotNullish(Game.spawns), om.Assert.isType(Game.spawns, "object");
}), om.it("should have spawns in controlled rooms", function() {
...
}).length > 0 && Game.time > 50 && om.Assert.greaterThan(e, 0, "Should have at least one spawn in controlled rooms");
}), om.it("should track spawning status", function() {
for (var e in Game.spawns) {
var t = Game.spawns[e];
om.Assert.isNotNullish(t.spawning), t.spawning && (om.Assert.isType(t.spawning, "object"), 
om.Assert.isNotNullish(t.spawning.name), om.Assert.greaterThan(t.spawning.remainingTime, 0));
}
}), om.it("should have spawns with valid energy capacity", function() {
for (var e in Game.spawns) {
var t = Game.spawns[e];
om.Assert.isNotNullish(t.store), om.Assert.greaterThanOrEqual(t.store.getCapacity(RESOURCE_ENERGY) || 0, 300);
}
}), om.it("should have spawns in rooms they control", function() {
for (var e in Game.spawns) {
var t = Game.spawns[e].room;
om.Assert.isNotNullish(t), om.Assert.isNotNullish(t.controller), om.Assert.isTrue(t.controller.my, "Spawn ".concat(e, " should be in a controlled room"));
}
});
}), om.describe("Spawn Room Context", function() {
om.it("should have spawns in rooms with sources", function() {
for (var e in Game.spawns) {
var t = Game.spawns[e], r = t.room.find(FIND_SOURCES);
om.Assert.greaterThan(r.length, 0, "Room ".concat(t.room.name, " should have at least one source"));
}
}), om.it("should track room controller progress", function() {
for (var e in Game.spawns) {
var t = Game.spawns[e].room.controller;
(null == t ? void 0 : t.my) && (om.Assert.isNotNullish(t.level), om.Assert.inRange(t.level, 1, 8), 
om.Assert.greaterThanOrEqual(t.progress, 0), t.level < 8 && om.Assert.greaterThan(t.progressTotal, 0));
}
});
}), om.describe("Controlled Rooms", function() {
om.it("should track controlled rooms", function() {
var e, t = 0;
for (var r in Game.rooms) {
var o = Game.rooms[r];
(null === (e = o.controller) || void 0 === e ? void 0 : e.my) && (t++, om.Assert.greaterThan(o.controller.level, 0), 
om.Assert.inRange(o.controller.level, 1, 8));
}
am.debug("Controlled rooms count", {
meta: {
controlledCount: t
}
});
}), om.it("should have valid structures in controlled rooms", function() {
var e;
for (var t in Game.rooms) {
var r = Game.rooms[t];
if (null === (e = r.controller) || void 0 === e ? void 0 : e.my) {
var o = r.find(FIND_MY_STRUCTURES);
r.controller.level >= 1 && Game.time > 50 && om.Assert.greaterThan(o.length, 0, "Room ".concat(t, " should have structures"));
}
}
});
}), am.info("Spawn system tests registered");

var im = Qr("CreepManagementTest");

om.describe("Creep Lifecycle", function() {
om.it("should have creeps object", function() {
om.Assert.isNotNullish(Game.creeps), om.Assert.isType(Game.creeps, "object");
}), om.it("should have valid creep properties", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
om.Assert.isNotNullish(t.name), om.Assert.isNotNullish(t.body), om.Assert.isNotNullish(t.memory), 
om.Assert.isNotNullish(t.room), om.Assert.isTrue(Array.isArray(t.body));
}
}), om.it("should track creep hits and health", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
om.Assert.greaterThan(t.hits, 0), om.Assert.greaterThan(t.hitsMax, 0), om.Assert.lessThanOrEqual(t.hits, t.hitsMax);
}
}), om.it("should have valid body parts", function() {
var e, t;
for (var r in Game.creeps) {
var o = Game.creeps[r];
om.Assert.greaterThan(o.body.length, 0, "Creep ".concat(r, " should have at least one body part"));
try {
for (var n = (e = void 0, p(o.body)), a = n.next(); !a.done; a = n.next()) {
var i = a.value;
om.Assert.isNotNullish(i.type), om.Assert.isNotNullish(i.hits), om.Assert.greaterThan(i.hits, 0);
}
} catch (t) {
e = {
error: t
...
}), om.it("should track creep store capacity", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
if (t.store) {
var r = t.store.getCapacity(), o = t.store.getUsedCapacity();
om.Assert.greaterThanOrEqual(r || 0, 0), om.Assert.greaterThanOrEqual(o, 0), om.Assert.lessThanOrEqual(o, r || 0);
}
}
});
}), om.describe("Creep Roles and Memory", function() {
om.it("should assign roles to all creeps", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
om.Assert.isNotNullish(t.memory.role, "Creep ".concat(e, " should have a role assigned"));
}
}), om.it("should assign rooms to creeps", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
om.Assert.isNotNullish(t.memory.room, "Creep ".concat(e, " should have a room assigned"));
}
}), om.it("should maintain working state", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
om.Assert.isType(typeof t.memory.working, "boolean", "Creep ".concat(e, " should have working state defined"));
}
});
}), om.describe("Creep Spawning", function() {
om.it("should track spawning creeps", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
if (t.spawning) {
var r = t.room.find(FIND_MY_SPAWNS);
om.Assert.greaterThan(r.length, 0, "Spawning creep ".concat(e, " should be in a room with spawns"));
}
}
}), om.it("should eventually complete spawning", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
t.spawning && t.ticksToLive && om.Assert.greaterThan(t.ticksToLive, 1400, "Spawning creep ".concat(e, " should have high TTL"));
}
});
}), om.describe("Creep Movement and Position", function() {
om.it("should have valid positions", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
om.Assert.isNotNullish(t.pos), om.Assert.isType(t.pos.x, "number"), om.Assert.isType(t.pos.y, "number"), 
om.Assert.inRange(t.pos.x, 0, 49), om.Assert.inRange(t.pos.y, 0, 49), om.Assert.isNotNullish(t.pos.roomName);
}
}), om.it("should be in the correct room", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
om.Assert.equal(t.pos.roomName, t.room.name, "Creep ".concat(e, " position should match room"));
}
});
}), om.describe("Creep Age and Recycling", function() {
om.it("should track ticksToLive", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
t.ticksToLive && (om.Assert.greaterThan(t.ticksToLive, 0, "Creep ".concat(e, " should have positive TTL")), 
om.Assert.lessThanOrEqual(t.ticksToLive, 1500, "Creep ".concat(e, " TTL should not exceed max")));
}
}), om.it("should consider recycling near-death creeps", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
if (t.ticksToLive && t.ticksToLive < 50) {
var r = "recycling" in t.memory && !0 === t.memory.recycling;
im.debug("Creep near death", {
creep: e,
meta: {
ttl: t.ticksToLive,
recycling: r
...
}), om.describe("Memory Synchronization", function() {
om.it("should have consistent creep memory", function() {
for (var e in Game.creeps) om.Assert.isNotNullish(Memory.creeps[e], "Creep ".concat(e, " should have memory entry"));
}), om.it("should have valid memory structure", function() {
for (var e in Game.creeps) {
var t = Memory.creeps[e];
om.Assert.isType(t, "object", "Creep ".concat(e, " memory should be an object"));
}
});
}), im.info("Creep management tests registered");

var sm = Qr("SwarmKernelTest");
...
om.describe("Kernel Process Management", function() {
om.it("should have kernel initialized", function() {
om.Assert.isNotNullish(Ao), om.Assert.isType(typeof Ao.run, "function"), om.Assert.isType(typeof Ao.registerProcess, "function"), 
om.Assert.isType(typeof Ao.unregisterProcess, "function");
}), om.it("should track registered processes", function() {
var e = Ao.getProcesses();
om.Assert.isTrue(Array.isArray(e)), sm.debug("Kernel registered processes", {
meta: {
processCount: e.length
}
});
}), om.it("should have creep processes for active creeps", function() {
var e = Object.keys(Game.creeps).length;
if (e > 0) {
var t = Ao.getProcesses().filter(function(e) {
return e.id.startsWith("creep:");
});
...
}), om.it("should have room processes for controlled rooms", function() {
var e, t = 0;
for (var r in Game.rooms) (null === (e = Game.rooms[r].controller) || void 0 === e ? void 0 : e.my) && t++;
if (t > 0) {
var o = Ao.getProcesses().filter(function(e) {
return e.id.startsWith("room:");
});
...
}), om.describe("Kernel Execution", function() {
om.it("should execute without errors", function() {
om.Assert.isType(typeof Ao.run, "function");
}), om.it("should track process execution order", function() {
var e, t, r = Ao.getProcesses();
try {
for (var o = p(r), n = o.next(); !n.done; n = o.next()) {
var a = n.value;
om.Assert.isNotNullish(a.priority), om.Assert.isType(a.priority, "number");
}
} catch (t) {
e = {
error: t
...
}), om.describe("Kernel Configuration", function() {
om.it("should have valid CPU budget configuration", function() {
"config" in Ao ? sm.debug("Kernel configuration exists") : sm.debug("Kernel configuration structure may vary");
}), om.it("should respect game CPU limits", function() {
om.Assert.isNotNullish(Game.cpu.limit), om.Assert.greaterThan(Game.cpu.limit, 0);
var e = Game.cpu.getUsed();
sm.debug("CPU usage", {
meta: {
cpuUsed: e.toFixed(2),
...
var lm = Qr("PheromoneSystemTest");

om.describe("Pheromone System", function() {
om.it("should have pheromone data in memory", function() {
om.Assert.isNotNullish(Memory), om.Assert.isType(Memory, "object");
}), om.it("should track pheromone levels in controlled rooms", function() {
var e, t, r;
for (var o in Game.rooms) if (null === (r = Game.rooms[o].controller) || void 0 === r ? void 0 : r.my) {
var n = cm(o, "swarm");
if (n && um(n, "pheromones")) {
var a = n.pheromones;
om.Assert.isType(a, "object");
try {
for (var i = (e = void 0, p([ "harvest", "build", "repair", "upgrade", "defense", "war", "expand" ])), s = i.next(); !s.done; s = i.next()) {
var c = s.value;
void 0 !== a[c] && (om.Assert.isType(a[c], "number"), om.Assert.greaterThanOrEqual(a[c], 0), 
om.Assert.lessThanOrEqual(a[c], 100));
}
} catch (t) {
e = {
error: t
...
}), om.describe("Pheromone Decay", function() {
om.it("should have bounded pheromone values", function() {
var e;
for (var t in Game.rooms) if (null === (e = Game.rooms[t].controller) || void 0 === e ? void 0 : e.my) {
var r = cm(t, "swarm");
if (r && um(r, "pheromones")) {
var o = r.pheromones;
for (var n in o) {
var a = o[n];
"number" == typeof a && om.Assert.inRange(a, 0, 100, "Pheromone ".concat(n, " should be between 0 and 100"));
}
}
}
});
}), om.describe("Pheromone Influence on Behavior", function() {
om.it("should influence creep role distribution", function() {
var e, t, r = {};
for (var o in Game.creeps) r[s = Game.creeps[o].memory.role] = (r[s] || 0) + 1;
if (Object.keys(r).length > 0) {
lm.debug("Creep role distribution", {
meta: {
roleCounts: r
}
});
var n = !1;
try {
for (var a = p([ "harvester", "upgrader", "builder", "hauler" ]), i = a.next(); !i.done; i = a.next()) {
var s;
...
Object.keys(Game.creeps).length > 0 && om.Assert.isTrue(n, "Should have at least one economic creep role");
}
});
}), om.describe("Room State and Pheromones", function() {
om.it("should correlate pheromones with room needs", function() {
var e;
for (var t in Game.rooms) {
var r = Game.rooms[t];
if (null === (e = r.controller) || void 0 === e ? void 0 : e.my) {
...
if (a && um(a, "pheromones")) {
var i = a.pheromones;
o.length > 0 && void 0 !== i.build && lm.debug("Room construction sites and build pheromone", {
room: t,
meta: {
constructionSiteCount: o.length,
buildPheromone: i.build
}
}), n.length > 0 && void 0 !== i.repair && lm.debug("Room damaged structures and repair pheromone", {
room: t,
meta: {
...
}), lm.info("Pheromone system tests registered");

var mm = Qr("StatsSystemTest");

om.describe("Stats System", function() {
om.it("should collect game time statistics", function() {
om.Assert.isNotNullish(Game.time), om.Assert.isType(Game.time, "number"), om.Assert.greaterThan(Game.time, 0), 
mm.debug("Current game time", {
meta: {
gameTime: Game.time
}
});
...
var e = Game.cpu.getUsed();
om.Assert.isType(e, "number"), om.Assert.greaterThanOrEqual(e, 0), om.Assert.lessThanOrEqual(e, 2 * Game.cpu.limit), 
mm.debug("CPU usage", {
meta: {
cpuUsed: e.toFixed(2),
cpuLimit: Game.cpu.limit
...
}), om.it("should track CPU bucket", function() {
om.Assert.isNotNullish(Game.cpu.bucket), om.Assert.inRange(Game.cpu.bucket, 0, 1e4), 
mm.debug("CPU bucket", {
meta: {
bucket: Game.cpu.bucket
...
}), om.it("should track GCL progress", function() {
om.Assert.isNotNullish(Game.gcl), om.Assert.isNotNullish(Game.gcl.level), om.Assert.greaterThan(Game.gcl.level, 0), 
om.Assert.greaterThanOrEqual(Game.gcl.progress, 0), om.Assert.greaterThan(Game.gcl.progressTotal, 0), 
mm.debug("GCL progress", {
meta: {
...
}), om.it("should track GPL if power is enabled", function() {
Game.gpl && (om.Assert.isNotNullish(Game.gpl.level), om.Assert.greaterThanOrEqual(Game.gpl.level, 0), 
om.Assert.greaterThanOrEqual(Game.gpl.progress, 0), mm.debug("GPL progress", {
meta: {
...
}), om.describe("Memory Statistics", function() {
om.it("should store stats in memory", function() {
var e = function(e) {
if (e in Memory) return Memory[e];
}("stats");
e ? (om.Assert.isType(e, "object"), mm.debug("Stats structure exists in memory")) : mm.debug("Stats structure not yet initialized");
}), om.it("should track room-level statistics", function() {
var e;
for (var t in Game.rooms) if (null === (e = Game.rooms[t].controller) || void 0 === e ? void 0 : e.my) {
var r = cm(t, "stats");
r && mm.debug("Room has stats", {
room: t,
meta: {
...
}), om.describe("Resource Statistics", function() {
om.it("should track energy statistics", function() {
var e, t = 0, r = 0;
for (var o in Game.rooms) {
var n = Game.rooms[o];
...
r > 0 && (mm.debug("Total energy across rooms", {
meta: {
roomCount: r,
totalEnergy: t
}
}), om.Assert.greaterThanOrEqual(t, 0));
}), om.it("should track creep count by role", function() {
var e = {};
for (var t in Game.creeps) e[r = Game.creeps[t].memory.role] = (e[r] || 0) + 1;
if (Object.keys(e).length > 0) for (var r in mm.debug("Creep counts by role", {
meta: {
roleCounts: e
}
}), e) om.Assert.greaterThan(e[r], 0);
});
}), om.describe("Room Statistics", function() {
om.it("should track room RCL progress", function() {
var e;
for (var t in Game.rooms) {
var r = Game.rooms[t];
if (null === (e = r.controller) || void 0 === e ? void 0 : e.my) if (om.Assert.inRange(r.controller.level, 1, 8), 
om.Assert.greaterThanOrEqual(r.controller.progress, 0), r.controller.level < 8) {
om.Assert.greaterThan(r.controller.progressTotal, 0);
var o = (r.controller.progress / r.controller.progressTotal * 100).toFixed(1);
mm.debug("Room RCL progress", {
room: t,
meta: {
...
}), om.it("should track room structure counts", function() {
var e;
for (var t in Game.rooms) {
var r = Game.rooms[t];
if (null === (e = r.controller) || void 0 === e ? void 0 : e.my) {
var o = r.find(FIND_MY_STRUCTURES), n = r.find(FIND_MY_CONSTRUCTION_SITES);
om.Assert.greaterThanOrEqual(o.length, 0), om.Assert.greaterThanOrEqual(n.length, 0), 
mm.debug("Room structures", {
room: t,
meta: {
...
}), om.it("should track room energy capacity", function() {
var e;
for (var t in Game.rooms) {
var r = Game.rooms[t];
if (null === (e = r.controller) || void 0 === e ? void 0 : e.my) {
om.Assert.greaterThan(r.energyCapacityAvailable, 0), om.Assert.greaterThanOrEqual(r.energyAvailable, 0), 
om.Assert.lessThanOrEqual(r.energyAvailable, r.energyCapacityAvailable);
var o = (r.energyAvailable / r.energyCapacityAvailable * 100).toFixed(1);
mm.debug("Room energy", {
room: t,
meta: {
...
}), om.describe("Empire Statistics", function() {
om.it("should count total controlled rooms", function() {
var e, t = 0;
for (var r in Game.rooms) (null === (e = Game.rooms[r].controller) || void 0 === e ? void 0 : e.my) && t++;
mm.debug("Total controlled rooms", {
meta: {
controlledCount: t
}
}), om.Assert.greaterThanOrEqual(t, 0), om.Assert.lessThanOrEqual(t, Game.gcl.level);
}), om.it("should count total creeps", function() {
var e = Object.keys(Game.creeps).length;
mm.debug("Total creeps", {
meta: {
creepCount: e
}
}), om.Assert.greaterThanOrEqual(e, 0);
}), om.it("should count total spawns", function() {
var e = Object.keys(Game.spawns).length;
mm.debug("Total spawns", {
meta: {
spawnCount: e
}
}), om.Assert.greaterThanOrEqual(e, 0);
});
}), om.describe("Market Statistics", function() {
om.it("should track credits if market is available", function() {
Game.market && (om.Assert.isNotNullish(Game.market.credits), om.Assert.greaterThanOrEqual(Game.market.credits, 0), 
mm.debug("Market credits", {
meta: {
credits: Game.market.credits
}
}));
}), om.it("should track active market orders", function() {
if (Game.market) {
var e = Game.market.orders, t = Object.keys(e).length;
mm.debug("Active market orders", {
meta: {
orderCount: t
}
}), om.Assert.greaterThanOrEqual(t, 0);
...
}), mm.info("Stats system tests registered");

var pm = Qr("TestLoader"), fm = Qr("Main");

!function(e) {
void 0 === e && (e = !1);
var t = function() {
lo.initialize(), po(_l), po(Al), po(Nl), po(Ml), po(Ul), po(kl), po(ol), po(nl), 
po(al), po(sl), po(ml), po(fl), po(hl), global.tooangel = dl;
var e = global;
e.botConfig = {
getConfig: Co,
updateConfig: wo
...
configureLogger: Lr
}, e.botVisualizationManager = Tl, e.botCacheManager = ko, lo.exposeToGlobal();
};
e ? (lo.initialize(), lo.enableLazyLoading(t), lo.exposeToGlobal()) : t();
}(Co().lazyLoadConsoleCommands);

try {
!function() {
try {
if ("function" != typeof global.describe) return void pm.info("screepsmod-testing not available, skipping test registration");
pm.info("Integration tests loaded successfully");
} catch (e) {
pm.error("Error loading integration tests", {
meta: {
error: String(e)
}
});
}
}(), fm.info("Integration tests loaded successfully");
} catch (qr) {
fm.debug("Integration tests not loaded: ".concat(String(qr)));
}

var dm = so.wrapLoop(function() {
try {
Zu();
} catch (e) {
throw fm.error("Critical error in main loop: ".concat(String(e)), {
meta: {
stack: e instanceof Error ? e.stack : void 0,
tick: Game.time
}
