...
var s = "#555555", c = "#AAAAAA", l = "#FFE87B", u = "#F53547", p = "#181818", m = "#8FBB93";
...
var n, a, i, s, c;
void 0 === o && (o = {});
var l = null !== (n = o.background) && void 0 !== n ? n : "#2ccf3b", u = null !== (a = o.textcolor) && void 0 !== a ? a : "#000000", p = null !== (i = o.textsize) && void 0 !== i ? i : .5, m = null !== (s = o.textfont) && void 0 !== s ? s : "Times New Roman", f = null !== (c = o.opacity) && void 0 !== c ? c : 1, d = p, y = e.length * d * .4 + .4, h = d + .4;
...
function A() {
return S || (S = 1, e = x, t = x.exports, function(r) {
var o = t && !t.nodeType && t, n = e && !e.nodeType && e, a = "object" == typeof f && f;
a.global !== a && a.window !== a && a.self !== a || (r = a);
var i, s, c = 2147483647, l = 36, u = /^xn--/, p = /[^\x20-\x7E]/, m = /[\x2E\u3002\uFF0E\uFF61]/g, d = {
overflow: "Overflow: input needs wider integers to process",
"not-basic": "Illegal input >= 0x80 (not a basic code point)",
"invalid-input": "Invalid input"
}, y = Math.floor, h = String.fromCharCode;
function g(e) {
...
var t = "";
return e > 65535 && (t += h((e -= 65536) >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), 
t + h(e);
}).join("");
}
function C(e) {
...
function w(e) {
var t, r, o, n, a, i, s, u, p, m, f = [], d = e.length, h = 0, v = 128, R = 72;
for ((r = e.lastIndexOf("-")) < 0 && (r = 0), o = 0; o < r; ++o) e.charCodeAt(o) >= 128 && g("not-basic"), 
f.push(e.charCodeAt(o));
for (n = r > 0 ? r + 1 : 0; n < d; ) {
for (a = h, i = 1, s = l; n >= d && g("invalid-input"), ((u = C(e.charCodeAt(n++))) >= l || u > y((c - h) / i)) && g("overflow"), 
h += u * i, !(u < (p = s <= R ? 1 : s >= R + 26 ? 26 : s - R)); s += l) i > y(c / (m = l - p)) && g("overflow"), 
i *= m;
R = b(h - a, t = f.length + 1, 0 == a), y(h / t) > c - v && g("overflow"), v += y(h / t), 
h %= t, f.splice(h++, 0, v);
}
return T(f);
}
function O(e) {
var t, r, o, n, a, i, s, u, p, m, f, d, v, R, T, C = [];
for (d = (e = E(e)).length, t = 128, r = 0, a = 72, i = 0; i < d; ++i) (f = e[i]) < 128 && C.push(h(f));
for (o = n = C.length, n && C.push("-"); o < d; ) {
for (s = c, i = 0; i < d; ++i) (f = e[i]) >= t && f < s && (s = f);
for (s - t > y((c - r) / (v = o + 1)) && g("overflow"), r += (s - t) * v, t = s, 
i = 0; i < d; ++i) if ((f = e[i]) < t && ++r > c && g("overflow"), f == t) {
for (u = r, p = l; !(u < (m = p <= a ? 1 : p >= a + 26 ? 26 : p - a)); p += l) T = u - m, 
R = l - m, C.push(h(S(m + T % R, 0))), u = y(T / R);
C.push(h(S(u, 0))), a = b(r, v, o == n), r = 0, ++o;
}
++r, ++t;
}
return C.join("");
...
function k() {
return w ? b : (w = 1, b = TypeError);
}

var M, N, I, P, G, L, D, F, B, H, W, K, Y, j, V, z, q, X, Q, Z, J, $, ee, te, re, oe, ne, ae, ie, se, ce, le, ue, pe, me, fe, de, ye, he, ge, ve, Re, Ee, Te, Ce, Se, be, we, Oe, _e, xe, Ue, Ae, ke, Me, Ne, Ie, Pe, Ge, Le, De, Fe, Be, He, We, Ke, Ye, je, Ve, ze, qe, Xe, Qe, Ze, Je, $e, et, tt, rt, ot, nt, at, it, st, ct, lt, ut, pt, mt, ft, dt, yt, ht = d(Object.freeze({
__proto__: null,
default: {}
}));
...
var o = e < 0 ? -b(-e) : b(e);
if (o !== e) {
var n = String(o), a = h.call(t, n.length + 1);
return g.call(n, r, "$&_") + "." + g.call(g.call(a, /([0-9]{3})/g, "$&_"), /_$/, "");
}
}
return g.call(t, r, "$&_");
}
var P = ht, G = P.custom, L = j(G) ? G : null, D = {
__proto__: null,
double: '"',
single: "'"
}, F = {
...
var N = void 0 === v.depth ? 5 : v.depth;
if (void 0 === a && (a = 0), a >= N && N > 0 && "object" == typeof t) return K(t) ? "[Array]" : "[Object]";
...
if (j(t)) {
var ne = x ? g.call(String(t), /^(Symbol\(.*\))_[^)]*$/, "$1") : _.call(t);
...
if (L && "function" == typeof t[L] && P) return P(t, {
depth: N - a
});
...
var me = re(t, V), fe = k ? k(t) === Object.prototype : t instanceof Object || t.constructor === Object, de = t instanceof Object ? "" : "null prototype", ye = !fe && U && Object(t) === t && U in t ? h.call(q(t), 8, -1) : de ? "Object" : "", he = (fe || "function" != typeof t.constructor ? "" : t.constructor.name ? t.constructor.name + " " : "") + (ye || de ? "[" + C.call(T.call([], ye || [], de || []), ": ") + "] " : "");
return 0 === me.length ? he + "{}" : F ? he + "{" + te(me, F) + "}" : he + "{ " + C.call(me, ", ") + " }";
}
return String(t);
};
...
return Q(h.call(e, 0, t.maxStringLength), t) + o;
}
var n = F[t.quoteStyle || "single"];
return n.lastIndex = 0, B(g.call(g.call(e, n, "\\$1"), /[\x00-\x1f]/g, Z), "single", t);
}
function Z(e) {
...
function vt() {
return L ? G : (L = 1, G = Object);
}

function Rt() {
return F ? D : (F = 1, D = Error);
}

function Et() {
return H ? B : (H = 1, B = EvalError);
}

function Tt() {
return K ? W : (K = 1, W = RangeError);
}

function Ct() {
return j ? Y : (j = 1, Y = ReferenceError);
}

function St() {
return z ? V : (z = 1, V = SyntaxError);
}

function bt() {
return X ? q : (X = 1, q = URIError);
}

function wt() {
return Z ? Q : (Z = 1, Q = Math.abs);
}

function Ot() {
return $ ? J : ($ = 1, J = Math.floor);
}

function _t() {
return te ? ee : (te = 1, ee = Math.max);
}

function xt() {
return oe ? re : (oe = 1, re = Math.min);
}

function Ut() {
return ae ? ne : (ae = 1, ne = Math.pow);
}

function At() {
return se ? ie : (se = 1, ie = Math.round);
}

function kt() {
return le ? ce : (le = 1, ce = Number.isNaN || function(e) {
return e != e;
});
}
...
function Nt() {
return fe ? me : (fe = 1, me = Object.getOwnPropertyDescriptor);
}
...
if (Te) return Ee;
Te = 1;
var e = "undefined" != typeof Symbol && Symbol, t = Re ? ve : (Re = 1, ve = function() {
...
function Lt() {
return Se ? Ce : (Se = 1, Ce = "undefined" != typeof Reflect && Reflect.getPrototypeOf || null);
}

function Dt() {
return we ? be : (we = 1, be = vt().getPrototypeOf || null);
}
...
Ue = 1;
var e = Ft();
return xe = Function.prototype.bind || e;
}

function Ht() {
return ke ? Ae : (ke = 1, Ae = Function.prototype.call);
}

function Wt() {
return Ne ? Me : (Ne = 1, Me = Function.prototype.apply);
}

function Kt() {
if (Fe) return De;
Fe = 1;
var e = Bt(), t = k(), r = Ht(), o = function() {
if (Le) return Ge;
Le = 1;
var e = Bt(), t = Wt(), r = Ht(), o = Pe ? Ie : (Pe = 1, Ie = "undefined" != typeof Reflect && Reflect && Reflect.apply);
return Ge = o || e.call(r, t);
}();
...
return Be = o && "function" == typeof o.get ? t([ o.get ]) : "function" == typeof a && function(e) {
...
if (je) return Ye;
je = 1;
var e = Function.prototype.call, t = Object.prototype.hasOwnProperty, r = Bt();
return Ye = r.call(e, t);
}
...
var e;
ze = 1;
var t = vt(), r = Rt(), o = Et(), n = Tt(), a = Ct(), i = St(), s = k(), c = bt(), l = wt(), u = Ot(), p = _t(), m = xt(), f = Ut(), d = At(), y = Mt(), h = Function, g = function(e) {
try {
return h('"use strict"; return (' + e + ").constructor;")();
} catch (e) {}
}, v = It(), R = Pt(), E = function() {
throw new s;
}, T = v ? function() {
try {
return E;
...
}() : E, C = Gt()(), S = jt(), b = Dt(), w = Lt(), O = Wt(), _ = Ht(), x = {}, U = "undefined" != typeof Uint8Array && S ? S(Uint8Array) : e, A = {
__proto__: null,
...
}, P = Bt(), G = Vt(), L = P.call(_, Array.prototype.concat), D = P.call(O, Array.prototype.splice), F = P.call(_, String.prototype.replace), B = P.call(_, String.prototype.slice), H = P.call(_, RegExp.prototype.exec), W = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, K = /\\(\\)?/g, Y = function(e, t) {
var r, o = e;
if (G(I, o) && (o = "%" + (r = I[o])[0] + "%"), G(A, o)) {
var n = A[o];
...
if (v && p + 1 >= r.length) {
var h = v(c, f);
c = (m = !!h) && "get" in h && !("originalValue" in h.get) ? h.get : c[f];
} else m = G(c, f), c = c[f];
m && !l && (A[a] = c);
}
}
...
if (Xe) return qe;
Xe = 1;
var e = zt(), t = Kt(), r = t([ e("%String.prototype.indexOf%") ]);
...
if (Ze) return Qe;
Ze = 1;
var e = zt(), t = qt(), r = gt(), o = k(), n = e("%Map%", !0), a = t("Map.prototype.get", !0), i = t("Map.prototype.set", !0), s = t("Map.prototype.has", !0), c = t("Map.prototype.delete", !0), l = t("Map.prototype.size", !0);
...
if (tt) return et;
tt = 1;
var e = k(), t = gt(), r = function() {
if (P) return I;
P = 1;
var e = gt(), t = k(), r = function(e, t, r) {
...
if ($e) return Je;
$e = 1;
var e = zt(), t = qt(), r = gt(), o = Xt(), n = k(), a = e("%WeakMap%", !0), i = t("WeakMap.prototype.get", !0), s = t("WeakMap.prototype.set", !0), c = t("WeakMap.prototype.has", !0), l = t("WeakMap.prototype.delete", !0);
...
if (at) return nt;
at = 1;
var e = Zt(), t = Qt(), r = Object.prototype.hasOwnProperty, o = Array.isArray, n = t(), a = function(e, t) {
return n.set(e, t), e;
}, i = function(e) {
return n.has(e);
}, s = function(e) {
...
if (st) return it;
st = 1;
var e = Qt(), t = Jt(), r = Zt(), o = Object.prototype.hasOwnProperty, n = {
brackets: function(e) {
return e + "[]";
},
comma: "comma",
...
}, p = {}, m = function r(o, n, i, c, l, m, f, d, y, h, g, v, R, E, T, C, S, b) {
for (var w, O = o, _ = b, x = 0, U = !1; void 0 !== (_ = _.get(p)) && !U; ) {
var A = _.get(o);
if (x += 1, void 0 !== A) {
...
if ("function" == typeof h ? O = h(n, O) : O instanceof Date ? O = R(O) : "comma" === i && a(O) && (O = t.maybeMap(O, function(e) {
return e instanceof Date ? R(e) : e;
})), null === O) {
if (m) return y && !C ? y(n, u.encoder, S, "key", E) : n;
O = "";
}
if ("string" == typeof (w = O) || "number" == typeof w || "boolean" == typeof w || "symbol" == typeof w || "bigint" == typeof w || t.isBuffer(O)) return y ? [ T(C ? n : y(n, u.encoder, S, "key", E)) + "=" + T(y(O, u.encoder, S, "value", E)) ] : [ T(n) + "=" + T(String(O)) ];
var k, M = [];
if (void 0 === O) return M;
if ("comma" === i && a(O)) C && y && (O = t.maybeMap(O, y)), k = [ {
value: O.length > 0 ? O.join(",") || null : void 0
} ]; else if (a(h)) k = h; else {
var N = Object.keys(O);
k = g ? N.sort(g) : N;
}
var I = d ? String(n).replace(/\./g, "%2E") : String(n), P = c && a(O) && 1 === O.length ? I + "[]" : I;
if (l && a(O) && 0 === O.length) return P + "[]";
for (var G = 0; G < k.length; ++G) {
var L = k[G], D = "object" == typeof L && L && void 0 !== L.value ? L.value : O[L];
if (!f || null !== D) {
var F = v && d ? String(L).replace(/\./g, "%2E") : String(L), B = a(O) ? "function" == typeof i ? i(P, F) : P : P + (v ? "." + F : "[" + F + "]");
b.set(o, x);
var H = e();
H.set(p, b), s(M, r(D, B, i, c, l, m, f, d, "comma" === i && C && a(O) ? null : y, h, g, v, R, E, T, C, S, H));
}
}
return M;
};
return it = function(t, i) {
...
var v = c[g], R = l[v];
p.skipNulls && null === R || s(f, m(R, v, d, y, p.allowEmptyArrays, p.strictNullHandling, p.skipNulls, p.encodeDotInKeys, p.encode ? p.encoder : null, p.filter, p.sort, p.allowDots, p.serializeDate, p.format, p.formatter, p.encodeValuesOnly, p.charset, h));
}
...
if (lt) return ct;
lt = 1;
var e = Jt(), t = Object.prototype.hasOwnProperty, r = Array.isArray, o = {
allowDots: !1,
allowEmptyArrays: !1,
allowPrototypes: !1,
allowSparse: !1,
...
var y, h, g = p[m], v = g.indexOf("]="), R = -1 === v ? g.indexOf("=") : v + 1;
if (-1 === R ? (y = s.decoder(g, o.decoder, d, "key"), h = s.strictNullHandling ? null : "") : null !== (y = s.decoder(g.slice(0, R), o.decoder, d, "key")) && (h = e.maybeMap(a(g.slice(R + 1), s, r(c[y]) ? c[y].length : 0), function(e) {
return s.decoder(e, o.decoder, d, "value");
})), h && s.interpretNumericEntities && "iso-8859-1" === d && (h = n(String(h))), 
g.indexOf("[]=") > -1 && (h = r(h) ? [ h ] : h), null !== y) {
var E = t.call(c, y);
E && "combine" === s.duplicates ? c[y] = e.combine(c[y], h, s.arrayLimit, s.plainObjects) : E && "last" !== s.duplicates || (c[y] = h);
}
}
return c;
...
function rr() {
return dt || (dt = 1, ft = "function" == typeof URL ? URL : function() {
if (mt) return _;
mt = 1;
var e = A();
function t() {
...
if (!m[E] && (C || E && !f[E])) {
for (var S, b, w = -1, O = 0; O < c.length; O++) -1 !== (_ = v.indexOf(c[O])) && (-1 === w || _ < w) && (w = _);
for (-1 !== (b = -1 === w ? v.lastIndexOf("@") : v.lastIndexOf("@", w)) && (S = v.slice(0, b), 
v = v.slice(b + 1), this.auth = decodeURIComponent(S)), w = -1, O = 0; O < s.length; O++) {
var _;
-1 !== (_ = v.indexOf(s[O])) && (-1 === w || _ < w) && (w = _);
}
...
var k = U[O];
if (k && !k.match(l)) {
for (var M = "", N = 0, I = k.length; N < I; N++) k.charCodeAt(N) > 127 ? M += "x" : M += k[N];
if (!M.match(l)) {
var P = U.slice(0, O), G = U.slice(O + 1), L = k.match(u);
L && (P.push(L[1]), G.unshift(L[2])), G.length && (v = "/" + G.join(".") + v), this.hostname = P.join(".");
break;
}
}
}
...
if (!p[T]) for (O = 0, A = i.length; O < A; O++) {
var B = i[O];
if (-1 !== v.indexOf(B)) {
...
o.href = o.format(), o;
for (var b = C.slice(-1)[0], w = (o.host || e.host || C.length > 1) && ("." === b || ".." === b) || "" === b, O = 0, _ = C.length; _ >= 0; _--) "." === (b = C[_]) ? C.splice(_, 1) : ".." === b ? (C.splice(_, 1), 
O++) : O && (C.splice(_, 1), O--);
if (!E && !T) for (;O--; O) C.unshift("..");
!E || "" === C[0] || C[0] && "/" === C[0].charAt(0) || C.unshift(""), w && "/" !== C.join("/").substr(-1) && C.push("");
...
O.toSetString = t ? r : function(e) {
return o(e) ? "$" + e : e;
}, O.fromSetString = t ? r : function(e) {
return o(e) ? e.slice(1) : e;
}, O.compareByGeneratedPositionsInflated = function(e, t) {
...
}, O.parseSourceMapInput = function(e) {
...
return O.normalize = d, O.join = y, O.relative = function(t, r) {
...
}, O.computeSourceURL = function(e, t, r) {
...
if (cr) return v;
cr = 1;
const e = C(), t = or(), r = ir().ArraySet, o = function() {
if (sr) return lr;
sr = 1;
const e = or();
return lr.MappingList = class {
constructor() {
...
function Er() {
if (yr) return Rr.exports;
yr = 1;
let e = null;
return Rr.exports = function() {
...
var Cr, Sr, br, wr = {}, Or = (Sr || (Sr = 1, g.SourceMapGenerator = ur().SourceMapGenerator, 
g.SourceMapConsumer = function() {
if (vr) return mr;
vr = 1;
const e = or(), t = dr(), r = ir().ArraySet;
C();
const o = Er(), n = Tr(), a = Symbol("smcInternal");
class i {
constructor(t, r) {
...
i.LEAST_UPPER_BOUND = 2, mr.SourceMapConsumer = i;
class s extends i {
constructor(t, o) {
...
s.prototype.consumer = i, mr.BasicSourceMapConsumer = s;
class c extends i {
constructor(t, r) {
...
return mr.IndexedSourceMapConsumer = c, mr;
}().SourceMapConsumer, g.SourceNode = function() {
if (Cr) return wr;
Cr = 1;
const e = ur().SourceMapGenerator, t = or(), r = /(\r?\n)/, o = "$$$isSourceNode$$$";
class n {
...
function Ar(e) {
xr.enableBatching ? (Ur.push(e), Ur.length >= xr.maxBatchSize && kr()) : console.log(e);
}
...
var Mr = new Set([ "type", "level", "message", "tick", "subsystem", "room", "creep", "processId", "shard" ]);
...
r.meta)) for (var a in r.meta) Mr.has(a) || (n[a] = r.meta[a]);
return JSON.stringify(n);
}

function Ir(e, t) {
xr.level <= br.DEBUG && Ar(Nr("DEBUG", e, t));
}

function Pr(e, t) {
xr.level <= br.INFO && Ar(Nr("INFO", e, t));
}

function Gr(e, t) {
xr.level <= br.WARN && Ar(Nr("WARN", e, t));
}

function Lr(e, t) {
xr.level <= br.ERROR && Ar(Nr("ERROR", e, t));
}

function Dr(e, t, r) {
if (!xr.cpuLogging) return t();
var o = Game.cpu.getUsed(), n = t(), a = Game.cpu.getUsed() - o;
return Ir("".concat(e, ": ").concat(a.toFixed(3), " CPU"), r), n;
}
...
var Yr = {
"hostile.detected": Wr.CRITICAL,
"nuke.detected": Wr.CRITICAL,
"safemode.activated": Wr.CRITICAL,
"structure.destroyed": Wr.HIGH,
"hostile.cleared": Wr.HIGH,
"creep.died": Wr.HIGH,
"energy.critical": Wr.HIGH,
"spawn.emergency": Wr.HIGH,
"posture.change": Wr.HIGH,
"spawn.completed": Wr.NORMAL,
"rcl.upgrade": Wr.NORMAL,
"construction.complete": Wr.NORMAL,
"remote.lost": Wr.NORMAL,
"squad.formed": Wr.NORMAL,
"squad.dissolved": Wr.NORMAL,
"market.transaction": Wr.LOW,
"pheromone.update": Wr.LOW,
"cluster.update": Wr.LOW,
"expansion.candidate": Wr.LOW,
"powerbank.discovered": Wr.LOW,
"cpu.spike": Wr.BACKGROUND,
"bucket.modeChange": Wr.BACKGROUND
}, jr = {
maxEventsPerTick: 50,
maxQueueSize: 200,
...
handlersInvoked: 0,
eventsCoalesced: 0
}, this.tickEvents = new Map, this.config = r(r({}, jr), e);
}
...
var c = {
handler: t,
priority: null !== (o = r.priority) && void 0 !== o ? o : Wr.NORMAL,
...
}), this.handlers.set(e, l), this.config.enableLogging && Kr.debug('EventBus: Registered handler for "'.concat(e, '" (id: ').concat(c.id, ")"), {
subsystem: "EventBus"
}), function() {
return s.off(e, c.id);
};
...
-1 !== o && (r.splice(o, 1), this.config.enableLogging && Kr.debug('EventBus: Unregistered handler "'.concat(t, '" from "').concat(e, '"'), {
subsystem: "EventBus"
}));
}
}, e.prototype.offAll = function(e) {
this.handlers.delete(e), this.config.enableLogging && Kr.debug('EventBus: Removed all handlers for "'.concat(e, '"'), {
subsystem: "EventBus"
});
...
var c = r(r({}, t), {
tick: Game.time
}), l = null !== (a = null !== (n = o.priority) && void 0 !== n ? n : Yr[e]) && void 0 !== a ? a : Wr.NORMAL, u = null !== (i = o.immediate) && void 0 !== i ? i : l >= Wr.CRITICAL, p = null === (s = o.allowCoalescing) || void 0 === s || s;
if (this.config.enableCoalescing && p && !u) {
var m = this.getCoalescingKey(e, c), f = this.tickEvents.get(m);
if (f) return f.count++, this.stats.eventsCoalesced++, void (this.config.enableLogging && Kr.debug('EventBus: Coalesced "'.concat(e, '" (count: ').concat(f.count, ")"), {
subsystem: "EventBus"
}));
...
this.stats.eventsEmitted++, this.config.enableLogging && Kr.debug('EventBus: Emitting "'.concat(e, '" (priority: ').concat(l, ", immediate: ").concat(String(u), ")"), {
subsystem: "EventBus"
});
var d = Game.cpu.bucket;
u || d >= this.config.lowBucketThreshold ? this.processEvent(e, c) : d >= this.config.criticalBucketThreshold ? this.queueEvent(e, c, l) : l >= Wr.CRITICAL ? this.processEvent(e, c) : (this.stats.eventsDropped++, 
this.config.enableLogging && Kr.warn('EventBus: Dropped event "'.concat(e, '" due to critical bucket'), {
subsystem: "EventBus"
}));
...
try {
for (var d = n(l), y = d.next(); !y.done; y = d.next()) {
var h = y.value;
this.off(e, h);
}
} catch (e) {
...
return e.event.priority < Wr.HIGH;
}).sort(function(e, t) {
...
var e = this.getStats();
Kr.debug("EventBus stats: ".concat(e.eventsEmitted, " emitted, ").concat(e.eventsProcessed, " processed, ") + "".concat(e.eventsDeferred, " deferred, ").concat(e.eventsDropped, " dropped, ") + "".concat(e.eventsCoalesced, " coalesced, ") + "".concat(e.queueSize, " queued, ").concat(e.handlerCount, " handlers"), {
subsystem: "EventBus"
});
}
}, e;
...
function e(e) {
void 0 === e && (e = {}), this.budgetViolations = new Map, this.config = r(r({}, qr), e);
}
...
this.config.strictMode ? Kr.error("CPU budget violation: ".concat(e, " used ").concat(r.toFixed(3), " CPU (limit: ").concat(n, ", overage: ").concat(s, "%)"), {
subsystem: "CPUBudget"
}) : Kr.warn("CPU budget exceeded: ".concat(e, " used ").concat(r.toFixed(3), " CPU (limit: ").concat(n, ", overage: ").concat(s, "%)"), {
subsystem: "CPUBudget"
});
}
return a;
...
return Kr.error("Error in ".concat(e, ": ").concat(i), {
subsystem: "CPUBudget"
}), null;
}
...
!this.checkBudget(e, o, a) && this.config.strictMode && Kr.warn("Skipping ".concat(e, " due to budget violation"), {
subsystem: "CPUBudget"
});
} catch (t) {
var i = t instanceof Error ? t.message : String(t);
Kr.error("Error in room ".concat(e, ": ").concat(i), {
subsystem: "CPUBudget"
});
}
...
var e, t, r = Zr(), o = Jr(), i = 0, s = 0;
try {
for (var c = n(Object.entries(o.data)), l = c.next(); !l.done; l = c.next()) {
var u = a(l.value, 2), p = u[0], m = u[1];
void 0 !== m.ttl && m.ttl !== Qr && Game.time - m.lastModified > m.ttl ? s++ : (r.entries.set(p, {
value: m.value,
...
i > 0 && Game.time % 100 == 0 && Kr.info("Rehydrated ".concat(i, " entries from Memory"), {
subsystem: "HeapCache",
meta: {
rehydratedCount: i,
expiredCount: s
...
Zr().entries.delete(e), delete Jr().data[e];
}, e.prototype.has = function(e) {
return void 0 !== this.get(e);
}, e.prototype.clear = function() {
Zr().entries.clear(), Jr().data = {};
...
var e, t, r, o, i = Zr(), s = Jr(), c = 0;
try {
for (var l = n(i.entries), u = l.next(); !u.done; u = l.next()) {
var p = a(u.value, 2), m = p[0], f = p[1];
void 0 !== f.ttl && f.ttl !== Qr && Game.time - f.lastModified > f.ttl && (i.entries.delete(m), 
c++);
}
} catch (t) {
e = {
...
var h = a(y.value, 2), g = (m = h[0], h[1]);
void 0 !== g.ttl && g.ttl !== Qr && Game.time - g.lastModified > g.ttl && (delete s.data[m], 
c++);
}
} catch (e) {
r = {
...
}(), eo = new $r, to = "errorMapper_sourceMapAvailable";
...
if (!1 === eo.get(to)) return this._consumer = null, this._sourceMapAvailable = !1, 
null;
try {
var t = eo.get("errorMapper_sourceMapData");
if (!t) return this._consumer = null, this._sourceMapAvailable = !1, eo.set(to, !1, 1 / 0), 
null;
try {
this._consumer = new Or.SourceMapConsumer(t), this._sourceMapAvailable = !0, eo.set(to, !0, 1 / 0);
} catch (e) {
console.log("SourceMapConsumer requires async initialization - source maps disabled"), 
this._consumer = null, this._sourceMapAvailable = !1, eo.set(to, !1, 1 / 0);
}
} catch (e) {
this._consumer = null, this._sourceMapAvailable = !1, eo.set(to, !1, 1 / 0);
}
...
function uo(e) {
io.enableBatching ? (so.push(e), so.length >= io.maxBatchSize && po()) : console.log(e);
}

function po() {
0 !== so.length && (console.log(so.join("\n")), so = []);
}

var mo = new Set([ "type", "level", "message", "tick", "subsystem", "room", "creep", "processId", "shard" ]);
...
if (r && (r.shard && (n.shard = r.shard), r.subsystem && (n.subsystem = r.subsystem), 
r.room && (n.room = r.room), r.creep && (n.creep = r.creep), r.processId && (n.processId = r.processId), 
r.meta)) for (var a in r.meta) mo.has(a) || (n[a] = r.meta[a]);
return JSON.stringify(n);
}

function yo(e, t) {
io.level <= oo.DEBUG && uo(fo("DEBUG", e, t));
}

function ho(e, t) {
io.level <= oo.INFO && uo(fo("INFO", e, t));
}

function go(e, t) {
io.level <= oo.WARN && uo(fo("WARN", e, t));
}

function vo(e, t) {
io.level <= oo.ERROR && uo(fo("ERROR", e, t));
}

function Ro(e, t, r) {
if (!io.cpuLogging) return t();
var o = Game.cpu.getUsed(), n = t(), a = Game.cpu.getUsed() - o;
return yo("".concat(e, ": ").concat(a.toFixed(3), " CPU"), r), n;
}

var Eo = new Set([ "type", "key", "value", "tick", "unit", "subsystem", "room", "shard" ]);
...
if (r && (n.unit = r), o && (o.shard && (n.shard = o.shard), o.subsystem && (n.subsystem = o.subsystem), 
o.room && (n.room = o.room), o.meta)) for (var a in o.meta) Eo.has(a) || (n[a] = o.meta[a]);
uo(JSON.stringify(n));
}
...
var o;
this.commands.has(e.name) && So.warn('Command "'.concat(e.name, '" is already registered, overwriting'), {
...
handler: t
}), So.debug('Registered command "'.concat(e.name, '"'), {
subsystem: "CommandRegistry"
});
}, e.prototype.unregister = function(e) {
var t = this.commands.delete(e);
return t && So.debug('Unregistered command "'.concat(e, '"'), {
subsystem: "CommandRegistry"
}), t;
...
var p = u.value, m = null !== (i = p.metadata.category) && void 0 !== i ? i : "General", f = null !== (s = c.get(m)) && void 0 !== s ? s : [];
f.push(p), c.set(m, f);
}
} catch (t) {
e = {
...
try {
for (var d = n(c), y = d.next(); !y.done; y = d.next()) {
var h = a(y.value, 2), g = (m = h[0], h[1]);
c.set(m, g.sort(function(e, t) {
...
return So.error('Error executing command "'.concat(e, '": ').concat(n), {
subsystem: "CommandRegistry"
}), "Error: ".concat(n);
}
...
try {
for (var p = n(u), m = p.next(); !m.done; m = p.next()) {
var f = m.value, d = c.get(f);
if (d && 0 !== d.length) {
l.push("--- ".concat(f, " ---"));
try {
for (var y = (r = void 0, n(d)), h = y.next(); !h.done; h = y.next()) {
var g = h.value, v = null !== (s = g.metadata.usage) && void 0 !== s ? s : "".concat(g.metadata.name, "()");
if (l.push("  ".concat(v)), l.push("    ".concat(g.metadata.description)), g.metadata.examples && g.metadata.examples.length > 0) {
l.push("    Examples:");
try {
for (var R = (a = void 0, n(g.metadata.examples)), E = R.next(); !E.done; E = R.next()) {
var T = E.value;
l.push("      ".concat(T));
}
} catch (e) {
...
this.commandsExposed = !0, So.debug("Exposed ".concat(this.commands.size, " commands to global scope"), {
subsystem: "CommandRegistry"
});
}
o.help = function(e) {
...
}), this.initialized = !0, So.info("Command registry initialized", {
subsystem: "CommandRegistry"
}));
}, e.prototype.enableLazyLoading = function(e) {
this.lazyLoadEnabled = !0, this.registrationCallback = e, So.info("Console commands lazy loading enabled", {
subsystem: "CommandRegistry"
});
}, e.prototype.triggerLazyLoad = function() {
!this.commandsRegistered && this.registrationCallback && (So.debug("Lazy loading console commands on first access", {
subsystem: "CommandRegistry"
...
try {
for (var a = n(bo), i = a.next(); !i.done; i = a.next()) {
var s = i.value;
if (Uo(s.target, o)) {
var c = e[s.methodName];
if ("function" == typeof c) {
var l = c.bind(e);
Oo.register(s.metadata, l), So.debug('Registered decorated command "'.concat(s.metadata.name, '"'), {
subsystem: "CommandRegistry"
});
}
}
...
var r, o, a, i, s, c, l, u, p, m;
if (t.length < 3) e.isValid = !1; else {
var f = new Map;
try {
for (var d = n(t), y = d.next(); !y.done; y = d.next()) {
var h = y.value, g = [];
try {
...
void Kr.warn("Lab layout in ".concat(e.roomName, " is not optimal for reactions"), {
subsystem: "Labs"
});
var C = null === (p = T[0]) || void 0 === p ? void 0 : p.lab, S = null === (m = T[1]) || void 0 === m ? void 0 : m.lab;
if (C && S) {
try {
for (var b = n(e.labs), w = b.next(); !w.done; w = b.next()) {
var O = w.value;
...
e.isValid = !0, e.lastUpdate = Game.time, Kr.info("Auto-assigned lab roles in ".concat(e.roomName, ": ") + "".concat(e.labs.filter(function(e) {
...
return s.lastUpdate = Game.time, Kr.info("Set active reaction in ".concat(e, ": ").concat(t, " + ").concat(r, " -> ").concat(o), {
subsystem: "Labs"
}), !0;
...
try {
for (var u = n(c), p = u.next(); !p.done; p = u.next()) {
var m = p.value;
...
}(), No = new Mo, Io = function() {
function e() {}
return e.prototype.getLabResourceNeeds = function(e) {
var t, r, o, a, i;
if (!Game.rooms[e]) return [];
var s = No.getConfig(e);
if (!s || !s.isValid) return [];
var c, l = [], u = No.getInputLabs(e), p = u.input1, m = u.input2;
p && s.activeReaction && (c = null !== (o = p.store[s.activeReaction.input1]) && void 0 !== o ? o : 0) < 1e3 && l.push({
labId: p.id,
...
var f = No.getBoostLabs(e), d = function(e) {
...
try {
for (var y = n(f), h = y.next(); !h.done; h = y.next()) d(h.value);
} catch (e) {
t = {
error: e
};
...
var t, r, o, a, i, s;
if (!Game.rooms[e]) return [];
var c = No.getConfig(e);
if (!c) return [];
var l = [], u = No.getOutputLabs(e);
try {
for (var p = n(u), m = p.next(); !m.done; m = p.next()) {
var f = (T = m.value).mineralType;
if (f) {
var d = null !== (i = T.store[f]) && void 0 !== i ? i : 0, y = c.activeReaction && f !== c.activeReaction.output;
(d > 2e3 || y && d > 0) && l.push({
labId: T.id,
resourceType: f,
amount: d,
...
var h = No.getInputLabs(e), g = [ h.input1, h.input2 ].filter(function(e) {
return void 0 !== e;
}), v = function(e) {
var t = e.mineralType;
...
var r, o, a, i, s = No.getConfig(e);
if (!s || !s.isValid) return !1;
var c = No.getInputLabs(e), l = c.input1, u = c.input2;
if (!l || !u) return !1;
if ((null !== (a = l.store[t.input1]) && void 0 !== a ? a : 0) < 500) return !1;
if ((null !== (i = u.store[t.input2]) && void 0 !== i ? i : 0) < 500) return !1;
var p = No.getOutputLabs(e);
if (0 === p.length) return !1;
try {
for (var m = n(p), f = m.next(); !f.done; f = m.next()) {
...
No.clearActiveReaction(e), Kr.info("Cleared active reactions in ".concat(e), {
subsystem: "Labs"
});
}, e.prototype.setActiveReaction = function(e, t, r, o) {
var n = No.setActiveReaction(e, t, r, o);
return n && Kr.info("Set active reaction: ".concat(t, " + ").concat(r, " -> ").concat(o), {
subsystem: "Labs",
room: e
}), n;
}, e.prototype.runReactions = function(e) {
return No.runReactions(e);
}, e.prototype.hasAvailableBoostLabs = function(e) {
return No.getBoostLabs(e).length > 0;
}, e.prototype.prepareBoostLab = function(e, t) {
var r, o, a, i, s, c = No.getConfig(e);
if (!c) return null;
var l = No.getBoostLabs(e);
try {
for (var u = n(l), p = u.next(); !p.done; p = u.next()) if ((y = p.value).mineralType === t && (null !== (s = y.store[t]) && void 0 !== s ? s : 0) >= 30) return y.id;
} catch (e) {
r = {
error: e
};
...
if (c.unboostCreep(e) === OK) return Kr.info("Unboosted ".concat(e.name, ", recovered resources"), {
subsystem: "Labs",
room: t.name
}), !0;
}
...
No.initialize(e), No.loadFromMemory(e);
...
function Fo(e, t) {
var r, o, n, a = null !== (r = Do[e]) && void 0 !== r ? r : 1e3, i = null !== (o = t.pheromones.war) && void 0 !== o ? o : 0, s = null !== (n = t.pheromones.siege) && void 0 !== n ? n : 0, c = Math.max(i, s), l = c > 50 ? 1 + c / 100 * .5 : 1;
...
function e(e) {
var t;
void 0 === e && (e = {}), this.logger = null !== (t = e.logger) && void 0 !== t ? t : Go;
}
...
var m = Bo(t);
try {
for (var f = n(m), d = f.next(); !d.done; d = f.next()) {
var y = d.value;
if (Lo[y] && (null !== (u = p.store[y]) && void 0 !== u ? u : 0) < Fo(y, t)) {
var h = {};
try {
for (var g = (i = void 0, n(Object.entries(p.store))), v = g.next(); !v.done; v = g.next()) {
...
var C = this.calculateReactionChain(y, h);
try {
for (var S = (c = void 0, n(C)), b = S.next(); !b.done; b = S.next()) {
var w = b.value;
if (this.hasResourcesForReaction(p, w, 1e3)) return w;
}
} catch (e) {
c = {
error: e
...
var r, o, i, s, c, l, u, p, m, f = [];
try {
for (var d = n(e), y = d.next(); !y.done; y = d.next()) {
var h = y.value, g = h.terminal;
if (g) {
var v = Bo(t);
try {
for (var R = (i = void 0, n(v)), E = R.next(); !E.done; E = R.next()) {
var T = E.value, C = Lo[T];
if (C) {
var S = null !== (m = g.store[T]) && void 0 !== m ? m : 0, b = Fo(T, t), w = b - S;
if (w > 0) {
var O = w / b, _ = C.priority * (1 + Math.min(O, .5)), x = {};
try {
for (var U = (c = void 0, n(Object.entries(g.store))), A = U.next(); !A.done; A = U.next()) {
var k = a(A.value, 2), M = k[0], N = k[1];
x[M] = N;
}
} catch (e) {
c = {
...
var L = G.value;
if (this.hasResourcesForReaction(g, L, 1e3)) {
f.push({
room: h,
reaction: L,
priority: _
...
subsystem: "Chemistry"
}) : p.runReaction(i, s) === OK && this.logger.debug("Produced ".concat(t.product, " in lab ").concat(p.id), {
subsystem: "Chemistry"
});
}
}
...
var r, o, a = e.memory, i = Ko(a.role);
if (!i) return !1;
...
if (!r) return Kr.debug("Lab not ready with ".concat(t, " for ").concat(e.name), {
subsystem: "Boost"
}), {
value: !1
};
...
if (o === OK) Kr.info("Boosted ".concat(e.name, " with ").concat(t), {
subsystem: "Boost"
}); else if (o !== ERR_NOT_FOUND) return Kr.error("Failed to boost ".concat(e.name, ": ").concat(function(e) {
switch (e) {
case ERR_NOT_OWNER:
...
try {
for (var u = n(i.boosts), p = u.next(); !p.done; p = u.next()) {
var m = l(p.value);
...
return 0 === c.length && (a.boosted = !0, Kr.info("".concat(e.name, " fully boosted (all ").concat(i.boosts.length, " boosts applied)"), {
subsystem: "Boost"
}), !0);
...
if (!(l.length < 3)) {
var u = l.slice(2), p = new Set, m = [ Ko("soldier"), Ko("ranger"), Ko("healer"), Ko("siegeUnit") ].filter(function(e) {
...
var y = d.value;
try {
for (var h = (a = void 0, n(y.boosts)), g = h.next(); !g.done; g = h.next()) {
var v = g.value;
p.add(v);
}
} catch (e) {
...
var R = 0;
try {
for (var E = n(p), T = E.next(); !(T.done || (v = T.value, R >= u.length)); T = E.next()) {
var C = u[R];
(C.mineralType !== v || C.store[v] < 1e3) && Kr.debug("Lab ".concat(C.id, " needs ").concat(v, " for boosting"), {
subsystem: "Boost"
}), R++;
}
} catch (e) {
...
var zo, qo, Xo, Qo, Zo = Hr("MemoryMonitor"), Jo = 2097152, $o = new (function() {
function e() {
this.lastCheckTick = 0, this.lastStatus = "normal";
}
return e.prototype.checkMemoryUsage = function() {
var e = RawMemory.get().length, t = e / Jo, r = "normal";
t >= .9 ? r = "critical" : t >= .8 && (r = "warning"), r !== this.lastStatus && ("critical" === r ? (Game.notify("CRITICAL: Memory at ".concat((100 * t).toFixed(1), "% (").concat(this.formatBytes(e), "/").concat(this.formatBytes(Jo), ")")), 
Zo.error("Memory usage critical", {
meta: {
used: e,
limit: Jo,
percentage: t
}
})) : "warning" === r ? Zo.warn("Memory usage warning", {
meta: {
used: e,
limit: Jo,
percentage: t
}
}) : Zo.info("Memory usage normal", {
meta: {
used: e,
limit: Jo,
percentage: t
...
t.deadCreeps = this.pruneDeadCreeps(), t.eventLogs = this.pruneEventLogs(20), t.staleIntel = this.pruneStaleIntel(en), 
t.marketHistory = this.pruneMarketHistory(5e3);
var r = RawMemory.get().length;
return t.bytesSaved = Math.max(0, e - r), t.bytesSaved > 0 && Kr.info("Memory pruning complete", {
...
var a = 0, i = Game.time - en;
for (var r in t.knownRooms) {
var s = t.knownRooms[r];
s.lastSeen < i && !s.isHighway && !s.hasPortal && a++;
}
a > 50 && e.push("".concat(a, " stale intel entries (older than ").concat(en, " ticks)"));
}
var c = 0;
...
if (t.length > 10) throw Kr.error("Cannot have more than 10 active segments", {
...
if (void 0 === o && (o = 1), !this.isSegmentLoaded(e)) return Kr.warn("Attempted to write to unloaded segment", {
subsystem: "MemorySegmentManager",
meta: {
segmentId: e,
key: t
...
return s.length > 102400 ? (Kr.error("Segment data exceeds 100KB limit", {
subsystem: "MemorySegmentManager",
meta: {
segmentId: e,
key: t,
...
return Kr.error("Failed to write segment data", {
subsystem: "MemorySegmentManager",
meta: {
segmentId: e,
key: t,
...
if (!this.isSegmentLoaded(e)) return Kr.warn("Attempted to read from unloaded segment", {
subsystem: "MemorySegmentManager",
meta: {
segmentId: e,
key: t
...
return Kr.error("Failed to read segment data", {
subsystem: "MemorySegmentManager",
meta: {
segmentId: e,
key: t,
...
this.isSegmentLoaded(e) ? (RawMemory.segments[e] = "", this.segmentCache.delete(e)) : Kr.warn("Attempted to clear unloaded segment", {
subsystem: "MemorySegmentManager",
meta: {
segmentId: e
}
...
for (var t = on[e], r = t.start; r <= t.end; r++) if (!this.isSegmentLoaded(r) || this.getSegmentSize(r) < 92160) return r;
return t.start;
...
var u = l.value;
if (!s || "object" != typeof s || !(u in s)) return Kr.warn("Memory path not found for migration", {
subsystem: "MemorySegmentManager",
meta: {
memoryPath: e,
segmentId: t,
...
if (!this.isSegmentLoaded(t)) return this.requestSegment(t), Kr.info("Segment not loaded, will migrate next tick", {
subsystem: "MemorySegmentManager",
meta: {
memoryPath: e,
segmentId: t,
...
var p = this.writeSegment(t, r, s);
return p && Kr.info("Successfully migrated data to segment", {
subsystem: "MemorySegmentManager",
meta: {
memoryPath: e,
segmentId: t,
...
if (null == e) return "";
var o, n, a, i = {}, s = {}, c = "", l = "", u = "", p = 2, m = 3, f = 2, d = [], y = 0, h = 0;
...
for (n = u.charCodeAt(0), o = 0; o < 8; o++) y = y << 1 | 1 & n, h == t - 1 ? (h = 0, 
d.push(r(y)), y = 0) : h++, n >>= 1;
} else {
for (n = 1, o = 0; o < f; o++) y = y << 1 | n, h == t - 1 ? (h = 0, d.push(r(y)), 
y = 0) : h++, n = 0;
for (n = u.charCodeAt(0), o = 0; o < 16; o++) y = y << 1 | 1 & n, h == t - 1 ? (h = 0, 
d.push(r(y)), y = 0) : h++, n >>= 1;
}
0 == --p && (p = Math.pow(2, f), f++), delete s[u];
} else for (n = i[u], o = 0; o < f; o++) y = y << 1 | 1 & n, h == t - 1 ? (h = 0, 
d.push(r(y)), y = 0) : h++, n >>= 1;
...
var n, a, i, s, c, l, u, p = [], m = 4, f = 4, d = 3, y = "", h = [], g = {
val: o(0),
position: r,
index: 1
};
for (n = 0; n < 3; n += 1) p[n] = n;
for (i = 0, c = Math.pow(2, 2), l = 1; l != c; ) s = g.val & g.position, g.position >>= 1, 
0 == g.position && (g.position = r, g.val = o(g.index++)), i |= (s > 0 ? 1 : 0) * l, 
l <<= 1;
switch (i) {
case 0:
for (i = 0, c = Math.pow(2, 8), l = 1; l != c; ) s = g.val & g.position, g.position >>= 1, 
0 == g.position && (g.position = r, g.val = o(g.index++)), i |= (s > 0 ? 1 : 0) * l, 
l <<= 1;
u = e(i);
break;
...
case 1:
for (i = 0, c = Math.pow(2, 16), l = 1; l != c; ) s = g.val & g.position, g.position >>= 1, 
0 == g.position && (g.position = r, g.val = o(g.index++)), i |= (s > 0 ? 1 : 0) * l, 
l <<= 1;
u = e(i);
break;
...
for (p[3] = u, a = u, h.push(u); ;) {
if (g.index > t) return "";
for (i = 0, c = Math.pow(2, d), l = 1; l != c; ) s = g.val & g.position, g.position >>= 1, 
0 == g.position && (g.position = r, g.val = o(g.index++)), i |= (s > 0 ? 1 : 0) * l, 
l <<= 1;
switch (u = i) {
case 0:
...
h.push(y), p[f++] = a + y.charAt(0), a = y, 0 == --m && (m = Math.pow(2, d), d++);
}
}
};
return a;
}(), null != qo ? qo.exports = Xo : "undefined" != typeof angular && null != angular && angular.module("LZString", []).factory("LZString", function() {
return Xo;
})), sn.exports), ln = function() {
function e() {}
return e.prototype.compress = function(e, t) {
void 0 === t && (t = 1);
var r = JSON.stringify(e), o = r.length, n = cn.compressToUTF16(r);
return {
compressed: n,
originalSize: o,
...
try {
var t = "string" == typeof e ? e : e.compressed, r = cn.decompressFromUTF16(t);
return r ? JSON.parse(r) : (Kr.error("Decompression returned null", {
subsystem: "MemoryCompressor"
}), null);
} catch (e) {
return Kr.error("Failed to decompress data", {
subsystem: "MemoryCompressor",
meta: {
error: String(e)
}
...
var l = an.suggestSegmentForType("HISTORICAL_INTEL");
if (!an.isSegmentLoaded(l)) return an.requestSegment(l), void Kr.info("Segment not loaded, migration will continue next tick", {
subsystem: "MemoryMigrations",
meta: {
segmentId: l
}
});
if (!an.writeSegment(l, "historicalIntel", a)) return void Kr.error("Failed to write historical intel to segment", {
subsystem: "MemoryMigrations",
meta: {
segmentId: l
}
});
o.knownRooms = n, Kr.info("Migrated historical intel to segments", {
subsystem: "MemoryMigrations",
meta: {
...
if (t) {
var r = t, o = r.portals;
if (o && !un.isCompressed(o)) {
var n = un.compressPortalMap(o);
r.compressedPortals = n, delete r.portals, Kr.info("Compressed portal map data", {
subsystem: "MemoryMigrations",
meta: {
...
if (o) {
var n = un.compressMarketHistory(o), a = an.suggestSegmentForType("MARKET_HISTORY");
if (!an.isSegmentLoaded(a)) return an.requestSegment(a), void Kr.info("Segment not loaded, migration will continue next tick", {
subsystem: "MemoryMigrations",
meta: {
segmentId: a
}
});
an.writeSegment(a, "priceHistory", n) ? (delete r.priceHistory, Kr.info("Migrated market history to segments", {
subsystem: "MemoryMigrations",
meta: {
originalSize: n.originalSize,
compressedSize: n.compressedSize,
...
})) : Kr.error("Failed to write market history to segment", {
subsystem: "MemoryMigrations",
meta: {
segmentId: a
}
...
r > 0 && Kr.info("Migrated ".concat(r, " cluster array properties"), {
subsystem: "MemoryMigrations",
meta: {
...
var e, t, r, o = Memory, a = null !== (r = o.memoryVersion) && void 0 !== r ? r : 0, i = pn.filter(function(e) {
return e.version > a;
});
if (0 !== i.length) {
Kr.info("Running ".concat(i.length, " memory migration(s)"), {
...
var l = c.value;
try {
Kr.info("Running migration v".concat(l.version, ": ").concat(l.description), {
subsystem: "MigrationRunner"
}), l.migrate(Memory), o.memoryVersion = l.version, Kr.info("Migration v".concat(l.version, " complete"), {
subsystem: "MigrationRunner"
});
} catch (e) {
Kr.error("Migration v".concat(l.version, " failed"), {
subsystem: "MigrationRunner",
meta: {
error: String(e)
}
...
return 0 === pn.length ? 0 : Math.max.apply(Math, i([], a(pn.map(function(e) {
return e.version;
})), !1));
...
return pn.filter(function(t) {
return t.version > e;
});
}, e.prototype.rollbackToVersion = function(e) {
var t = Memory;
Kr.warn("Rolling back memory version to ".concat(e), {
subsystem: "MigrationRunner",
meta: {
...
}(), fn = new mn, dn = "empire", yn = "clusters", hn = function() {
function e() {
...
fn.runMigrations(), this.ensureEmpireMemory(), this.ensureClustersMemory(), Game.time - this.lastCleanupTick >= 10 && (this.cleanDeadCreeps(), 
this.lastCleanupTick = Game.time), Game.time - this.lastPruningTick >= 100 && (rn.pruneAll(), 
this.lastPruningTick = Game.time), Game.time - this.lastMonitoringTick >= 50 && ($o.checkMemoryUsage(), 
...
var e = "memory:".concat(dn), t = eo.get(e);
if (!t) {
this.ensureEmpireMemory();
var r = Memory;
eo.set(e, r[dn], Qr), t = r[dn];
}
return t;
}, e.prototype.getClusters = function() {
var e = "memory:".concat(yn), t = eo.get(e);
if (!t) {
this.ensureClustersMemory();
var r = Memory;
eo.set(e, r[yn], Qr), t = r[yn];
}
return t;
...
this.level <= Qo.DEBUG && console.log(JSON.stringify(r({
level: "DEBUG",
message: e,
tick: Game.time
}, t)));
}, e.prototype.info = function(e, t) {
this.level <= Qo.INFO && console.log(JSON.stringify(r({
level: "INFO",
message: e,
tick: Game.time
}, t)));
}, e.prototype.warn = function(e, t) {
this.level <= Qo.WARN && console.log(JSON.stringify(r({
level: "WARN",
message: e,
tick: Game.time
}, t)));
}, e.prototype.error = function(e, t) {
this.level <= Qo.ERROR && console.log(JSON.stringify(r({
level: "ERROR",
message: e,
tick: Game.time
}, t)));
...
var En, Tn = {
"hostile.detected": vn.CRITICAL,
"nuke.detected": vn.CRITICAL,
"safemode.activated": vn.CRITICAL,
"structure.destroyed": vn.HIGH,
"hostile.cleared": vn.HIGH,
"creep.died": vn.HIGH,
"energy.critical": vn.HIGH,
"spawn.emergency": vn.HIGH,
"posture.change": vn.HIGH,
"spawn.completed": vn.NORMAL,
"rcl.upgrade": vn.NORMAL,
"construction.complete": vn.NORMAL,
"remote.lost": vn.NORMAL,
"squad.formed": vn.NORMAL,
"squad.dissolved": vn.NORMAL,
"market.transaction": vn.LOW,
"pheromone.update": vn.LOW,
"cluster.update": vn.LOW,
"expansion.candidate": vn.LOW,
"powerbank.discovered": vn.LOW,
"cpu.spike": vn.BACKGROUND,
"bucket.modeChange": vn.BACKGROUND
}, Cn = {
maxEventsPerTick: 50,
maxQueueSize: 200,
lowBucketThreshold: 2e3,
...
var c = {
handler: t,
priority: null !== (o = r.priority) && void 0 !== o ? o : vn.NORMAL,
minBucket: null !== (n = r.minBucket) && void 0 !== n ? n : 0,
once: null !== (a = r.once) && void 0 !== a && a,
id: "handler_".concat(++this.handlerIdCounter)
}, l = null !== (i = this.handlers.get(e)) && void 0 !== i ? i : [];
return l.push(c), l.sort(function(e, t) {
return t.priority - e.priority;
}), this.handlers.set(e, l), this.config.enableLogging && Rn.debug('EventBus: Registered handler for "'.concat(e, '" (id: ').concat(c.id, ")"), {
subsystem: "EventBus"
}), function() {
return s.off(e, c.id);
};
...
-1 !== o && (r.splice(o, 1), this.config.enableLogging && Rn.debug('EventBus: Unregistered handler "'.concat(t, '" from "').concat(e, '"'), {
subsystem: "EventBus"
}));
}
}, e.prototype.offAll = function(e) {
this.handlers.delete(e), this.config.enableLogging && Rn.debug('EventBus: Removed all handlers for "'.concat(e, '"'), {
subsystem: "EventBus"
});
}, e.prototype.emit = function(e, t, o) {
var n, a, i;
...
var s = r(r({}, t), {
tick: Game.time
}), c = null !== (a = null !== (n = o.priority) && void 0 !== n ? n : Tn[e]) && void 0 !== a ? a : vn.NORMAL, l = null !== (i = o.immediate) && void 0 !== i ? i : c >= vn.CRITICAL;
this.stats.eventsEmitted++, this.config.enableLogging && Rn.debug('EventBus: Emitting "'.concat(e, '" (priority: ').concat(c, ", immediate: ").concat(String(l), ")"), {
subsystem: "EventBus"
});
var u = Game.cpu.bucket;
l || u >= this.config.lowBucketThreshold ? this.processEvent(e, s) : u >= this.config.criticalBucketThreshold ? this.queueEvent(e, s, c) : c >= vn.CRITICAL ? this.processEvent(e, s) : (this.stats.eventsDropped++, 
this.config.enableLogging && Rn.warn('EventBus: Dropped event "'.concat(e, '" due to critical bucket'), {
subsystem: "EventBus"
}));
}, e.prototype.processEvent = function(e, t) {
var r, o, a, i, s = this.handlers.get(e);
...
var f = t instanceof Error ? t.message : String(t);
Rn.error('EventBus: Handler error for "'.concat(e, '": ').concat(f), {
subsystem: "EventBus"
});
}
}
...
return e.event.priority < vn.HIGH;
}).sort(function(e, t) {
return e.event.queuedAt - t.event.queuedAt;
})[0];
if (!(o && o.event.priority < r)) return void this.stats.eventsDropped++;
...
if (Game.time % this.config.statsLogInterval === 0) {
var e = this.getStats();
Rn.debug("EventBus stats: ".concat(e.eventsEmitted, " emitted, ").concat(e.eventsProcessed, " processed, ") + "".concat(e.eventsDeferred, " deferred, ").concat(e.eventsDropped, " dropped, ") + "".concat(e.queueSize, " queued, ").concat(e.handlerCount, " handlers"), {
subsystem: "EventBus"
});
}
}, e;
...
if (e.tickModulo < 0) throw Rn.error('Kernel: Cannot register process "'.concat(e.name, '" - tickModulo must be non-negative (got ').concat(e.tickModulo, ")"), {
subsystem: "Kernel"
}), new Error("Invalid tickModulo: ".concat(e.tickModulo, " (must be >= 0)"));
if (void 0 !== e.tickOffset && e.tickOffset >= e.tickModulo) throw Rn.error('Kernel: Cannot register process "'.concat(e.name, '" - tickOffset (').concat(e.tickOffset, ") must be less than tickModulo (").concat(e.tickModulo, ")"), {
subsystem: "Kernel"
...
id: e.id,
name: e.name,
priority: null !== (r = e.priority) && void 0 !== r ? r : En.MEDIUM,
frequency: i,
...
this.processes.set(e.id, c), this.queueDirty = !0, Rn.debug('Kernel: Registered process "'.concat(c.name, '" (').concat(c.id, ")"), {
subsystem: "Kernel"
});
}, e.prototype.unregisterProcess = function(e) {
var t = this.processes.delete(e);
return t && (this.queueDirty = !0, Rn.debug("Kernel: Unregistered process ".concat(e), {
subsystem: "Kernel"
})), t;
...
this.initialized || (Rn.info("Kernel initialized with ".concat(this.processes.size, " processes"), {
subsystem: "Kernel"
}), this.initialized = !0);
}, e.prototype.updateBucketMode = function() {
var e, t = Game.cpu.bucket;
if ((e = t < this.config.criticalBucketThreshold ? "critical" : t < this.config.lowBucketThreshold ? "low" : t > this.config.highBucketThreshold ? "high" : "normal") !== this.bucketMode && (Rn.info("Kernel: Bucket mode changed from ".concat(this.bucketMode, " to ").concat(e, " (bucket: ").concat(t, ")"), {
subsystem: "Kernel"
}), this.bucketMode = e), Game.time % 100 == 0 && ("low" === this.bucketMode || "critical" === this.bucketMode)) {
var r = this.processes.size;
Rn.info("Bucket ".concat(this.bucketMode.toUpperCase(), " mode: ").concat(t, "/10000 bucket. ") + "Running all ".concat(r, " processes normally (bucket mode is informational only)"), {
subsystem: "Kernel"
});
}
}, e.prototype.validateConfig = function() {
this.config.criticalBucketThreshold >= this.config.lowBucketThreshold && (Rn.warn("Kernel: Adjusting critical bucket threshold ".concat(this.config.criticalBucketThreshold, " to stay below low threshold ").concat(this.config.lowBucketThreshold), {
subsystem: "Kernel"
}), this.config.criticalBucketThreshold = Math.max(0, this.config.lowBucketThreshold - 1)), 
this.config.lowBucketThreshold >= this.config.highBucketThreshold && (Rn.warn("Kernel: Adjusting high bucket threshold ".concat(this.config.highBucketThreshold, " to stay above low threshold ").concat(this.config.lowBucketThreshold), {
subsystem: "Kernel"
...
var e = function(e) {
return void 0 === e && (e = On), function(e, t, r) {
return void 0 === r && (r = On), {
high: _n("high", e, t, r),
medium: _n("medium", e, t, r),
low: _n("low", e, t, r)
};
...
Rn.info("Adaptive budgets updated: rooms=".concat(t, ", bucket=").concat(r, ", ") + "high=".concat(e.high.toFixed(3), ", medium=").concat(e.medium.toFixed(3), ", low=").concat(e.low.toFixed(3)), {
subsystem: "Kernel"
});
}
}
...
Rn.debug('Kernel: Process "'.concat(e.name, '" suspended (').concat(r, " ticks remaining)"), {
subsystem: "Kernel"
});
}
return !1;
...
e.stats.suspensionReason = null, Rn.info('Kernel: Process "'.concat(e.name, '" automatically resumed after suspension. ') + "Previous reason: ".concat(o, ". Consecutive errors: ").concat(e.stats.consecutiveErrors), {
subsystem: "Kernel",
processId: e.id
...
if (a < e.interval) return Game.time % 100 == 0 && e.priority >= En.HIGH && Rn.debug('Kernel: Process "'.concat(e.name, '" skipped (interval: ').concat(a, "/").concat(e.interval, " ticks)"), {
subsystem: "Kernel"
}), !1;
}
return !0;
...
Rn.error('Kernel: Process "'.concat(e.name, '" error: ').concat(r), {
subsystem: "Kernel"
}), t instanceof Error && t.stack && Rn.error(t.stack, {
subsystem: "Kernel"
});
...
e.state = "suspended", Rn.error('Kernel: Process "'.concat(e.name, '" permanently suspended after ').concat(o, " consecutive failures"), {
subsystem: "Kernel",
processId: e.id
...
e.state = "suspended", Rn.warn('Kernel: Process "'.concat(e.name, '" suspended for ').concat(n, " ticks after ").concat(o, " consecutive failures"), {
subsystem: "Kernel",
processId: e.id,
meta: {
...
s > this.config.budgetWarningThreshold && Game.time % this.config.budgetWarningInterval === 0 && Rn.warn('Kernel: Process "'.concat(e.name, '" exceeded CPU budget: ').concat(a.toFixed(3), " > ").concat(i.toFixed(3), " (").concat((100 * s).toFixed(0), "%)"), {
subsystem: "Kernel"
});
}, e.prototype.run = function() {
if (this.updateBucketMode(), this.updateAdaptiveBudgets(), this.tickCpuUsed = 0, 
this.skippedProcessesThisTick = 0, bn.processQueue(), this.queueDirty && (this.rebuildProcessQueue(), 
Rn.info("Kernel: Rebuilt process queue with ".concat(this.processQueue.length, " processes"), {
subsystem: "Kernel"
})), 0 !== this.processQueue.length) {
Game.time % 10 == 0 && Rn.info("Kernel: Running ".concat(this.processQueue.length, " registered processes"), {
subsystem: "Kernel"
});
...
r = this.processQueue.length - e - t, Rn.warn("Kernel: CPU budget exhausted after ".concat(e, " processes. ").concat(r, " processes deferred to next tick. Used: ").concat(Game.cpu.getUsed().toFixed(2), "/").concat(this.getCpuLimit().toFixed(2)), {
subsystem: "Kernel"
...
bn.logStats());
} else Rn.warn("Kernel: No processes registered in queue", {
subsystem: "Kernel"
});
...
if (Rn.info("Kernel: ".concat(e, " ran, ").concat(t, " skipped (interval: ").concat(r, ", CPU: ").concat(o, "), ") + "CPU: ".concat(s.toFixed(2), "/").concat(c.toFixed(2), " (").concat((s / c * 100).toFixed(1), "%), bucket: ").concat(a, "/10000 (").concat(i, "%), mode: ").concat(this.bucketMode), {
subsystem: "Kernel"
...
l.length > 0 && Rn.info("Kernel: Priority decay active: ".concat(l.map(function(e) {
...
u.length > 0 && Rn.warn("Kernel: Top skipped processes: ".concat(u.map(function(e) {
...
return !!t && (t.state = "suspended", Rn.info('Kernel: Suspended process "'.concat(t.name, '"'), {
subsystem: "Kernel"
}), !0);
...
return t.stats.suspensionReason = null, Rn.info('Kernel: Manually resumed process "'.concat(t.name, '". ') + "Previous reason: ".concat(r, ". Consecutive errors: ").concat(t.stats.consecutiveErrors), {
subsystem: "Kernel",
processId: e
}), this.emit("process.recovered", {
processId: t.id,
...
Rn.info("Kernel: Reset all process statistics", {
subsystem: "Kernel"
});
...
this.updateConfig(Un(e));
}, e.prototype.on = function(e, t, r) {
return void 0 === r && (r = {}), bn.on(e, t, r);
}, e.prototype.once = function(e, t, r) {
return void 0 === r && (r = {}), bn.once(e, t, r);
}, e.prototype.emit = function(e, t, r) {
void 0 === r && (r = {}), bn.emit(e, t, r);
}, e.prototype.offAll = function(e) {
bn.offAll(e);
...
return bn.hasHandlers(e);
}, e.prototype.getEventBus = function() {
return bn;
}, e;
}();

new Mn(Un(r({}, wn).cpu)), function(e) {
...
var Dn = null, Fn = new Proxy({}, {
get: function(e, t) {
return Dn || (Dn = new Mn(Ln(Pn().cpu))), Dn[t];
},
set: function(e, t, r) {
return Dn || (Dn = new Mn(Ln(Pn().cpu))), Dn[t] = r, !0;
}
}), Bn = [], Hn = new Set;
...
try {
for (var c = n(Bn), l = c.next(); !l.done; l = c.next()) {
var u = l.value;
if (u.target === s || Object.getPrototypeOf(u.target) === s || u.target === Object.getPrototypeOf(s)) {
var p = e[u.methodName];
if ("function" == typeof p) {
var m = p.bind(e), f = null !== (o = u.options.interval) && void 0 !== o ? o : 5, d = zn(f), y = d.interval, h = d.jitter;
Fn.registerProcess({
id: u.options.id,
name: u.options.name,
priority: null !== (a = u.options.priority) && void 0 !== a ? a : En.MEDIUM,
frequency: null !== (i = u.options.frequency) && void 0 !== i ? i : "medium",
minBucket: u.options.minBucket,
cpuBudget: u.options.cpuBudget,
interval: y,
execute: m
}), So.debug('Registered decorated process "'.concat(u.options.name, '" (').concat(u.options.id, ") with interval ").concat(y, " (base: ").concat(f, ", jitter: ").concat(h > 0 ? "+" : "").concat(h, ")"), {
...
}, Qn = [ PWR_GENERATE_OPS, PWR_OPERATE_SPAWN, PWR_OPERATE_EXTENSION, PWR_OPERATE_TOWER, PWR_OPERATE_LAB, PWR_OPERATE_STORAGE, PWR_REGEN_SOURCE, PWR_OPERATE_FACTORY ], Zn = [ PWR_GENERATE_OPS, PWR_OPERATE_SPAWN, PWR_SHIELD, PWR_DISRUPT_SPAWN, PWR_DISRUPT_TOWER, PWR_FORTIFY, PWR_OPERATE_TOWER, PWR_DISRUPT_TERMINAL ], Jn = function() {
function e(e) {
void 0 === e && (e = {}), this.assignments = new Map, this.gplState = null, this.lastGPLUpdate = 0, 
this.config = r(r({}, Xn), e);
}
...
targetMilestone: m,
lastUpdate: Game.time
}, this.lastGPLUpdate !== a && a > 0 && (Kr.info("GPL milestone reached: Level ".concat(a), {
...
l && u && c.processPower() === OK && Kr.debug("Processing power in ".concat(i.roomName, ": ").concat(i.reason), {
subsystem: "PowerCreep"
});
}
}
...
if (p || m) {
var f = (null !== (r = null == p ? void 0 : p.store.getUsedCapacity(RESOURCE_POWER)) && void 0 !== r ? r : 0) + (null !== (o = null == m ? void 0 : m.store.getUsedCapacity(RESOURCE_POWER)) && void 0 !== o ? o : 0), d = null !== (a = null == p ? void 0 : p.store.getUsedCapacity(RESOURCE_ENERGY)) && void 0 !== a ? a : 0, y = !1, h = "", g = 0;
...
g = 50) : (y = !1, h = "Power reserved for power banks"), i.push({
roomName: u.name,
shouldProcess: y,
reason: h,
powerAvailable: f,
...
return u.homeRoom = a, u.role = o, Kr.info("Power creep ".concat(e.name, " assigned as ").concat(o, " to ").concat(a), {
subsystem: "PowerCreep"
}), l;
}, e.prototype.generatePowerPath = function(e) {
var t = this, r = ("powerQueen" === e ? Qn : Zn).filter(function(e) {
...
if (u) {
var p = l.upgrade(u);
p === OK ? (Kr.info("Upgraded ".concat(l.name, " to level ").concat(l.level + 1, " with ").concat(u), {
subsystem: "PowerCreep"
}), c.level = l.level) : p !== ERR_NOT_ENOUGH_RESOURCES && Kr.warn("Failed to upgrade ".concat(l.name, ": ").concat(p), {
subsystem: "PowerCreep"
});
}
}
...
if (!e.powers[p]) {
var m = POWER_INFO[p];
if (m && void 0 !== m.level && m.level[0] <= (null !== (s = null === (i = this.gplState) || void 0 === i ? void 0 : i.currentLevel) && void 0 !== s ? s : 0)) return p;
}
}
} catch (e) {
r = {
...
c === OK ? Kr.info("Created new power creep: ".concat(i, " (").concat(s, ")"), {
subsystem: "PowerCreep"
}) : Kr.warn("Failed to create power creep: ".concat(c), {
subsystem: "PowerCreep"
});
}
}
...
})[0]) && l.spawn(p) === OK && (Kr.info("Power creep ".concat(s, " spawned at ").concat(u.name), {
subsystem: "PowerCreep"
...
})[0]) && l.pos.getRangeTo(p) <= 1 && l.renew(p) === OK && Kr.debug("Power creep ".concat(s, " renewed"), {
subsystem: "PowerCreep"
});
}
}
...
return o && (o.memory.homeRoom = t), Kr.info("Power creep ".concat(e, " reassigned to ").concat(t), {
subsystem: "PowerCreep"
}), !0;
...
Kr.info("Power System: GPL ".concat(this.gplState.currentLevel, " ") + "(".concat(this.gplState.currentProgress, "/").concat(this.gplState.progressNeeded, "), ") + "Operators: ".concat(e.length, "/").concat(this.gplState.currentLevel, " ") + "(".concat(t, " eco, ").concat(r, " combat)"), {
subsystem: "PowerCreep"
});
}
}, o([ Yn("empire:powerCreep", "Power Creep Management", {
priority: En.LOW,
interval: 20,
minBucket: 0,
cpuBudget: .03
}) ], e.prototype, "run", null), o([ Vn() ], e);
}(), $n = new Jn, ea = {
minPower: 1e3,
maxDistance: 5,
...
function e(e) {
void 0 === e && (e = {}), this.operations = new Map, this.lastScan = 0, this.config = r(r({}, ea), e);
}
return e.prototype.run = function() {
...
var e, t, r = gn.getEmpire(), o = function(o) {
...
r.powerBanks.push(s), n.power >= a.config.minPower && Kr.info("Power bank discovered in ".concat(o, ": ").concat(n.power, " power"), {
subsystem: "PowerBank"
});
}
};
try {
for (var d = (i = void 0, n(m)), y = d.next(); !y.done; y = d.next()) f(y.value);
} catch (e) {
i = {
error: e
};
...
if (!o) return e.state = "failed", void Kr.warn("Power bank in ".concat(e.roomName, " disappeared"), {
subsystem: "PowerBank"
});
e.power = o.power, e.decayTick = Game.time + (null !== (t = o.ticksToDecay) && void 0 !== t ? t : 0), 
e.assignedCreeps.attackers.length > 0 && (e.state = "attacking", Kr.info("Starting attack on power bank in ".concat(e.roomName), {
subsystem: "PowerBank"
}));
}
...
if (!o) return e.state = "collecting", void Kr.info("Power bank destroyed in ".concat(e.roomName, ", collecting power"), {
subsystem: "PowerBank"
});
...
s > .9 * a && Kr.warn("Power bank in ".concat(e.roomName, " may decay before completion (").concat(Math.round(s), " > ").concat(a, ")"), {
subsystem: "PowerBank"
...
0 === r.length && 0 === o.length && (e.state = "complete", Kr.info("Power bank operation complete in ".concat(e.roomName, ": ").concat(e.powerCollected, " power collected"), {
subsystem: "PowerBank"
}));
...
var o = gn.getEmpire(), n = Object.values(Game.rooms).filter(function(e) {
var t;
...
this.operations.set(e.roomName, p), e.active = !0, Kr.info("Started power bank operation in ".concat(e.roomName, " (").concat(e.power, " power, home: ").concat(a.name, ")"), {
subsystem: "PowerBank"
});
}
...
i += Math.max(0, m.healers - f.healers)), "collecting" !== p.state && "attacking" !== p.state || (s += Math.max(0, m.carriers - f.carriers));
}
}
} catch (e) {
t = {
...
for (var o = n(r), a = o.next(); !a.done; a = o.next()) {
var i = a.value;
Kr.info("Power bank op ".concat(i.roomName, ": ").concat(i.state, ", ") + "".concat(i.assignedCreeps.attackers.length, "A/").concat(i.assignedCreeps.healers.length, "H/").concat(i.assignedCreeps.carriers.length, "C, ") + "".concat(Math.round(i.damageDealt / 1e3), "k damage, ").concat(i.powerCollected, " collected"), {
subsystem: "PowerBank"
});
}
} catch (t) {
...
}, o([ Yn("empire:powerBank", "Power Bank Harvesting", {
priority: En.LOW,
interval: 50,
minBucket: 0,
cpuBudget: .02
}) ], e.prototype, "run", null), o([ Vn() ], e);
}(), ra = new ta, oa = function() {
function e() {}
return e.prototype.status = function(e) {
var t, r, o, a, i, s, c, l, u = No.getConfig(e);
...
p += "Lab Assignments:\n";
try {
for (var m = n(u.labs), f = m.next(); !f.done; f = m.next()) {
var d = f.value, y = Game.getObjectById(d.labId), h = null !== (c = null == y ? void 0 : y.mineralType) && void 0 !== c ? c : "empty", g = null !== (l = null == y ? void 0 : y.store[h]) && void 0 !== l ? l : 0;
p += "  ".concat(d.role, ": ").concat(h, " (").concat(g, ") @ (").concat(d.pos.x, ",").concat(d.pos.y, ")\n");
}
} catch (e) {
t = {
error: e
...
var v = Po.getLabResourceNeeds(e);
if (v.length > 0) {
p += "\nResource Needs:\n";
try {
...
var C = Po.getLabOverflow(e);
if (C.length > 0) {
p += "\nOverflow (needs emptying):\n";
try {
for (var S = n(C), b = S.next(); !b.done; b = S.next()) {
var w = b.value;
p += "  ".concat(w.resourceType, ": ").concat(w.amount, " (priority ").concat(w.priority, ")\n");
}
} catch (e) {
i = {
error: e
...
return Po.setActiveReaction(e, t, r, o) ? "Set active reaction: ".concat(t, " + ").concat(r, " → ").concat(o) : "Failed to set reaction (check lab configuration)";
}, e.prototype.clear = function(e) {
return Po.clearReactions(e), "Cleared active reactions in ".concat(e);
}, e.prototype.boost = function(e, t) {
var r, o, a = Game.rooms[e];
if (!a) return "Room ".concat(e, " not visible");
var i = Vo.areBoostLabsReady(a, t), s = Vo.getMissingBoosts(a, t), c = "=== Boost Status: ".concat(e, " / ").concat(t, " ===\n");
if (c += "Ready: ".concat(i, "\n"), s.length > 0) {
c += "\nMissing Boosts:\n";
try {
...
s += "".concat(p, " | ").concat(u.resourceType, " | ").concat(m, " | ").concat(f, " | ").concat(null !== (a = u.roomName) && void 0 !== a ? a : "N/A", "\n");
}
} catch (t) {
e = {
error: t
...
var e, t, r = ra.getActiveOperations();
...
return $n.reassignPowerCreep(e, t) ? "Reassigned ".concat(e, " to ").concat(t) : "Failed to reassign ".concat(e, " (not found)");
...
var t, r, o, i, s, c, l;
try {
var u = JSON.parse(e), p = ua(JSON.stringify(u.d));
if (u.c !== p) return Rn.warn("InterShardMemory checksum mismatch", {
...
return C.ws && (b.mainWarShard = C.ws), C.es && (b.primaryEcoShard = C.es), C.ct && (b.colonizationTarget = C.ct), 
C.en && (b.enemies = C.en.map(function(e) {
return {
username: e.u,
rooms: e.r,
threatLevel: e.t,
...
return Rn.error("Failed to deserialize InterShardMemory: ".concat(String(e)), {
subsystem: "InterShard"
}), null;
}
}
...
function e(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = r(r({}, ha), e), this.interShardMemory = {
version: 1,
shards: {},
globalTargets: {
targetPowerLevel: 0
...
if (r) {
var o = ma(r);
o && (this.interShardMemory = o, Rn.debug("Loaded InterShardMemory", {
subsystem: "Shard"
}));
}
} catch (e) {
var n = e instanceof Error ? e.message : String(e);
Rn.error("Failed to load InterShardMemory: ".concat(n), {
subsystem: "Shard"
});
}
var a = null !== (t = null === (e = Game.shard) || void 0 === e ? void 0 : e.name) && void 0 !== t ? t : "shard0";
this.interShardMemory.shards[a] || (this.interShardMemory.shards[a] = la(a));
}, e.prototype.run = function() {
...
var p = u.value, m = p.find(FIND_MY_STRUCTURES, {
filter: function(e) {
...
try {
for (var y = (o = void 0, n(d)), h = y.next(); !h.done; h = y.next()) {
...
var t;
return null === (t = e.controller) || void 0 === t ? void 0 : t.my;
}), p = Game.cpu.getUsed() / Game.cpu.limit, m = p < .5 ? "low" : p < .75 ? "medium" : p < .9 ? "high" : "critical", f = u.length > 0 ? u.reduce(function(e, t) {
var r, o;
return e + (null !== (o = null === (r = t.controller) || void 0 === r ? void 0 : r.level) && void 0 !== o ? o : 0);
}, 0) / u.length : 0, d = 0;
try {
for (var y = n(u), h = y.next(); !h.done; h = y.next()) {
...
Rn.info("Processing colonize task: ".concat(r, " from ").concat(e.sourceShard), {
subsystem: "Shard"
});
...
e.status = "active";
var r = null !== (t = e.targetRoom) && void 0 !== t ? t : "unknown";
Rn.info("Processing reinforce task: ".concat(r, " from ").concat(e.sourceShard), {
subsystem: "Shard"
});
}, e.prototype.handleTransferTask = function(e) {
e.status = "active", Rn.info("Processing transfer task from ".concat(e.sourceShard), {
subsystem: "Shard"
});
...
e.status = "active";
var r = null !== (t = e.targetRoom) && void 0 !== t ? t : "unknown";
Rn.info("Processing evacuate task: ".concat(r, " to ").concat(e.targetShard), {
subsystem: "Shard"
});
...
Rn.info("Discovered portal in ".concat(e, " to ").concat(n, "/").concat(a), {
subsystem: "Shard"
});
}
}
...
"frontier" === o.role && n.roomCount >= 3 && n.avgRCL >= 5 && (i = "core", Rn.info("Transitioning from frontier to core shard", {
subsystem: "Shard"
})), "war" === o.role && n.warIndex < 20 && (i = n.economyIndex > 70 && n.roomCount >= 3 ? "resource" : n.roomCount >= 2 ? "core" : "frontier", 
Rn.info("War ended, transitioning to ".concat(i), {
subsystem: "Shard"
})), i !== o.role && (o.role = i, Rn.info("Auto-assigned shard role: ".concat(i), {
subsystem: "Shard"
}));
}
...
var o = ga[e.role], n = t === r ? Game.cpu.bucket : e.health.bucketLevel;
...
return e + t;
}, 0) : this.config.defaultCpuLimit * c.length, u = null !== (i = null === (a = Game.shard) || void 0 === a ? void 0 : a.name) && void 0 !== i ? i : "shard0", p = {}, m = 0;
try {
for (var f = n(c), d = f.next(); !d.done; d = f.next()) {
var y = s[E = d.value];
if (y) {
...
var E;
p[E = R.value] && (g[E] = Math.max(5, Math.round(p[E] / m * l)));
}
} catch (e) {
r = {
error: e
...
C && Game.cpu.setShardLimits(g) === OK && Rn.info("Updated shard CPU limits: ".concat(JSON.stringify(g)), {
subsystem: "Shard"
});
}
} catch (e) {
var S = e instanceof Error ? e.message : String(e);
Rn.debug("Could not set shard limits: ".concat(S), {
subsystem: "Shard"
});
}
...
e.valid || (Rn.warn("InterShardMemory validation failed: ".concat(e.errors.join(", ")), {
subsystem: "Shard"
}), this.repairInterShardMemory());
var t = pa(this.interShardMemory);
if (t.length > ya) {
Rn.warn("InterShardMemory size exceeds limit: ".concat(t.length, "/").concat(ya), {
subsystem: "Shard"
}), this.trimInterShardMemory();
var r = pa(this.interShardMemory);
return r.length > ya ? (Rn.error("InterShardMemory still too large after trim: ".concat(r.length, "/").concat(ya), {
subsystem: "Shard"
...
Rn.error("Failed to sync InterShardMemory: ".concat(o), {
subsystem: "Shard"
...
var i = a(o.value, 2), s = i[0], c = i[1];
c.health && "number" == typeof c.health.lastUpdate || (this.interShardMemory.shards[s] = la(s)), 
...
Rn.info("Repaired InterShardMemory structure", {
subsystem: "Shard"
});
...
try {
var r = InterShardMemory.getLocal();
if (!r) return void Rn.warn("InterShardMemory verification failed: no data present", {
subsystem: "Shard"
});
var o = ma(r);
if (!o) return void Rn.warn("InterShardMemory verification failed: deserialization failed", {
subsystem: "Shard"
});
var n = null !== (t = null === (e = Game.shard) || void 0 === e ? void 0 : e.name) && void 0 !== t ? t : "shard0";
o.shards[n] || Rn.warn("InterShardMemory verification failed: current shard ".concat(n, " not found"), {
subsystem: "Shard"
});
} catch (e) {
var a = e instanceof Error ? e.message : String(e);
Rn.warn("InterShardMemory verification failed: ".concat(a), {
subsystem: "Shard"
});
}
...
var e, t;
try {
Rn.info("Attempting InterShardMemory recovery", {
subsystem: "Shard"
});
var r = InterShardMemory.getLocal();
if (r) {
var o = ma(r);
if (o) return this.interShardMemory = o, void Rn.info("Recovered InterShardMemory from storage", {
subsystem: "Shard"
});
}
var n = null !== (t = null === (e = Game.shard) || void 0 === e ? void 0 : e.name) && void 0 !== t ? t : "shard0";
...
lastSync: 0,
checksum: 0
}, this.interShardMemory.shards[n] = la(n), Rn.info("Recreated InterShardMemory with current shard only", {
subsystem: "Shard"
});
} catch (e) {
var a = e instanceof Error ? e.message : String(e);
Rn.error("InterShardMemory recovery failed: ".concat(a), {
subsystem: "Shard"
});
}
...
}).slice(0, 10), Rn.warn("Emergency trim applied to InterShardMemory", {
subsystem: "Shard"
}));
...
if (o) {
var n = o.health;
Rn.info("Shard ".concat(r, " (").concat(o.role, "): ") + "".concat(n.roomCount, " rooms, RCL ").concat(n.avgRCL, ", ") + "CPU: ".concat(n.cpuCategory, ", Eco: ").concat(n.economyIndex, "%, War: ").concat(n.warIndex, "%"), {
subsystem: "Shard"
});
}
...
r && (s.targetRoom = r), this.interShardMemory.tasks.push(s), Rn.info("Created inter-shard task: ".concat(e, " to ").concat(t), {
subsystem: "Shard"
});
...
var t, r, o = null !== (r = null === (t = Game.shard) || void 0 === t ? void 0 : t.name) && void 0 !== r ? r : "shard0", n = this.interShardMemory.shards[o];
n && (n.role = e, Rn.info("Set shard role to: ".concat(e), {
subsystem: "Shard"
}));
...
this.interShardMemory.tasks.push(c), Rn.info("Created resource transfer task: ".concat(o, " ").concat(r, " to ").concat(e, "/").concat(t), {
subsystem: "Shard"
});
...
t && (t.status = "failed", t.updatedAt = Game.time, Rn.info("Cancelled task ".concat(e), {
subsystem: "Shard"
}));
}, e.prototype.getSyncStatus = function() {
var e, t, r = pa(this.interShardMemory).length, o = r / ya * 100, a = Game.time - this.interShardMemory.lastSync, i = r < 92160 && a < 500, s = 0;
try {
...
Rn.info("Forcing InterShardMemory sync with validation", {
subsystem: "Shard"
}), this.syncInterShardMemory();
}, e.prototype.getMemoryStats = function() {
var e, t, o = pa(this.interShardMemory).length, a = pa(r(r({}, this.interShardMemory), {
tasks: [],
globalTargets: {
targetPowerLevel: 0
}
...
size: o,
limit: ya,
percent: Math.round(o / ya * 1e4) / 100,
breakdown: {
shards: a,
tasks: i,
portals: s,
...
}, o([ (fa.LOW, function(e, t, r) {}) ], e.prototype, "run", null), o([ function(e) {
return e;
} ], e);
}(), Ra = new va, Ea = function() {
function e() {
...
var a = Ra.getActiveTransferTasks();
try {
for (var i = n(a), s = i.next(); !s.done; s = i.next()) {
var c = s.value;
...
var p = this.memory.requests[u];
p && this.processTransferRequest(p);
}
...
this.memory.requests[e.id] = o, Rn.info("Created transfer request: ".concat(e.resourceAmount, " ").concat(e.resourceType, " from ").concat(r, " to ").concat(e.targetShard, "/").concat(e.targetRoom), {
subsystem: "CrossShardTransfer"
});
} else Rn.warn("No room with sufficient ".concat(e.resourceType, " for transfer"), {
subsystem: "CrossShardTransfer"
});
} else Rn.warn("No portal found to ".concat(e.targetShard, ", cannot create transfer request"), {
subsystem: "CrossShardTransfer"
});
}
...
if (o >= r) return e.status = "gathering", void Rn.info("Transfer request ".concat(e.taskId, " moving to gathering phase"), {
subsystem: "CrossShardTransfer"
});
...
return void Rn.error("Failed to optimize body for crossShardCarrier: ".concat(String(e)), {
subsystem: "CrossShardTransfer"
});
}
...
e.priority >= 80 ? da.HIGH : e.priority >= 50 ? da.NORMAL : da.LOW;
for (var u = 0; u < l; u++) e.taskId, e.portalRoom, e.targetShard, "crossShardCarrier_".concat(e.taskId, "_").concat(u, "_").concat(Game.time), 
e.sourceRoom, Game.time, e.targetRoom, Rn.info("Requested spawn of crossShardCarrier for transfer ".concat(e.taskId, " (").concat(u + 1, "/").concat(l, ")"), {
subsystem: "CrossShardTransfer"
});
Rn.debug("Transfer request ".concat(e.taskId, " needs ").concat(i, " carry capacity, requested ").concat(l, " carriers"), {
subsystem: "CrossShardTransfer"
});
} else Rn.warn("Source room ".concat(e.sourceRoom, " not available for spawning carriers"), {
subsystem: "CrossShardTransfer"
});
...
}) && (e.status = "moving", Rn.info("Transfer request ".concat(e.taskId, " moving to portal"), {
subsystem: "CrossShardTransfer"
})) : e.status = "queued";
...
}).length > 0 && (e.status = "transferring", Rn.info("Transfer request ".concat(e.taskId, " reached portal, transferring"), {
subsystem: "CrossShardTransfer"
}));
...
Ra.recordPortalTraversal(e.portalRoom, e.targetShard, !0), Rn.info("Transfer request ".concat(e.taskId, " completed"), {
subsystem: "CrossShardTransfer"
}));
...
r && !r.assignedCreeps.includes(t) && (r.assignedCreeps.push(t), Rn.info("Assigned creep ".concat(t, " to transfer request ").concat(e), {
subsystem: "CrossShardTransfer"
}));
...
var t, r, o, a, i, s = null !== (a = null === (o = Game.shard) || void 0 === o ? void 0 : o.name) && void 0 !== a ? a : "shard0", c = Ca.getCurrentShardState();
...
var f = m.value, d = f.isStable ? "✓" : "✗", y = "⚠".repeat(f.threatRating), h = null !== (i = f.traversalCount) && void 0 !== i ? i : 0, g = Game.time - f.lastScouted;
...
category: "Shard"
}) ], e.prototype, "bestPortal", null), o([ _o({
...
category: "Shard"
}) ], e.prototype, "createTask", null), o([ _o({
...
category: "Shard"
}) ], e.prototype, "cpuHistory", null), o([ _o({
name: "shard.tasks",
description: "List all inter-shard tasks",
usage: "shard.tasks()",
examples: [ "shard.tasks()" ],
category: "Shard"
}) ], e.prototype, "tasks", null), o([ _o({
...
category: "Shard"
}) ], e.prototype, "syncStatus", null), o([ _o({
...
category: "Shard"
}) ], e.prototype, "memoryStats", null), o([ _o({
...
function e(e) {
void 0 === e && (e = {}), this.config = r(r({}, wa), e);
}
return e.prototype.predictEnergyInTicks = function(e, t) {
if (t < 0) throw new Error("Cannot predict negative ticks");
t > this.config.maxPredictionTicks && (Kr.warn("Prediction horizon ".concat(t, " exceeds max ").concat(this.config.maxPredictionTicks, ", clamping"), {
...
return this.config.enableLogging && Kr.debug("Energy prediction for ".concat(e.name, ": ").concat(n, " → ").concat(i, " (").concat(t, " ticks, ").concat(a.toFixed(2), "/tick)"), {
subsystem: "EnergyFlowPredictor"
}), s;
...
category: "Economy"
}) ], e.prototype, "predictEnergy", null), o([ _o({
...
category: "Economy"
}) ], e.prototype, "showIncome", null), o([ _o({
...
category: "Economy"
}) ], e.prototype, "showConsumption", null), o([ _o({
...
category: "Economy"
}) ], e.prototype, "canAfford", null), o([ _o({
...
function Aa(e) {
var t, r, o = gn.getEmpire(), a = 0, i = Pa(e);
try {
for (var s = n(i), c = s.next(); !c.done; c = s.next()) {
var l = c.value, u = o.knownRooms[l];
u && (u.owner && !La(u.owner) && (a += 30), u.threatLevel >= 2 && (a += 10 * u.threatLevel), 
...
var i, s, c, l, u, p = 10 * r.sources, m = 50 * a * 2, f = (650 + 450 * r.sources) / (1500 / m) / m, d = 5e3 * r.sources + 50 * a * 300, y = d / 5e4, h = p * (null !== (n = [ 0, .1, .3, .6 ][r.threatLevel]) && void 0 !== n ? n : 0), g = p - f - y - h, v = f + y, R = v > 0 ? g / v : 0;
return {
roomName: e,
sourceId: o,
energyPerTick: p,
...
var m = p.value, f = gn.getSwarmState(m.name);
if (f && !((null !== (s = null === (i = m.controller) || void 0 === i ? void 0 : i.level) && void 0 !== s ? s : 0) < this.config.minRclForRemotes)) {
var d = null !== (c = f.remoteAssignments) && void 0 !== c ? c : [], y = this.validateRemoteAssignments(d, e, m.name), h = this.calculateRemoteCapacity(m, f);
if (y.length < h) {
var g = this.findRemoteCandidates(m.name, e, y), v = h - y.length, R = g.slice(0, v);
try {
for (var E = (o = void 0, n(R)), T = E.next(); !T.done; T = E.next()) {
var C = T.value;
y.includes(C) || (y.push(C), Kr.info("Assigned remote room ".concat(C, " to ").concat(m.name), {
subsystem: "Expansion"
}));
}
} catch (e) {
...
if (!n) return !0;
var a = null;
n.owner && (Kr.info("Removing remote ".concat(e, " - now owned by ").concat(n.owner), {
subsystem: "Expansion"
}), a = "claimed");
var i = o.getMyUsername();
if (!a && n.reserver && n.reserver !== i && (Kr.info("Removing remote ".concat(e, " - reserved by ").concat(n.reserver), {
subsystem: "Expansion"
}), a = "hostile"), !a && n.threatLevel >= 3 && (Kr.info("Removing remote ".concat(e, " - threat level ").concat(n.threatLevel), {
subsystem: "Expansion"
}), a = "hostile"), !a) {
var s = Game.map.getRoomLinearDistance(r, e);
s > o.config.maxRemoteDistance && (Kr.info("Removing remote ".concat(e, " - too far (").concat(s, ")"), {
subsystem: "Expansion"
}), a = "unreachable");
}
return !a || (Fn.emit("remote.lost", {
homeRoom: r,
remoteRoom: e,
reason: a,
source: r
...
} else Game.time % 1e3 == 0 && Kr.debug("Skipping remote ".concat(a, " - not profitable (ROI: ").concat(c.roi.toFixed(2), ")"), {
subsystem: "Expansion"
});
}
}
...
u.targetRoom = o.roomName, u.task = "claim", Kr.info("Assigned claim target ".concat(o.roomName, " to ").concat(l.name), {
subsystem: "Expansion"
}), o.claimed = !0, i = !0;
break;
}
...
if (c) {
var d = gn.getSwarmState(c.name);
d && "defensive" !== d.posture && "evacuate" !== d.posture && d.danger < 2 && "expand" !== d.posture && (d.posture = "expand", 
Kr.info("Set ".concat(c.name, " to expand posture for claiming ").concat(e, " (distance: ").concat(l, ")"), {
subsystem: "Expansion"
}));
}
}
...
var u = l.homeRoom;
if (u) {
var p = gn.getSwarmState(u);
if (null === (a = null == p ? void 0 : p.remoteAssignments) || void 0 === a ? void 0 : a.length) try {
for (var m = (r = void 0, n(p.remoteAssignments)), f = m.next(); !f.done; f = m.next()) {
var d = f.value;
if (!this.hasReserverAssigned(d)) {
l.targetRoom = d, l.task = "reserve", Kr.info("Assigned reserve target ".concat(d, " to ").concat(c.name), {
subsystem: "Expansion"
});
break;
}
...
if (o < this.config.minGclProgressForClaim) return Game.time % 500 == 0 && Kr.info("Waiting for GCL progress: ".concat((100 * o).toFixed(1), "% (need ").concat((100 * this.config.minGclProgressForClaim).toFixed(0), "%)"), {
subsystem: "Expansion"
}), !1;
...
return !(a < this.config.minStableRoomPercentage && (Game.time % 500 == 0 && Kr.info("Waiting for room stability: ".concat(n.length, "/").concat(r.length, " rooms stable (").concat((100 * a).toFixed(0), "%, need ").concat((100 * this.config.minStableRoomPercentage).toFixed(0), "%)"), {
subsystem: "Expansion"
}), 1));
...
var i = a[0];
Kr.info("Next expansion target: ".concat(i.roomName, " (score: ").concat(i.score, ", cluster bonus: ").concat(i.clusterScore - i.score, ", distance: ").concat(i.distanceToCluster, ")"), {
subsystem: "Expansion"
});
}
return a[0];
...
u && (u.owner && !La(u.owner) && a.push("Hostile player ".concat(u.owner, " in ").concat(l)), 
...
return function(e) {
var t, r, o = gn.getEmpire(), a = Pa(e), i = new Set;
try {
for (var s = n(a), c = s.next(); !c.done; c = s.next()) {
var l = c.value, u = o.knownRooms[l];
(null == u ? void 0 : u.owner) && !La(u.owner) && i.add(u.owner);
}
} catch (e) {
t = {
error: e
...
return (null === (o = null == n ? void 0 : n.controller) || void 0 === o ? void 0 : o.my) ? (Kr.info("Expansion to ".concat(t.roomName, " completed successfully"), {
subsystem: "Expansion"
}), s.removeFromClaimQueue(e, t.roomName), "continue") : (Kr.warn("Expansion to ".concat(t.roomName, " timed out after ").concat(r, " ticks"), {
subsystem: "Expansion"
...
}) && r > 1e3) return Kr.warn("No active claimer for ".concat(t.roomName, " expansion"), {
subsystem: "Expansion"
}), s.cancelExpansion(e, t.roomName, "claimer_died"), "continue";
var i = e.knownRooms[t.roomName];
if ((null == i ? void 0 : i.owner) && i.owner !== s.getMyUsername()) return Kr.warn("".concat(t.roomName, " claimed by ").concat(i.owner, " before we could claim it"), {
subsystem: "Expansion"
...
return u < 2e4 ? (Kr.warn("Cancelling expansion to ".concat(t.roomName, " due to low energy (avg: ").concat(u, ")"), {
subsystem: "Expansion"
...
l.task = void 0, Kr.info("Cleared target for ".concat(c.name, " due to expansion cancellation"), {
subsystem: "Expansion"
}));
}
} catch (e) {
...
Kr.info("Cancelled expansion to ".concat(t, ", reason: ").concat(r), {
subsystem: "Expansion"
});
...
var r = gn.getSwarmState(e);
return r ? (r.remoteAssignments || (r.remoteAssignments = []), r.remoteAssignments.includes(t) ? (Kr.warn("Remote ".concat(t, " already assigned to ").concat(e), {
subsystem: "Expansion"
}), !1) : (r.remoteAssignments.push(t), Kr.info("Manually added remote ".concat(t, " to ").concat(e), {
subsystem: "Expansion"
}), !0)) : (Kr.error("Cannot add remote: ".concat(e, " not found"), {
subsystem: "Expansion"
}), !1);
...
return -1 !== o && (r.remoteAssignments.splice(o, 1), Kr.info("Manually removed remote ".concat(t, " from ").concat(e), {
subsystem: "Expansion"
}), !0);
}, o([ Kn("expansion:manager", "Expansion Manager", {
priority: En.LOW,
interval: 20,
minBucket: 0,
cpuBudget: .02
...
function e() {}
return e.prototype.status = function() {
var e, t, r, o, a, i, s, c, l, u, p = gn.getEmpire(), m = Object.values(Game.rooms).filter(function(e) {
var t;
return null === (t = e.controller) || void 0 === t ? void 0 : t.my;
}), f = (Game.gcl.progress / Game.gcl.progressTotal * 100).toFixed(1), d = Game.gcl.level - m.length, y = d > 0, h = p.objectives.expansionPaused, g = p.claimQueue.length, v = p.claimQueue.filter(function(e) {
return !e.claimed;
...
try {
for (var S = n(C), b = S.next(); !b.done; b = S.next()) {
var w = b.value, O = Game.time - w.lastEvaluated;
T += "  ".concat(w.roomName, ": Score ").concat(w.score.toFixed(0), ", Distance ").concat(w.distance, ", Age ").concat(O, " ticks\n");
}
} catch (t) {
e = {
error: t
...
try {
for (var U = n(_), A = U.next(); !A.done; A = U.next()) x(w = A.value);
} catch (e) {
r = {
error: e
};
...
var k = new Map;
try {
for (var M = n(m), N = M.next(); !N.done; N = M.next()) {
var I = null !== (c = null === (s = N.value.controller) || void 0 === s ? void 0 : s.level) && void 0 !== c ? c : 0;
k.set(I, (null !== (l = k.get(I)) && void 0 !== l ? l : 0) + 1);
}
} catch (e) {
a = {
error: e
...
for (I = 8; I >= 1; I--) {
var P = null !== (u = k.get(I)) && void 0 !== u ? u : 0;
if (P > 0) {
var G = "█".repeat(P);
...
return gn.getEmpire().objectives.expansionPaused = !0, "Expansion paused. Use expansion.resume() to re-enable.";
}, e.prototype.resume = function() {
return gn.getEmpire().objectives.expansionPaused = !1, "Expansion resumed.";
...
var e = gn.getEmpire(), t = e.claimQueue.length;
...
category: "Empire"
}) ], e.prototype, "addRemote", null), o([ _o({
...
category: "Empire"
}) ], e.prototype, "removeRemote", null), o([ _o({
...
if (Game.time - a < 1e3) return Kr.debug("Reputation request on cooldown (".concat(1e3 - (Game.time - a), " ticks remaining)"), {
subsystem: "TooAngel"
}), !1;
...
if (!o || !o.terminal || !o.terminal.my) return Kr.warn("No terminal available to request reputation", {
subsystem: "TooAngel"
}), !1;
var c = function(e) {
...
if (!c || !c.hasTerminal) return Kr.warn("No TooAngel NPC room with terminal found", {
subsystem: "TooAngel"
}), !1;
var l = o.terminal, u = l.store[RESOURCE_ENERGY];
if (u < 100) return Kr.warn("Insufficient energy for reputation request: ".concat(u, " < ").concat(100), {
subsystem: "TooAngel"
}), !1;
var p = l.send(RESOURCE_ENERGY, 100, c.roomName, JSON.stringify({
type: "reputation"
}));
return p === OK ? (Kr.info("Sent reputation request to ".concat(c.roomName, " from ").concat(o.name), {
subsystem: "TooAngel"
}), n.reputation.lastRequestedAt = Game.time, !0) : (Kr.warn("Failed to send reputation request: ".concat(p), {
subsystem: "TooAngel"
}), !1);
}
...
try {
var t = JSON.parse(e);
if ("quest" === t.type && t.id && t.room && t.quest && "number" == typeof t.end) return !t.result && t.end <= Game.time ? (Kr.debug("Ignoring quest ".concat(t.id, " with past deadline: ").concat(t.end, " (current: ").concat(Game.time, ")"), {
subsystem: "TooAngel"
}), null) : t;
} catch (e) {}
return null;
...
}).length < Ja.MAX_ACTIVE_QUESTS;
}

function ri(e) {
return Ja.SUPPORTED_TYPES.includes(e);
}

function oi(e, t, r) {
var o, n;
if (!ti()) return Kr.debug("Cannot accept more quests (at max capacity)", {
subsystem: "TooAngel"
}), !1;
...
if (!n || !n.terminal || !n.terminal.my) return Kr.warn("No terminal available to apply for quest", {
subsystem: "TooAngel"
}), !1;
var l = n.terminal, u = l.store[RESOURCE_ENERGY];
if (u < Ja.MIN_APPLICATION_ENERGY) return Kr.warn("Insufficient energy for quest application: ".concat(u, " < ").concat(Ja.MIN_APPLICATION_ENERGY), {
subsystem: "TooAngel"
}), !1;
var p = {
type: "quest",
id: e,
action: "apply"
}, m = l.send(RESOURCE_ENERGY, Ja.MIN_APPLICATION_ENERGY, t, JSON.stringify(p));
return m === OK ? (Kr.info("Applied for quest ".concat(e, " from ").concat(n.name, " to ").concat(t), {
subsystem: "TooAngel"
}), qa().activeQuests[e] = {
id: e,
type: "buildcs",
...
deadline: 0,
appliedAt: Game.time
}, !0) : (Kr.warn("Failed to apply for quest: ".concat(m), {
subsystem: "TooAngel"
}), !1);
}
...
r ? ("won" === e.result ? (Kr.info("Quest ".concat(e.id, " completed successfully!"), {
subsystem: "TooAngel"
}), r.status = "completed") : (Kr.warn("Quest ".concat(e.id, " failed"), {
subsystem: "TooAngel"
}), r.status = "failed"), r.completedAt = Game.time, t.completedQuests.includes(e.id) || t.completedQuests.push(e.id)) : Kr.warn("Received completion for unknown quest: ".concat(e.id), {
subsystem: "TooAngel"
});
}
...
}(e.targetRoom)) return Kr.info("Quest ".concat(e.id, " (buildcs) completed! All construction sites built in ").concat(e.targetRoom), {
subsystem: "TooAngel"
}), function(e) {
var t, r, o = function(e) {
return ei()[e] || null;
}(e);
if (!o) return Kr.warn("Cannot notify completion for unknown quest: ".concat(e), {
subsystem: "TooAngel"
}), !1;
...
r.terminal.send(RESOURCE_ENERGY, 100, o.originRoom, JSON.stringify(i)) === OK && Kr.info("Notified quest completion: ".concat(e, " (").concat("won", ")"), {
subsystem: "TooAngel"
});
}(e.id), e.status = "completed", void (e.completedAt = Game.time);
var u = l.find(FIND_CONSTRUCTION_SITES);
Kr.debug("Quest ".concat(e.id, " (buildcs): ").concat(u.length, " construction sites remaining in ").concat(e.targetRoom), {
subsystem: "TooAngel"
});
var p = e.assignedCreeps || [], m = [];
try {
for (var f = n(p), d = f.next(); !d.done; d = f.next()) {
...
try {
for (var E = (o = void 0, n(R)), T = E.next(); !(T.done || ((w = (b = T.value).memory).questId = e.id, 
m.push(b), p.push(b.name), Kr.info("Assigned ".concat(b.name, " to quest ").concat(e.id, " (buildcs)"), {
subsystem: "TooAngel"
}), m.length >= 3)); T = E.next()) ;
} catch (e) {
o = {
...
e.assignedCreeps = p;
try {
for (var C = n(m), S = C.next(); !S.done; S = C.next()) {
var b, w;
(w = (b = S.value).memory).questId = e.id, w.questTarget = e.targetRoom, w.questAction = "build";
}
} catch (e) {
i = {
error: e
...
} else Kr.debug("Cannot execute buildcs quest ".concat(e.id, ": room ").concat(e.targetRoom, " not visible"), {
subsystem: "TooAngel"
});
}
...
var e = Memory;
e.tooangel || (e.tooangel = {}), e.tooangel.enabled = !0, Kr.info("TooAngel integration enabled", {
subsystem: "TooAngel"
});
}, e.prototype.disable = function() {
var e = Memory;
e.tooangel || (e.tooangel = {}), e.tooangel.enabled = !1, Kr.info("TooAngel integration disabled", {
subsystem: "TooAngel"
});
}, e.prototype.run = function() {
...
var s = Qa(i.description);
null !== s && (Kr.info("Received reputation update from TooAngel: ".concat(s), {
subsystem: "TooAngel"
}), r.reputation = {
value: s,
...
var i = a.value;
if (!i.order && i.description) {
var s = $a(i.description);
if (s) {
if (Kr.info("Received quest ".concat(s.id, ": ").concat(s.quest, " in ").concat(s.room, " (deadline: ").concat(s.end, ")"), {
subsystem: "TooAngel"
}), s.result) {
ni(s);
continue;
...
assignedCreeps: []
}, ri(s.quest) || (Kr.warn("Received unsupported quest type: ".concat(s.quest), {
subsystem: "TooAngel"
...
for (var r in t) {
var o = t[r];
"active" === o.status && (o.deadline > 0 && Game.time > o.deadline ? (Kr.warn("Quest ".concat(r, " missed deadline (").concat(o.deadline, ")"), {
subsystem: "TooAngel"
}), o.status = "failed", o.completedAt = Game.time) : "buildcs" === o.type ? ai(o) : (Kr.warn("Unsupported quest type for execution: ".concat(o.type), {
subsystem: "TooAngel"
...
for (var t in e) {
var r = e[t];
r.deadline > 0 && Game.time >= r.deadline - Ja.DEADLINE_BUFFER && ("active" !== r.status && "applied" !== r.status || (Kr.warn("Quest ".concat(t, " expired (deadline: ").concat(r.deadline, ", current: ").concat(Game.time, ")"), {
subsystem: "TooAngel"
...
Memory[e] || (Kr.error("TooAngel manager error: ".concat(t), {
subsystem: "TooAngel"
}), Memory[e] = !0);
}
...
r && (Kr.info("Detected TooAngel NPC room: ".concat(t), {
subsystem: "TooAngel"
}), e.push(r));
}
return e;
...
try {
for (var o = n(r), a = o.next(); !a.done; a = o.next()) za(a.value);
} catch (t) {
e = {
error: t
};
...
r.length > 0 && Kr.info("Scanned ".concat(r.length, " TooAngel NPC rooms"), {
subsystem: "TooAngel"
});
...
var l = c.value;
if (!o[l]) return Kr.info("Auto-applying for quest ".concat(l, " from ").concat(a), {
subsystem: "TooAngel"
}), void oi(l, a);
}
} catch (t) {
...
return n.join("\n");
}, o([ Yn("empire:tooangel", "TooAngel Manager", {
priority: En.LOW,
interval: 10
}) ], e.prototype, "run", null), o([ Vn() ], e);
}(), ui = new li, pi = {
...
function e() {}
return e.prototype.status = function() {
var e = $o.checkMemoryUsage(), t = e.breakdown, r = "Memory Status: ".concat(e.status.toUpperCase(), "\n");
return r += "Usage: ".concat($o.formatBytes(e.used), " / ").concat($o.formatBytes(e.limit), " (").concat((100 * e.percentage).toFixed(1), "%)\n\n"), 
r += "Breakdown:\n", r += "  Empire:        ".concat($o.formatBytes(t.empire), " (").concat((t.empire / t.total * 100).toFixed(1), "%)\n"), 
r += "  Rooms:         ".concat($o.formatBytes(t.rooms), " (").concat((t.rooms / t.total * 100).toFixed(1), "%)\n"), 
r += "  Creeps:        ".concat($o.formatBytes(t.creeps), " (").concat((t.creeps / t.total * 100).toFixed(1), "%)\n"), 
r += "  Clusters:      ".concat($o.formatBytes(t.clusters), " (").concat((t.clusters / t.total * 100).toFixed(1), "%)\n"), 
(r += "  SS2 Queue:     ".concat($o.formatBytes(t.ss2PacketQueue), " (").concat((t.ss2PacketQueue / t.total * 100).toFixed(1), "%)\n")) + "  Other:         ".concat($o.formatBytes(t.other), " (").concat((t.other / t.total * 100).toFixed(1), "%)\n");
}, e.prototype.analyze = function(e) {
void 0 === e && (e = 10);
var t = $o.getLargestConsumers(e), r = rn.getRecommendations(), o = "Top ".concat(e, " Memory Consumers:\n");
return t.forEach(function(e, t) {
o += "".concat(t + 1, ". ").concat(e.type, ":").concat(e.name, " - ").concat($o.formatBytes(e.size), "\n");
}), r.length > 0 ? (o += "\nRecommendations:\n", r.forEach(function(e) {
o += "- ".concat(e, "\n");
})) : o += "\nNo recommendations at this time.\n", o;
}, e.prototype.prune = function() {
var e = rn.pruneAll(), t = "Memory Pruning Complete:\n";
return t += "  Dead creeps removed:        ".concat(e.deadCreeps, "\n"), t += "  Event log entries removed:  ".concat(e.eventLogs, "\n"), 
t += "  Stale intel removed:        ".concat(e.staleIntel, "\n"), (t += "  Market history removed:     ".concat(e.marketHistory, "\n")) + "  Total bytes saved:          ".concat($o.formatBytes(e.bytesSaved), "\n");
}, e.prototype.segments = function() {
var e, t, r = an.getActiveSegments(), o = "Memory Segments:\n\n";
...
if (n.length > 0) {
var a = n.map(function(e) {
var t = an.getSegmentSize(e);
return "".concat(e, ":").concat($o.formatBytes(t));
});
o += " [".concat(a.join(", "), "]");
}
o += "\n";
...
try {
for (var s = n(Object.entries(on)), c = s.next(); !c.done; c = s.next()) {
var l = a(c.value, 2);
i(l[0], l[1]);
}
} catch (t) {
...
var l = un.getCompressionStats(a), u = "Compression Test for: ".concat(e, "\n");
return u += "  Original size:    ".concat($o.formatBytes(l.originalSize), "\n"), 
u += "  Compressed size:  ".concat($o.formatBytes(l.compressedSize), "\n"), u += "  Bytes saved:      ".concat($o.formatBytes(l.bytesSaved), "\n"), 
(u += "  Compression ratio: ".concat((100 * l.ratio).toFixed(1), "%\n")) + "  Worth compressing: ".concat(l.ratio < .9 ? "YES" : "NO", "\n");
}, e.prototype.migrations = function() {
var e = fn.getCurrentVersion(), t = fn.getLatestVersion(), r = fn.getPendingMigrations(), o = "Memory Migration Status:\n";
...
var e = fn.getCurrentVersion();
fn.runMigrations();
var t = fn.getCurrentVersion();
...
return gn.initialize(), "Memory reset complete. All data cleared (main memory + 100 segments).";
}, o([ _o({
name: "memory.status",
...
if (f.priority !== ci.CRITICAL && s < this.config.bucketThresholds[f.priority]) {
this.stats.skippedThisTick++;
continue;
}
var d = null !== (a = f.maxCpu) && void 0 !== a ? a : this.config.defaultMaxCpu;
...
var h = Game.cpu.getUsed() - y;
u += h, h > d && console.log("[Scheduler] WARN: Task ".concat(f.id, " exceeded CPU budget: ").concat(h.toFixed(2), " > ").concat(d));
} catch (e) {
...
}(), Ei = ((gi = global)._computationScheduler || (gi._computationScheduler = new Ri), 
gi._computationScheduler), Ti = new Map;
...
var i = Ci(e.room.name), s = null, c = 1 / 0, l = 1 / 0;
try {
for (var u = n(t), p = u.next(); !p.done; p = u.next()) {
var m = p.value, f = "".concat(r, ":").concat(m.id), d = (i.assignments.get(f) || []).length, y = e.pos.getRangeTo(m.pos);
(d < c || d === c && y < l) && (s = m, c = d, l = y);
}
} catch (e) {
o = {
error: e
...
return '<div class="module-container">\n    <div class="module-info">\n      <span class="module-title">'.concat(Oi(e.name, "yellow"), '</span>\n      <span class="module-describe">').concat(Oi(e.describe, "green"), '</span>\n    </div>\n    <div class="module-api-list">').concat(t, "</div>\n  </div>").replace(/\n/g, "");
}, Ai = function(e) {
var t = [];
e.describe && t.push(Oi(e.describe, "green")), e.params && t.push(e.params.map(function(e) {
return "  - ".concat(Oi(e.name, "blue"), ": ").concat(Oi(e.desc, "green"));
}).map(function(e) {
return '<div class="api-content-line">'.concat(e, "</div>");
}).join(""));
var r = e.params ? e.params.map(function(e) {
return Oi(e.name, "blue");
}).join(", ") : "", o = Oi(e.functionName, "yellow") + (e.commandType ? "" : "(".concat(r, ")"));
t.push(o);
var n = t.map(function(e) {
return '<div class="api-content-line">'.concat(e, "</div>");
}).join(""), a = "".concat(e.functionName).concat(Game.time);
return '\n  <div class="api-container">\n    <label for="'.concat(a, '">').concat(e.title, " ").concat(Oi(e.functionName, "yellow", !0), '</label>\n    <input id="').concat(a, '" type="checkbox" />\n    <div class="api-content">').concat(n, "</div>\n  </div>\n  ").replace(/\n/g, "");
}, ki = function() {
...
return e ? function(e) {
var t = Oo.getCommandsByCategory(), r = t.get(e);
...
var e, t, r = Oo.getCommandsByCategory(), o = [];
try {
for (var s = n(r), c = s.next(); !c.done; c = s.next()) {
var l = a(c.value, 2), u = l[0], p = l[1].map(function(e) {
var t, r = {
title: e.metadata.description,
functionName: e.metadata.name,
...
return xi.apply(void 0, i([], a(o), !1));
}();
...
}) : Oi("Room ".concat(e, " not found or not visible"), "red", !0);
}, e.prototype.roomControl = function(e) {
var t = Game.rooms[e];
if (!t) return Oi("Room ".concat(e, " not found or not visible"), "red", !0);
...
r += '<div style="margin-bottom: 10px;">', r += Oi("Energy: ".concat(t.energyAvailable, "/").concat(t.energyCapacityAvailable), "green") + "<br>", 
t.controller && (r += Oi("Controller Level: ".concat(t.controller.level, " (").concat(t.controller.progress, "/").concat(t.controller.progressTotal, ")"), "blue") + "<br>"), 
r += "</div>", r += _i.button({
...
return e += Oi("✓ Success message", "green", !0) + "\n", e += Oi("⚠ Warning message", "yellow", !0) + "\n", 
e += Oi("✗ Error message", "red", !0) + "\n", e += Oi("ℹ Info message", "blue", !0) + "\n", 
(e += "\nNormal text: " + Oi("colored text", "green") + " normal text\n") + "Bold text: " + Oi("important", null, !0) + "\n";
}, o([ _o({
name: "uiHelp",
...
var p = a(u.value, 2), m = p[0], f = p[1];
void 0 !== f.ttl && -1 !== f.ttl && Game.time - f.cachedAt > f.ttl ? c.push(m) : e.entries.set(m, {
value: f.value,
cachedAt: f.cachedAt,
...
try {
for (var d = n(c), y = d.next(); !y.done; y = d.next()) m = y.value, delete s.data[m];
} catch (e) {
o = {
error: e
};
...
for (var l = n(i.entries), u = l.next(); !u.done; u = l.next()) {
var p = a(u.value, 2), m = p[0], f = p[1];
void 0 !== f.ttl && -1 !== f.ttl && Game.time - f.cachedAt > f.ttl && (i.entries.delete(m), 
c++);
}
} catch (t) {
e = {
...
for (var d = n(Object.entries(s.data)), y = d.next(); !y.done; y = d.next()) {
var h = a(y.value, 2), g = (m = h[0], h[1]);
void 0 !== g.ttl && -1 !== g.ttl && Game.time - g.cachedAt > g.ttl && (delete s.data[m], 
c++);
}
} catch (e) {
r = {
...
try {
for (var u = n(Object.entries(s.data)), p = u.next(); !p.done; p = u.next()) {
var m = a(p.value, 2), f = m[0], d = m[1];
...
try {
for (var y = n(l), h = y.next(); !h.done; h = y.next()) f = h.value, delete s.data[f];
} catch (e) {
o = {
error: e
};
...
for (var l = n(i.entries), u = l.next(); !u.done; u = l.next()) {
var p = a(u.value, 2), m = p[0], f = p[1];
this.isExpirable(f) && Game.time - f.cachedAt > f.ttl && (i.entries.delete(m), i.dirtyKeys.delete(m), 
c++);
}
} catch (t) {
e = {
...
for (var d = n(Object.entries(s.data)), y = d.next(); !y.done; y = d.next()) {
var h = a(y.value, 2), g = (m = h[0], h[1]);
this.isExpirable(g) && Game.time - g.cachedAt > g.ttl && (delete s.data[m], c++);
}
} catch (e) {
r = {
error: e
...
return n || (n = "memory" === r ? new Pi(e) : "hybrid" === r ? new Di(e) : new Ii(e), 
...
var r, o, a, i;
void 0 === t && (t = "default");
var s = "".concat(t, ":heap"), c = "".concat(t, ":memory"), l = "".concat(t, ":hybrid"), u = 0, p = [ this.stores.get(s), this.stores.get(c), this.stores.get(l) ].filter(Boolean);
try {
for (var m = n(p), f = m.next(); !f.done; f = m.next()) {
var d = f.value;
if (d) {
var y = d.keys();
try {
for (var h = (a = void 0, n(y)), g = h.next(); !g.done; g = h.next()) {
var v = g.value, R = v.indexOf(":");
if (-1 !== R) {
...
try {
for (var u = n(this.stores.values()), p = u.next(); !p.done; p = u.next()) p.value.clear();
} catch (e) {
t = {
error: e
};
...
var t, r, o, a, i, s, c, l, u, p;
if (e) {
var m = this.getStats(e), f = "".concat(e, ":heap"), d = "".concat(e, ":memory"), y = "".concat(e, ":hybrid"), h = null !== (s = null === (i = this.stores.get(f)) || void 0 === i ? void 0 : i.size()) && void 0 !== s ? s : 0, g = null !== (l = null === (c = this.stores.get(d)) || void 0 === c ? void 0 : c.size()) && void 0 !== l ? l : 0, v = null !== (p = null === (u = this.stores.get(y)) || void 0 === u ? void 0 : u.size()) && void 0 !== p ? p : 0, R = (E = m.hits + m.misses) > 0 ? m.hits / E : 0;
return {
hits: m.hits,
misses: m.misses,
hitRate: R,
...
try {
for (var w = n(this.stats.values()), O = w.next(); !O.done; O = w.next()) T += (m = O.value).hits, 
...
try {
O && !O.done && (r = w.return) && r.call(w);
} finally {
if (t) throw t.error;
}
}
try {
for (var _ = n(this.stores.values()), x = _.next(); !x.done; x = _.next()) b += x.value.size();
} catch (e) {
o = {
error: e
};
...
p && p.lastAccessed < s && (s = p.lastAccessed, i = u);
}
} catch (e) {
r = {
error: e
...
return void 0 === t ? "Invalid log level: ".concat(e, ". Valid levels: debug, info, warn, error, none") : (co({
level: t
...
category: "Logging"
}) ], e.prototype, "setLogLevel", null), o([ _o({
name: "toggleDebug",
...
debug: function(e) {
for (var t = [], r = 1; r < arguments.length; r++) t[r - 1] = arguments[r];
return console.log.apply(console, i([ "[".concat(os, "]"), e ], a(ns.apply(void 0, i([], a(t), !1))), !1));
},
info: function(e) {
for (var t = [], r = 1; r < arguments.length; r++) t[r - 1] = arguments[r];
return console.log.apply(console, i([ "[".concat(os, "]"), e ], a(ns.apply(void 0, i([], a(t), !1))), !1));
...
warn: function(e) {
for (var t = [], r = 1; r < arguments.length; r++) t[r - 1] = arguments[r];
return console.log.apply(console, i([ "[".concat(os, "] WARN:"), e ], a(ns.apply(void 0, i([], a(t), !1))), !1));
},
error: function(e) {
for (var t = [], r = 1; r < arguments.length; r++) t[r - 1] = arguments[r];
return console.log.apply(console, i([ "[".concat(os, "] ERROR:"), e ], a(ns.apply(void 0, i([], a(t), !1))), !1));
}
}), ps = function(e) {
return {};
};
...
this.config = r(r({}, gs), e), this.currentSnapshot = this.createEmptySnapshot(), 
...
this.roomMeasurements.clear(), this.skippedProcessesThisTick = 0, hs.reset();
}
}, e.prototype.finalizeTick = function() {
var e, t, o, n, a, i, s, c, l, u, p, m, f, d, y, h, g = this;
if (this.config.enabled) {
...
progressPercent: (null !== (m = null === (p = Game.gpl) || void 0 === p ? void 0 : p.progressTotal) && void 0 !== m ? m : 0) > 0 ? (null !== (d = null === (f = Game.gpl) || void 0 === f ? void 0 : f.progress) && void 0 !== d ? d : 0) / (null !== (h = null === (y = Game.gpl) || void 0 === y ? void 0 : y.progressTotal) && void 0 !== h ? h : 0) * 100 : 0
}
...
var r, o, i, s, c, l, u, p, m, f, d, y, h, g, v;
if (this.config.enabled) {
...
hostiles: T.length,
brain: {
danger: null !== (h = null == R ? void 0 : R.danger) && void 0 !== h ? h : 0,
postureCode: this.postureToCode(null !== (g = null == R ? void 0 : R.posture) && void 0 !== g ? g : "eco"),
...
for (var S = n(Object.entries(R.pheromones)), b = S.next(); !b.done; b = S.next()) {
var w = a(b.value, 2), O = w[0], _ = w[1];
C.pheromones[O] = _;
}
} catch (e) {
r = {
...
var c = a(s.value, 2), l = c[0], u = c[1];
o.roomsEvaluated++;
var p = this.isWarRoom(l) ? this.config.budgetLimits.warRoom : this.config.budgetLimits.ecoRoom, m = "room:".concat(l), f = this.currentSnapshot.processes[m], d = p * (null !== (r = null == f ? void 0 : f.tickModulo) && void 0 !== r ? r : 1), y = u.profiler.avgCpu, h = y / d;
...
var u = [];
try {
for (var p = n(Object.entries(this.currentSnapshot.rooms)), m = p.next(); !m.done; m = p.next()) {
var f = a(m.value, 2), d = f[0], y = f[1];
if (!(y.profiler.samples < this.config.anomalyDetection.minSamples)) {
var h = null !== (i = this.roomMeasurements.get(d)) && void 0 !== i ? i : 0;
if (!((w = y.profiler.avgCpu) < .01)) {
var g = h / w;
if (g >= this.config.anomalyDetection.spikeThreshold) {
var v = ps(), R = v ? "RCL ".concat(null !== (l = null === (c = null === (s = Game.rooms[d]) || void 0 === s ? void 0 : s.controller) || void 0 === c ? void 0 : c.level) && void 0 !== l ? l : 0, ", posture: ").concat(v.posture, ", danger: ").concat(v.danger) : void 0;
u.push({
type: "spike",
target: d,
targetType: "room",
...
var C = a(T.value, 2), S = C[0], b = C[1];
if (!(b.runCount < this.config.anomalyDetection.minSamples)) {
h = b.maxCpu;
var w = b.avgCpu;
if (!(Game.time - b.lastRunTick > 100 || w < .01) && (h >= w * this.config.anomalyDetection.spikeThreshold && u.push({
type: "spike",
target: S,
targetType: "process",
current: h,
...
var e, t, r, o, i, s, c, l, u, p = this.getProfilerMemory(), m = function(e, t) {
var a, m, d = t.reduce(function(e, t) {
return e + t;
}, 0), y = e.startsWith("role:"), h = y ? e.substring(5) : e;
if (y) {
var g = Object.values(Game.creeps).filter(function(e) {
return e.memory.role === h;
}), v = g.length, R = 0, E = 0, T = 0, C = 0, S = 0;
try {
for (var b = (a = void 0, n(g)), w = b.next(); !w.done; w = b.next()) {
var O = w.value, _ = O.memory, x = null !== (o = null === (r = _.state) || void 0 === r ? void 0 : r.action) && void 0 !== o ? o : "idle", U = null !== (i = _.working) && void 0 !== i ? i : "idle" !== x;
S += O.body.length, C += null !== (s = O.ticksToLive) && void 0 !== s ? s : 0, O.spawning ? R++ : U && "idle" !== x ? T++ : E++;
}
} catch (e) {
a = {
error: e
...
try {
w && !w.done && (m = b.return) && m.call(b);
} finally {
if (a) throw a.error;
}
}
var A = t.length > 0 ? d / t.length : 0, k = (N = null === (c = p.roles) || void 0 === c ? void 0 : c[h]) ? N.avgCpu * (1 - f.config.smoothingFactor) + A * f.config.smoothingFactor : A, M = N ? Math.max(N.peakCpu, A) : A;
f.currentSnapshot.roles[h] = {
name: h,
count: v,
avgCpu: k,
peakCpu: M,
...
totalBodyParts: S
}, p.roles || (p.roles = {}), p.roles[h] = {
avgCpu: k,
peakCpu: M,
samples: f.currentSnapshot.roles[h].samples,
callsThisTick: t.length
};
} else {
var N;
k = (N = p.subsystems[h]) ? N.avgCpu * (1 - f.config.smoothingFactor) + d * f.config.smoothingFactor : d, 
M = N ? Math.max(N.peakCpu, d) : d, f.currentSnapshot.subsystems[h] = {
name: h,
avgCpu: k,
peakCpu: M,
calls: t.length,
...
avgCpu: k,
peakCpu: M,
samples: f.currentSnapshot.subsystems[h].samples,
callsThisTick: t.length
};
}
}, f = this;
try {
for (var d = n(this.subsystemMeasurements), y = d.next(); !y.done; y = d.next()) {
var h = a(y.value, 2);
m(h[0], h[1]);
}
} catch (t) {
...
name: u.name,
role: null !== (a = p.role) && void 0 !== a ? a : "unknown",
homeRoom: null !== (i = p.homeRoom) && void 0 !== i ? i : u.room.name,
...
this.currentSnapshot.pathfinding = hs.getMetrics();
...
var e, t, o, i, s, c, l, u, p, m, f = Memory, d = this.currentSnapshot;
f.stats = {
tick: d.tick,
...
try {
for (var y = n(Object.entries(d.rooms)), h = y.next(); !h.done; h = y.next()) {
var g = a(h.value, 2), v = g[0], R = g[1];
f.stats.rooms[v] = {
rcl: R.rcl,
energy: {
...
try {
for (var E = n(Object.entries(d.subsystems)), T = E.next(); !T.done; T = E.next()) {
var C = a(T.value, 2), S = C[0], b = C[1];
...
try {
for (var w = n(Object.entries(d.roles)), O = w.next(); !O.done; O = w.next()) {
var _ = a(O.value, 2), x = (S = _[0], _[1]);
f.stats.roles[S] = {
count: x.count,
avg_cpu: x.avgCpu,
peak_cpu: x.peakCpu,
...
f.stats.processes = {};
try {
for (var U = n(Object.entries(d.processes)), A = U.next(); !A.done; A = U.next()) {
var k = a(A.value, 2), M = k[0], N = k[1];
f.stats.processes[M] = {
name: N.name,
priority: N.priority,
...
f.stats.creeps = {};
try {
for (var I = n(Object.entries(d.creeps)), P = I.next(); !P.done; P = I.next()) {
...
var e, t, r, o, a, i, s, c, l, u, p = this.currentSnapshot;
...
us.info("Top Roles:");
try {
for (var g = n(h), v = g.next(); !v.done; v = g.next()) {
var R = v.value;
...
try {
for (var w = n(b), O = w.next(); !O.done; O = w.next()) {
var _ = O.value;
...
try {
for (var U = n(x), A = U.next(); !A.done; A = U.next()) {
var k = A.value;
...
try {
for (var u = n(e.rooms), p = u.next(); !p.done; p = u.next()) {
var m = p.value, f = "stats.room.".concat(m.roomName);
c["".concat(f, ".rcl")] = m.rcl, c["".concat(f, ".energy.available")] = m.energyAvailable, 
c["".concat(f, ".energy.capacity")] = m.energyCapacity, c["".concat(f, ".storage.energy")] = m.storageEnergy, 
c["".concat(f, ".terminal.energy")] = m.terminalEnergy, c["".concat(f, ".creeps")] = m.creepCount, 
c["".concat(f, ".controller.progress")] = m.controllerProgress, c["".concat(f, ".controller.progress_total")] = m.controllerProgressTotal, 
c["".concat(f, ".controller.progress_percent")] = m.controllerProgressTotal > 0 ? m.controllerProgress / m.controllerProgressTotal * 100 : 0;
var d = ps(m.roomName);
if (d) {
...
d.pheromones) try {
for (var y = (o = void 0, n(Object.entries(d.pheromones))), h = y.next(); !h.done; h = y.next()) {
var g = a(h.value, 2), v = g[0], R = g[1];
...
if (i.length > a) {
for (us.warn("Stats data exceeds segment limit: ".concat(i.length, " bytes, trimming..."), {
subsystem: "Stats"
...
try {
for (var p = n(Object.keys(this.statsData.series)), m = p.next(); !m.done; m = p.next()) l = m.value, 
...
info: function(e, t) {
t ? console.log("[".concat(_s, "] ").concat(e), Os(t)) : console.log("[".concat(_s, "] ").concat(e));
},
warn: function(e, t) {
t ? console.log("[".concat(_s, "] WARN: ").concat(e), Os(t)) : console.log("[".concat(_s, "] WARN: ").concat(e));
},
error: function(e, t) {
t ? console.log("[".concat(_s, "] ERROR: ").concat(e), Os(t)) : console.log("[".concat(_s, "] ERROR: ").concat(e));
},
debug: function(e, t) {
t ? console.log("[".concat(_s, "] DEBUG: ").concat(e), Os(t)) : console.log("[".concat(_s, "] DEBUG: ").concat(e));
}
}), Us = function() {
function e() {
...
return t.name === e;
}) && !s.isLayerEnabled(t) && (s.enableLayer(t), xs.info("Enabled layer ".concat(ds[t], " via flag")));
}, s = this;
try {
...
function e(e, t) {
void 0 === e && (e = {}), this.config = r(r({}, Ms), e), this.memoryManager = t;
}
...
if (e.text("Energy: ".concat(d, "/").concat(y, " (").concat(h, "%)"), l, u, {
align: "left",
font: "0.4 monospace",
color: "#ffff00"
}), u += p, t.storage) {
var g = t.storage.store.getUsedCapacity(RESOURCE_ENERGY);
e.text("Storage: ".concat(Math.round(g / 1e3), "k energy"), l, u, {
align: "left",
font: "0.4 monospace",
color: "#00ff00"
}), u += p;
...
var u = a(l.value, 2), p = u[0], m = u[1], f = null !== (i = Ns[p]) && void 0 !== i ? i : "#888888", d = 6 * Math.min(1, m / 100);
e.rect(42, s, 6, .4, {
fill: "#333333",
opacity: .8
}), d > 0 && e.rect(42, s, d, .4, {
...
}), e.text("".concat(p, ": ").concat(Math.round(m)), 41.8, s + .35, {
align: "right",
font: "0.35 monospace",
color: f
}), s += .5;
...
try {
for (var u = n(Object.entries(r.pheromones)), p = u.next(); !p.done; p = u.next()) {
var m = a(p.value, 2), f = m[0], d = m[1];
d > l && (l = d, c = f);
}
} catch (e) {
...
var y = null !== (s = Ns[c]) && void 0 !== s ? s : "#888888", h = .15 * Math.min(1, l / 100);
t.rect(40, 10, 8, 5, {
fill: y,
opacity: h
...
try {
for (var h = n(y), g = h.next(); !g.done; g = h.next()) {
var v = g.value;
e.circle(v.pos, {
radius: 5,
fill: "#00ff00",
...
var r, o, a, i, s, c, l, u, p = t.storage;
if (p) {
...
var h = (y.pos.x + p.pos.x) / 2, g = (y.pos.y + p.pos.y) / 2;
...
var S = .8, b = -.8, w = Object.keys(p.store).filter(function(e) {
return p.store[e] > 1e3;
}).sort(function(e, t) {
return p.store[t] - p.store[e];
}).slice(0, 3);
try {
for (var O = n(w), _ = O.next(); !_.done; _ = O.next()) {
var x = _.value;
...
S = .8, b = -.8, w = Object.keys(U.store).filter(function(e) {
return U.store[e] > 1e3;
}).sort(function(e, t) {
return U.store[t] - U.store[e];
}).slice(0, 3);
try {
for (var A = n(w), k = A.next(); !k.done; k = A.next()) x = k.value, e.resource(x, U.pos.x + S, U.pos.y + b, .3), 
S += .6;
} catch (e) {
l = {
error: e
...
var r, o, a, i, s, c, l = ks.getCachedStructures(t.name);
if (l) try {
for (var u = n(l), p = u.next(); !p.done; p = u.next()) {
...
try {
for (var h = n(d), g = h.next(); !g.done; g = h.next()) {
var v = g.value;
...
var t, r, o = ks.getPerformanceMetrics(), i = .5, s = 7.5, c = .5;
e.rect(0, 7, 10, 5.5, {
fill: "#000000",
opacity: .8,
stroke: "#ffff00",
...
try {
for (var u = n(Object.entries(o.layerCosts)), p = u.next(); !p.done; p = u.next()) {
var m = a(p.value, 2), f = m[0], d = m[1];
d > 0 && (e.text("  ".concat(f, ": ").concat(d.toFixed(3)), i, s, {
align: "left",
font: "0.35 monospace",
color: "#aaaaaa"
}), s += .4);
...
function e(e, t) {
void 0 === e && (e = {}), this.config = r(r({}, Ps), e), this.memoryManager = t;
}
return e.prototype.setMemoryManager = function(e) {
this.memoryManager = e;
...
var p = null === (a = this.memoryManager) || void 0 === a ? void 0 : a.getOrInitSwarmState(u.name), m = u.controller.level, f = (null == p ? void 0 : p.danger) ? Math.min(Math.max(p.danger, 0), 3) : 0, d = null !== (i = Gs[f]) && void 0 !== i ? i : "#ffffff", y = {
radius: 10,
fill: d,
...
var h = null !== (s = Ls[p.posture]) && void 0 !== s ? s : "#ffffff";
...
for (var p = (r = void 0, n(u.remoteAssignments)), m = p.next(); !m.done; m = p.next()) {
var f = m.value, d = {
color: "#00ffff",
...
try {
for (var g = (c = void 0, n(h)), v = g.next(); !v.done; v = g.next()) {
var R = v.value, E = {
color: "#ff0000",
...
stroke: "#ff00ff",
strokeWidth: 2
}), e.text("☢".concat(p.length), new RoomPosition(25, 25, i.name), {
color: "#ffffff",
fontSize: 10,
align: "center",
...
"undefined" == typeof RoomVisual || Vs || (Vs = !0, RoomVisual.prototype.structure = function(e, t, o, n) {
void 0 === n && (n = {});
var a = r({
opacity: 1
}, n);
...
var zs = Hr("CreepContext"), qs = ((Fs = {})[STRUCTURE_SPAWN] = 100, Fs[STRUCTURE_EXTENSION] = 90, 
...
void 0 === a.working && (a.working = e.store.getUsedCapacity() > 0, zs.debug("".concat(e.name, " initialized working=").concat(a.working, " from carry state"), {
creep: e.name
}));
...
get containers() {
return void 0 === (e = i)._containers && (Qs(e), e._containers = e.allStructures.filter(function(e) {
return e.structureType === STRUCTURE_CONTAINER;
})), e._containers;
var e;
},
get depositContainers() {
return void 0 === (e = i)._depositContainers && (Qs(e), e._depositContainers = e.allStructures.filter(function(e) {
return e.structureType === STRUCTURE_CONTAINER;
...
}, u = {}, p = {}.propertyIsEnumerable, m = Object.getOwnPropertyDescriptor, d = m && !p.call({
1: 2
}, 1);
u.f = d ? function(e) {
var t = m(this, e);
...
}, S = C, b = S({}.toString), w = S("".slice), O = function(e) {
return w(b(e), 8, -1);
}, _ = n, x = O, U = Object, A = C("".split), k = _(function() {
return !U("z").propertyIsEnumerable(0);
}) ? function(e) {
return "String" === x(e) ? A(e, "") : U(e);
} : U, M = function(e) {
return null == e;
}, N = M, I = TypeError, P = function(e) {
if (N(e)) throw new I("Can't call method on " + e);
return e;
}, G = k, L = P, D = function(e) {
return G(L(e));
...
var r;
}, V = C({}.isPrototypeOf), z = r.navigator, q = z && z.userAgent, X = r, Q = q ? String(q) : "", Z = X.process, J = X.Deno, $ = Z && Z.versions || J && J.version, ee = $ && $.v8;
ee && (h = (y = ee.split("."))[0] > 0 && y[0] < 4 ? 1 : +(y[0] + y[1])), !h && Q && (!(y = Q.match(/Edge\/(\d+)/)) || y[1] >= 74) && (y = Q.match(/Chrome\/(\d+)/)) && (h = +y[1]);
var te = h, re = n, oe = r.String, ne = !!Object.getOwnPropertySymbols && !re(function() {
...
}, ye = de, he = M, ge = l, ve = B, Re = W, Ee = TypeError, Te = {
exports: {}
...
return t;
}, we = r, Oe = be, _e = "__core-js_shared__", xe = Te.exports = we[_e] || Oe(_e, {});
...
}), pt = a, mt = l, ft = u, dt = g, yt = D, ht = nt, gt = Le, vt = ut, Rt = Object.getOwnPropertyDescriptor;
o.f = pt ? Rt : function(e, t) {
if (e = yt(e), t = ht(t), vt) try {
return Rt(e, t);
} catch (e) {}
if (gt(e, t)) return dt(!mt(ft.f, e, t), e[t]);
};
...
}), Ct = W, St = String, bt = TypeError, wt = function(e) {
if (Ct(e)) return e;
throw new bt(St(e) + " is not an object");
}, Ot = a, _t = ut, xt = Tt, Ut = wt, At = nt, kt = TypeError, Mt = Object.defineProperty, Nt = Object.getOwnPropertyDescriptor, It = "enumerable", Pt = "configurable", Gt = "writable";
...
var Lt = Et, Dt = g, Ft = a ? function(e, t, r) {
...
var Xt, Qt, Zt, Jt = zt.inspectSource, $t = B, er = r.WeakMap, tr = $t(er) && /native code/.test(String(er)), rr = We, or = ke("keys"), nr = function(e) {
...
if (ir || ur.state) {
var hr = ur.state || (ur.state = new yr);
...
var gr = pr("state");
mr[gr] = !0, Xt = function(e, t) {
if (lr(e, gr)) throw new dr(fr);
...
}, Rr = C, Er = n, Tr = B, Cr = Le, Sr = a, br = jt.CONFIGURABLE, wr = Jt, Or = vr.enforce, _r = vr.get, xr = String, Ur = Object.defineProperty, Ar = Rr("".slice), kr = Rr("".replace), Mr = Rr([].join), Nr = Sr && !Er(function() {
...
var o = Or(e);
return Cr(o, "source") || (o.source = Mr(Ir, "string" == typeof t ? t : "")), e;
};
Function.prototype.toString = Pr(function() {
return Tr(this) && _r(this).source || wr(this);
}, "toString");
...
var po = j, mo = Hr, fo = uo, yo = wt, ho = C([].concat), go = po("Reflect", "ownKeys") || function(e) {
var t = mo.f(yo(e)), r = fo.f;
return r ? ho(t, r(e)) : t;
}, vo = Le, Ro = go, Eo = o, To = Et, Co = n, So = B, bo = /#|\.prototype\./, wo = function(e, t) {
var r = _o[Oo(e)];
return r === Uo || r !== xo && (So(t) ? Co(t) : !!t);
}, Oo = wo.normalize = function(e) {
return String(e).replace(bo, ".").toLowerCase();
}, _o = wo.data = {}, xo = wo.NATIVE = "N", Uo = wo.POLYFILL = "P", Ao = wo, ko = r, Mo = o.f, No = Ft, Io = function(e, t, r, o) {
o || (o = {});
...
if (r = c ? ko : l ? ko[s] || Po(s, {}) : ko[s] && ko[s].prototype) for (o in t) {
...
return "Array" === Fo(e);
}, Ho = TypeError, Wo = O, Ko = C, Yo = function(e) {
...
}, pn = Jt, mn = function() {}, fn = j("Reflect", "construct"), dn = /^\s*(?:class|function)\b/, yn = sn(dn.exec), hn = !dn.test(mn), gn = function(e) {
if (!ln(e)) return !1;
try {
return fn(mn, [], e), !0;
} catch (e) {
...
}) ? vn : gn, En = Bo, Tn = Rn, Cn = W, Sn = Ze("species"), bn = Array, wn = function(e, t) {
return new (function(e) {
var t;
return En(e) && (t = e.constructor, (Tn(t) && (t === bn || En(t.prototype)) || Cn(t) && null === (t = t[Sn])) && (t = void 0)), 
void 0 === t ? bn : t;
}(e))(0 === t ? 0 : t);
}, On = Jo, _n = de, xn = Ie, Un = Zr, An = wn;
Do({
target: "Array",
proto: !0
}, {
...
var kn = {}, Mn = io, Nn = so, In = Object.keys || function(e) {
return Mn(e, Nn);
}, Pn = a, Gn = Tt, Ln = Et, Dn = wt, Fn = D, Bn = In;
kn.f = Pn && !Gn ? Object.defineProperties : function(e, t) {
Dn(e);
for (var r, o = Fn(t), n = Bn(t), a = n.length, i = 0; a > i; ) Ln.f(e, r = n[i++], o[r]);
return e;
};
var Hn, Wn = j("document", "documentElement"), Kn = wt, Yn = kn, jn = so, Vn = ar, zn = Wn, qn = ct, Xn = "prototype", Qn = "script", Zn = nr("IE_PROTO"), Jn = function() {}, $n = function(e) {
return "<" + Qn + ">" + e + "</" + Qn + ">";
}, ea = function(e) {
e.write($n("")), e.close();
...
ua("Array", "flatMap");
var pa = Jo, ma = Ie, fa = Zr, da = jr, ya = wn;
Do({
target: "Array",
proto: !0
}, {
...
const t = Pa.decode(e), r = t << 4 & 4294901760 | (4032 & t) >> 6 << 8 | 63 & t, o = Object.create(RoomPosition.prototype);
...
if (0 === t) return [ e ];
let o = [];
return o = gi(t).map(t => e.x + t.x < 0 || e.x + t.x > 49 || e.y + t.y < 0 || e.y + t.y > 49 ? null : Ia(e, t.x, t.y)).filter(e => null !== e), 
r && o.push(e), o;
}, Ei = (e, t) => {
const r = Qa(e);
let o = [];
...
var Ai, ki, Mi, Ni;
const Ii = new Ta.Codec({
array: !1,
depth: 30
}), Pi = new Map;
null !== (Ai = Memory[Ni = ha.MEMORY_PORTAL_PATH]) && void 0 !== Ai || (Memory[Ni] = []);
for (const e of Memory[ha.MEMORY_PORTAL_PATH]) {
const t = Di(e), r = null !== (ki = Pi.get(t.room1)) && void 0 !== ki ? ki : new Map;
r.set(t.room2, t), Pi.set(t.room1, r);
const o = null !== (Mi = Pi.get(t.room2)) && void 0 !== Mi ? Mi : new Map;
o.set(t.room1, t), Pi.set(t.room2, o);
}
function Gi(e) {
var t, r, o, n, a;
if (!Si(e) && !(e => {
...
return [ ...r.values() ];
}(e)) (null !== (t = Pi.get(o.room1)) && void 0 !== t ? t : new Map).set(o.room2, o), 
(null !== (r = Pi.get(o.room2)) && void 0 !== r ? r : new Map).set(o.room1, o), 
i.add(o.room2);
const s = Pi.get(e);
for (const t of null !== (o = null == s ? void 0 : s.keys()) && void 0 !== o ? o : []) i.has(t) || (null === (n = Pi.get(e)) || void 0 === n || n.delete(t), 
null === (a = Pi.get(t)) || void 0 === a || a.delete(e));
}
function Li(e) {
var t;
let r = "";
return r += ri(e.room1), r += ri(e.room2), r += Ii.encode(null !== (t = e.expires) && void 0 !== t ? t : 0), 
r += Ya([ ...e.portalMap.entries() ].flat()), r;
}
function Di(e) {
const t = oi(e.slice(0, 3)), r = oi(e.slice(3, 6)), o = Ii.decode(e.slice(6, 8)), n = new Ui, a = ja(e.slice(8));
...
function Fi(e) {
var t;
const r = new Set(Object.values(null !== (t = Game.map.describeExits(e)) && void 0 !== t ? t : {})), o = Pi.get(e);
if (!o) return [ ...r ];
...
return r.ignorePortals || [ ...null !== (l = null === (c = Pi.get(t)) || void 0 === c ? void 0 : c.values()) && void 0 !== l ? l : [] ].flatMap(e => t === e.room1 ? [ ...e.portalMap.keys() ] : [ ...e.portalMap.reversed.keys() ]).forEach(t => e.set(t.x, t.y, 255)), 
e;
...
let t = 1 / 0;
for (const r of Pi.keys()) t = Math.min(t, qi(e, r));
return t;
});
function Qi(e, t) {
...
function Zi(e, t, r) {
var o, n, a, i, s, c, l, u;
let p = Object.assign(Object.assign({}, ha.DEFAULT_MOVE_OPTS), r);
...
const o = Object.assign(Object.assign({}, ha.DEFAULT_MOVE_OPTS), r), n = Ua((e, t) => e + t, (e, t) => {
var r;
...
for (;u !== e; ) {
const e = c.get(u), n = null === (a = Pi.get(e)) || void 0 === a ? void 0 : a.get(u);
...
function ps(e, t, r, o) {
var n;
const a = Object.assign(Object.assign({}, ha.DEFAULT_MOVE_OPTS), o), i = null !== (n = a.cache) && void 0 !== n ? n : xa, s = yi(r, null == o ? void 0 : o.keepTargetInRoom, null == o ? void 0 : o.flee);
...
const t = Object.assign(Object.assign({}, ha.DEFAULT_VISUALIZE_OPTS), r.visualizePathStyle), o = wi(s, c, null == r ? void 0 : r.reverse);
...
const ys = (e, t) => 0 !== e.length && 0 !== t.length && e.some(e => t.some(t => e.inRangeTo(t.pos, t.range))), hs = "_csp", gs = "_cst", vs = (e, t) => {
if (!e.pos) return !1;
if ("fatigue" in e && e.fatigue > 0) return !1;
const r = Ra.get(Wi(e, hs)), o = Ra.get(Wi(e, gs));
return Ra.set(Wi(e, hs), e.pos), r && o && e.pos.isEqualTo(r) ? o + t < Game.time : (Ra.set(Wi(e, gs), Game.time), 
!1);
}, Rs = {
key: "js",
serialize(e) {
...
const h = ms(Wi(e, Es), {
cache: l
}), g = Ra.get(Wi(e, "_cpi")), v = h && wi(h, null != g ? g : 0), R = null !== (i = null === (a = c.avoidTargets) || void 0 === a ? void 0 : a.call(c, e.pos.roomName)) && void 0 !== i ? i : [];
if (c.repathIfStuck && h && vs(e, c.repathIfStuck)) fs(Wi(e, Es), {
cache: l
...
}, tc.cachePath = ps, tc.cachedPathKey = ls, tc.calculateAdjacencyMatrix = gi, tc.calculateAdjacentPositions = vi, 
...
}, tc.config = ha, tc.decompressPath = e => {
let t = Ha(e.slice(0, 2));
const r = [ t ], o = La.decode(e.slice(2));
for (const e of o) t = $a(t, e), r.push(t);
return r;
}, tc.fastRoomPosition = Ma, tc.fixEdgePosition = hi, tc.follow = function(e, t) {
...
tc.getMoveIntents = es, tc.getRangeTo = Ja, tc.globalPosition = Qa, tc.isExit = di, 
...
let l = Ra.get(Wi(e, Os));
const u = ms(t, r);
if ((s || c.length) && void 0 !== l) {
let t = null == u ? void 0 : u.findIndex(t => t.isEqualTo(e.pos));
-1 === t && (t = void 0), void 0 !== t && ((null == r ? void 0 : r.reverse) ? t <= l : t >= l) && (Ra.delete(Wi(e, Os)), 
l = void 0);
}
let p = ERR_NOT_FOUND;
if (void 0 === l && (p = ds(e, t, r)), p !== ERR_NOT_FOUND) {
const t = Ra.get(Wi(e, "_cpi"));
if (!(s && vs(e, s) || u && ys(wi(u, null != t ? t : 0, null == r ? void 0 : r.reverse), c))) return p;
void 0 !== t && (l = (null == r ? void 0 : r.reverse) ? t - 1 : t + 2, Ra.set(Wi(e, Os), l));
}
let m = ms(t, r);
return m ? (void 0 !== l && (m = wi(m, l, null == r ? void 0 : r.reverse)), 0 === m.length ? ERR_NO_PATH : ws(e, m, r)) : ERR_NO_PATH;
}, tc.moveTo = ws, tc.normalizeTargets = yi, tc.offsetRoomPosition = Ia, tc.packCoord = Wa, 
tc.packCoordList = Ya, tc.packPos = Ba, tc.packPosList = Va, tc.packRoomName = ri, 
tc.packRoomNames = ei, tc.posAtDirection = $a, tc.preTick = function() {
pi(), function() {
...
for (const o of Pi.values()) for (const n of o.values()) r.has(n) || (r.add(n), 
n.expires && n.expires < Game.time ? (null === (e = Pi.get(n.room1)) || void 0 === e || e.delete(n.room2), 
null === (t = Pi.get(n.room2)) || void 0 === t || t.delete(n.room1)) : Memory[ha.MEMORY_PORTAL_PATH].push(Li(n)));
}();
}();
...
var ic = Hr("ActionExecutor"), sc = "#ffaa00", cc = "#ffffff", lc = "#ff0000", uc = "#00ff00", pc = "#0000ff";
...
d = 0, h <= 1 ? d = 10 * y : h <= 2 ? d = 4 * y : h <= 3 && (d = 1 * y), ws(e.memory, d);
break;
...
var a;
}(n, e)) dc.info("State completed, evaluating new action", {
...
} else n && (dc.info("State invalid, re-evaluating behavior", {
room: e.creep.pos.roomName,
creep: e.creep.name,
meta: r({
action: n.action,
...
var Sc = Hr("HarvesterBehavior"), bc = Hr("HaulerBehavior"), wc = {
larvaWorker: Cc,
...
l = new Map;
try {
for (var y = n(c), h = y.next(); !h.done; h = y.next()) {
var g = h.value;
l.set(g.id, 0);
}
} catch (e) {
...
g = S.value;
var b = null !== (s = l.get(g.id)) && void 0 !== s ? s : 0;
b < T && (T = b, E = g);
}
} catch (e) {
o = {
...
if (a) return Sc.debug("".concat(e.creep.name, " harvester transferring to container ").concat(a.id)), 
{
type: "transfer",
target: a,
resourceType: RESOURCE_ENERGY
...
return i ? (Sc.debug("".concat(e.creep.name, " harvester transferring to link ").concat(i.id)), 
{
type: "transfer",
target: i,
resourceType: RESOURCE_ENERGY
...
var h = Si(e.creep, e.mineralContainers, "mineral_container");
if (h) {
...
try {
for (var E = n(f), T = E.next(); !T.done; T = E.next()) {
...
try {
for (var w = n(m), O = w.next(); !O.done; O = w.next()) {
var _ = O.value;
try {
for (var x = (c = void 0, n(b)), U = x.next(); !U.done; U = x.next()) {
var A = U.value;
...
try {
for (var d = n(f), y = d.next(); !y.done; y = d.next()) {
var h = y.value;
if (e.factory.store.getUsedCapacity(h) < 1e3 && c.store.getUsedCapacity(h) > 500) return {
type: "withdraw",
target: c,
resourceType: h
};
...
function Oc(e) {
var t;
return (null !== (t = wc[e.memory.role]) && void 0 !== t ? t : Cc)(e);
}
...
role: "hauler",
family: "economy",
bodies: [ Ac([ CARRY, CARRY, MOVE, MOVE ], 200), Ac([ CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 400), Ac([ CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 800), Ac(i(i([], a(Array(16).fill(CARRY)), !1), a(Array(16).fill(MOVE)), !1), 1600) ],
priority: 90,
maxPerRoom: 2,
remoteRole: !0
},
...
role: "remoteHauler",
family: "economy",
bodies: [ Ac([ CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE ], 400), Ac([ CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE ], 800), Ac(i(i([], a(Array(16).fill(CARRY)), !1), a(Array(16).fill(MOVE)), !1), 1600) ],
priority: 80,
maxPerRoom: 6,
remoteRole: !0
},
...
family: "economy",
bodies: [ Ac(i(i([], a(Array(4).fill(CARRY)), !1), a(Array(4).fill(MOVE)), !1), 400), Ac(i(i([], a(Array(8).fill(CARRY)), !1), a(Array(8).fill(MOVE)), !1), 800), Ac(i(i([], a(Array(12).fill(CARRY)), !1), a(Array(12).fill(MOVE)), !1), 1200), Ac(i(i([], a(Array(16).fill(CARRY)), !1), a(Array(16).fill(MOVE)), !1), 1600) ],
priority: 85,
maxPerRoom: 6,
remoteRole: !0
},
...
role: "powerCarrier",
family: "power",
bodies: [ Ac(i(i([], a(Array(20).fill(CARRY)), !1), a(Array(20).fill(MOVE)), !1), 2e3), Ac(i(i([], a(Array(25).fill(CARRY)), !1), a(Array(25).fill(MOVE)), !1), 2500) ],
priority: 25,
maxPerRoom: 2,
remoteRole: !0
}
...
function Mc(e) {
var t, r, o, a, i = xc(e.find(FIND_HOSTILE_CREEPS));
...
var s = 0, c = 0, l = 0, u = 0, p = 0, m = 0, f = 0, d = 0;
try {
for (var y = n(i), h = y.next(); !h.done; h = y.next()) {
var g = h.value, v = 0, R = 0, E = 0, T = 0;
try {
for (var C = (o = void 0, n(g.body)), S = C.next(); !S.done; S = C.next()) {
var b = S.value;
...
c += 30 * v + 10 * R, l += g.hits, g.body.some(function(e) {
return e.boost;
}) && (u++, s += 200), E > 0 && (p++, s += 100), R > 0 && m++, v > 0 && f++, T >= 5 && (d++, 
s += 150), s += 10 * (v + R);
}
} catch (e) {
t = {
...
var w, O = e.find(FIND_MY_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_TOWER;
}
}).reduce(function(e, t) {
...
return 0 === e ? 0 : e < Nc ? 1 : e < Ic ? 2 : 3;
}(s);
return w = s < 100 ? "monitor" : s < 500 && !_ ? "defend" : _ && s < 1e3 ? "assist" : s > 1e3 || u > 3 ? "safemode" : "defend", 
e.find(FIND_NUKES).length > 0 && (s += 500, w = "safemode", A = 3), {
roomName: e.name,
dangerLevel: A,
threatScore: s,
...
function Kc(e, t, o) {
var a, i, s, c, l, u, p, m, f, d, y, h, g, v, R, E, T;
void 0 === o && (o = {});
var C = r(r({}, Hc), o), S = Wc.get(e.name);
if (S && Game.time - S.lastCalculated < C.recalculateInterval) return S;
var b = new Set, w = null !== (E = null === (R = e.controller) || void 0 === R ? void 0 : R.level) && void 0 !== E ? E : 0, O = e.find(FIND_SOURCES), _ = e.controller, x = e.storage, U = e.find(FIND_MINERALS)[0], A = null !== (T = null == x ? void 0 : x.pos) && void 0 !== T ? T : t;
try {
for (var k = n(O), M = k.next(); !M.done; M = k.next()) {
...
try {
for (var L = n(N), D = L.next(); !D.done; D = L.next()) G = D.value, b.add("".concat(G.x, ",").concat(G.y));
} catch (e) {
l = {
error: e
};
...
try {
for (var F = n(N), B = F.next(); !B.done; B = F.next()) G = B.value, b.add("".concat(G.x, ",").concat(G.y));
} catch (e) {
p = {
error: e
};
...
if (!x) {
try {
for (var H = n(O), W = H.next(); !W.done; W = H.next()) {
...
try {
for (var j = n(N), V = j.next(); !V.done; V = j.next()) G = V.value, b.add("".concat(G.x, ",").concat(G.y));
} catch (e) {
g = {
error: e
};
...
return Wc.set(e.name, z), Kr.debug("Calculated road network for ".concat(e.name, ": ").concat(b.size, " positions"), {
...
function zc(e, t, o) {
var a, i, s, c, l, u, p, m, f;
void 0 === o && (o = {});
var d = r(r({}, Hc), o), y = new Map;
if (!d.includeRemoteRoads) return y;
var h = e.storage, g = e.find(FIND_MY_SPAWNS)[0], v = null !== (p = null == h ? void 0 : h.pos) && void 0 !== p ? p : null == g ? void 0 : g.pos;
if (!v) return y;
try {
...
var C = Yc(e.name, T);
if (!C) {
Kr.warn("Cannot determine exit direction from ".concat(e.name, " to ").concat(T), {
subsystem: "RoadNetwork"
});
continue;
}
var S = jc(e.name, C);
if (0 === S.length) {
Kr.warn("No valid exit positions found in ".concat(e.name, " towards ").concat(T), {
subsystem: "RoadNetwork"
});
continue;
}
...
if (!w.incomplete) try {
for (var O = (s = void 0, n(w.path)), _ = O.next(); !_.done; _ = O.next()) {
var x = _.value;
...
if (!A.incomplete) try {
for (var k = (l = void 0, n(A.path)), M = k.next(); !M.done; M = k.next()) x = M.value, 
...
var N = e instanceof Error ? e.message : String(e);
Kr.warn("Failed to calculate remote road to ".concat(T, ": ").concat(N), {
subsystem: "RoadNetwork"
});
}
}
...
for (var l = n(c), u = l.next(); !u.done; u = l.next()) {
var p = u.value;
p.structureType === STRUCTURE_ROAD ? s.set(p.pos.x, p.pos.y, 1) : p.structureType === STRUCTURE_CONTAINER || p.structureType === STRUCTURE_RAMPART && "my" in p && p.my || s.set(p.pos.x, p.pos.y, 255);
}
} catch (e) {
t = {
error: e
...
var b = Kc(e, t);
try {
for (var w = n(b.positions), O = w.next(); !O.done; O = w.next()) {
var _ = O.value;
g.add(_);
}
} catch (e) {
...
var x = e.storage, U = e.find(FIND_MY_SPAWNS)[0], A = null !== (h = null == x ? void 0 : x.pos) && void 0 !== h ? h : null == U ? void 0 : U.pos;
if (A) {
var k = function(e, t, o) {
var a, i, s, c;
void 0 === o && (o = {});
var l = r(r({}, Hc), o), u = new Set;
try {
for (var p = n([ "top", "bottom", "left", "right" ]), m = p.next(); !m.done; m = p.next()) {
var f = m.value;
try {
var d = jc(e.name, f);
...
if (h.incomplete) Kr.warn("Incomplete path when calculating exit road for ".concat(f, " in ").concat(e.name, " (target exit: ").concat(y.x, ",").concat(y.y, "). Path length: ").concat(h.path.length), {
subsystem: "RoadNetwork"
}); else try {
for (var g = (s = void 0, n(h.path)), v = g.next(); !v.done; v = g.next()) {
var R = v.value;
...
Kr.warn("Failed to calculate exit road for ".concat(f, " in ").concat(e.name, ": ").concat(E), {
subsystem: "RoadNetwork"
});
}
}
...
try {
for (var M = n(k), N = M.next(); !N.done; N = M.next()) _ = N.value, g.add(_);
} catch (e) {
u = {
error: e
};
...
if (a.length > 0) {
var I = zc(e, a).get(e.name);
if (I) try {
for (var P = n(I), G = P.next(); !G.done; G = P.next()) _ = G.value, g.add(_);
} catch (e) {
m = {
error: e
};
...
for (var u = n(c), p = u.next(); !p.done; p = u.next()) {
var m = p.value;
Qc(m.pos, t) && s.add("".concat(m.pos.x, ",").concat(m.pos.y));
}
} catch (e) {
r = {
error: e
...
for (var f = n(l), d = f.next(); !d.done; d = f.next()) {
var y = d.value;
Qc(y.pos, t) && s.add("".concat(y.pos.x, ",").concat(y.pos.y));
}
} catch (e) {
a = {
error: e
...
try {
for (var D = n(L), F = D.next(); !F.done; F = D.next()) _ = F.value, g.add(_);
} catch (e) {
d = {
error: e
};
...
var h = f[y];
if (h) {
var g = Game.map.getRoomLinearDistance(m.name, e), v = Game.time + 50 * g, R = {
creepName: h.name,
targetRoom: e,
assignedAt: Game.time,
eta: v
};
this.assignments.set(h.name, R), h.memory.assistTarget = e, l++, So.info("Assigned ".concat(t, " ").concat(h.name, " from ").concat(m.name, " to assist ").concat(e, " (ETA: ").concat(v - Game.time, " ticks)"), {
subsystem: "Defense"
});
}
}
...
l > 0 && So.info("Defense coordination: Assigned ".concat(l, "/").concat(r, " ").concat(t, "s to ").concat(e), {
subsystem: "Defense"
});
...
try {
for (var s = n(this.assignments.entries()), c = s.next(); !c.done; c = s.next()) {
var l = a(c.value, 2), u = l[0], p = l[1], m = Game.creeps[u];
m ? (m.room.name === p.targetRoom && 0 === xc(m.room.find(FIND_HOSTILE_CREEPS)).length && (delete m.memory.assistTarget, 
i.push(u), So.debug("Released ".concat(u, " from defense assistance (no hostiles in ").concat(p.targetRoom, ")"), {
subsystem: "Defense"
})), Game.time - p.assignedAt > 1e3 && (delete m.memory.assistTarget, i.push(u), 
So.debug("Removed stale defense assignment for ".concat(u), {
subsystem: "Defense"
}))) : i.push(u);
}
} catch (t) {
...
try {
for (var f = n(i), d = f.next(); !d.done; d = f.next()) u = d.value, this.assignments.delete(u);
} catch (e) {
r = {
error: e
};
...
var t = Game.creeps[e];
t && delete t.memory.assistTarget, this.assignments.delete(e), So.info("Cancelled defense assignment for ".concat(e), {
subsystem: "Defense"
});
}
}, o([ Kn("cluster:defense", "Defense Coordinator", {
priority: En.HIGH,
interval: 3,
minBucket: 0,
cpuBudget: .05
...
if (t.hostileCount > 3 * r.length) return So.info("Creep ".concat(e.name, " retreating: heavily outnumbered (").concat(t.hostileCount, " hostiles vs ").concat(r.length, " defenders)"), {
subsystem: "Defense",
room: e.room.name,
creep: e.name
}), !0;
...
return e.hits < .3 * e.hitsMax && t.healerCount > 0 && 0 === o.length ? (So.info("Creep ".concat(e.name, " retreating: damaged (").concat(e.hits, "/").concat(e.hitsMax, ") facing ").concat(t.healerCount, " enemy healers without friendly healer support"), {
subsystem: "Defense",
room: e.room.name,
creep: e.name
}), !0) : t.boostedCount > 0 && r.length < 2 * t.boostedCount && (So.info("Creep ".concat(e.name, " retreating: facing ").concat(t.boostedCount, " boosted hostiles without sufficient support"), {
subsystem: "Defense",
room: e.room.name,
creep: e.name
}), !0);
...
try {
for (var f = n(Object.entries(u)), d = f.next(); !d.done; d = f.next()) {
var y = a(d.value, 2), h = y[0], g = y[1], v = Number(h), R = Game.rooms[g];
if (null === (s = null == R ? void 0 : R.controller) || void 0 === s ? void 0 : s.my) {
var E = p[v];
if (E) {
var T = e.room.find(E);
T.length > 0 && m.push.apply(m, i([], a(T), !1));
}
}
}
} catch (e) {
...
try {
for (var h = n(u), g = h.next(); !g.done; g = h.next()) {
...
Kr.info("Defender analysis for ".concat(e.name, ": ").concat(c.guards, " guards, ").concat(c.rangers, " rangers, ").concat(c.healers, " healers (urgency: ").concat(c.urgency, "x) - ").concat(c.reasons.join(", ")), {
subsystem: "Defense"
}), c;
}
...
return n !== Jc.NONE || o ? (o ? (r = o).level = n : (r = {
level: n,
startedAt: Game.time,
assistanceRequested: !1,
boostsAllocated: !1,
lastEscalation: 0
}, this.emergencyStates.set(e.name, r)), n === Jc.NONE ? (o && (So.info("Emergency resolved in ".concat(e.name), {
subsystem: "Defense"
}), this.emergencyStates.delete(e.name)), r) : (o && n > o.level && (So.warn("Emergency escalated in ".concat(e.name, ": Level ").concat(o.level, " → ").concat(n), {
subsystem: "Defense"
...
}).length > 0) return Jc.CRITICAL;
var a = r.filter(function(e) {
return e.body.some(function(e) {
return e.boost;
});
}), i = o.guards - n.guards + (o.rangers - n.rangers);
return a.length > 0 && i >= 2 || r.length >= 5 && 0 === n.guards && 0 === n.rangers ? Jc.HIGH : t.danger >= 2 && i >= 1 ? Jc.MEDIUM : t.danger >= 1 ? Jc.LOW : Jc.NONE;
}, e.prototype.executeEmergencyResponse = function(e, t, r) {
r.level !== Jc.HIGH && r.level !== Jc.CRITICAL || r.assistanceRequested || this.requestDefenseAssistance(e, t) && (r.assistanceRequested = !0), 
r.level >= Jc.MEDIUM && !r.boostsAllocated && e.controller && e.controller.level >= 6 && (this.allocateBoostsForDefense(e, t), 
...
return Kr.warn("Defense assistance requested for ".concat(e.name, ": ").concat(n.guardsNeeded, " guards, ").concat(n.rangersNeeded, " rangers, ").concat(n.healersNeeded, " healers - ").concat(n.threat), {
subsystem: "Defense"
}), n;
}(e, t);
if (!o) return !1;
...
return a.push(o), n.defenseRequests = a, So.warn("Defense assistance requested for ".concat(e.name, ": ") + "".concat(o.guardsNeeded, " guards, ").concat(o.rangersNeeded, " rangers - ").concat(o.threat), {
subsystem: "Defense"
}), !0;
}, e.prototype.allocateBoostsForDefense = function(e, t) {
var r, o = Memory, n = null !== (r = o.boostDefensePriority) && void 0 !== r ? r : {};
n[e.name] = !0, o.boostDefensePriority = n, So.info("Allocated boost priority for defenders in ".concat(e.name), {
subsystem: "Defense"
});
...
So.warn("".concat(e.name, " posture: CRITICAL DEFENSE"), {
subsystem: "Defense"
}));
break;
...
t.pheromones.war = 40, So.info("".concat(e.name, " posture: HIGH DEFENSE"), {
subsystem: "Defense"
}));
break;
...
So.info("".concat(e.name, " posture: MEDIUM DEFENSE"), {
subsystem: "Defense"
}));
break;

case Jc.LOW:
"eco" !== t.posture && "expand" !== t.posture || (t.pheromones.defense = 30, So.debug("".concat(e.name, ": LOW DEFENSE alert"), {
subsystem: "Defense"
}));
}
...
if (s === OK) So.warn("SAFE MODE ACTIVATED in ".concat(e.name), {
subsystem: "Defense"
}); else {
var c = void 0 !== s ? String(s) : "undefined";
So.error("Failed to activate safe mode in ".concat(e.name, ": ").concat(c), {
subsystem: "Defense"
});
}
}
...
for (var i = n(a), s = i.next(); !s.done; s = i.next()) {
var c = s.value;
if (c.hits < .2 * c.hitsMax) return So.warn("Spawn ".concat(c.name, " critical: ").concat(c.hits, "/").concat(c.hitsMax), {
subsystem: "Defense"
}), !0;
}
} catch (e) {
...
if (e.storage && e.storage.hits < .2 * e.storage.hitsMax) return So.warn("Storage critical: ".concat(e.storage.hits, "/").concat(e.storage.hitsMax), {
subsystem: "Defense"
}), !0;
if (e.terminal && e.terminal.hits < .2 * e.terminal.hitsMax) return So.warn("Terminal critical: ".concat(e.terminal.hits, "/").concat(e.terminal.hitsMax), {
subsystem: "Defense"
}), !0;
...
if (l.length > 3 * u.length) return So.warn("Overwhelmed: ".concat(l.length, " hostiles vs ").concat(u.length, " defenders"), {
subsystem: "Defense"
}), !0;
...
return p.length > 0 && u.length < 2 * p.length && (So.warn("Boosted hostiles detected: ".concat(p.length), {
subsystem: "Defense"
}), !0);
}, e;
}(), cl = new sl, ll = {
...
this.transfersThisTick = 0, this.config = r(r({}, ll), e);
}
return e.prototype.run = function() {
var e, t, r, o;
...
var l = s.length;
So.warn("Triggering evacuation for ".concat(n, ": ").concat(l, " nuke(s) detected, impact in ").concat(null !== (r = c.timeToLand) && void 0 !== r ? r : 0, " ticks"), {
...
if (!a) return So.error("Cannot evacuate ".concat(e, ": no valid target room found"), {
subsystem: "Evacuation"
}), !1;
var i = {
roomName: e,
...
var s = gn.getSwarmState(e);
return s && (s.posture = "evacuate"), So.warn("Starting evacuation of ".concat(e, " (").concat(t, "), target: ").concat(a) + (r ? ", deadline: ".concat(r - Game.time, " ticks") : ""), {
subsystem: "Evacuation"
}), !0;
...
if (!t) return e.complete = !0, void So.error("Lost room ".concat(e.roomName, " during evacuation"), {
subsystem: "Evacuation"
});
...
So.info("Evacuation of ".concat(e.roomName, " complete: ") + "".concat(e.resourcesEvacuated.reduce(function(e, t) {
return e + t.amount;
}, 0), " resources, ") + "".concat(e.creepsRecalled.length, " creeps"), {
subsystem: "Evacuation"
})), e.deadline && Game.time >= e.deadline && (e.complete = !0, So.warn("Evacuation of ".concat(e.roomName, " reached deadline"), {
subsystem: "Evacuation"
}));
...
try {
for (var m = n(this.config.priorityResources), f = m.next(); !f.done; f = m.next()) {
var d = f.value;
if (!((R = c.store.getUsedCapacity(d)) <= 0 || (E = l.store.getFreeCapacity(d)) <= 0)) {
var y = p(R), h = c.store.getUsedCapacity(RESOURCE_ENERGY);
if (!(d !== RESOURCE_ENERGY && y > h || (T = Math.min(R, E, 5e4)) <= 0 || c.send(d, T, e.targetRoom) !== OK)) return e.resourcesEvacuated.push({
resourceType: d,
amount: T
}), this.transfersThisTick++, void So.debug("Evacuated ".concat(T, " ").concat(d, " from ").concat(t.name, " to ").concat(e.targetRoom), {
subsystem: "Evacuation"
});
}
}
...
try {
for (var g = n(Object.keys(c.store)), v = g.next(); !v.done; v = g.next()) {
var R, E, T;
if (!(d = v.value, this.config.priorityResources.includes(d) || (R = c.store.getUsedCapacity(d)) <= 0 || (E = l.store.getFreeCapacity(d)) <= 0 || (y = p(R), 
h = c.store.getUsedCapacity(RESOURCE_ENERGY), d !== RESOURCE_ENERGY && y > h || (T = Math.min(R, E, 5e4)) <= 0 || c.send(d, T, e.targetRoom) !== OK))) return e.resourcesEvacuated.push({
resourceType: d,
amount: T
...
var u = gn.getSwarmState(e);
u && (u.posture = "eco"), So.info("Evacuation of ".concat(e, " cancelled"), {
subsystem: "Evacuation"
});
}
...
}, o([ Kn("cluster:evacuation", "Evacuation Manager", {
priority: En.HIGH,
interval: 5,
minBucket: 0,
cpuBudget: .02
}) ], e.prototype, "run", null), o([ Vn() ], e);
}(), pl = new ul, ml = Hr("MilitaryBehaviors"), fl = "patrol";

function dl(e) {
var t, r, o = e.find(FIND_MY_SPAWNS), a = o.length, i = e.name, s = Bi.get(i, {
namespace: fl
});
...
var c = e.name, l = [];
try {
for (var u = n(o), p = u.next(); !p.done; p = u.next()) {
var m = p.value;
...
var r = hl(e);
if (r) {
var o = e.creep.pos.getRangeTo(r), n = gl(e.creep, RANGED_ATTACK), a = gl(e.creep, ATTACK);
return n && o <= 3 ? {
type: "rangedAttack",
target: r
} : a && o <= 1 ? {
...
var i = hl(e);
if (i) return o = e.creep.pos.getRangeTo(i), n = gl(e.creep, RANGED_ATTACK), a = gl(e.creep, ATTACK), 
n && o <= 3 ? {
type: "rangedAttack",
target: i
} : a && o <= 1 ? {
...
var a = hl(e);
if (a) {
var i = e.creep.pos.getRangeTo(a), s = gl(e.creep, RANGED_ATTACK), c = gl(e.creep, ATTACK);
return s && i <= 3 ? {
type: "rangedAttack",
target: a
} : c && i <= 1 ? {
...
var l = hi(e.creep.pos, FIND_HOSTILE_STRUCTURES, {
filter: function(e) {
...
var a = hi(e.creep.pos, FIND_HOSTILE_SPAWNS);
if (a) return {
type: "dismantle",
target: a
};
var i = hi(e.creep.pos, FIND_HOSTILE_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_TOWER;
}
});
...
if (i) {
var s = e.creep.pos.getRangeTo(i), c = gl(e.creep, RANGED_ATTACK), l = gl(e.creep, ATTACK);
return c && s <= 3 ? {
type: "rangedAttack",
target: i
} : l && s <= 1 ? {
...
function _l(e) {
var t;
return (null !== (t = Ol[e.memory.role]) && void 0 !== t ? t : El)(e);
}
...
for (var d = e.find(FIND_SOURCES), y = e.find(FIND_MINERALS)[0], h = e.controller, g = yi(e, FIND_HOSTILE_CREEPS), v = e.getTerrain(), R = 0, E = 0, T = 5; T < 50; T += 10) for (var C = 5; C < 50; C += 10) {
var S = v.get(T, C);
S === TERRAIN_MASK_SWAMP ? R++ : 0 === S && E++;
}
var b = R > 2 * E ? "swamp" : E > 2 * R ? "plains" : "mixed", w = e.name.match(/^[WE](\d+)[NS](\d+)$/), O = !!w && (parseInt(w[1], 10) % 10 == 0 || parseInt(w[2], 10) % 10 == 0), _ = e.find(FIND_STRUCTURES, {
filter: function(e) {
...
(null === (s = null == h ? void 0 : h.owner) || void 0 === s ? void 0 : s.username) && (x.owner = h.owner.username), 
(null === (c = null == h ? void 0 : h.reservation) || void 0 === c ? void 0 : c.username) && (x.reserver = h.reservation.username), 
...
if (!o) {
if (o = function(e, t, r) {
var o, i, s, c, l, u = t.knownRooms, p = Game.map.describeExits(e);
if (p) {
var m = [];
try {
for (var f = n(Object.entries(p)), d = f.next(); !d.done; d = f.next()) {
var y = a(d.value, 2)[1];
if (!r || y !== r) {
var h = null !== (c = null === (s = u[y]) || void 0 === s ? void 0 : s.lastSeen) && void 0 !== c ? c : 0;
Game.time - h > 1e3 && m.push({
room: y,
lastSeen: h
});
}
...
return i ? e.creep.pos.getRangeTo(i) <= 3 ? (Ml(e.room, t), e.memory.lastExploredRoom = e.room.name, 
delete e.memory.targetRoom, {
type: "idle"
}) : {
type: "moveTo",
...
function Gl(e) {
var t;
return (null !== (t = Pl[e.memory.role]) && void 0 !== t ? t : Il)(e);
}
...
var t, r, o;
if (!e.room) return null;
var a = e.room, i = null !== (o = e.memory.homeRoom) && void 0 !== o ? o : a.name, s = Qi(a, STRUCTURE_LAB), c = Qi(a, STRUCTURE_SPAWN), l = Qi(a, STRUCTURE_EXTENSION), u = Qi(a, STRUCTURE_FACTORY)[0], p = Qi(a, STRUCTURE_POWER_SPAWN)[0], m = [];
try {
for (var f = n(Object.keys(e.powers)), d = f.next(); !d.done; d = f.next()) {
...
var o = e.availablePowers, s = yi(e.room, FIND_HOSTILE_CREEPS), c = yi(e.room, FIND_HOSTILE_STRUCTURES);
...
var l = qi(e.room, FIND_MY_CREEPS, {
filter: function(e) {
...
var f = i(i([], a(e.spawns), !1), [ e.storage, e.terminal ], !1).filter(function(e) {
return void 0 !== e;
});
try {
for (var d = n(f), y = d.next(); !y.done; y = d.next()) {
...
var n = gn.getCluster(t.clusterId);
...
function Hl(e, t, r, o) {
var a, i, s, c, l, u, p = (s = t, l = (c = function(e) {
var t = e.match(/^([WE])(\d+)([NS])(\d+)$/);
return t ? {
...
try {
for (var y = n(Bl), h = y.next(); !h.done; h = y.next()) {
var g = h.value;
if (!(g.cost <= o)) break;
d = g;
}
...
return Kr.debug("Remote hauler calculation: ".concat(e, " -> ").concat(t, " (").concat(r, " sources, ").concat(p, " rooms away) - RT: ").concat(m, " ticks, E/tick: ").concat(f, ", Min: ").concat(R, ", Rec: ").concat(E, ", Cap: ").concat(d.capacity), {
...
if (f < ("remoteHarvester" === t ? d ? Xi(d).length : 2 : "remoteHauler" === t && d ? Hl(e, m, Xi(d).length, null !== (c = null === (s = Game.rooms[e]) || void 0 === s ? void 0 : s.energyCapacityAvailable) && void 0 !== c ? c : 800).recommendedHaulers : 2)) return m;
}
} catch (e) {
o = {
error: e
...
var u = 1 / 0, p = [];
try {
for (var m = n(l), f = m.next(); !f.done; f = m.next()) {
...
var h = p.length > 1 ? p[Game.time % p.length] : p[0];
...
if ("remoteHarvester" === t || "remoteHauler" === t) return null !== zl(e, t, r);
if ("remoteWorker" === t) {
...
return p < u.maxPerRoom;
}
if ("remoteGuard" === t) {
var m;
if (0 === (m = null !== (c = r.remoteAssignments) && void 0 !== c ? c : []).length) return !1;
try {
for (var f = n(m), d = f.next(); !d.done; d = f.next()) {
var y = d.value, h = Game.rooms[y];
if (h) {
var g = qi(h, FIND_HOSTILE_CREEPS).filter(function(e) {
return e.body.some(function(e) {
return e.type === ATTACK || e.type === RANGED_ATTACK || e.type === WORK;
});
});
if (g.length > 0 && Vl(e, t, y) < Math.min(u.maxPerRoom, Math.ceil(g.length / 2))) return !0;
}
}
} catch (e) {
a = {
...
var v = null !== (l = jl(e).get(t)) && void 0 !== l ? l : 0, R = u.maxPerRoom;
if ("upgrader" === t && r.clusterId && (null == (x = gn.getCluster(r.clusterId)) ? void 0 : x.focusRoom) === e) {
var E = Game.rooms[e];
...
if ("claimer" === t) {
var C = gn.getEmpire(), S = Object.values(Game.rooms).filter(function(e) {
var t;
return null === (t = e.controller) || void 0 === t ? void 0 : t.my;
}), b = S.length < Game.gcl.level, w = C.claimQueue.some(function(e) {
return !e.claimed;
}), O = function(e, t) {
...
var o = (null === (i = r.reservation) || void 0 === i ? void 0 : i.username) === p, n = null !== (c = null === (s = r.reservation) || void 0 === s ? void 0 : s.ticksToEnd) && void 0 !== c ? c : 0;
...
var x;
if (!(x = gn.getCluster(r.clusterId)) || !x.resourceRequests || 0 === x.resourceRequests.length) return !1;
...
function tu(e, t) {
var r, o, i, s, c, l, u = Qi(e, STRUCTURE_SPAWN).find(function(e) {
return !e.spawning;
});
if (u) {
var p = e.energyCapacityAvailable, m = e.energyAvailable, f = 0 === Ql(jl(e.name, !0)), d = f ? m : p;
if (f && m < 150 && (Kr.warn("WORKFORCE COLLAPSE: ".concat(m, " energy available, need 150 to spawn minimal larvaWorker. ") + "Room will recover once energy reaches 150.", {
subsystem: "spawn",
room: e.name
}), Fn.emit("spawn.emergency", {
roomName: e.name,
energyAvailable: m,
message: "Critical workforce collapse - waiting for energy to spawn minimal creep",
source: "SpawnManager"
})), Jl(e.name, e) && Game.time % 10 == 0) {
var y = jl(e.name, !0), h = jl(e.name, !1), g = null !== (i = y.get("larvaWorker")) && void 0 !== i ? i : 0, v = null !== (s = y.get("harvester")) && void 0 !== s ? s : 0;
Kr.info("BOOTSTRAP MODE: ".concat(Ql(y), " active energy producers ") + "(".concat(g, " larva, ").concat(v, " harvest), ").concat(Ql(h), " total. ") + "Energy: ".concat(m, "/").concat(p), {
subsystem: "spawn",
room: e.name
});
}
...
var o, a, i;
if (0 === Ql(jl(e, !0))) return Kr.info("Bootstrap: Spawning larvaWorker (emergency - no active energy producers)", {
subsystem: "spawn",
room: e
}), "larvaWorker";
var s = jl(e, !1), c = Zl(t);
Kr.info("Bootstrap: Checking ".concat(c.length, " roles in order"), {
subsystem: "spawn",
room: e,
meta: {
totalCreeps: s.size,
...
var m = null !== (i = s.get(p.role)) && void 0 !== i ? i : 0;
if (m < p.minCount) {
var f = Xl(e, p.role, r, !0);
if (Kr.info("Bootstrap: Role ".concat(p.role, " needs spawning (current: ").concat(m, ", min: ").concat(p.minCount, ", needsRole: ").concat(f, ")"), {
subsystem: "spawn",
room: e
}), f) return p.role;
Kr.warn("Bootstrap: Role ".concat(p.role, " blocked by needsRole check (current: ").concat(m, "/").concat(p.minCount, ")"), {
subsystem: "spawn",
room: e
});
}
} else Kr.info("Bootstrap: Skipping ".concat(p.role, " (condition not met)"), {
subsystem: "spawn",
room: e
});
}
...
return Kr.info("Bootstrap: No role needs spawning", {
subsystem: "spawn",
room: e
}), null;
}(e.name, e, t);
...
if (!(_ = kc[R])) return;
var E = $l(_, d);
if (E && m >= E.cost) ; else if (!(E = $l(_, m))) return void Kr.info("Bootstrap: No affordable body for ".concat(R, " (available: ").concat(m, ", min needed: ").concat(null !== (l = null === (c = _.bodies[0]) || void 0 === c ? void 0 : c.cost) && void 0 !== l ? l : "unknown", ")"), {
subsystem: "spawn",
room: e.name
});
var T = eu(R);
...
return void Kr.error("EXCEPTION during spawn attempt for ".concat(R, ": ").concat(t), {
subsystem: "spawn",
room: e.name,
meta: {
error: String(t),
...
if (C === OK) Kr.info("BOOTSTRAP SPAWN: ".concat(R, " (").concat(T, ") with ").concat(E.parts.length, " parts, cost ").concat(E.cost, ". Recovery in progress."), {
subsystem: "spawn",
room: e.name
}), Fn.emit("spawn.completed", {
roomName: e.name,
creepName: T,
role: R,
cost: E.cost,
...
Kr.warn("BOOTSTRAP SPAWN FAILED: ".concat(R, " (").concat(T, ") - ").concat(S, ". Body: ").concat(E.parts.length, " parts, cost: ").concat(E.cost, ", available: ").concat(m), {
subsystem: "spawn",
room: e.name,
meta: {
errorCode: C,
...
var b = function(e, t) {
var r, o, i, s, c = jl(e.name), l = function(e) {
switch (e) {
case "eco":
return {
harvester: 1.5,
...
try {
for (var p = n(Object.entries(kc)), m = p.next(); !m.done; m = p.next()) {
var f = a(m.value, 2), d = f[0], y = f[1];
if (Xl(e.name, d, t)) {
var h = y.priority, g = null !== (i = l[d]) && void 0 !== i ? i : .5, v = Fl(d, t.pheromones), R = Dl(e, t, d), E = null !== (s = c.get(d)) && void 0 !== s ? s : 0, T = (h + R) * g * v * (y.maxPerRoom > 0 ? Math.max(.1, 1 - E / y.maxPerRoom) : .1);
u.push({
role: d,
score: T
});
...
var A = gn.getCluster(t.clusterId);
if (A) {
...
memory: x
})) === OK) return void Fn.emit("spawn.completed", {
roomName: e.name,
creepName: T,
role: R,
cost: U.cost,
...
void Kr.warn("Spawn failed for ".concat(R, ": ").concat(S, ". Body: ").concat(U.parts.length, " parts, cost: ").concat(U.cost), {
subsystem: "spawn",
room: e.name,
meta: {
errorCode: C,
...
b.length > 0 && Game.time % 20 == 0 ? Kr.info("Waiting for energy: ".concat(b.length, " roles need spawning, waiting for optimal bodies. ") + "Energy: ".concat(m, "/").concat(p), {
subsystem: "spawn",
room: e.name,
meta: {
...
}) : 0 === b.length && Game.time % 100 == 0 && Kr.info("No spawns needed: All roles fully staffed. Energy: ".concat(m, "/").concat(p), {
subsystem: "spawn",
room: e.name,
meta: {
energyAvailable: m,
...
var au, iu, su, cu, lu, uu, pu, mu, fu, du, yu, hu, gu, vu = function() {
function e(e) {
void 0 === e && (e = {}), this.config = r(r({}, nu), e);
}
return e.prototype.run = function() {
var e, t;
...
var s, c, l, u, p = this, m = t.filter(function(e) {
...
if (0 !== m.length) {
var f = i(i([], a(r), !1), a(o), !1).filter(function(e) {
return e.link.store.getFreeCapacity(RESOURCE_ENERGY) > p.config.transferThreshold;
}).sort(function(e, t) {
return t.priority - e.priority;
});
if (0 !== f.length) try {
for (var d = n(m), y = d.next(); !y.done; y = d.next()) {
var h = y.value;
if (!(h.link.cooldown > 0)) {
var g = null;
try {
for (var v = (l = void 0, n(f)), R = v.next(); !R.done; R = v.next()) {
var E = R.value;
...
if (E.role !== ru.STORAGE) !g && E.link.store.getFreeCapacity(RESOURCE_ENERGY) > this.config.transferThreshold && (g = E); else if (E.link.store.getUsedCapacity(RESOURCE_ENERGY) < this.config.storageLinkReserve) {
g = E;
break;
}
}
...
if (g) {
var T = h.link.store.getUsedCapacity(RESOURCE_ENERGY), C = h.link.transferEnergy(g.link, T);
C === OK ? So.debug("Link transfer: ".concat(T, " energy from ").concat(h.link.pos, " to ").concat(g.link.pos, " (").concat(g.role, ")"), {
subsystem: "Link",
room: e.name
}) : C !== ERR_TIRED && C !== ERR_FULL && So.warn("Link transfer failed: ".concat(C, " from ").concat(h.link.pos, " to ").concat(g.link.pos), {
subsystem: "Link",
room: e.name
});
}
...
if (a && e.pos.getRangeTo(a) <= 2) return ru.CONTROLLER;
if (i && e.pos.getRangeTo(i) <= 2) return ru.STORAGE;
try {
for (var c = n(s), l = c.next(); !l.done; l = c.next()) {
var u = l.value;
...
return n && a;
}, o([ Kn("link:manager", "Link Manager", {
priority: En.MEDIUM,
interval: 5,
minBucket: 0,
cpuBudget: .05
...
function e(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = r(r({}, Eu), e);
}
return e.prototype.run = function() {
...
r.market.lastScan = Game.time, So.debug("Updated market prices for ".concat(this.config.trackedResources.length, " resources"), {
subsystem: "Market"
});
}
...
var t;
return null === (t = gn.getEmpire().market) || void 0 === t ? void 0 : t.resources[e];
...
for (var t in e) {
var r = e[t];
Game.time - r.created > 1e4 && (Game.market.cancelOrder(t), So.info("Cancelled old order: ".concat(r.type, " ").concat(r.resourceType), {
subsystem: "Market"
})), r.remainingAmount < 100 && Game.market.cancelOrder(t);
}
}, e.prototype.updateBuyOrders = function() {
var e, t, r, o = gn.getEmpire().objectives.warMode, n = {};
...
o || u ? this.createBuyOrder(s, c - l, o, u) : So.debug("Skipping buy for ".concat(s, ": waiting for better price"), {
subsystem: "Market"
});
}
}
...
So.info("Created buy order: ".concat(t, " ").concat(e, " at ").concat(i.toFixed(3), " credits").concat(u), {
subsystem: "Market"
});
}
}
...
if (!(null == n ? void 0 : n.terminal) || !(null === (o = n.controller) || void 0 === o ? void 0 : o.my)) return So.warn("Cannot sell from ".concat(e, ": no terminal or not owned"), {
subsystem: "Market"
}), !1;
var a = n.terminal.store.getUsedCapacity(t);
if (a < r) return So.debug("Cannot sell ".concat(r, " ").concat(t, " from ").concat(e, ": only ").concat(a, " available"), {
subsystem: "Market"
}), !1;
var i = gn.getEmpire();
...
return u === OK ? (So.info("Created surplus sell order: ".concat(r, " ").concat(t, " from ").concat(e, " at ").concat(c.toFixed(3), " credits/unit"), {
subsystem: "Market"
}), !0) : (So.warn("Failed to create sell order: ".concat(u, " for ").concat(r, " ").concat(t, " from ").concat(e), {
subsystem: "Market"
}), !1);
...
l ? this.createSellOrder(i, c - s, l) : So.debug("Holding ".concat(i, " surplus: waiting for better price"), {
subsystem: "Market"
});
}
}
...
var l = r ? " (HIGH PRICE!)" : "";
So.info("Created sell order: ".concat(t, " ").concat(e, " at ").concat(a.toFixed(3), " credits").concat(l), {
subsystem: "Market"
});
}
}
...
So.info("Order completed: ".concat(a.resource, " ").concat(a.type, " - Traded: ").concat(a.totalTraded, ", Value: ").concat(a.totalValue.toFixed(0), ", Profit: ").concat(l.toFixed(0)), {
subsystem: "Market"
});
}
...
var e, t;
if (Game.time % 50 == 0 && gn.getEmpire().objectives.warMode) {
...
Game.market.deal(c.id, u, l.name) === OK && So.info("Bought ".concat(u, " ").concat(i, " for ").concat(c.price.toFixed(3), " credits/unit"), {
subsystem: "Market"
});
}
}
...
try {
for (var u = n(this.config.criticalResources), p = u.next(); !p.done; p = u.next()) {
var m = null !== (a = i[l = p.value]) && void 0 !== a ? a : 0;
...
Game.market.deal(n.id, a, o.name) === OK && So.warn("EMERGENCY BUY: ".concat(a, " ").concat(e, " at ").concat(n.price.toFixed(3), " credits/unit"), {
subsystem: "Market"
});
}
}
...
So.debug("Extended buy order for ".concat(r.resourceType, ": +").concat(r.remainingAmount, " at ").concat(r.price.toFixed(3)), {
subsystem: "Market"
}));
}
...
So.debug("Extended sell order for ".concat(r.resourceType, ": +").concat(r.remainingAmount, " at ").concat(r.price.toFixed(3)), {
subsystem: "Market"
})));
}
}
...
var e, t, r, o, a, i, s, c = gn.getEmpire().market;
if ((null == c ? void 0 : c.pendingArbitrage) && 0 !== c.pendingArbitrage.length) {
var l = [];
try {
for (var u = n(c.pendingArbitrage), p = u.next(); !p.done; p = u.next()) {
...
var h = !1;
if (m.sellOrderId) {
var g = Game.market.getOrderById(m.sellOrderId);
if (g && g.remainingAmount > 0 && g.roomName) {
var v = Math.min(m.amount, g.remainingAmount, y), R = Game.market.calcTransactionCost(v, d.room.name, g.roomName);
if (d.store[RESOURCE_ENERGY] >= R && Game.market.deal(g.id, v, d.room.name) === OK) {
var E = (g.price - m.buyPrice) * v;
...
So.info("Arbitrage complete: sold ".concat(v, " ").concat(m.resource, " from ").concat(d.room.name, " at ").concat(g.price.toFixed(3), ", profit ").concat(E.toFixed(2)), {
subsystem: "Market"
}), h = !0;
}
}
...
}) === OK && (So.info("Arbitrage posted sell order: ".concat(m.amount, " ").concat(m.resource, " at ").concat(m.targetSellPrice.toFixed(3), " from ").concat(d.room.name), {
subsystem: "Market"
}), h = !0), h || l.push(m);
}
} else l.push(m);
...
var s = gn.getEmpire().market, c = Object.values(Game.rooms).filter(function(e) {
var t;
return e.terminal && (null === (t = e.controller) || void 0 === t ? void 0 : t.my);
});
if (s && 0 !== c.length) {
...
var h = Math.min(l(d), l(y), 5e3);
if (h <= 0) return "continue";
try {
for (var g = (t = void 0, n(c)), v = g.next(); !v.done; v = g.next()) {
var R = v.value, E = R.terminal;
if (!((null !== (o = E.store.getFreeCapacity(e)) && void 0 !== o ? o : 0) < h)) {
var T = Game.market.calcTransactionCost(h, R.name, y.roomName), C = (T + Game.market.calcTransactionCost(h, R.name, d.roomName)) / h, S = d.price - y.price - C;
if (!(S <= 0 || C / y.price > p.config.maxTransportCostRatio || E.store[RESOURCE_ENERGY] < T)) {
var b = y.price * h;
if (!(Game.market.credits - b < p.config.minCredits) && Game.market.deal(y.id, h, R.name) === OK) {
var w = {
...
null === (i = s.pendingArbitrage) || void 0 === i || i.push(w), So.info("Arbitrage started: bought ".concat(h, " ").concat(e, " at ").concat(y.price.toFixed(3), " to sell @ ").concat(d.price.toFixed(3), " (profit/unit ~").concat(S.toFixed(2), ")"), {
subsystem: "Market"
});
break;
}
...
try {
for (var m = n(this.config.trackedResources), f = m.next(); !f.done; f = m.next()) u(f.value);
} catch (t) {
e = {
error: t
};
...
var l = c.value, u = [];
try {
for (var p = (r = void 0, n(i)), m = p.next(); !m.done; m = p.next()) {
var f = m.value;
if (f.terminal) {
var d = null !== (a = f.terminal.store[l]) && void 0 !== a ? a : 0;
u.push({
room: f,
amount: d
});
...
var h = u[0], g = u[u.length - 1], v = h.amount - g.amount;
if (v > .5 * y && h.amount > 5e3 && h.room.terminal && g.room.terminal) {
var R = Math.min(Math.floor(v / 2), 1e4), E = Game.market.calcTransactionCost(R, h.room.name, g.room.name);
(l === RESOURCE_ENERGY && E < .1 * R || l !== RESOURCE_ENERGY && E < 1e3) && h.room.terminal.send(l, R, g.room.name) === OK && So.info("Balanced ".concat(R, " ").concat(l, ": ").concat(h.room.name, " -> ").concat(g.room.name, " (cost: ").concat(E, " energy)"), {
subsystem: "Market"
});
}
}
...
}, o([ Yn("empire:market", "Market Manager", {
priority: En.LOW,
interval: 100,
minBucket: 0,
cpuBudget: .02
...
var o, a, i, s, c, l, u, p, m, f = this.calculateTransferCost(r, e, t), d = {
path: [ e, t ],
cost: f,
isDirect: !0
}, y = this.buildTerminalGraph();
if (y.length < 3) return d;
var h = new Map, g = new Map, v = new Set;
try {
for (var R = n(y), E = R.next(); !E.done; E = R.next()) {
var T = E.value;
h.set(T.roomName, 1 / 0), v.add(T.roomName);
}
} catch (e) {
o = {
error: e
...
for (h.set(e, 0); v.size > 0; ) {
var C = null, S = 1 / 0;
try {
for (var b = (i = void 0, n(v)), w = b.next(); !w.done; w = b.next()) {
var O = w.value, _ = null !== (u = h.get(O)) && void 0 !== u ? u : 1 / 0;
_ < S && (S = _, C = O);
}
} catch (e) {
i = {
...
if (!C || S === 1 / 0) break;
if (C === t) break;
if (v.delete(C), !(this.getPathLength(C, g) >= this.MAX_HOPS)) try {
for (var x = (c = void 0, n(y)), U = x.next(); !U.done; U = x.next()) {
var A = U.value;
if (v.has(A.roomName) && A.roomName !== C) {
var k = this.calculateTransferCost(r, C, A.roomName), M = (null !== (p = h.get(C)) && void 0 !== p ? p : 1 / 0) + k;
M < (null !== (m = h.get(A.roomName)) && void 0 !== m ? m : 1 / 0) && (h.set(A.roomName, M), 
g.set(A.roomName, C));
}
}
} catch (e) {
...
var N = h.get(t);
if (void 0 !== N && N < f) {
var I = this.reconstructPath(t, g);
I.length > 0 && I[0] === e && (d = {
path: I,
cost: N,
isDirect: !1
}, So.debug("Multi-hop route found: ".concat(I.join(" -> "), " (cost: ").concat(N, " vs direct: ").concat(f, ")"), {
...
function e(e) {
void 0 === e && (e = {}), this.transferQueue = [], this.config = r(r({}, wu), e);
}
...
})) return So.debug("Transfer already queued: ".concat(o, " ").concat(r, " from ").concat(e, " to ").concat(t), {
subsystem: "Terminal"
}), !1;
...
amount: o,
priority: n
}), So.info("Queued transfer request: ".concat(o, " ").concat(r, " from ").concat(e, " to ").concat(t, " (priority: ").concat(n, ")"), {
subsystem: "Terminal"
}), !0) : (So.warn("Cannot queue transfer: rooms or terminals not available", {
subsystem: "Terminal"
}), !1);
}, e.prototype.run = function() {
if (!(Game.cpu.bucket < this.config.minBucket)) {
...
route: p,
isEmergency: !0
}), So.warn("Emergency energy transfer queued: ".concat(c.config.emergencyEnergyAmount, " from ").concat(u.name, " to ").concat(t.name, " (danger: ").concat(r.danger, ")"), {
subsystem: "Terminal"
}));
}
}
...
u >= this.config.capacityWarningThreshold && u < this.config.capacityClearanceThreshold && Game.time % 100 == 0 && So.warn("Terminal ".concat(i.name, " at ").concat((100 * u).toFixed(1), "% capacity (").concat(l, "/").concat(c, ")"), {
subsystem: "Terminal"
...
var r, o, a, i, s, c;
So.info("Auto-clearing terminal ".concat(e.name, " (").concat((t.store.getUsedCapacity() / t.store.getCapacity() * 100).toFixed(1), "% full)"), {
subsystem: "Terminal"
});
var l, u = gn.getClusters();
for (var p in u) {
var m = u[p];
if (m.memberRooms.includes(e.name)) {
var f = 0;
try {
for (var d = (r = void 0, n(m.memberRooms)), y = d.next(); !y.done; y = d.next()) {
var h = y.value, g = Game.rooms[h];
(null === (s = null == g ? void 0 : g.controller) || void 0 === s ? void 0 : s.my) && g.controller.level > f && (f = g.controller.level, 
l = h);
}
} catch (e) {
r = {
...
var b = C - S;
if (l && l !== e.name) {
var w = null === (c = Game.rooms[l]) || void 0 === c ? void 0 : c.terminal;
if (w && w.store.getFreeCapacity() > b) {
var O = bu.findOptimalRoute(e.name, l, b);
if (O) {
...
priority: 5,
route: O
}), So.info("Queued clearance transfer: ".concat(b, " ").concat(T, " from ").concat(e.name, " to hub ").concat(l), {
subsystem: "Terminal"
});
continue;
}
...
Game.time % 10 == 0 && Cu.sellSurplusFromTerminal(e.name, T, b) && So.info("Sold ".concat(b, " ").concat(T, " from ").concat(e.name, " terminal via market"), {
subsystem: "Terminal"
});
}
}
...
var n = o.cost / r;
if (n > l.config.maxTransferCostRatio) return So.debug("Skipping terminal transfer from ".concat(t.room.name, " to ").concat(e.room.name, ": cost ratio ").concat(n.toFixed(2), " too high"), {
subsystem: "Terminal"
}), "continue";
...
return So.info("Queued energy transfer: ".concat(r, " from ").concat(t.room.name, " to ").concat(e.room.name, " (").concat(a, ", cost: ").concat(o.cost, ")"), {
subsystem: "Terminal"
}), "break";
};
try {
...
try {
for (var u = n(i), p = u.next(); !p.done; p = u.next()) c(p.value);
} catch (e) {
t = {
error: e
};
...
try {
for (var u = n(e), p = u.next(); !p.done; p = u.next()) {
var m = p.value, f = m.terminal, d = Object.keys(f.store);
try {
for (var y = (o = void 0, n(d)), h = y.next(); !h.done; h = y.next()) {
var g = h.value;
if (g !== RESOURCE_ENERGY) {
var v = f.store.getUsedCapacity(g);
0 !== v && (l.has(g) || l.set(g, []), l.get(g).push({
room: m,
amount: v
}));
}
...
amount: a,
priority: 1
}), So.info("Queued mineral transfer: ".concat(a, " ").concat(e, " from ").concat(r.room.name, " to ").concat(o.room.name), {
subsystem: "Terminal"
});
}, E = this;
try {
...
if (a < t.amount) return So.debug("Terminal transfer cancelled: insufficient ".concat(t.resourceType, " in ").concat(t.fromRoom, " (need ").concat(t.amount, ", have ").concat(a, ")"), {
subsystem: "Terminal"
...
So.info("Terminal transfer executed: ".concat(t.amount, " ").concat(t.resourceType, " from ").concat(t.fromRoom, " to ").concat(s).concat(u && !p ? " (hop to ".concat(t.toRoom, ")") : "").concat(t.isEmergency ? " [EMERGENCY]" : ""), {
subsystem: "Terminal"
}), o.add(t.fromRoom), u && !p ? t.fromRoom = s : i.transferQueue = i.transferQueue.filter(function(e) {
return e !== t;
});
} else So.warn("Terminal transfer failed: ".concat(l, " for ").concat(t.amount, " ").concat(t.resourceType, " from ").concat(t.fromRoom, " to ").concat(s), {
subsystem: "Terminal"
}), i.transferQueue = i.transferQueue.filter(function(e) {
return e !== t;
});
...
var r, o, i, s, c, l, u, p = new Map;
try {
for (var m = n(e), f = m.next(); !f.done; f = m.next()) {
var d = f.value, y = Game.rooms[d];
if (null == y ? void 0 : y.terminal) try {
for (var h = (i = void 0, n(t)), g = h.next(); !g.done; g = h.next()) {
var v = g.value, R = null !== (u = y.terminal.store[v]) && void 0 !== u ? u : 0;
...
try {
for (var u = (r = void 0, n(l)), p = u.next(); !p.done; p = u.next()) {
var m = p.value;
try {
for (var f = (a = void 0, n(c)), d = f.next(); !d.done; d = f.next()) {
var y = d.value, h = Math.min(Math.floor((m.amount - s) / 2), Math.floor((s - y.amount) / 2), 3e3), g = e === RESOURCE_CATALYZED_UTRIUM_ACID || e === RESOURCE_CATALYZED_KEANIUM_ALKALIDE || e === RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE || e === RESOURCE_CATALYZED_GHODIUM_ACID || e === RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE || e === RESOURCE_CATALYZED_GHODIUM_ALKALIDE;
h >= (g ? 300 : 500) && (T.queueTransfer(m.roomName, y.roomName, e, h, g ? 8 : 5), 
So.info("Queued compound balance: ".concat(h, " ").concat(e, " from ").concat(m.roomName, " to ").concat(y.roomName), {
subsystem: "Terminal"
}), m.amount -= h, y.amount += h);
}
} catch (e) {
a = {
error: e
...
try {
for (var C = n(p.entries()), S = C.next(); !S.done; S = C.next()) {
var b = a(S.value, 2);
E(v = b[0], b[1]);
}
} catch (e) {
...
}, o([ Kn("terminal:manager", "Terminal Manager", {
priority: En.MEDIUM,
interval: 20,
minBucket: 0,
cpuBudget: .1
...
yu), su[RESOURCE_BATTERY] = ((hu = {})[RESOURCE_ENERGY] = 600, hu), su), Au = ((gu = {})[RESOURCE_BATTERY] = 10, 
gu[RESOURCE_UTRIUM_BAR] = 5, gu[RESOURCE_LEMERGIUM_BAR] = 5, gu[RESOURCE_ZYNTHIUM_BAR] = 5, 
gu[RESOURCE_KEANIUM_BAR] = 5, gu[RESOURCE_GHODIUM_MELT] = 4, gu[RESOURCE_OXIDANT] = 3, 
gu[RESOURCE_REDUCTANT] = 3, gu[RESOURCE_PURIFIER] = 3, gu), ku = function() {
function e(e) {
void 0 === e && (e = {}), this.config = r(r({}, xu), e);
}
return e.prototype.run = function() {
var e, t;
if (!(Game.cpu.bucket < this.config.minBucket)) {
...
var u = !0;
try {
for (var p = n(Object.entries(l)), m = p.next(); !m.done; m = p.next()) {
var f = a(m.value, 2), d = f[0], y = f[1];
if (i.store.getUsedCapacity(d) < y) {
u = !1;
break;
}
}
...
if (u) {
var h = i.produce(c);
h === OK ? So.info("Factory in ".concat(e.name, " producing ").concat(c), {
subsystem: "Factory"
}) : h !== ERR_TIRED && So.debug("Factory production failed in ".concat(e.name, ": ").concat(h), {
subsystem: "Factory"
});
}
}
...
var o, i, s, c, l, u = [];
try {
for (var p = n(Object.entries(Uu)), m = p.next(); !m.done; m = p.next()) {
var f = a(m.value, 2), d = f[0], y = f[1], h = d, g = !0, v = 0;
try {
for (var R = (s = void 0, n(Object.entries(y))), E = R.next(); !E.done; E = R.next()) {
var T = a(E.value, 2), C = T[0], S = T[1], b = C, w = r.store.getUsedCapacity(b);
if (w < 2 * S) {
g = !1;
break;
}
...
if (g) {
var O = t.store.getUsedCapacity(h) + r.store.getUsedCapacity(h);
if (!(O > this.config.outputBufferAmount)) {
var _ = null !== (l = Au[h]) && void 0 !== l ? l : 1, x = _ * v * (1 - O / this.config.outputBufferAmount);
u.push({
commodity: h,
priority: _,
score: x
...
var l = [];
try {
for (var u = n(Object.entries(c)), p = u.next(); !p.done; p = u.next()) {
var m = a(p.value, 2), f = m[0], d = m[1], y = f, h = e.store.getUsedCapacity(y), g = Math.max(0, this.config.inputBufferAmount - h);
g > 0 && l.push({
resource: y,
amount: Math.min(g, 2 * d)
});
}
} catch (e) {
r = {
...
var t, r;
try {
for (var o = n(Object.keys(Uu)), a = o.next(); !a.done; a = o.next()) {
var i = a.value;
...
}, o([ Kn("factory:manager", "Factory Manager", {
priority: En.LOW,
interval: 30,
minBucket: 0,
cpuBudget: .05
...
Game.time % 1e3 == 0 && So.info("Market trend analysis completed in ".concat(c.toFixed(2), " CPU, ").concat(this.opportunities.length, " opportunities detected"), {
...
var e, t, r, o, a, i, s, c, l, u, p, m = gn.getEmpire(), f = [];
try {
for (var d = n(this.config.trackedResources), y = d.next(); !y.done; y = d.next()) {
var h = y.value, g = null === (a = m.market) || void 0 === a ? void 0 : a.resources[h];
if (g) {
var v = this.supplyDemandCache.get(h);
if (v) {
-1 === g.trend && v.sentiment < -.3 && (S = Math.abs(v.sentiment) * (1 - (null !== (i = g.volatility) && void 0 !== i ? i : .5))) >= this.config.opportunityConfidenceThreshold && f.push({
resource: h,
type: "buy",
expectedValue: 1e4 * (g.avgPrice - (null !== (s = g.predictedPrice) && void 0 !== s ? s : g.avgPrice)),
confidence: S,
action: "Buy ".concat(h, " at current price (falling trend, oversupply)"),
urgency: this.calculateUrgency(S, Math.abs(v.sentiment)),
createdAt: Game.time
}), 1 === g.trend && v.sentiment > .3 && (S = v.sentiment * (1 - (null !== (c = g.volatility) && void 0 !== c ? c : .5))) >= this.config.opportunityConfidenceThreshold && f.push({
resource: h,
type: "sell",
expectedValue: 1e4 * ((null !== (l = g.predictedPrice) && void 0 !== l ? l : g.avgPrice) - g.avgPrice),
confidence: S,
...
expectedValue: C,
confidence: S,
action: "Arbitrage ".concat(h, ": buy at ").concat(T.price.toFixed(3), ", sell at ").concat(E.price.toFixed(3)),
urgency: 3,
createdAt: Game.time
});
}
(null !== (u = g.volatility) && void 0 !== u ? u : 0) >= this.config.highVolatilityThreshold && So.warn("High volatility detected for ".concat(h, ": ").concat((100 * (null !== (p = g.volatility) && void 0 !== p ? p : 0)).toFixed(1), "%"), {
subsystem: "MarketTrends"
});
}
}
...
try {
for (var b = n(f), w = b.next(); !w.done; w = b.next()) {
var O = w.value;
O.urgency >= 2 && So.info("Trading opportunity: ".concat(O.action, ", expected value: ").concat(O.expectedValue.toFixed(0), " credits, confidence: ").concat((100 * O.confidence).toFixed(0), "%"), {
subsystem: "MarketTrends"
});
}
} catch (e) {
...
}, o([ Yn("empire:marketTrends", "Market Trend Analyzer", {
priority: En.LOW,
interval: 500,
minBucket: 0,
cpuBudget: .02
}) ], e.prototype, "run", null), e = o([ Vn() ], e);
}();
...
function e(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = r(r({}, Gu), e);
}
return e.prototype.run = function() {
var e = this, t = Game.cpu.getUsed(), r = gn.getEmpire();
...
Game.time % 100 == 0 && Kr.info("Empire tick completed in ".concat(o.toFixed(2), " CPU"), {
subsystem: "Empire"
});
}, e.prototype.cleanupClaimQueue = function(e, t) {
var r = e.claimQueue.length;
e.claimQueue = e.claimQueue.filter(function(e) {
return !t.has(e.roomName) || (Kr.info("Removing ".concat(e.roomName, " from claim queue - now owned"), {
subsystem: "Empire"
}), !1);
}), e.claimQueue.length < r && Kr.info("Cleaned up claim queue: removed ".concat(r - e.claimQueue.length, " owned room(s)"), {
subsystem: "Empire"
});
...
var p = u.value;
(d = e.knownRooms[p.name]) && d.owner !== c && (d.owner = c, Kr.info("Updated room intel for ".concat(p.name, " - now owned by ").concat(c), {
subsystem: "Empire"
}));
}
} catch (e) {
...
m.sort(function(e, t) {
return t.score - e.score;
}), e.claimQueue = m.slice(0, 10), m.length > 0 && Game.time % 100 == 0 && Kr.info("Expansion queue updated: ".concat(m.length, " candidates, top score: ").concat(m[0].score), {
subsystem: "Empire"
});
}
...
e.controllerLevel > 0 && !e.owner && (r += 2 * e.controllerLevel), r += Ia(e.name, t, o), 
...
active: !1
}), Kr.info("Power bank discovered in ".concat(r, ": ").concat(o.power, " power"), {
subsystem: "Empire"
}));
};
try {
...
r.threatLevel >= 2 && !e.warTargets.includes(t) && (e.warTargets.push(t), Kr.warn("Added war target: ".concat(t, " (threat level ").concat(r.threatLevel, ")"), {
subsystem: "Empire"
}));
}
...
Kr.warn("War mode enabled due to active war targets", {
subsystem: "Empire"
})), 0 === e.warTargets.length && e.objectives.warMode && (e.objectives.warMode = !1, 
Kr.info("War mode disabled - no active war targets", {
subsystem: "Empire"
}));
}, e.prototype.getNextExpansionTarget = function() {
var e = gn.getEmpire().claimQueue.filter(function(e) {
return !e.claimed;
});
return e.length > 0 ? e[0] : null;
}, e.prototype.markExpansionClaimed = function(e) {
var t = gn.getEmpire().claimQueue.find(function(t) {
return t.roomName === e;
});
t && (t.claimed = !0, Kr.info("Marked expansion target as claimed: ".concat(e), {
subsystem: "Empire"
}));
...
t > 0 && Game.time % 500 == 0 && Kr.info("Refreshed intel for ".concat(t, " rooms"), {
subsystem: "Empire"
});
}
...
try {
for (var p = (o = void 0, n(u)), m = p.next(); !m.done; m = p.next()) {
var f = m.value;
if (s >= this.config.maxRoomsToDiscoverPerTick) return void Kr.debug("Reached discovery limit of ".concat(this.config.maxRoomsToDiscoverPerTick, " rooms per tick"), {
subsystem: "Empire"
});
...
s > 0 && Kr.info("Discovered ".concat(s, " nearby rooms for scouting"), {
subsystem: "Empire"
});
}
}
...
t >= this.config.gclNotifyThreshold && Game.time % 500 == 0 && Kr.info("GCL ".concat(Game.gcl.level, " progress: ").concat(t.toFixed(1), "% (").concat(Game.gcl.progress, "/").concat(Game.gcl.progressTotal, ")"), {
subsystem: "Empire"
...
a < 5e4 ? e.objectives.expansionPaused || (e.objectives.expansionPaused = !0, Kr.info("Expansion paused: insufficient energy reserves (".concat(a.toFixed(0), " < ").concat(5e4, ")"), {
subsystem: "Empire"
})) : e.objectives.expansionPaused && (e.objectives.expansionPaused = !1, Kr.info("Expansion resumed: ".concat(o.length, " stable rooms with ").concat(a.toFixed(0), " avg energy"), {
subsystem: "Empire"
}));
} else e.objectives.expansionPaused || (e.objectives.expansionPaused = !0, Kr.info("Expansion paused: waiting for stable room (RCL >= 4 with storage)", {
subsystem: "Empire"
}));
}
...
launched: !1,
launchTick: 0
}), Kr.info("Added nuke candidate: ".concat(t, " (score: ").concat(n, ")"), {
subsystem: "Empire"
}));
}, a = this;
try {
...
if (Game.time % 50 == 0) {
var e = gn.getClusters(), t = Object.values(Game.rooms).filter(function(e) {
var t;
return null === (t = e.controller) || void 0 === t ? void 0 : t.my;
}), r = function(r) {
...
i < 3e4 && Game.time % 500 == 0 && Kr.warn("Cluster ".concat(r, " has low energy: ").concat(i.toFixed(0), " avg (threshold: 30000)"), {
subsystem: "Empire"
}), c && Game.time % 500 == 0 && Kr.warn("Cluster ".concat(r, " has high CPU usage: ").concat(s.toFixed(2), " per room"), {
subsystem: "Empire"
}), o.metrics || (o.metrics = {
energyIncome: 0,
energyConsumption: 0,
...
o.metrics.economyIndex = Math.round((l + u) / 2), o.metrics.economyIndex < 40 && Game.time % 500 == 0 && Kr.warn("Cluster ".concat(r, " economy index low: ").concat(o.metrics.economyIndex, " - consider rebalancing"), {
subsystem: "Empire"
});
};
for (var o in e) r(o);
...
var m = 1 / 0, f = null;
try {
for (var d = (o = void 0, n(c)), y = d.next(); !y.done; y = d.next()) {
var h = y.value, g = Game.map.getRoomLinearDistance(h.name, p.roomName);
g < m && (m = g, f = h);
}
} catch (e) {
o = {
...
if (f) {
var v = p.decayTick - Game.time, R = 50 * m * 2 + p.power / 2, E = v > 1.5 * R && m <= 5 && p.power >= 1e3 && (null !== (s = null === (i = f.controller) || void 0 === i ? void 0 : i.level) && void 0 !== s ? s : 0) >= 7;
E || Game.time % 500 != 0 ? E && Game.time % 500 == 0 && Kr.info("Profitable power bank in ".concat(p.roomName, ": ") + "power=".concat(p.power, ", distance=").concat(m, ", timeRemaining=").concat(v), {
subsystem: "Empire"
}) : Kr.debug("Power bank in ".concat(p.roomName, " not profitable: ") + "power=".concat(p.power, ", distance=").concat(m, ", timeRemaining=").concat(v, ", ") + "requiredTime=".concat(R.toFixed(0)), {
subsystem: "Empire"
});
}
}
...
}, o([ Yn("empire:manager", "Empire Manager", {
priority: En.MEDIUM,
interval: 30,
minBucket: 0,
cpuBudget: .05
...
criticalResourceThresholds: (Iu = {}, Iu[RESOURCE_GHODIUM] = 5e3, Iu),
enabled: !0
}, Bu = function() {
function e(e, t) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = r(r({}, Fu), e), this.memoryAccessor = t;
}
...
this.updateMemory()) : Kr.debug("Pixel buying skipped: insufficient credits", {
subsystem: "PixelBuying"
}) : Kr.debug("Pixel buying skipped: no resource surplus", {
subsystem: "PixelBuying"
})));
...
if (c.energy < u + this.config.minEnergySurplus) return Kr.debug("Pixel buying: energy below surplus (".concat(c.energy, " < ").concat(u + this.config.minEnergySurplus, ")"), {
subsystem: "PixelBuying"
}), !1;
try {
for (var p = n(Object.entries(this.config.criticalResourceThresholds)), m = p.next(); !m.done; m = p.next()) {
var f = a(m.value, 2), d = f[0], y = f[1];
if ((R = null !== (i = c[d]) && void 0 !== i ? i : 0) < y) return Kr.debug("Pixel buying: ".concat(d, " below threshold (").concat(R, " < ").concat(y, ")"), {
subsystem: "PixelBuying"
}), !1;
}
} catch (t) {
...
for (var g = n(h), v = g.next(); !v.done; v = g.next()) {
var R, E = v.value;
if ((R = null !== (s = c[E]) && void 0 !== s ? s : 0) < this.config.minBaseMineralReserve) return Kr.debug("Pixel buying: ".concat(E, " below reserve (").concat(R, " < ").concat(this.config.minBaseMineralReserve, ")"), {
subsystem: "PixelBuying"
}), !1;
}
} catch (e) {
...
if (c <= 0) Kr.debug("Cannot afford any pixels after reserve", {
subsystem: "PixelBuying"
}); else {
var l = o.roomName ? Game.market.calcTransactionCost(c, a.name, o.roomName) : 0;
if (a.terminal.store[RESOURCE_ENERGY] < l) Kr.debug("Not enough energy for pixel transaction (need ".concat(l, ")"), {
subsystem: "PixelBuying"
}); else {
...
orderId: o.id,
fromRoom: a.name
}), Kr.info("Purchased ".concat(c, " pixels at ").concat(o.price.toFixed(2), " credits each ") + "(total: ".concat(p.toFixed(0), " credits)").concat(n ? " (GOOD PRICE!)" : ""), {
subsystem: "PixelBuying"
});
} else Kr.warn("Failed to purchase pixels: error code ".concat(u), {
subsystem: "PixelBuying"
});
}
}
} else Kr.debug("No terminal available for pixel purchase", {
subsystem: "PixelBuying"
});
} else Kr.debug("Pixel price (".concat(o.price, ") above target (").concat(this.config.targetPixelPrice, "), waiting"), {
subsystem: "PixelBuying"
});
} else Kr.debug("No pixel orders below max price (".concat(this.config.maxPixelPrice, ")"), {
subsystem: "PixelBuying"
});
} else Kr.debug("No pixel sell orders available", {
subsystem: "PixelBuying"
});
...
this.config.enabled = !0, Kr.info("Pixel buying enabled", {
subsystem: "PixelBuying"
});
}, e.prototype.disable = function() {
this.config.enabled = !1, Kr.info("Pixel buying disabled", {
subsystem: "PixelBuying"
});
}, e;
}(), Hu = {
...
function e(e, t) {
void 0 === e && (e = {}), this.config = r(r({}, Hu), e), this.memoryAccessor = t;
}
return e.prototype.setMemoryAccessor = function(e) {
this.memoryAccessor = e;
}, e.prototype.run = function() {
...
e.consecutiveFullTicks = 0, e.bucketFullSince = 0, Kr.info("Generated pixel from CPU bucket (total generated: ".concat(e.totalPixelsGenerated, ")"), {
...
} else Kr.warn("Failed to generate pixel: error code ".concat(t), {
subsystem: "PixelGeneration",
meta: {
bucket: Game.cpu.bucket,
result: t
...
this.config.enabled = !0, Kr.info("Pixel generation enabled", {
subsystem: "PixelGeneration"
});
}, e.prototype.disable = function() {
this.config.enabled = !1, Kr.info("Pixel generation disabled", {
subsystem: "PixelGeneration"
});
}, e.prototype.updateConfig = function(e) {
this.config = r(r({}, this.config), e);
...
}, Yu = 1e7, ju = 5e6, Vu = ((Pu = {})[STRUCTURE_SPAWN] = 15e3, Pu[STRUCTURE_TOWER] = 5e3, 
Pu[STRUCTURE_STORAGE] = 3e4, Pu[STRUCTURE_TERMINAL] = 1e5, Pu[STRUCTURE_LAB] = 5e4, 
Pu[STRUCTURE_NUKER] = 1e5, Pu[STRUCTURE_POWER_SPAWN] = 1e5, Pu[STRUCTURE_OBSERVER] = 8e3, 
Pu[STRUCTURE_EXTENSION] = 3e3, Pu[STRUCTURE_LINK] = 5e3, Pu);
...
function qu(e, t, r) {
t.timeToLand < 5e3 ? (r.posture = "evacuate", Kr.warn("EVACUATION TRIGGERED for ".concat(e.name, ": Critical structures threatened by nuke!"), {
subsystem: "Nuke"
})) : ("war" !== r.posture && "evacuate" !== r.posture && (r.posture = "defensive"), 
Kr.warn("NUKE DEFENSE PREPARATION in ".concat(e.name, ": Critical structures in blast radius"), {
subsystem: "Nuke"
...
if (p.length > 0) {
var m = Math.min.apply(Math, i([], a(p.map(function(t) {
return Game.map.getRoomLinearDistance(e, t.name);
})), !1));
n -= 2 * m, s.push("".concat(m, " rooms away"));
}
t.warTargets.includes(e) && (n += 15, s.push("War target"));
var f = new RoomPosition(25, 25, e), d = Ju(e, f, t);
return d >= r.roiThreshold ? (n += Math.min(20, Math.floor(5 * d)), s.push("ROI: ".concat(d.toFixed(1), "x"))) : (n -= 20, 
s.push("Low ROI: ".concat(d.toFixed(1), "x"))), {
roomName: e,
score: n,
reasons: s
};
...
i.estimatedDamage = Yu + ju * l, i.estimatedValue = .01 * i.estimatedDamage;
}
return i;
}
...
try {
for (var p = n(u), m = p.next(); !m.done; m = p.next()) {
var f = m.value.structure, d = Math.abs(f.pos.x - t.x), y = Math.abs(f.pos.y - t.y), h = 0 === Math.max(d, y) ? Yu : ju;
f.hits <= h ? (i.estimatedDamage += f.hits, i.threatenedStructures.push("".concat(f.structureType, "-").concat(f.pos.x, ",").concat(f.pos.y)), 
i.estimatedValue += $u(f)) : i.estimatedDamage += h;
}
} catch (e) {
o = {
error: e
...
if (!s) return Kr.warn("Cannot deploy siege squad for nuke on ".concat(e.targetRoom, ": No clusters available"), {
subsystem: "Nuke"
}), !1;
var m = t[s.id];
if (!m) return !1;
var f = null === (i = m.squads) || void 0 === i ? void 0 : i.find(function(t) {
...
Kr.info("Siege pheromones increased for ".concat(e.targetRoom, " to coordinate with nuke strike"), {
subsystem: "Nuke"
}));
var y = "siege-nuke-".concat(e.targetRoom, "-").concat(Game.time), h = {
id: y,
type: "siege",
members: [],
...
return m.squads || (m.squads = []), m.squads.push(h), e.siegeSquadId = y, Kr.warn("SIEGE SQUAD DEPLOYED: Squad ".concat(y, " will coordinate with nuke on ").concat(e.targetRoom), {
subsystem: "Nuke"
}), !0;
}
...
var tp = function() {
function e(e, t) {
void 0 === e && (e = {}), this.nukerReadyLogged = new Set, this.config = r(r({}, Ku), e), 
...
if (m <= 2) {
var f = 0 === m ? Yu : ju;
l.hits <= f && a.push("".concat(l.structureType, "-").concat(l.pos.x, ",").concat(l.pos.y));
}
}
} catch (e) {
r = {
...
c.danger = 3, Kr.warn("INCOMING NUKE DETECTED in ".concat(o, "! ") + "Landing at (".concat(t.pos.x, ", ").concat(t.pos.y, "), impact in ").concat(t.timeToLand, " ticks. ") + "Source: ".concat(t.launchRoomName || "unknown", ". ") + "Threatened structures: ".concat(i.length), {
subsystem: "Nuke"
}), c.eventLog.push({
type: "nuke_incoming",
time: Game.time,
...
try {
for (var p = (a = void 0, n(l)), m = p.next(); !m.done; m = p.next()) u(m.value);
} catch (e) {
a = {
error: e
};
...
} else c.nukeDetected && (c.nukeDetected = !1, Kr.info("Nuke threat cleared in ".concat(o), {
subsystem: "Nuke"
}));
};
...
Kr.warn("COUNTER-NUKE AUTHORIZED: ".concat(u.sourceRoom, " added to war targets for nuke retaliation"), {
subsystem: "Nuke"
}), Game.rooms) if (null === (s = Game.rooms[f].controller) || void 0 === s ? void 0 : s.my) {
var d = r(f);
d && (d.pheromones.war = Math.min(100, d.pheromones.war + 30));
}
} else Kr.warn("Counter-nuke desired against ".concat(u.sourceRoom, " but insufficient resources"), {
subsystem: "Nuke"
});
}
}
...
0 === u && 0 === p ? r.has(f) || (Kr.info("Nuker in ".concat(i, " is fully loaded and ready to launch"), {
subsystem: "Nuke"
}), r.add(f)) : r.delete(f);
}
}
...
(n > 0 || a > 0) && Kr.debug("Nuker in ".concat(t, " needs ").concat(n, " energy, ").concat(a, " ghodium"), {
subsystem: "Nuke"
});
}
}
...
var c = s.value, l = Qu(c, e, t, r);
l.score >= t.minScore && (e.nukeCandidates.push({
roomName: c,
score: l.score,
launched: !1,
launchTick: 0
}), Kr.info("Nuke candidate: ".concat(c, " (score: ").concat(l.score, ") - ").concat(l.reasons.join(", ")), {
subsystem: "Nuke"
}));
}
} catch (e) {
...
r.lastROI = n / o, r.nukesLaunched > 0 && r.nukesLaunched % 5 == 0 && Kr.info("Nuke economics: ".concat(r.nukesLaunched, " nukes, ROI: ").concat(null === (t = r.lastROI) || void 0 === t ? void 0 : t.toFixed(2), "x, ") + "Value destroyed: ".concat((r.totalValueDestroyed / 1e3).toFixed(0), "k"), {
subsystem: "Nuke"
});
}
}
...
var m = r();
try {
for (var f = n(e.nukesInFlight), d = f.next(); !d.done; d = f.next()) {
var y = d.value, h = y.impactTick - Game.time;
y.siegeSquadId || h <= t.siegeCoordinationWindow && h > 0 && ep(y, m, o) && Kr.info("Siege squad deployment coordinated with nuke on ".concat(y.targetRoom, ", ") + "impact in ".concat(h, " ticks"), {
subsystem: "Nuke"
});
}
} catch (e) {
...
try {
for (var g = n(Object.values(m)), v = g.next(); !v.done; v = g.next()) {
var R = v.value;
...
o && !o.siegeSquadId && (o.siegeSquadId = t.id, Kr.info("Linked siege squad ".concat(t.id, " with nuke on ").concat(r), {
subsystem: "Nuke"
}));
};
try {
...
var p = new Map;
try {
for (var m = n(e.nukesInFlight), f = m.next(); !f.done; f = m.next()) {
...
try {
for (var h = n(p.entries()), g = h.next(); !g.done; g = h.next()) {
var v = a(g.value, 2), R = v[0], E = v[1];
if (!(E.length < 2)) {
...
try {
for (var w = (l = void 0, n(E)), O = w.next(); !O.done; O = w.next()) (d = O.value).salvoId = b;
} catch (e) {
l = {
error: e
};
...
Kr.info("Nuke salvo ".concat(b, " coordinated: ").concat(E.length, " nukes on ").concat(R, ", impact spread: ").concat(S, " ticks"), {
subsystem: "Nuke"
});
} else Kr.warn("Nukes on ".concat(R, " not synchronized (spread: ").concat(S, " ticks > ").concat(t.salvoSyncWindow, ")"), {
subsystem: "Nuke"
});
}
}
...
var u = Game.rooms[l];
(null === (s = u.controller) || void 0 === s ? void 0 : s.my) && (h = u.find(FIND_MY_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_NUKER;
}
})[0]) && h.store.getUsedCapacity(RESOURCE_ENERGY) >= t.minEnergy && h.store.getUsedCapacity(RESOURCE_GHODIUM) >= t.minGhodium && c.push(h);
}
if (0 !== c.length) try {
for (var p = n(e.nukeCandidates), m = p.next(); !m.done; m = p.next()) {
var f = m.value;
if (!f.launched) {
try {
for (var d = (a = void 0, n(c)), y = d.next(); !y.done; y = d.next()) {
var h = y.value;
if (!(Game.map.getRoomLinearDistance(h.room.name, f.roomName) > 10)) {
var g = new RoomPosition(25, 25, f.roomName), v = Zu(f.roomName, g, e), R = Ju(f.roomName, g, e);
if (R < t.roiThreshold) Kr.warn("Skipping nuke launch on ".concat(f.roomName, ": ROI ").concat(R.toFixed(2), "x below threshold ").concat(t.roiThreshold, "x"), {
subsystem: "Nuke"
}); else {
var E = h.launchNuke(g);
if (E === OK) {
f.launched = !0, f.launchTick = Game.time;
var T = {
id: "".concat(h.room.name, "-").concat(f.roomName, "-").concat(Game.time),
sourceRoom: h.room.name,
...
e.nukeEconomics.lastLaunchTick = Game.time, Kr.warn("NUKE LAUNCHED from ".concat(h.room.name, " to ").concat(f.roomName, "! ") + "Impact in ".concat(t.nukeFlightTime, " ticks. ") + "Predicted damage: ".concat((v.estimatedDamage / 1e6).toFixed(1), "M hits, ") + "value: ".concat((v.estimatedValue / 1e3).toFixed(0), "k, ROI: ").concat(R.toFixed(2), "x"), {
subsystem: "Nuke"
});
var C = c.indexOf(h);
C > -1 && c.splice(C, 1);
...
Kr.error("Failed to launch nuke: ".concat(E), {
subsystem: "Nuke"
});
}
}
...
r > 0 && Kr.info("Cleaned up ".concat(r, " impacted nuke alert(s)"), {
subsystem: "Nuke"
});
}
}(t);
...
var i = a.value;
if (!i.evacuationTriggered && zu(i)) {
var s = Game.rooms[i.roomName];
if (s) {
var c = this.getSwarmState(i.roomName);
c && (qu(s, i, c), i.evacuationTriggered = !0);
}
}
}
} catch (e) {
...
a ? n.requestTransfer(a, e, t, r, o.terminalPriority) && Kr.info("Requested ".concat(r, " ").concat(t, " transfer from ").concat(a, " to ").concat(e, " for nuker"), {
subsystem: "Nuke"
}) : Kr.debug("No donor room found for ".concat(r, " ").concat(t, " to ").concat(e), {
subsystem: "Nuke"
});
...
function e(e) {
void 0 === e && (e = {}), this.coordinator = new tp(r(r({}, rp), e), {
getEmpire: function() {
return gn.getEmpire();
},
getSwarmState: function(e) {
return gn.getSwarmState(e);
},
getClusters: function() {
return gn.getClusters();
}
});
}
return e.prototype.run = function() {
...
return t(r, e), r.prototype.run = function() {
e.prototype.run.call(this);
}, o([ Yn("empire:pixelBuying", "Pixel Buying Manager", {
priority: En.IDLE,
interval: 200,
minBucket: 0,
cpuBudget: .01
...
return t(r, e), r.prototype.run = function() {
e.prototype.run.call(this);
}, o([ Yn("empire:pixelGeneration", "Pixel Generation Manager", {
priority: En.IDLE,
interval: 1,
minBucket: 0,
cpuBudget: .01
...
function lp(e, t, r) {
var o, n = gn.getSwarmState(e);
if (n) {
var a = null !== (o = n.remoteAssignments) && void 0 !== o ? o : [], i = a.indexOf(t);
if (-1 !== i) {
a.splice(i, 1), n.remoteAssignments = a;
var s = gn.getEmpire().knownRooms[t];
s && (s.threatLevel = 3, s.lastSeen = Game.time), Kr.warn("Removed remote room ".concat(t, " from ").concat(e, " due to: ").concat(r), {
...
function up(e) {
var t, r, o, a = gn.getSwarmState(e);
if (a) {
...
function e(e) {
void 0 === e && (e = {}), this.config = r(r({}, pp), e);
}
return e.prototype.run = function() {
var e, t, r, o, a, i = Object.values(Game.rooms).filter(function(e) {
var t;
...
try {
for (var s = n(i), c = s.next(); !c.done; c = s.next()) {
var l = c.value, u = gn.getSwarmState(l.name);
if (u) {
up(l.name);
var p = null !== (a = u.remoteAssignments) && void 0 !== a ? a : [];
if (0 !== p.length) {
try {
for (var m = (r = void 0, n(p)), f = m.next(); !f.done; f = m.next()) {
var d = f.value;
...
if (!r) return Kr.warn("Could not find valid position for container at source ".concat(t.id, " in ").concat(e.name), {
...
return o === OK ? (Kr.info("Placed container construction site at source ".concat(t.id, " in ").concat(e.name), {
subsystem: "RemoteInfra"
}), !0) : (Kr.debug("Failed to place container at source ".concat(t.id, " in ").concat(e.name, ": ").concat(o), {
subsystem: "RemoteInfra"
}), !1);
...
var r, o, a = zc(e, t), i = a.get(e.name);
...
try {
for (var m = n(t), f = m.next(); !f.done; f = m.next()) {
var d = f.value;
if (p >= 3) break;
if (i.length + p >= 5) break;
if (!c.has(d) && !l.has(d)) {
var y = a(d.split(","), 2), h = y[0], g = y[1], v = parseInt(h, 10), R = parseInt(g, 10);
...
p > 0 && Kr.debug("Placed ".concat(p, " remote road construction sites in ").concat(e.name), {
subsystem: "RemoteInfra"
});
}
}, e.prototype.getMyUsername = function() {
...
}, o([ Kn("remote:infrastructure", "Remote Infrastructure Manager", {
priority: En.LOW,
interval: 50,
minBucket: 0,
cpuBudget: .05
...
function e(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = r(r({}, dp), e);
}
return e.prototype.run = function() {
this.lastRun = Game.time;
...
if (i.warTargets) try {
for (var p = n(i.warTargets), m = p.next(); !m.done; m = p.next()) {
var f = m.value;
...
var y, h = i.knownRooms[d];
h && h.owner && !h.owner.includes("Source Keeper") && ((y = s.get(h.owner)) ? (y.rooms.includes(d) || y.rooms.push(d), 
y.lastSeen = Math.max(y.lastSeen, h.lastSeen), y.threatLevel = Math.max(y.threatLevel, h.threatLevel)) : s.set(h.owner, {
username: h.owner,
rooms: [ d ],
...
Kr.info("Cross-shard intel: ".concat(g, " enemies tracked, ").concat(v, " high threat"), {
...
}, o([ Yn("empire:crossShardIntel", "Cross-Shard Intel", {
priority: En.LOW,
interval: 50,
minBucket: 0,
cpuBudget: .01
...
function e(e) {
void 0 === e && (e = {}), this.trackers = new Map, this.config = r(r({}, gp), e);
}
...
var r, o, a, i, s, c, l, u, p = this.getTracker(e.name), m = "sources_".concat(e.name), f = global[m];
...
var C = 0;
try {
for (var S = n(T), b = S.next(); !b.done; b = S.next()) {
var w = b.value;
try {
for (var O = (s = void 0, n(w.body)), _ = O.next(); !_.done; _ = O.next()) {
var x = _.value;
...
r >= 3 && (e.pheromones.siege = this.clamp(e.pheromones.siege + 20)), Kr.info("Hostile detected: ".concat(t, " hostiles, danger=").concat(r), {
room: e.role,
subsystem: "Pheromone"
});
...
var t, r, o, i, s, c, l, u, p = [];
try {
for (var m = n(e), f = m.next(); !f.done; f = m.next()) {
var d = a(f.value, 2), y = d[0], h = d[1], g = this.getNeighborRoomNames(y);
try {
for (var v = (o = void 0, n(g)), R = v.next(); !R.done; R = v.next()) {
var E = R.value;
if (e.get(E)) try {
for (var T = (s = void 0, n([ "defense", "war", "expand", "siege" ])), C = T.next(); !C.done; C = T.next()) {
var S = C.value, b = h.pheromones[S];
if (b > 1) {
var w = this.config.diffusionRates[S];
p.push({
source: y,
target: E,
type: S,
...
try {
for (var O = n(p), _ = O.next(); !_.done; _ = O.next()) {
...
r > 90 ? So.error("Memory usage critical: ".concat(r.toFixed(1), "% (").concat(e, "/").concat(t, " bytes)"), {
subsystem: "Memory"
}) : r > 75 && So.warn("Memory usage high: ".concat(r.toFixed(1), "% (").concat(e, "/").concat(t, " bytes)"), {
subsystem: "Memory"
});
...
try {
for (var a = n(r), i = a.next(); !i.done; i = a.next()) {
var s = i.value, c = gn.getSwarmState(s.name);
c && o.set(s.name, c);
}
} catch (t) {
e = {
...
}, e.prototype.precacheRoomPaths = function() {}, o([ Yn("core:memoryCleanup", "Memory Cleanup", {
priority: En.LOW,
interval: 50,
cpuBudget: .01
}) ], e.prototype, "cleanupMemory", null), o([ jn("core:memorySizeCheck", "Memory Size Check", {
interval: 100,
cpuBudget: .005
}) ], e.prototype, "checkMemorySize", null), o([ Kn("core:memorySegmentStats", "Memory Segment Stats", {
priority: En.IDLE,
interval: 10,
cpuBudget: .01
}) ], e.prototype, "updateMemorySegmentStats", null), o([ Kn("cluster:pheromoneDiffusion", "Pheromone Diffusion", {
priority: En.MEDIUM,
interval: 10,
cpuBudget: .02
}) ], e.prototype, "runPheromoneDiffusion", null), o([ Yn("room:labConfig", "Lab Config Manager", {
priority: En.LOW,
interval: 200,
cpuBudget: .01
}) ], e.prototype, "initializeLabConfigs", null), o([ jn("room:pathCachePrecache", "Path Cache Precache (Disabled)", {
interval: 1e3,
cpuBudget: .01
}) ], e.prototype, "precacheRoomPaths", null), o([ Vn() ], e);
}(), Cp = new Tp, Sp = Co("NativeCallsTracker");
...
var Op = new Set([ "harvester", "upgrader", "mineralHarvester", "depositHarvester", "factoryWorker", "labTech", "builder" ]), _p = {
harvester: En.CRITICAL,
queenCarrier: En.CRITICAL,
hauler: En.HIGH,
guard: En.HIGH,
healer: En.HIGH,
soldier: En.HIGH,
...
harasser: En.HIGH,
powerQueen: En.HIGH,
powerWarrior: En.HIGH,
larvaWorker: En.HIGH,
builder: En.MEDIUM,
upgrader: En.MEDIUM,
interRoomCarrier: En.MEDIUM,
scout: En.MEDIUM,
claimer: En.MEDIUM,
engineer: En.MEDIUM,
remoteHarvester: En.MEDIUM,
powerHarvester: En.MEDIUM,
powerCarrier: En.MEDIUM,
remoteHauler: En.LOW,
remoteWorker: En.LOW,
linkManager: En.LOW,
terminalManager: En.LOW,
mineralHarvester: En.LOW,
labTech: En.IDLE,
factoryWorker: En.IDLE
};

function xp(e) {
var t;
return null !== (t = _p[e]) && void 0 !== t ? t : En.MEDIUM;
}
...
try {
for (var u = n(this.registeredCreeps), p = u.next(); !p.done; p = u.next()) c = p.value, 
...
var m = s < 5;
(o > 0 || a > 0 || Game.time % 10 == 0 || m) && So.info("CreepProcessManager: ".concat(r.size, " active, ").concat(i, " spawning, ").concat(s, " total (registered: ").concat(o, ", unregistered: ").concat(a, ")"), {
...
if ((Game.time % 10 == 0 || o) && So.info("Executing role for creep ".concat(e.name, " (").concat(t.role, ")"), {
subsystem: "CreepProcessManager",
creep: e.name
}), function(e) {
var t = e.memory;
if (!Op.has(t.role)) return !1;
var r = t.state;
...
if (!t.targetId) return !1;
var r = Game.getObjectById(t.targetId);
return !(!r || !wp(r) || !e.pos.inRangeTo(r.pos, 3) || "upgrade" === t.action && 0 === e.store.getUsedCapacity(RESOURCE_ENERGY) || "withdraw" === t.action && 0 === e.store.getFreeCapacity(RESOURCE_ENERGY));
}(e, r);
...
if (!t.targetId) return !1;
var r = Game.getObjectById(t.targetId);
return !(!r || !wp(r) || !e.pos.isNearTo(r.pos) || 0 === e.store.getFreeCapacity());
}(e, r);
...
if (!t.targetId) return !1;
var r = Game.getObjectById(t.targetId);
return !(!r || !wp(r) || !e.pos.inRangeTo(r.pos, 3) || 0 === e.store.getUsedCapacity(RESOURCE_ENERGY));
}(e, r);
...
So.error("EXCEPTION in role execution for ".concat(e.name, " (").concat(i, "/").concat(a, "): ").concat(t), {
subsystem: "CreepProcessManager",
creep: e.name,
meta: {
error: String(t),
...
}), this.registeredCreeps.add(e.name), So.info("Registered creep process: ".concat(e.name, " (").concat(t, ") with priority ").concat(r), {
subsystem: "CreepProcessManager"
});
}, e.prototype.unregisterCreepProcess = function(e) {
var t = "creep:".concat(e);
Fn.unregisterProcess(t), this.registeredCreeps.delete(e), So.info("Unregistered creep process: ".concat(e), {
subsystem: "CreepProcessManager"
});
...
if (l) {
var u = xp(l.memory.role), p = null !== (r = En[u]) && void 0 !== r ? r : "UNKNOWN";
a[p] = (null !== (o = a[p]) && void 0 !== o ? o : 0) + 1;
}
}
} catch (t) {
e = {
...
return Bi.set(e.name, i, {
namespace: this.STRUCTURE_CACHE_NAMESPACE,
ttl: this.structureCacheTtl
}), i;
}, e.prototype.updateEvolutionStage = function(e, t, r) {
var o = this.determineEvolutionStage(e, t, r);
return o !== e.colonyLevel && (Kr.info("Room evolution: ".concat(e.colonyLevel, " -> ").concat(o), {
room: t.name,
subsystem: "Evolution"
}), e.colonyLevel = o, !0);
}, e.prototype.updateMissingStructures = function(e, t) {
var r, o, n, a, i, s, c, l, u, p, m, f, d = this.getStructureCounts(t), y = null !== (o = null === (r = t.controller) || void 0 === r ? void 0 : r.level) && void 0 !== o ? o : 0, h = kp[e.colonyLevel], g = h.requiresLabs && y >= 6, v = g ? null !== (n = h.minLabCount) && void 0 !== n ? n : 3 : 0, R = h.requiresFactory && y >= 7, E = h.requiresTerminal && y >= 6, T = h.requiresStorage && y >= 4, C = h.requiresPowerSpawn && y >= 7, S = h.requiresObserver && y >= 8, b = h.requiresNuker && y >= 8;
e.missingStructures = {
...
return Kr.info("Posture change: ".concat(n, " -> ").concat(o), {
room: a,
subsystem: "Posture"
}), e.posture = o, Fn.emit("posture.change", {
roomName: a,
oldPosture: n,
newPosture: o,
...
function jp(e, t, r) {
var o, a, i, s, c, l = e.getTerrain(), u = null !== (c = r.minSpaceRadius) && void 0 !== c ? c : 7, p = 0, m = 0;
if (t.x < u || t.x > 49 - u || t.y < u || t.y > 49 - u) return {
fits: !1,
reason: "Anchor too close to room edge (needs ".concat(u, " tile margin)")
};
try {
for (var f = n(r.structures), d = f.next(); !d.done; d = f.next()) {
...
m++, l.get(h, g) === TERRAIN_MASK_WALL && p++;
}
} catch (e) {
o = {
error: e
...
var E = R.value;
h = t.x + E.x, g = t.y + E.y, h < 1 || h > 48 || g < 1 || g > 48 || (m++, l.get(h, g) === TERRAIN_MASK_WALL && p++);
}
} catch (e) {
i = {
error: e
...
try {
for (var m = n(l), f = m.next(); !f.done; f = m.next()) u += (A = f.value).pos.x, 
p += A.pos.y;
} catch (e) {
r = {
error: e
...
for (var d = Math.round(u / (l.length + 1)), y = Math.round(p / (l.length + 1)), h = null !== (s = t.minSpaceRadius) && void 0 !== s ? s : 7, g = [], v = 0; v <= 15; v++) {
for (var R = -v; R <= v; R++) for (var E = -v; E <= v; E++) if (!(Math.abs(R) !== v && Math.abs(E) !== v && v > 0)) {
var T = d + R, C = y + E;
if (!(T < h || T > 49 - h || C < h || C > 49 - h)) {
var S = new RoomPosition(T, C, e.name), b = jp(e, S, t);
if (b.fits) {
var w = 1e3, O = S.getRangeTo(c);
O >= 4 && O <= 8 ? w += 100 : O < 4 ? w -= 50 : O > 12 && (w -= 30);
var _ = 0;
try {
...
if (M < 10 ? w += 50 : M > 20 && (w -= 30), void 0 !== b.wallCount && void 0 !== b.totalTiles) {
...
function zp(e, t) {
var r, o = Dp(t), n = {}, s = e.structures.filter(function(e) {
...
for (var m = Math.round(s / (a.length + 1)), f = Math.round(c / (a.length + 1)), d = 0; d < 15; d++) for (var y = -d; y <= d; y++) for (var h = -d; h <= d; h++) if (Math.abs(y) === d || Math.abs(h) === d) {
var g = m + y, v = f + h;
if (!(g < 3 || g > 46 || v < 3 || v > 46) && Yp(e, g, v)) {
if (Math.max(Math.abs(g - o.pos.x), Math.abs(v - o.pos.y)) > 20) continue;
if (i.get(g, v) === TERRAIN_MASK_WALL) continue;
...
var im = function() {
function e(e, t) {
void 0 === t && (t = {}), this.roomName = e, this.config = r(r({}, rm), t);
}
return e.prototype.run = function(e) {
var t, r, o, a = Rs.startRoom(this.roomName), i = Game.rooms[this.roomName];
...
var s = gn.getOrInitSwarmState(this.roomName);
if (this.config.enablePheromones && Game.time % 5 == 0 && Ep.updateMetrics(i, s), 
this.updateThreatAssessment(i, s), il.assess(i, s), cl.checkSafeMode(i, s), this.config.enableEvolution && (Gp.updateEvolutionStage(s, i, e), 
Gp.updateMissingStructures(s, i)), Lp.updatePosture(s), this.config.enablePheromones && Ep.updatePheromones(s, i), 
this.config.enableTowers && this.runTowerControl(i, s), this.config.enableConstruction && Lp.allowsBuilding(s.posture)) {
var c = tm(null !== (o = null === (r = i.controller) || void 0 === r ? void 0 : r.level) && void 0 !== o ? o : 1) ? 5 : 10;
...
Rs.recordRoom(i, l), Rs.endRoom(this.roomName, a);
} else Rs.endRoom(this.roomName, a);
}, e.prototype.updateThreatAssessment = function(e, t) {
var r, o, s, c, l, u, p, m, f, d;
if (Game.time % 5 == 0) {
var y = am(e), h = y.spawns.length + y.towers.length, g = nm.get(this.roomName);
g && g.lastTick < Game.time && h < g.lastStructureCount && (y.spawns.length < g.lastSpawns.length && Fn.emit("structure.destroyed", {
roomName: this.roomName,
structureType: STRUCTURE_SPAWN,
structureId: "unknown",
source: this.roomName
}), y.towers.length < g.lastTowers.length && Fn.emit("structure.destroyed", {
roomName: this.roomName,
structureType: STRUCTURE_TOWER,
structureId: "unknown",
source: this.roomName
})), nm.set(this.roomName, {
lastStructureCount: h,
lastSpawns: i([], a(y.spawns), !1),
lastTowers: i([], a(y.towers), !1),
lastTick: Game.time
});
}
...
var T = E.value;
try {
for (var C = (s = void 0, n(T.body)), S = C.next(); !S.done; S = C.next()) {
var b = S.value;
...
if (v.length > 0) {
var w = Mc(e), O = w.dangerLevel;
if (O > t.danger) {
if (Ep.updateDangerFromThreat(t, w.threatScore, w.dangerLevel), t.clusterId) {
var _ = gn.getCluster(t.clusterId);
_ && Ep.diffuseDangerToCluster(e.name, w.threatScore, _.memberRooms);
}
gn.addRoomEvent(this.roomName, "hostileDetected", "".concat(v.length, " hostiles, danger=").concat(O, ", score=").concat(w.threatScore));
try {
for (var x = n(v), U = x.next(); !U.done; U = x.next()) T = U.value, Fn.emit("hostile.detected", {
roomName: this.roomName,
hostileId: T.id,
...
t.danger = O;
} else t.danger > 0 && (Fn.emit("hostile.cleared", {
roomName: this.roomName,
source: this.roomName
}), t.danger = 0);
if (Game.time % 10 == 0) {
...
gn.addRoomEvent(this.roomName, "nukeDetected", "".concat(A.length, " nuke(s) incoming from ").concat(k)), 
t.nukeDetected = !0;
try {
for (var M = n(A), N = M.next(); !N.done; N = M.next()) {
var I = N.value;
Fn.emit("nuke.detected", {
roomName: this.roomName,
nukeId: I.id,
...
var n = Dc(null !== (i = null === (a = e.controller) || void 0 === a ? void 0 : a.level) && void 0 !== i ? i : 1, t.danger), s = r.pos.findClosestByRange(FIND_STRUCTURES, {
filter: function(e) {
...
try {
for (var p = n(s), m = p.next(); !m.done; m = p.next()) u(m.value);
} catch (e) {
r = {
error: e
};
...
var r, o, s, c = am(e), l = c.constructionSites;
if (!(l.length >= 10)) {
var u = null !== (o = null === (r = e.controller) || void 0 === r ? void 0 : r.level) && void 0 !== o ? o : 1, p = c.spawns[0], m = null == p ? void 0 : p.pos;
if (p) {
var f = Xp(e, u);
...
var d = null !== (s = null == f ? void 0 : f.blueprint) && void 0 !== s ? s : qp(u);
if (d && m) {
...
var a, i, s, c, l, u, p;
void 0 === o && (o = []);
var m = null !== (u = null === (l = e.controller) || void 0 === l ? void 0 : l.level) && void 0 !== u ? u : 1, f = zp(r, m), d = e.getTerrain(), y = [], h = new Map;
try {
for (var g = n(f), v = g.next(); !v.done; v = g.next()) {
var R = v.value, E = t.x + R.x, T = t.y + R.y;
if (!(E < 1 || E > 48 || T < 1 || T > 48) && d.get(E, T) !== TERRAIN_MASK_WALL) {
var C = "".concat(E, ",").concat(T);
h.has(R.structureType) || h.set(R.structureType, new Set), null === (p = h.get(R.structureType)) || void 0 === p || p.add(C);
}
}
} catch (e) {
a = {
...
if (h.set(STRUCTURE_ROAD, S), m >= 6) {
var b = e.find(FIND_MINERALS);
if (b.length > 0) {
var w = b[0], O = new Set;
O.add("".concat(w.pos.x, ",").concat(w.pos.y)), h.set(STRUCTURE_EXTRACTOR, O);
}
}
...
var A = U.value, k = (C = "".concat(A.pos.x, ",").concat(A.pos.y), A.structureType), M = h.get(k);
M && M.has(C) || y.push({
structure: A,
...
if (l >= 1) break;
f.destroy() === OK && (l++, Kr.info("Destroyed misplaced structure: ".concat(d), {
subsystem: "Blueprint",
room: f.room.name,
meta: {
...
if (y > 0) {
var h = 1 === y ? "structure" : "structures";
gn.addRoomEvent(this.roomName, "structureDestroyed", "".concat(y, " misplaced ").concat(h, " destroyed for blueprint compliance"));
}
}
var g = {
sitesPlaced: 0,
...
var t, r, o, s, c, l, u, p = Game.map.getRoomTerrain(e), m = [], f = [], d = function(e) {
...
for (var l = n(c), u = l.next(); !u.done; u = l.next()) {
var p = u.value;
s.add("".concat(p.pos.x, ",").concat(p.pos.y));
}
} catch (e) {
t = {
error: e
...
for (var m = 0; m < 50; m++) a.get(m, 0) === TERRAIN_MASK_WALL || s.has("".concat(m, ",0")) || o.push({
x: m,
y: 0,
exitDirection: "top",
isChokePoint: !1
});
for (m = 0; m < 50; m++) a.get(m, 49) === TERRAIN_MASK_WALL || s.has("".concat(m, ",49")) || o.push({
x: m,
y: 49,
exitDirection: "bottom",
isChokePoint: !1
});
for (var f = 1; f < 49; f++) a.get(0, f) === TERRAIN_MASK_WALL || s.has("0,".concat(f)) || o.push({
x: 0,
y: f,
exitDirection: "left",
isChokePoint: !1
});
for (f = 1; f < 49; f++) a.get(49, f) === TERRAIN_MASK_WALL || s.has("49,".concat(f)) || o.push({
x: 49,
y: f,
exitDirection: "right",
isChokePoint: !1
...
}), b = [], w = [], O = 0; O < S.length; O++) {
v = S[O];
var _ = S[O - 1];
!(_ && Math.abs(v.x - _.x) <= 1 && Math.abs(v.y - _.y) <= 1) && w.length > 0 && (b.push(w), 
w = []), w.push(v);
}
w.length > 0 && b.push(w);
try {
...
p.get(M, N) !== TERRAIN_MASK_WALL && (A.length >= 4 && (O === k || O === k - 1) ? f.push({
x: M,
y: N,
exitDirection: C,
isChokePoint: !1
...
}(e.name), f = [], d = [], y = i([], a(m.ramparts), !1);
try {
for (var h = n(m.walls), g = h.next(); !g.done; g = h.next()) {
var v = g.value, R = "".concat(v.x, ",").concat(v.y);
...
}(e, t, r, c), h = e.find(FIND_MY_CONSTRUCTION_SITES), g = e.find(FIND_STRUCTURES);
if (h.length >= 10) return {
sitesPlaced: 0,
wallsRemoved: 0
};
var v = 0, R = 0, E = Math.min(s, 10 - h.length), T = g.filter(function(e) {
return e.structureType === STRUCTURE_WALL;
}).length + h.filter(function(e) {
return e.structureType === STRUCTURE_WALL;
}).length, C = g.filter(function(e) {
return e.structureType === STRUCTURE_RAMPART;
}).length + h.filter(function(e) {
return e.structureType === STRUCTURE_RAMPART;
...
var r = t.destroy();
r === OK ? (R++, So.info("Removed wall at (".concat(e.x, ",").concat(e.y, ") to allow road passage"), {
subsystem: "Defense"
})) : So.warn("Failed to remove wall at (".concat(e.x, ",").concat(e.y, "): ").concat(r), {
subsystem: "Defense"
});
}
};
try {
for (var O = n(y.wallsToRemove), _ = O.next(); !_.done; _ = O.next()) w(_.value);
} catch (e) {
l = {
error: e
};
...
r || o || e.createConstructionSite(t.x, t.y, STRUCTURE_WALL) === OK && (v++, So.debug("Placed perimeter wall at (".concat(t.x, ",").concat(t.y, ")"), {
subsystem: "Defense"
}));
};
try {
for (var U = n(y.walls), A = U.next(); !A.done && "break" !== x(A.value); A = U.next()) ;
} catch (e) {
p = {
error: e
};
...
}) ? So.debug("Placed rampart at road crossing (".concat(t.x, ",").concat(t.y, ")"), {
subsystem: "Defense"
}) : So.debug("Placed rampart gap at (".concat(t.x, ",").concat(t.y, ")"), {
subsystem: "Defense"
}));
};
try {
for (var M = n(y.ramparts), N = M.next(); !N.done && "break" !== k(N.value); N = M.next()) ;
} catch (e) {
f = {
error: e
};
...
}(e, m, d.roads, u, v, t.remoteAssignments)).wallsRemoved > 0 && gn.addRoomEvent(this.roomName, "wallRemoved", "".concat(g.wallsRemoved, " wall(s) removed to allow road passage"));
}
var R = function(e, t, r) {
var o, s, c, l, u, p, m, f, d, y, h, g, v, R, E = null !== (y = null === (d = e.controller) || void 0 === d ? void 0 : d.level) && void 0 !== y ? y : 1, T = zp(r, E), C = e.getTerrain(), S = [];
if (E >= 6) {
var b = e.find(FIND_MINERALS);
if (b.length > 0) {
var w = b[0];
...
var O = i(i([], a(T), !1), a(S), !1), _ = 0, x = e.find(FIND_MY_CONSTRUCTION_SITES), U = e.find(FIND_STRUCTURES);
if (x.length >= 10) return 0;
var A = {};
try {
for (var k = n(U), M = k.next(); !M.done; M = k.next()) {
...
try {
for (var D = n(O), F = D.next(); !F.done && "break" !== L(F.value); F = D.next()) ;
} catch (e) {
u = {
error: e
};
...
var s = Kc(e, t), c = e.getTerrain(), l = e.find(FIND_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_ROAD;
}
}), u = new Set(l.map(function(e) {
return "".concat(e.pos.x, ",").concat(e.pos.y);
})), p = new Set(i.filter(function(e) {
return e.structureType === STRUCTURE_ROAD;
}).map(function(e) {
return "".concat(e.pos.x, ",").concat(e.pos.y);
})), m = 0;
try {
for (var f = n(s.positions), d = f.next(); !d.done; d = f.next()) {
var y = d.value;
if (m >= 2) break;
if (i.length + m >= 10) break;
if (!u.has(y) && !p.has(y)) {
var h = a(y.split(","), 2), g = h[0], v = h[1], R = parseInt(g, 10), E = parseInt(v, 10);
c.get(R, E) !== TERRAIN_MASK_WALL && e.createConstructionSite(R, E, STRUCTURE_ROAD) === OK && m++;
}
}
} catch (e) {
r = {
...
try {
for (var g = n(u), v = g.next(); !v.done; v = g.next()) h(T = v.value);
} catch (e) {
a = {
error: e
};
...
if (l.placed >= m) break;
var C = T.pos, S = C.x, b = C.y, w = e.createConstructionSite(S, b, STRUCTURE_RAMPART);
if (w === OK) l.placed++, So.debug("Placed rampart on ".concat(T.structureType, " at (").concat(S, ",").concat(b, ")"), {
subsystem: "Defense"
}); else if (w === ERR_FULL) break;
}
} catch (e) {
s = {
error: e
...
return (l.placed > 0 || y.length > 0) && So.info("Rampart automation for ".concat(e.name, ": ") + "".concat(l.protected, "/").concat(l.totalCritical, " protected, ") + "".concat(l.placed, " placed, ") + "".concat(y.length - l.placed, " pending"), {
subsystem: "Defense"
}), l;
}(e, u, t.danger, C)).placed > 0 && gn.addRoomEvent(this.roomName, "rampartPlaced", "".concat(T.placed, " rampart(s) placed on critical structures"));
}
t.metrics.constructionSites = l.length + R + E + g.sitesPlaced + T.placed;
}
...
var t = gn.getSwarmState(e.name);
if (t) {
Po.initialize(e.name), Vo.prepareLabs(e, t);
...
if (Po.areLabsReady(e.name, o)) {
var n = No.getConfig(e.name), a = null == n ? void 0 : n.activeReaction;
a && a.input1 === r.input1 && a.input2 === r.input2 && a.output === r.product || Po.setActiveReaction(e.name, r.input1, r.input2, r.product), 
em.executeReaction(e, r);
} else So.debug("Labs not ready for reaction: ".concat(r.input1, " + ").concat(r.input2, " -> ").concat(r.product), {
subsystem: "Labs",
room: e.name
});
}
...
if (s) {
var c = o.sources, l = a.filter(function(e) {
return c.some(function(t) {
return e.pos.getRangeTo(t) <= 2;
});
}), u = e.controller, p = u ? a.find(function(e) {
...
if (p && 0 === s.cooldown) {
var y = p.store.getUsedCapacity(RESOURCE_ENERGY) < 400, h = s.store.getUsedCapacity(RESOURCE_ENERGY) >= 400;
y && h && s.transferEnergy(p);
}
}
}
}
...
return e.prototype.run = function() {
var e, t, r, o, i, s, c, l, u = global, p = u._ownedRooms, m = u._ownedRoomsTick;
...
for (var d = n(l), y = d.next(); !y.done; y = d.next()) {
var h = y.value;
this.nodes.has(h.name) || this.nodes.set(h.name, new im(h.name));
}
} catch (t) {
e = {
error: t
...
try {
for (var g = n(this.nodes), v = g.next(); !v.done; v = g.next()) {
var R = a(v.value, 1)[0];
(h = Game.rooms[R]) && (null === (c = h.controller) || void 0 === c ? void 0 : c.my) || this.nodes.delete(R);
}
} catch (e) {
r = {
error: e
...
So.error("Error in room ".concat(C.roomName, ": ").concat(S), {
...
So.error("Error in room ".concat(e.name, ": ").concat(s), {
subsystem: "RoomManager",
room: e.name,
meta: {
stack: c
...
function lm(e) {
var t, r, o;
return e.find(FIND_HOSTILE_CREEPS).length > 0 ? En.CRITICAL : (null === (t = e.controller) || void 0 === t ? void 0 : t.my) ? En.HIGH : "ralphschuler" === (null === (o = null === (r = e.controller) || void 0 === r ? void 0 : r.reservation) || void 0 === o ? void 0 : o.username) ? En.MEDIUM : En.LOW;
}
...
function pm(e, t, r) {
var o;
return t === En.CRITICAL ? {
tickModulo: void 0,
tickOffset: void 0
} : t === En.HIGH && (null === (o = e.controller) || void 0 === o ? void 0 : o.my) ? {
tickModulo: 5,
tickOffset: r % 5
} : t === En.MEDIUM ? {
tickModulo: 10,
...
var a = Game.rooms[o];
r.add(o);
var i = "room:".concat(o), s = Fn.getProcess(i), c = lm(a), l = um(a);
...
try {
for (var u = n(this.registeredRooms), p = u.next(); !p.done; p = u.next()) o = p.value, 
...
So.debug("Registered room process: ".concat(e.name, " with priority ").concat(r, " ").concat(s), {
...
Fn.unregisterProcess(n), Fn.registerProcess({
id: n,
...
var s = i.tickModulo ? "mod=".concat(i.tickModulo, ", offset=").concat(i.tickOffset) : "every tick";
So.debug("Updated room process: ".concat(e.name, " priority=").concat(t, " budget=").concat(r, " (").concat(s, ")"), {
subsystem: "RoomProcessManager"
});
}, e.prototype.unregisterRoomProcess = function(e) {
var t = "room:".concat(e);
Fn.unregisterProcess(t), this.registeredRooms.delete(e), this.roomIndices.delete(e), 
So.debug("Unregistered room process: ".concat(e), {
subsystem: "RoomProcessManager"
});
}, e.prototype.getMinBucketForPriority = function(e) {
return 0;
...
if (p) {
var m = lm(p), f = null !== (r = En[m]) && void 0 !== r ? r : "UNKNOWN";
i[f] = (null !== (o = i[f]) && void 0 !== o ? o : 0) + 1, (null === (a = p.controller) || void 0 === a ? void 0 : a.my) && s++;
}
}
} catch (t) {
e = {
...
var u = new PathFinder.CostMatrix, p = s.find(FIND_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_ROAD;
}
});
...
var r, o, a, i, s, c, l = this, u = e.storage, p = e.find(FIND_MY_SPAWNS);
if (u || 0 !== p.length) {
var m = 0;
try {
for (var f = n(t), d = f.next(); !d.done; d = f.next()) {
var y = d.value, h = Game.rooms[y];
if (h) {
var g = h.find(FIND_SOURCES), v = h.find(FIND_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_CONTAINER;
}
});
...
var R = p[0];
try {
for (var E = (a = void 0, n(g)), T = E.next(); !T.done; T = E.next()) {
...
return e.structureType === STRUCTURE_CONTAINER;
}), O = w.length > 0 ? w.map(function(e) {
return e.pos;
}) : g.map(function(e) {
return e.pos;
});
try {
for (var _ = (s = void 0, n(O)), x = _.next(); !x.done; x = _.next()) {
...
debug: function(e, t) {
return Hr("RemoteMining").debug(e, t);
},
info: function(e, t) {
return Hr("RemoteMining").info(e, t);
},
warn: function(e, t) {
return Hr("RemoteMining").warn(e, t);
},
error: function(e, t) {
return Hr("RemoteMining").error(e, t);
}
}, Cm = {
...
}, Tm), bm = new Em(Tm, Cm, Sm), wm = function() {
function e() {
this.logger = Hr("Pathfinding");
}
...
u.length > 0 && (ji(a.pos, l.pos, u), ji(l.pos, a.pos, u));
}
} catch (e) {
t = {
error: e
...
if (e.controller) {
var p = e.findPath(a.pos, e.controller.pos, {
ignoreCreeps: !0,
range: 3,
serialize: !1
});
p.length > 0 && ji(a.pos, e.controller.pos, p);
}
}
}
}(e);
...
}(), Um = new ym(new wm, new Om, new _m, new xm), Am = Hr("SS2TerminalComms"), km = function() {
function e() {}
...
for (var u = [], p = 0; p <= l.finalPacket; p++) {
var m = l.packets.get(p);
if (!m) {
Am.warn("Missing packet in multi-packet message", {
meta: {
packetId: p,
messageId: s.msgId,
sender: i.sender.username
...
sender: i.sender.username,
message: f
}), this.messageBuffers.delete(c), this.saveStateToMemory(), Am.info("Received complete multi-packet message from ".concat(i.sender.username), {
meta: {
messageId: s.msgId,
packets: u.length,
totalSize: f.length,
...
return r.length > 0 && Am.debug("Processed ".concat(Game.market.incomingTransactions.length, " terminal transactions, completed ").concat(r.length, " messages")), 
r;
...
return i ? (this.queuePackets(e.id, t, r, o, a, i), Am.info("Queued ".concat(a.length, " packets for multi-packet message"), {
meta: {
terminalId: e.id,
messageId: i,
packets: a.length,
...
}), OK) : (Am.error("Failed to extract message ID from first packet"), ERR_INVALID_ARGS);
...
Am.debug("Queue processing stopped due to CPU budget limit (".concat(5, " CPU)"));
break;
}
...
if (h === OK) {
if (Memory.ss2PacketQueue[m].nextPacketIndex = f.nextPacketIndex + 1, i++, Memory.ss2PacketQueue[m].nextPacketIndex >= f.packets.length) {
var g = this.extractMessageId(y);
Am.info("Completed sending multi-packet message", {
meta: {
messageId: g,
...
} else h === ERR_NOT_ENOUGH_RESOURCES ? Am.warn("Not enough resources to send packet, will retry next tick", {
meta: {
queueKey: m,
resource: f.resourceType,
amount: f.amount
}
}) : (Am.error("Failed to send packet: ".concat(h, ", removing queue item"), {
meta: {
queueKey: m,
result: h
}
}), s.push(m));
} else Am.warn("No packet at index ".concat(f.nextPacketIndex, ", removing queue item"), {
meta: {
queueKey: m
}
}), s.push(m);
}
} else Am.warn("Terminal not found for queue item, removing from queue", {
meta: {
queueKey: m,
...
return i > 0 && Am.debug("Sent ".concat(i, " queued packets this tick")), i;
...
var f = this.extractMessageId(m.packets[0]);
Am.warn("Queue item timed out after ".concat(i - m.queuedAt, " ticks"), {
meta: {
messageId: f,
queueKey: p,
...
try {
for (var d = n(s), y = d.next(); !y.done; y = d.next()) {
var h = y.value;
...
var s = a(i.value, 2), c = s[0], l = s[1];
r - l.receivedAt > this.MESSAGE_TIMEOUT && (Am.warn("Message timed out", {
meta: {
messageId: l.msgId,
sender: l.sender
}
...
return Am.error("Error parsing JSON", {
meta: {
error: String(e)
}
}), null;
...
var e = Fn.getBucketMode();
return "critical" === e || "low" === e ? "low" : "high" === e ? "high" : "normal";
}, e.prototype.updateBucketMode = function() {
var e = this.getBucketMode();
e !== this.currentMode && (So.info("Bucket mode changed: ".concat(this.currentMode, " -> ").concat(e), {
subsystem: "Scheduler"
}), this.currentMode = e);
}, e.prototype.getCpuLimit = function() {
var e = Game.cpu.limit;
...
So.error("Task ".concat(i.name, " failed: ").concat(c), {
subsystem: "Scheduler"
});
}
var l = Game.cpu.getUsed() - s;
if (this.tickCpuUsed += l, !this.hasCpuBudget()) {
So.warn("CPU budget exhausted, skipping remaining tasks", {
subsystem: "Scheduler"
});
break;
}
...
var Im = new Is({}, gn), Pm = new Ds({}, gn), Gm = !1, Lm = !1;

function Dm() {
var e, t;
Lm && Game.time % 10 != 0 || So.info("SwarmBot loop executing at tick ".concat(Game.time), {
subsystem: "SwarmBot",
meta: {
systemsInitialized: Lm
}
}), Lm || (co({
level: (t = Pn()).debug ? oo.DEBUG : oo.INFO,
cpuLogging: t.profiling,
enableBatching: !0,
maxBatchSize: 50
}), So.info("Bot initialized", {
subsystem: "SwarmBot",
meta: {
debug: t.debug,
profiling: t.profiling
}
}), Rs.initialize(), t.profiling && (function() {
...
bp(e, "say", "say")), Fn.on("structure.destroyed", function(e) {
var t = gn.getSwarmState(e.roomName);
t && (Ep.onStructureDestroyed(t, e.structureType), Kr.debug("Pheromone update: structure destroyed in ".concat(e.roomName), {
subsystem: "Pheromone",
room: e.roomName
}));
}), Fn.on("remote.lost", function(e) {
var t = gn.getSwarmState(e.homeRoom);
t && (Ep.onRemoteSourceLost(t), Kr.info("Pheromone update: remote source lost for ".concat(e.homeRoom), {
subsystem: "Pheromone",
room: e.homeRoom
}));
}), Kr.info("Pheromone event handlers initialized", {
subsystem: "Pheromone"
}), Um.initializePathCacheEvents(), bm.initialize(ci.MEDIUM), eo.initialize(), Ca.initialize(), 
Lm = !0), Fn.updateFromCpuConfig(Pn().cpu), Gm || (So.info("Registering all processes with kernel...", {
subsystem: "ProcessRegistry"
}), function() {
for (var e, t, r = [], o = 0; o < arguments.length; o++) r[o] = arguments[o];
try {
for (var a = n(r), i = a.next(); !i.done; i = a.next()) qn(i.value);
} catch (t) {
e = {
error: t
};
...
So.info("Registered decorated processes from ".concat(r.length, " instance(s)"), {
subsystem: "ProcessDecorators"
});
}(Cp, _u, Mu, Ru, Du, Wa, fp, Cu, ap, sp, op, ra, $n, Ca, hp, ui, pl, el), So.info("Registered ".concat(Fn.getProcesses().length, " processes with kernel"), {
subsystem: "ProcessRegistry"
}), Fn.initialize(), Gm = !0), Rs.startTick(), "critical" === Fn.getBucketMode() && Game.time % 10 == 0 && So.warn("CRITICAL: CPU bucket at ".concat(Game.cpu.bucket, ", continuing normal processing"), {
subsystem: "SwarmBot"
}), ou.clear(), Xs.clear(), bn.startTick();
var r, o = "_ownedRooms", a = "_ownedRoomsTick", i = global, s = i[o], c = i[a];
s && c === Game.time ? r = s : (r = Object.values(Game.rooms).filter(function(e) {
var t;
return null === (t = e.controller) || void 0 === t ? void 0 : t.my;
}), i[o] = r, i[a] = Game.time), rc.preTick(), gn.initialize(), Rs.measureSubsystem("processSync", function() {
...
for (var o = n(Object.values(Game.rooms)), a = o.next(); !a.done; a = o.next()) {
var i = a.value;
(null === (r = i.controller) || void 0 === r ? void 0 : r.my) && tu(i, gn.getOrInitSwarmState(i.name));
}
} catch (t) {
e = {
error: t
...
km.processQueue();
}), Fn.hasCpuBudget() && Rs.measureSubsystem("powerCreeps", function() {
!function() {
var e, t;
try {
for (var r = n(Object.values(Game.powerCreeps)), o = r.next(); !o.done; o = r.next()) {
var a = o.value;
void 0 !== a.ticksToLive && Ll(a);
}
} catch (t) {
e = {
error: t
...
}), Fn.hasCpuBudget() && Rs.measureSubsystem("visualizations", function() {
!function() {
var e, t;
if (Pn().visualizations) {
var r = function() {
var e;
...
var s = e instanceof Error ? e.message : String(e);
So.error("Visualization error in ".concat(i.name, ": ").concat(s), {
...
s = e instanceof Error ? e.message : String(e), So.error("Map visualization error: ".concat(s), {
subsystem: "visualizations"
});
}
}
}();
}), rc.reconcileTraffic(), Fn.hasCpuBudget() && Rs.measureSubsystem("scheduledTasks", function() {
var e;
e = Math.max(0, Game.cpu.limit - Game.cpu.getUsed()), Ei.run(e);
}), gn.persistHeapCache(), Rs.collectProcessStats(Fn.getProcesses().reduce(function(e, t) {
return e.set(t.id, t), e;
}, new Map)), Rs.collectKernelBudgetStats(Fn), Rs.setSkippedProcesses(Fn.getSkippedProcessesThisTick()), 
Rs.finalizeTick(), So.flush();
}

var Fm = function() {
function e() {}
return e.prototype.toggleVisualizations = function() {
var e = !Pn().visualizations;
return Gn({
visualizations: e
}), "Visualizations: ".concat(e ? "ENABLED" : "DISABLED");
}, e.prototype.toggleVisualization = function(e) {
var t = Im.getConfig(), r = Object.keys(t).filter(function(e) {
return e.startsWith("show") && "boolean" == typeof t[e];
});
if (!r.includes(e)) return "Invalid key: ".concat(e, ". Valid keys: ").concat(r.join(", "));
var o = e;
Im.toggle(o);
var n = Im.getConfig()[o];
return "Room visualization '".concat(e, "': ").concat(n ? "ENABLED" : "DISABLED");
}, e.prototype.toggleMapVisualization = function(e) {
var t = Pm.getConfig(), r = Object.keys(t).filter(function(e) {
return e.startsWith("show") && "boolean" == typeof t[e];
});
if (!r.includes(e)) return "Invalid key: ".concat(e, ". Valid keys: ").concat(r.join(", "));
var o = e;
Pm.toggle(o);
var n = Pm.getConfig()[o];
...
var t = {
pheromones: Yo.Pheromones,
paths: Yo.Paths,
traffic: Yo.Traffic,
defense: Yo.Defense,
economy: Yo.Economy,
construction: Yo.Construction,
performance: Yo.Performance
}, r = t[e.toLowerCase()];
...
var e, t, r, o = ks.getConfig(), i = "=== Visualization Configuration ===\n";
i += "Mode: ".concat(o.mode, "\n"), i += "\nEnabled Layers:\n";
var s = ((e = {})[Yo.Pheromones] = "Pheromones", e[Yo.Paths] = "Paths", e[Yo.Traffic] = "Traffic", 
e[Yo.Defense] = "Defense", e[Yo.Economy] = "Economy", e[Yo.Construction] = "Construction", 
e[Yo.Performance] = "Performance", e);
try {
for (var c = n(Object.entries(s)), l = c.next(); !l.done; l = c.next()) {
var u = a(l.value, 2), p = u[0], m = u[1], f = parseInt(p, 10), d = 0 !== (o.enabledLayers & f);
i += "  ".concat(m, ": ").concat(d ? "✓" : "✗", "\n");
}
} catch (e) {
t = {
...
category: "Visualization"
}) ], e.prototype, "toggleVisualizations", null), o([ _o({
...
category: "Visualization"
}) ], e.prototype, "toggleVisualization", null), o([ _o({
...
category: "Visualization"
}) ], e.prototype, "toggleMapVisualization", null), o([ _o({
name: "showMapConfig",
description: "Show current map visualization configuration",
usage: "showMapConfig()",
examples: [ "showMapConfig()" ],
category: "Visualization"
}) ], e.prototype, "showMapConfig", null), o([ _o({
name: "setVisMode",
...
category: "Visualization"
}) ], e.prototype, "setVisMode", null), o([ _o({
name: "toggleVisLayer",
...
try {
for (var h = n(y.slice(0, 10)), g = h.next(); !g.done; g = h.next()) {
var v = g.value;
...
if (p || "subsystem" === e) {
var w = u.subsystems || {}, O = Object.values(w);
if (O.length > 0) {
...
m.push("  ".concat(G, " (").concat(P.role, "): ").concat(P.cpu.toFixed(3), " CPU in ").concat(P.current_room));
}
}
} catch (e) {
c = {
...
var e, t, r, o, a = Rs.validateBudgets(), i = "=== CPU Budget Report (Tick ".concat(a.tick, ") ===\n");
...
try {
for (var m = n(c), f = m.next(); !f.done; f = m.next()) p = f.value, i += "  ".concat(p.target, ": ").concat(p.cpuUsed.toFixed(3), " CPU / ").concat(p.budgetLimit.toFixed(3), " limit (").concat((100 * p.percentUsed).toFixed(1), "%)\n");
} catch (e) {
r = {
error: e
};
...
var e, t, r, o, a = Rs.detectAnomalies();
...
try {
for (var m = n(c), f = m.next(); !f.done; f = m.next()) p = f.value, i += "  ".concat(p.target, ": ").concat(p.current.toFixed(3), " CPU (").concat(p.multiplier.toFixed(1), "x budget ").concat(p.baseline.toFixed(3), ")\n"), 
p.context && (i += "    Context: ".concat(p.context, "\n"));
} catch (e) {
r = {
error: e
...
var t, r, o, a;
void 0 === e && (e = !1);
var i = Rs.getCurrentSnapshot(), s = "=== CPU Profile (Tick ".concat(i.tick, ") ===\n");
...
s += "  ".concat(m.name, " (RCL").concat(m.rcl, ", ").concat(f, "): avg ").concat(m.profiler.avgCpu.toFixed(3), " | peak ").concat(m.profiler.peakCpu.toFixed(3), " | samples ").concat(m.profiler.samples, "\n");
}
} catch (e) {
t = {
error: e
...
try {
for (var y = n(d), h = y.next(); !h.done; h = y.next()) {
var g = h.value, v = g.cpuBudget > 0 ? (g.avgCpu / g.cpuBudget * 100).toFixed(0) : "N/A";
s += "  ".concat(g.name, " (").concat(g.frequency, "): avg ").concat(g.avgCpu.toFixed(3), " / budget ").concat(g.cpuBudget.toFixed(3), " (").concat(v, "%)\n");
}
} catch (e) {
o = {
error: e
...
var s = Rs.getCurrentSnapshot(), c = s.rooms[e];
if (!c) return "Error: No stats available for ".concat(e, ". The room may not have been processed yet.");
var l = "room:".concat(e), u = s.processes[l], p = gn.getSwarmState(e), m = p && ("war" === p.posture || "siege" === p.posture || p.danger >= 2), f = m ? .25 : .1, d = null !== (o = null == u ? void 0 : u.tickModulo) && void 0 !== o ? o : 1, y = f * d, h = "═══════════════════════════════════════════════\n";
h += "  Room Diagnostic: ".concat(e, "\n"), h += "═══════════════════════════════════════════════\n\n", 
h += "📊 Basic Info:\n", h += "  RCL: ".concat(c.rcl, "\n"), h += "  Controller Progress: ".concat(c.controller.progressPercent.toFixed(1), "%\n"), 
h += "  Posture: ".concat(Rs.postureCodeToName(c.brain.postureCode), "\n"), h += "  Danger Level: ".concat(c.brain.dangerLevel, "\n"), 
...
h += "     - War mode increases CPU budget to ".concat(m ? y.toFixed(3) : (.25 * d).toFixed(3), "\n")), 
...
category: "Statistics"
}) ], e.prototype, "resetCacheStats", null), o([ _o({
...
category: "Statistics"
}) ], e.prototype, "roomFindCacheStats", null), o([ _o({
...
try {
for (var m = n(a.unhealthyProcesses), f = m.next(); !f.done; f = m.next()) p = f.value, 
...
try {
for (var c = n(s), l = c.next(); !l.done; l = c.next()) {
var u = l.value, p = u.stats.avgCpu.toFixed(4), m = u.stats.healthScore.toFixed(0), f = u.stats.healthScore >= 80 ? "✓" : u.stats.healthScore >= 50 ? "⚠" : "✗";
...
try {
for (var c = n(o), l = c.next(); !l.done; l = c.next()) {
var u = l.value, p = u.stats.healthScore.toFixed(0), m = u.stats.healthScore >= 80 ? "✓" : u.stats.healthScore >= 50 ? "⚠" : "✗", f = u.stats.lastSuccessfulRunTick > 0 ? Game.time - u.stats.lastSuccessfulRunTick : "never", d = "suspended" === u.state ? "SUSPENDED (".concat(u.stats.suspensionReason, ")") : u.state.toUpperCase();
s += "".concat(u.name, " | ").concat(m, " ").concat(p, "/100 | ").concat(u.stats.errorCount, " | ").concat(u.stats.consecutiveErrors, " | ").concat(d, " | ").concat(f, "\n");
}
} catch (t) {
e = {
error: t
...
var e, t, r = Fn.getProcesses().filter(function(e) {
return "suspended" === e.state;
});
...
var t, r, o = Fn.getProcesses().filter(function(e) {
...
s += "".concat(p.name, " | ").concat(p.priority, " | ").concat(p.stats.runCount, " | ").concat(m, " | ").concat(p.stats.errorCount, "\n");
}
} catch (e) {
t = {
error: e
...
try {
for (var c = n(s), l = c.next(); !l.done; l = c.next()) {
var u = l.value, p = u.stats.avgCpu.toFixed(4);
...
category: "Kernel"
}) ], e.prototype, "showKernelStats", null), o([ _o({
name: "listProcesses",
description: "List all registered kernel processes",
usage: "listProcesses()",
examples: [ "listProcesses()" ],
category: "Kernel"
}) ], e.prototype, "listProcesses", null), o([ _o({
name: "suspendProcess",
...
category: "Kernel"
}) ], e.prototype, "showProcessHealth", null), o([ _o({
...
category: "Kernel"
}) ], e.prototype, "listCreepProcesses", null), o([ _o({
...
}(), Wm = new ss, Km = new Fm, Ym = new Bm, jm = new ls, Vm = new Hm, zm = new cs, qm = Co("Main");

!function(e) {
void 0 === e && (e = !1);
var t = function() {
Oo.initialize(), xo(Wm), xo(Km), xo(Ym), xo(jm), xo(Vm), xo(zm), xo(ia), xo(sa), 
xo(ca), xo(ba), xo(xa), xo(Ya), xo(fi), global.tooangel = pi;
var e = global;
e.botConfig = {
getConfig: Pn,
updateConfig: Gn
...
configureLogger: co
}, e.botVisualizationManager = ks, e.botCacheManager = Bi, Oo.exposeToGlobal();
};
e ? (Oo.initialize(), Oo.enableLazyLoading(t), Oo.exposeToGlobal()) : t();
}(Pn().lazyLoadConsoleCommands);

var Xm = no.wrapLoop(function() {
try {
Dm();
} catch (e) {
throw qm.error("Critical error in main loop: ".concat(String(e)), {
meta: {
