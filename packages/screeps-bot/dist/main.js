...
var e = require("@ralphschuler/screeps-stats"), t = require("@ralphschuler/screeps-utils"), r = require("@ralphschuler/screeps-visuals"), o = require("@ralphschuler/screeps-defense"), n = require("@ralphschuler/screeps-economy"), a = require("@ralphschuler/screeps-chemistry"), i = require("@ralphschuler/screeps-pathfinding"), s = require("@ralphschuler/screeps-remote-mining"), c = function() {
...
var D, F, B, W, V, j, K, H, q, Y, z, X, Q, J, $, Z, ee, te, re, oe, ne, ae, ie, se, ce, ue, le, me, pe, fe, de, ye, he, ge, ve, Re, Ee, Te, Se, Ce, we, be, xe, Oe, _e, Ae, Ne, Me, Ue, ke, Pe, Ie, Ge, Le, De, Fe, Be, We, Ve, je, Ke, He, qe, Ye, ze, Xe, Qe, Je, $e, Ze, et, tt, rt, ot, nt, at, it, st, ct, ut, lt, mt, pt, ft, dt, yt, ht, gt, vt, Rt, Et, Tt, St = E(Object.freeze({
__proto__: null,
default: {}
}));
...
var k = St, P = k.custom, I = H(P) ? P : null, G = {
__proto__: null,
double: '"',
single: "'"
}, L = {
...
var ue = re(t, q);
return "cause" in Error.prototype || !("cause" in t) || N.call(t, "cause") ? 0 === ue.length ? "[" + String(t) + "]" : "{ [" + String(t) + "] " + S.call(ue, ", ") + " }" : "{ [" + String(t) + "] " + S.call(T.call("[cause]: " + q(t.cause), ue), ", ") + " }";
}
...
var e;
Ze = 1;
var t = wt(), r = bt(), o = xt(), n = Ot(), a = _t(), i = At(), s = L(), c = Nt(), u = Mt(), l = Ut(), m = kt(), p = Pt(), f = It(), d = Gt(), y = Dt(), h = Function, g = function(e) {
try {
return h('"use strict"; return (' + e + ").constructor;")();
} catch (e) {}
}, v = Bt(), R = Wt(), E = function() {
throw new s;
}, T = v ? function() {
try {
return E;
...
}() : E, S = Vt()(), C = Jt(), w = Kt(), b = jt(), x = zt(), O = Yt(), _ = {}, A = "undefined" != typeof Uint8Array && C ? C(Uint8Array) : e, N = {
__proto__: null,
...
function sr() {
return Et || (Et = 1, Rt = "function" == typeof URL ? URL : function() {
if (vt) return k;
vt = 1;
var e = G();
function t() {
...
e && (this.hostname = e);
}, k.parse = y, k.resolve = function(e, t) {
return y(e, !1, !0).resolve(t);
}, k.resolveObject = function(e, t) {
...
function Lr(e) {
kr.enableBatching ? (Pr.push(e), Pr.length >= kr.maxBatchSize && Dr()) : console.log(e);
}
...
function Wr(e, t) {
kr.level <= Ar.DEBUG && Lr(Br("DEBUG", e, t));
}

function Vr(e, t) {
kr.level <= Ar.INFO && Lr(Br("INFO", e, t));
}

function jr(e, t) {
kr.level <= Ar.WARN && Lr(Br("WARN", e, t));
}

function Kr(e, t) {
kr.level <= Ar.ERROR && Lr(Br("ERROR", e, t));
}
...
c.push("    Examples:");
try {
for (var R = (n = void 0, l(g.metadata.examples)), E = R.next(); !E.done; E = R.next()) {
var T = E.value;
c.push("      ".concat(T));
}
} catch (e) {
...
}(), Oo = new xo(wo(To().cpu)), _o = function() {
function e(e) {
...
try {
for (var T = l(this.stats.values()), S = T.next(); !S.done; S = T.next()) g += (u = S.value).hits, 
...
try {
for (var C = l(this.stores.values()), w = C.next(); !w.done; w = C.next()) E += w.value.size();
} catch (e) {
o = {
error: e
};
...
var Lo = "roomFind", Do = ((Uo = {})[FIND_SOURCES] = 5e3, Uo[FIND_MINERALS] = 5e3, 
Uo[FIND_DEPOSITS] = 100, Uo[FIND_STRUCTURES] = 50, Uo[FIND_MY_STRUCTURES] = 50, 
Uo[FIND_HOSTILE_STRUCTURES] = 20, Uo[FIND_MY_SPAWNS] = 100, Uo[FIND_MY_CONSTRUCTION_SITES] = 20, 
Uo[FIND_CONSTRUCTION_SITES] = 20, Uo[FIND_CREEPS] = 5, Uo[FIND_MY_CREEPS] = 5, Uo[FIND_HOSTILE_CREEPS] = 3, 
Uo[FIND_DROPPED_RESOURCES] = 5, Uo[FIND_TOMBSTONES] = 10, Uo[FIND_RUINS] = 10, Uo[FIND_FLAGS] = 50, 
Uo[FIND_NUKES] = 20, Uo[FIND_POWER_CREEPS] = 10, Uo[FIND_MY_POWER_CREEPS] = 10, 
Uo);
...
}(), vn = new gn, Rn = "empire", En = "clusters", Tn = function() {
function e() {
...
var e = "memory:".concat(En), t = eo.get(e);
if (!t) {
this.ensureClustersMemory();
var r = Memory;
eo.set(e, r[En], Qr), t = r[En];
}
return t;
...
R && y++;
try {
for (var E = (o = void 0, l(v)), T = E.next(); !T.done; T = E.next()) {
var S = T.value;
...
return Xr.debug("Remote hauler calculation: ".concat(e, " -> ").concat(t, " (").concat(r, " sources, ").concat(m, " rooms away) - RT: ").concat(p, " ticks, E/tick: ").concat(f, ", Min: ").concat(R, ", Rec: ").concat(E, ", Cap: ").concat(d.capacity), {
...
var Un, kn = ((An = {})[MOVE] = 50, An[WORK] = 100, An[CARRY] = 50, An[ATTACK] = 80, 
...
return e.priority >= Un.EMERGENCY;
});
...
return e.priority >= Un.HIGH && e.priority < Un.EMERGENCY;
}).length,
normal: t.requests.filter(function(e) {
return e.priority >= Un.NORMAL && e.priority < Un.HIGH;
}).length,
low: t.requests.filter(function(e) {
return e.priority < Un.NORMAL;
}).length,
...
try {
for (var R = l(v), E = R.next(); !E.done; E = R.next()) {
var T = E.value;
g[T.n] = {
name: T.n,
...
function e(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = c(c({}, Jn), e), this.interShardMemory = {
version: 1,
shards: {},
globalTargets: {
targetPowerLevel: 0
...
var R = 0;
try {
for (var E = l(u), T = E.next(); !T.done; T = E.next()) {
...
var o = $n[e.role], n = t === r ? Game.cpu.bucket : e.health.bucketLevel;
...
var n = ea.getActiveTransferTasks();
try {
...
var t = ea.getOptimalPortalRoute(e.targetShard);
if (t) {
...
ea.updateTaskProgress(e.taskId, t);
...
return e === CARRY;
}).length, u = Math.ceil(i / c), l = Math.min(u, 3), m = Un.NORMAL;
m = e.priority >= 80 ? Un.HIGH : e.priority >= 50 ? Un.NORMAL : Un.LOW;
for (var p = 0; p < l; p++) {
var f = {
...
if (0 === t.length) return e.status = "failed", void ea.updateTaskProgress(e.taskId, e.transferred, "failed");
t.filter(function(t) {
...
return void 0 !== e;
}).length && (e.status = "complete", e.transferred = e.amount, ea.updateTaskProgress(e.taskId, 100, "complete"), 
ea.recordPortalTraversal(e.portalRoom, e.targetShard, !0), Xr.info("Transfer request ".concat(e.taskId, " completed"), {
subsystem: "CrossShardTransfer"
}));
...
}(), ra = new ta, oa = new Map, na = -1, aa = null;

function ia(e, t) {
var r, o;
void 0 === t && (t = !1), na === Game.time && aa === Game.creeps || (oa.clear(), 
na = Game.time, aa = Game.creeps);
var n = t ? "".concat(e, "_active") : e, a = oa.get(n);
...
var p = m.value, f = sa(e, t, p), d = Game.rooms[p];
...
if ("remoteHarvester" === t || "remoteHauler" === t) return null !== ca(e, t, r);
if ("remoteWorker" === t) {
if (0 === (p = null !== (i = r.remoteAssignments) && void 0 !== i ? i : []).length) return !1;
var m = function(e, t) {
na === Game.time && aa === Game.creeps || (oa.clear(), na = Game.time, aa = Game.creeps);
var r = "".concat(e, ":").concat(t), o = oa.get(r);
...
if (g.length > 0 && sa(e, t, y) < Math.min(u.maxPerRoom, Math.ceil(g.length / 2))) return !0;
}
}
} catch (e) {
n = {
...
var v = null !== (c = ia(e).get(t)) && void 0 !== c ? c : 0, R = u.maxPerRoom;
...
if (c) {
var u = e.energyCapacityAvailable, p = e.energyAvailable, f = 0 === ma(ia(e.name, !0)), d = f ? p : u;
...
var y = ia(e.name, !0), h = ia(e.name, !1), g = null !== (n = y.get("larvaWorker")) && void 0 !== n ? n : 0, v = null !== (a = y.get("harvester")) && void 0 !== a ? a : 0;
Xr.info("BOOTSTRAP MODE: ".concat(ma(y), " active energy producers ") + "(".concat(g, " larva, ").concat(v, " harvest), ").concat(ma(h), " total. ") + "Energy: ".concat(p, "/").concat(u), {
subsystem: "spawn",
room: e.name
});
}
...
var o, n, a;
if (0 === ma(ia(e, !0))) return Xr.info("Bootstrap: Spawning larvaWorker (emergency - no active energy producers)", {
subsystem: "spawn",
room: e
}), "larvaWorker";
var i = ia(e, !1), s = pa(t);
...
if (!(O = $o[R])) return;
var E = da(O, d);
if (E && p >= E.cost) ; else if (!(E = da(O, p))) return void Xr.info("Bootstrap: No affordable body for ".concat(R, " (available: ").concat(p, ", min needed: ").concat(null !== (s = null === (i = O.bodies[0]) || void 0 === i ? void 0 : i.cost) && void 0 !== s ? s : "unknown", ")"), {
subsystem: "spawn",
room: e.name
});
var T = ya(R);
...
if (S === OK) Xr.info("BOOTSTRAP SPAWN: ".concat(R, " (").concat(T, ") with ").concat(E.parts.length, " parts, cost ").concat(E.cost, ". Recovery in progress."), {
subsystem: "spawn",
room: e.name
...
Xr.warn("BOOTSTRAP SPAWN FAILED: ".concat(R, " (").concat(T, ") - ").concat(C, ". Body: ").concat(E.parts.length, " parts, cost: ").concat(E.cost, ", available: ").concat(p), {
subsystem: "spawn",
room: e.name,
meta: {
errorCode: S,
...
var w = function(e, t) {
var r, o, n, a, i = ia(e.name), s = function(e) {
switch (e) {
case "eco":
return {
harvester: 1.5,
...
if (la(e.name, d, t)) {
var h = y.priority, g = null !== (n = s[d]) && void 0 !== n ? n : .5, v = _n(d, t.pheromones), R = On(e, t, d), E = null !== (a = i.get(d)) && void 0 !== a ? a : 0, T = (h + R) * g * v * (y.maxPerRoom > 0 ? Math.max(.1, 1 - E / y.maxPerRoom) : .1);
c.push({
role: d,
score: T
});
...
var ga = zr("CreepContext"), va = ((Qn = {})[STRUCTURE_SPAWN] = 100, Qn[STRUCTURE_EXTENSION] = 90, 
Qn[STRUCTURE_TOWER] = 80, Qn[STRUCTURE_RAMPART] = 75, Qn[STRUCTURE_WALL] = 70, Qn[STRUCTURE_STORAGE] = 70, 
Qn[STRUCTURE_CONTAINER] = 60, Qn[STRUCTURE_ROAD] = 30, Qn), Ra = new Map;
...
var r, o, n = null !== (r = va[e.structureType]) && void 0 !== r ? r : 50;
return (null !== (o = va[t.structureType]) && void 0 !== o ? o : 50) - n;
})), e._prioritizedSites;
}

function Sa(e) {
return void 0 === e._repairTargets && (Ea(e), e._repairTargets = e.allStructures.filter(function(e) {
...
return Ra.set(e.name, o), o;
}(n);
void 0 === a.working && (a.working = e.store.getUsedCapacity() > 0, ga.debug("".concat(e.name, " initialized working=").concat(a.working, " from carry state"), {
creep: e.name
}));
...
get containers() {
return void 0 === (e = i)._containers && (Ea(e), e._containers = e.allStructures.filter(function(e) {
return e.structureType === STRUCTURE_CONTAINER;
})), e._containers;
var e;
},
get depositContainers() {
return void 0 === (e = i)._depositContainers && (Ea(e), e._depositContainers = e.allStructures.filter(function(e) {
return e.structureType === STRUCTURE_CONTAINER;
...
}, g = i, v = Function.prototype, E = v.call, T = g && v.bind.bind(E, E), S = g ? T : function(e) {
return function() {
...
var Gr = Bt.exports, Lr = B, Dr = Et, Fr = Gr, Br = we, Wr = {}, Vr = Math.ceil, jr = Math.floor, Kr = Math.trunc || function(e) {
var t = +e;
return (t > 0 ? jr : Vr)(t);
}, Hr = function(e) {
var t = +e;
...
}, xa = (e, t) => `cg_${e.key}_${t}`, Oa = (e, t) => Object.assign(Object.assign({}, e), {
get(r) {
var o;
const n = e.get(r);
if (n) try {
const e = null !== (o = Ra.get(xa(t, n))) && void 0 !== o ? o : t.deserialize(n);
return void 0 !== e && Ra.set(xa(t, n), e, Game.time + CREEP_LIFE_TIME), e;
} catch (o) {
return e.delete(r), void Ra.delete(xa(t, n));
}
},
set(r, o, n) {
const a = e.get(r);
...
i ? (e.set(r, i, n), Ra.set(xa(t, i), o, Game.time + CREEP_LIFE_TIME)) : e.delete(r);
},
delete(r) {
const o = e.get(r);
o && Ra.delete(xa(t, o)), e.delete(r);
},
with: t => Oa(e, t)
});
function _a() {
...
}, ba.cachePath = fs, ba.cachedPathKey = ms, ba.calculateAdjacencyMatrix = Ri, ba.calculateAdjacentPositions = Ei, 
ba.calculateNearbyPositions = Ti, ba.calculatePositionsAtRange = Si, ba.cleanAllCaches = fi, 
...
return r;
}, ba.fastRoomPosition = Pa, ba.fixEdgePosition = vi, ba.follow = function(e, t) {
...
}, ba.moveTo = Os, ba.normalizeTargets = gi, ba.offsetRoomPosition = Ga, ba.packCoord = Ka, 
...
ba.roomNameToCoords = Qa, ba.sameRoomPosition = Ia, ba.unpackCoord = Ha, ba.unpackCoordList = Ya, 
ba.unpackPos = ja, ba.unpackPosList = Xa, ba.unpackRoomName = ai, ba.unpackRoomNames = oi, 
ba;
}(), Oa = zr("TargetAssignmentManager"), _a = new Map;
...
try {
for (var T = l(h), S = T.next(); !S.done; S = T.next()) {
...
var R = 0;
try {
for (var E = l(t), T = E.next(); !T.done; T = E.next()) {
var S = T.value;
...
return _a.set(e.name, r), Oa.debug("Calculated fresh assignments for ".concat(e.name), {
meta: {
...
function e(e) {
void 0 === e && (e = {}), this.config = c(c({}, Pa), e);
}
...
function Fa(e, t) {
var r = function(e) {
var t, r = Math.min(3, Math.max(1, e.urgency)), o = null !== (t = La[r]) && void 0 !== t ? t : La[2];
return {
...
}(t), o = "defense_".concat(t.roomName, "_").concat(Game.time), n = Da(e, t.roomName), a = {
id: o,
type: "defense",
members: [],
rallyRoom: n,
...
Ma[RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE] = 300, (Ua = {})[RESOURCE_CATALYZED_GHODIUM_ALKALIDE] = 600, 
Ua[RESOURCE_CATALYZED_UTRIUM_ACID] = 600, Ua[RESOURCE_CATALYZED_KEANIUM_ALKALIDE] = 300, 
Ua[RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE] = 600, (ka = {})[RESOURCE_CATALYZED_GHODIUM_ALKALIDE] = 900, 
ka[RESOURCE_CATALYZED_UTRIUM_ACID] = 600, ka[RESOURCE_CATALYZED_ZYNTHIUM_ACID] = 900, 
ka[RESOURCE_CATALYZED_KEANIUM_ALKALIDE] = 600, ka[RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE] = 900;
...
if (p) {
var f = m.storage.store.getUsedCapacity(RESOURCE_ENERGY) - ja(u, p.danger);
f > r && f > i && (i = f, a = u);
}
}
}
...
function t(e) {
void 0 === e && (e = {}), this.lastRun = new Map, this.config = c(c({}, oi), e);
}
...
var u = ri(e, new RoomPosition(s, c, e.name), "defense");
u.score > 0 && n.push(u);
}
}
...
a > 1 && Game.time % 50 == 0 && Xr.debug("Cluster ".concat(t.id, " tick: ").concat(a.toFixed(2), " CPU"), {
subsystem: "Cluster"
});
...
for (var R = (i = void 0, l(y)), E = R.next(); !E.done; E = R.next()) {
...
Xr.debug("Transferred ".concat(S, " ").concat(t, " from ").concat(v.room.name, " to ").concat(T.room.name), {
subsystem: "Cluster"
});
break;
}
...
var t = Array.from(ei.values()).filter(function(t) {
...
var n, a;
void 0 === o && (o = {});
var i = c(c({}, za), o), s = [], u = Sn.getEmpire(), l = u.knownRooms, m = new Set(u.warTargets);
for (var p in l) {
var f = l[p];
...
if (!(Game.time - y < 5e3)) {
var h = Xa(f, d, m.has(p), i), g = "neutral";
...
if (0 !== r.length) {
var o = r[0];
Ya(e, o.doctrine) ? function(e, t, r) {
if (!function(e) {
...
var o = Sn.getEmpire().knownRooms[t], n = null != r ? r : qa(t, {
...
if (!Ya(e, n)) return Xr.warn("Cannot launch ".concat(n, " operation on ").concat(t, " - insufficient resources"), {
subsystem: "Offensive"
}), null;
...
return n;
}(0, o), a = "".concat(r, "_").concat(t, "_").concat(Game.time), i = Da(e, t), s = .3;
...
var r = t.id;
if ($a.has(r)) Xr.debug("Squad ".concat(r, " already forming"), {
...
var i = Un.NORMAL;
"siege" === t.type ? i = Un.HIGH : "defense" === t.type && (i = Un.EMERGENCY);
var s = function(r, a) {
...
switch (e) {
case "harasser":
return Za([ MOVE, ATTACK ], o, [ MOVE, ATTACK ]);

case "soldier":
return Za([ TOUGH, MOVE, ATTACK, MOVE, ATTACK ], o, [ TOUGH, MOVE, ATTACK ]);

case "ranger":
return Za([ TOUGH, MOVE, RANGED_ATTACK ], o, [ MOVE, RANGED_ATTACK ]);

case "healer":
return Za([ TOUGH, MOVE, HEAL ], o, [ MOVE, HEAL ]);

case "siegeUnit":
return Za([ TOUGH, MOVE, WORK ], o, [ TOUGH, MOVE, WORK ]);
...
var e, t, r = Game.time;
try {
for (var o = l($a.entries()), n = o.next(); !n.done; n = o.next()) {
...
try {
for (var r = l(ei.entries()), o = r.next(); !o.done; o = r.next()) {
var n = m(o.value, 2);
n[0], ti(n[1]);
}
} catch (t) {
...
("complete" === i.state || "failed" === i.state) && s > 5e3 && (ei.delete(a), Xr.debug("Cleaned up operation ".concat(a), {
subsystem: "Offensive"
}));
}
} catch (t) {
...
m && m.storage && m.storage.store.getUsedCapacity(RESOURCE_ENERGY) < 1e4 && Ka(e, u.roomName, 2e4);
}
}
} catch (e) {
t = {
...
try {
for (var E = (a = void 0, l(R)), T = E.next(); !T.done; T = E.next()) {
...
for (var M = d.guardsNeeded + d.rangersNeeded + d.healersNeeded, U = Math.min(M, c.length), k = 0; k < U; k++) {
var P = c[k];
...
for (k = c.length - 1; k >= 0; k--) d.assignedCreeps.includes(c[k].creep.name) && c.splice(k, 1);
}
}
} catch (e) {
t = {
...
function si(e) {
var t, r, o = Sn.getEmpire(), n = 0, a = pi(e);
try {
for (var i = l(a), s = i.next(); !s.done; s = i.next()) {
var c = s.value, u = o.knownRooms[c];
u && (u.owner && !di(u.owner) && (n += 30), u.threatLevel >= 2 && (n += 10 * u.threatLevel), 
...
function t(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = c(c({}, Ri), e);
}
return t.prototype.run = function() {
...
var r = 0;
2 === e.sources ? r += 40 : 1 === e.sources && (r += 20), r += ii(e.mineralType);
var o = this.getMinDistanceToOwned(e.name, t);
return o > this.config.maxExpansionDistance ? 0 : (r -= 5 * o, r -= si(e.name), 
r -= 15 * e.threatLevel, r += ci(e.terrain), ui(e.name) && (r += 10), r += li(e.name), 
...
try {
for (var s = l(a), c = s.next(); !c.done; c = s.next()) {
var u = yi(c.value.name, this.config.maxRoomDiscoveryDistance);
try {
...
E || Game.time % 500 != 0 ? E && Game.time % 500 == 0 && Xr.info("Profitable power bank in ".concat(m.roomName, ": ") + "power=".concat(m.power, ", distance=").concat(p, ", timeRemaining=").concat(v), {
subsystem: "Empire"
...
try {
for (var E = (o = void 0, l(R)), T = E.next(); !T.done; T = E.next()) {
var S = T.value;
...
var o = 0;
return 2 === e.sources ? o += 40 : 1 === e.sources && (o += 20), o += ii(e.mineralType), 
o -= 5 * t, o -= si(e.name), o -= 15 * e.threatLevel, o += ci(e.terrain), ui(e.name) && (o += 10), 
o += li(e.name), e.controllerLevel > 0 && !e.owner && (o += 2 * e.controllerLevel), 
o + mi(e.name, r, t);
...
u && (u.owner && !di(u.owner) && n.push("Hostile player ".concat(u.owner, " in ").concat(c)), 
...
return function(e) {
var t, r, o = Sn.getEmpire(), n = pi(e), a = new Set;
try {
for (var i = l(n), s = i.next(); !s.done; s = i.next()) {
var c = s.value, u = o.knownRooms[c];
(null == u ? void 0 : u.owner) && !di(u.owner) && a.add(u.owner);
}
} catch (e) {
t = {
error: e
...
}, xi = 1e7, Oi = 5e6, _i = ((gi = {})[STRUCTURE_SPAWN] = 15e3, gi[STRUCTURE_TOWER] = 5e3, 
...
gi[STRUCTURE_EXTENSION] = 3e3, gi[STRUCTURE_LINK] = 5e3, gi), Ai = function() {
function e(e) {
...
o ? n.terminalManager.requestTransfer(o, e, t, r, this.config.terminalPriority) && Xr.info("Requested ".concat(r, " ").concat(t, " transfer from ").concat(o, " to ").concat(e, " for nuker"), {
subsystem: "Nuke"
}) : Xr.debug("No donor room found for ".concat(r, " ").concat(t, " to ").concat(e), {
subsystem: "Nuke"
});
...
try {
for (var R = (n = void 0, l(g)), E = R.next(); !E.done; E = R.next()) v(E.value);
} catch (e) {
n = {
error: e
};
...
return e.impactTick;
}), T = Math.min.apply(Math, p([], m(E), !1)), S = Math.max.apply(Math, p([], m(E), !1)) - T;
...
n.estimatedDamage = xi + Oi * s, n.estimatedValue = .01 * n.estimatedDamage;
}
return n;
}
...
try {
for (var u = l(c), m = u.next(); !m.done; m = u.next()) {
var p = m.value.structure, f = Math.abs(p.pos.x - t.x), d = Math.abs(p.pos.y - t.y), y = 0 === Math.max(f, d) ? xi : Oi;
...
criticalResourceThresholds: (vi = {}, vi[RESOURCE_GHODIUM] = 5e3, vi),
enabled: !0
}, Ui = function() {
function e(e) {
void 0 === e && (e = {}), this.lastRun = 0, this.config = c(c({}, Mi), e);
}
return e.prototype.run = function() {
...
var R, E = v.value;
if ((R = null !== (a = i[E]) && void 0 !== a ? a : 0) < this.config.minBaseMineralReserve) return Xr.debug("Pixel buying: ".concat(E, " below reserve (").concat(R, " < ").concat(this.config.minBaseMineralReserve, ")"), {
subsystem: "PixelBuying"
}), !1;
}
} catch (e) {
...
function e(e) {
void 0 === e && (e = {}), this.config = c(c({}, Pi), e);
}
return e.prototype.run = function() {
...
function e(e) {
void 0 === e && (e = {}), this.operations = new Map, this.lastScan = 0, this.config = c(c({}, Li), e);
}
return e.prototype.run = function() {
...
}, Wi = [ PWR_GENERATE_OPS, PWR_OPERATE_SPAWN, PWR_OPERATE_EXTENSION, PWR_OPERATE_TOWER, PWR_OPERATE_LAB, PWR_OPERATE_STORAGE, PWR_REGEN_SOURCE, PWR_OPERATE_FACTORY ], Vi = [ PWR_GENERATE_OPS, PWR_OPERATE_SPAWN, PWR_SHIELD, PWR_DISRUPT_SPAWN, PWR_DISRUPT_TOWER, PWR_FORTIFY, PWR_OPERATE_TOWER, PWR_DISRUPT_TERMINAL ], ji = function() {
function e(e) {
void 0 === e && (e = {}), this.assignments = new Map, this.gplState = null, this.lastGPLUpdate = 0, 
this.config = c(c({}, Bi), e);
}
return e.prototype.run = function() {
...
var t = this, r = ("powerQueen" === e ? Wi : Vi).filter(function(e) {
...
function Yi(e, t, r) {
var o, n, a, i, s, u, m, p, f, d, y, h, g, v, R, E, T;
void 0 === r && (r = {});
var S = c(c({}, Hi), r), C = qi.get(e.name);
...
try {
for (var M = l(x), U = M.next(); !U.done; U = M.next()) {
var k = $i(N, U.value.pos, e.name, S.maxPathOps);
try {
for (var P = (a = void 0, l(k)), I = P.next(); !I.done; I = P.next()) {
var G = I.value;
...
if (O) {
k = $i(N, O.pos, e.name, S.maxPathOps);
try {
for (var L = l(k), D = L.next(); !D.done; D = L.next()) G = D.value, w.add("".concat(G.x, ",").concat(G.y));
} catch (e) {
s = {
error: e
};
...
if (A && b >= 6) {
k = $i(N, A.pos, e.name, S.maxPathOps);
try {
for (var F = l(k), B = F.next(); !B.done; B = F.next()) G = B.value, w.add("".concat(G.x, ",").concat(G.y));
} catch (e) {
m = {
error: e
};
...
k = $i(t, V.value.pos, e.name, S.maxPathOps);
try {
for (var j = (y = void 0, l(k)), K = j.next(); !K.done; K = j.next()) G = K.value, 
w.add("".concat(G.x, ",").concat(G.y));
} catch (e) {
y = {
error: e
...
if (O) {
k = $i(t, O.pos, e.name, S.maxPathOps);
try {
for (var H = l(k), q = H.next(); !q.done; q = H.next()) G = q.value, w.add("".concat(G.x, ",").concat(G.y));
} catch (e) {
g = {
error: e
};
...
return qi.set(e.name, Y), Xr.debug("Calculated road network for ".concat(e.name, ": ").concat(w.size, " positions"), {
...
if (!v) return y;
try {
for (var R = l(t), E = R.next(); !E.done; E = R.next()) {
var T = E.value;
try {
var S = zi(e.name, T);
if (!S) {
Xr.warn("Cannot determine exit direction from ".concat(e.name, " to ").concat(T), {
subsystem: "RoadNetwork"
});
continue;
}
var C = Xi(e.name, S);
if (0 === C.length) {
Xr.warn("No valid exit positions found in ".concat(e.name, " towards ").concat(T), {
subsystem: "RoadNetwork"
});
continue;
}
...
if (!N.incomplete) try {
for (var M = (s = void 0, l(N.path)), U = M.next(); !U.done; U = M.next()) _ = U.value, 
...
Xr.warn("Failed to calculate remote road to ".concat(T, ": ").concat(k), {
subsystem: "RoadNetwork"
});
}
}
...
if (u) {
var m = ts(u);
m.lost && m.reason && rs(e, c, m.reason);
}
}
} catch (e) {
t = {
...
function e(e) {
void 0 === e && (e = {}), this.config = c(c({}, ns), e);
}
return e.prototype.run = function() {
...
function Ss(e, t, r) {
var o, n;
if (!Es()) return Xr.debug("Cannot accept more quests (at max capacity)", {
subsystem: "TooAngel"
}), !1;
...
if (l < gs.MIN_APPLICATION_ENERGY) return Xr.warn("Insufficient energy for quest application: ".concat(l, " < ").concat(gs.MIN_APPLICATION_ENERGY), {
subsystem: "TooAngel"
}), !1;
var m = {
type: "quest",
...
try {
for (var E = (o = void 0, l(R)), T = E.next(); !(T.done || ((b = (w = T.value).memory).questId = e.id, 
...
assignedCreeps: []
}, Ts(i.quest) || (Xr.warn("Received unsupported quest type: ".concat(i.quest), {
subsystem: "TooAngel"
...
subsystem: "TooAngel"
}), o.status = "failed", o.completedAt = Game.time) : "buildcs" === o.type ? ws(o) : (Xr.warn("Unsupported quest type for execution: ".concat(o.type), {
subsystem: "TooAngel"
...
for (var t in e) {
var r = e[t];
r.deadline > 0 && Game.time >= r.deadline - gs.DEADLINE_BUFFER && ("active" !== r.status && "applied" !== r.status || (Xr.warn("Quest ".concat(t, " expired (deadline: ").concat(r.deadline, ", current: ").concat(Game.time, ")"), {
subsystem: "TooAngel"
...
try {
for (var o = l(r), n = o.next(); !n.done; n = o.next()) ps(n.value);
} catch (t) {
e = {
error: t
};
...
function e(e) {
void 0 === e && (e = {}), this.trackers = new Map, this.config = c(c({}, Os), e);
}
return e.prototype.getTracker = function(e) {
var t = this.trackers.get(e);
return t || (t = {
energyHarvested: new _s(10),
energySpawning: new _s(10),
energyConstruction: new _s(10),
energyRepair: new _s(10),
energyTower: new _s(10),
controllerProgress: new _s(10),
hostileCount: new _s(5),
damageReceived: new _s(5),
idleWorkers: new _s(10),
lastControllerProgress: 0
}, this.trackers.set(e, t)), t;
}, e.prototype.updateMetrics = function(e, r) {
var o, n, a, i, s, c, u, m, p = this.getTracker(e.name), f = "sources_".concat(e.name), d = global[f];
d && d.tick === Game.time ? m = d.sources : (m = e.find(FIND_SOURCES), global[f] = {
sources: m,
tick: Game.time
});
var y = 0, h = 0;
try {
for (var g = l(m), v = g.next(); !v.done; v = g.next()) {
var R = v.value;
...
var E = y - h;
if (p.energyHarvested.add(E), null === (u = e.controller) || void 0 === u ? void 0 : u.my) {
var T = e.controller.progress - p.lastControllerProgress;
T > 0 && T < 1e5 && p.controllerProgress.add(T), p.lastControllerProgress = e.controller.progress;
}
var S = t.safeFind(e, FIND_HOSTILE_CREEPS);
p.hostileCount.add(S.length);
var C = 0;
try {
for (var w = l(S), b = w.next(); !b.done; b = w.next()) {
var x = b.value;
try {
for (var O = (s = void 0, l(x.body)), _ = O.next(); !_.done; _ = O.next()) {
var A = _.value;
...
var E = R.value;
if (e.get(E)) try {
for (var T = (a = void 0, l([ "defense", "war", "expand", "siege" ])), S = T.next(); !S.done; S = T.next()) {
...
}(), Ps = new ks, Is = zr("NativeCallsTracker");

function Gs(t, r, o) {
var n = t[r];
if (n && !n.__nativeCallsTrackerWrapped) {
var a = Object.getOwnPropertyDescriptor(t, r);
if (a && !1 === a.configurable) Is.warn("Cannot wrap method - property is not configurable", {
meta: {
methodName: r
}
}); else try {
...
var Bs = zr("OpportunisticActions");

function Ws() {
return Game.cpu.bucket >= 2e3;
}

var Vs = zr("CollectionPoint"), js = "collectionPoint";
...
namespace: js,
ttl: 500
}), Vs.info("Calculated new collection point at ".concat(i.x, ",").concat(i.y), e.name)) : (t.collectionPoint = void 0, 
Mo.invalidate(e.name, js), Vs.warn("Failed to calculate collection point for room", e.name)), 
i;
}
...
var Ys = zr("ActionExecutor"), zs = "#ffaa00", Xs = "#ffffff", Qs = "#ff0000", Js = "#00ff00", $s = "#0000ff";

function Zs(e, t, r) {
var o, n;
if (!t || !t.type) return Ys.warn("".concat(e.name, " received invalid action, clearing state")), 
...
if (e.pos.isNearTo(o)) return Bs.debug("".concat(e.name, " opportunistically picking up ").concat(o.amount, " energy at ").concat(o.pos)), 
{
type: "pickup",
target: o
};
...
return Bs.debug("".concat(e.name, " opportunistically transferring to ").concat(o.structureType, " at ").concat(o.pos)), 
{
type: "transfer",
target: o,
resourceType: RESOURCE_ENERGY
...
if (e.pos.isNearTo(o) && o.hits < .3 * o.hitsMax) return Bs.debug("".concat(e.name, " opportunistically repairing ").concat(o.structureType, " at ").concat(o.pos, " (").concat(o.hits, "/").concat(o.hitsMax, ")")), 
{
type: "repair",
target: o
};
...
t.type !== a.type && Ys.debug("".concat(e.name, " opportunistic action: ").concat(t.type, " → ").concat(a.type)), 
"idle" === a.type ? Ys.warn("".concat(e.name, " (").concat(r.memory.role, ") executing IDLE action")) : Ys.debug("".concat(e.name, " (").concat(r.memory.role, ") executing ").concat(a.type));
var i = !1;
switch (a.type) {
case "harvest":
i = ec(e, function() {
...
case "rangedHeal":
e.rangedHeal(a.target), xa.moveTo(e, a.target, {
visualizePathStyle: {
stroke: Js
}
}) === ERR_NO_PATH && (i = !0);
...
e.pos.isEqualTo(a.position) || xa.moveTo(e, a.position) === ERR_NO_PATH && (i = !0);
break;
...
case "idle":
if (xa.isExit(e.pos)) {
u = new RoomPosition(25, 25, e.pos.roomName), xa.moveTo(e, u, {
priority: 2
});
break;
}
...
var m = Ks(l, Sn.getOrInitSwarmState(l.name));
...
i && (delete r.memory.state, xa.clearCachedPath(e), Yo(e)), function(e) {
...
return s !== OK && Ys.info("Movement attempt returned non-OK result", {
room: e.pos.roomName,
creep: e.name,
meta: {
...
c = e.memory, u = p, Ds(c).buildProgress += u;
break;
...
d = 0, h <= 1 ? d = 10 * y : h <= 2 ? d = 4 * y : h <= 3 && (d = 1 * y), Fs(e.memory, d);
break;
...
!function(e, t) {
Ds(e).upgradeProgress += t;
}(e.memory, R);
}
}(e, n, r, a), (i === ERR_FULL || i === ERR_NOT_ENOUGH_RESOURCES || i === ERR_INVALID_TARGET) && (Ys.info("Clearing state after action error", {
room: e.pos.roomName,
creep: e.name,
meta: {
action: null != n ? n : "rangeAction",
...
var oc = zr("EnergyCollection");

function nc(e) {
if (e.droppedResources.length > 0) {
var r = qo(e.creep, e.droppedResources, "energy_drop", 5);
if (r) return oc.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") selecting dropped resource at ").concat(r.pos)), 
{
type: "pickup",
target: r
};
...
if (n) return oc.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") selecting container ").concat(n.id, " at ").concat(n.pos, " with ").concat(n.store.getUsedCapacity(RESOURCE_ENERGY), " energy")), 
{
type: "withdraw",
target: n,
resourceType: RESOURCE_ENERGY
};
if (oc.warn("".concat(e.creep.name, " (").concat(e.memory.role, ") found ").concat(o.length, " containers but distribution returned null, falling back to closest")), 
i = e.creep.pos.findClosestByRange(o)) return oc.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") using fallback container ").concat(i.id, " at ").concat(i.pos)), 
{
type: "withdraw",
target: i,
resourceType: RESOURCE_ENERGY
...
if (e.storage && e.storage.store.getUsedCapacity(RESOURCE_ENERGY) > 0) return oc.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") selecting storage at ").concat(e.storage.pos)), 
{
type: "withdraw",
target: e.storage,
resourceType: RESOURCE_ENERGY
};
var a = Bo(e.room).filter(function(e) {
return e.energy > 0;
});
if (a.length > 0) {
var i, s = t.findDistributedTarget(e.creep, a, "energy_source");
if (s) return oc.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") selecting source ").concat(s.id, " at ").concat(s.pos)), 
{
type: "harvest",
target: s
};
if (oc.warn("".concat(e.creep.name, " (").concat(e.memory.role, ") found ").concat(a.length, " sources but distribution returned null, falling back to closest")), 
i = e.creep.pos.findClosestByRange(a)) return oc.debug("".concat(e.creep.name, " (").concat(e.memory.role, ") using fallback source ").concat(i.id, " at ").concat(i.pos)), 
{
type: "harvest",
target: i
};
}
return oc.warn("".concat(e.creep.name, " (").concat(e.memory.role, ") findEnergy returning idle - no energy sources available")), 
{
type: "idle"
};
}
...
var cc = zr("HarvesterBehavior"), uc = zr("HaulerBehavior"), lc = function() {
function e() {}
return e.prototype.getLabResourceNeeds = function(e) {
var t, r, o, n, a;
if (!Game.rooms[e]) return [];
var i = Us.getConfig(e);
if (!i || !i.isValid) return [];
var s, c = [], u = Us.getInputLabs(e), m = u.input1, p = u.input2;
...
var f = Us.getBoostLabs(e), d = function(e) {
...
var t, r, o, n, a, i;
if (!Game.rooms[e]) return [];
var s = Us.getConfig(e);
if (!s) return [];
var c = [], u = Us.getOutputLabs(e);
try {
for (var m = l(u), p = m.next(); !p.done; p = m.next()) {
...
var h = Us.getInputLabs(e), g = [ h.input1, h.input2 ].filter(function(e) {
return void 0 !== e;
}), v = function(e) {
var t = e.mineralType;
if (!t) return "continue";
...
try {
for (var R = l(g), E = R.next(); !E.done; E = R.next()) {
var T;
v(T = E.value);
}
} catch (e) {
...
Us.clearActiveReaction(e), Xr.info("Cleared active reactions in ".concat(e), {
subsystem: "Labs"
});
}, e.prototype.setActiveReaction = function(e, t, r, o) {
var n = Us.setActiveReaction(e, t, r, o);
return n && Xr.info("Set active reaction: ".concat(t, " + ").concat(r, " -> ").concat(o), {
subsystem: "Labs",
room: e
}), n;
}, e.prototype.runReactions = function(e) {
return Us.runReactions(e);
}, e.prototype.hasAvailableBoostLabs = function(e) {
return Us.getBoostLabs(e).length > 0;
}, e.prototype.prepareBoostLab = function(e, t) {
var r, o, n, a, i, s = Us.getConfig(e);
if (!s) return null;
var c = Us.getBoostLabs(e);
try {
...
Us.initialize(e), Us.loadFromMemory(e);
...
var t, r, o = (r = Aa((t = e.creep).room).harvesterToSource.get(t.id)) ? Game.getObjectById(r) : null;
...
}(e), cc.debug("".concat(e.creep.name, " harvester assigned to source ").concat(null == o ? void 0 : o.id))), 
!o) return cc.warn("".concat(e.creep.name, " harvester has no source to harvest")), 
{
type: "idle"
};
...
if (i) return cc.debug("".concat(e.creep.name, " harvester transferring to container ").concat(i.id)), 
{
type: "transfer",
target: i,
resourceType: RESOURCE_ENERGY
...
return s ? (cc.debug("".concat(e.creep.name, " harvester transferring to link ").concat(s.id)), 
{
type: "transfer",
target: s,
resourceType: RESOURCE_ENERGY
}) : (cc.debug("".concat(e.creep.name, " harvester dropping energy on ground")), 
{
type: "drop",
resourceType: RESOURCE_ENERGY
});
...
hauler: function(e) {
var r, o = tc(e);
if (uc.debug("".concat(e.creep.name, " hauler state: working=").concat(o, ", energy=").concat(e.creep.store.getUsedCapacity(RESOURCE_ENERGY), "/").concat(e.creep.store.getCapacity())), 
o) {
...
if (i.length > 0 && (u = qo(e.creep, i, "hauler_spawn", 10))) return uc.debug("".concat(e.creep.name, " hauler delivering to spawn ").concat(u.id)), 
{
type: "transfer",
target: u,
resourceType: RESOURCE_ENERGY
...
if (e.isEmpty) return uc.warn("".concat(e.creep.name, " hauler idle (empty, working=true, no targets)")), 
{
type: "idle"
};
uc.debug("".concat(e.creep.name, " hauler has energy but no targets, switching to collection mode")), 
rc(e);
}
...
if (y) return uc.debug("".concat(e.creep.name, " hauler withdrawing from container ").concat(y.id, " with ").concat(y.store.getUsedCapacity(RESOURCE_ENERGY), " energy")), 
{
type: "withdraw",
target: y,
resourceType: RESOURCE_ENERGY
};
uc.warn("".concat(e.creep.name, " hauler found ").concat(d.length, " containers but distribution returned null, falling back to closest"));
var h = e.creep.pos.findClosestByRange(d);
if (h) return uc.debug("".concat(e.creep.name, " hauler using fallback container ").concat(h.id)), 
{
type: "withdraw",
target: h,
resourceType: RESOURCE_ENERGY
...
uc.warn("".concat(e.creep.name, " hauler found ").concat(e.mineralContainers.length, " mineral containers but distribution returned null, falling back to closest"));
...
}))) return uc.debug("".concat(e.creep.name, " hauler using fallback mineral container ").concat(R.id)), 
{
type: "withdraw",
target: R,
resourceType: v
...
return e.storage && e.storage.store.getUsedCapacity(RESOURCE_ENERGY) > 0 ? (uc.debug("".concat(e.creep.name, " hauler withdrawing from storage")), 
{
type: "withdraw",
target: e.storage,
resourceType: RESOURCE_ENERGY
}) : (uc.warn("".concat(e.creep.name, " hauler idle (no energy sources found)")), 
{
type: "idle"
});
},
...
var s = (r = Aa((t = e.creep).room).builderToTarget.get(t.id)) ? Game.getObjectById(r) : null;
return s ? {
type: "build",
target: s
...
try {
for (var E = l(f), T = E.next(); !T.done; T = E.next()) {
...
var n = mc.getLabResourceNeeds(e.room.name);
...
var t, r = mc.getLabOverflow(e.room.name);
if (r.length > 0) {
r.sort(function(e, t) {
return t.priority - e.priority;
});
...
var a = mc.getLabResourceNeeds(e.room.name);
...
var t = tc(e), r = e.memory.targetRoom, o = e.memory.homeRoom;
if (!r || r === o) return {
type: "idle"
};
if (e.nearbyEnemies && e.hostiles.length > 0) {
...
function fc(e) {
var t;
return (null !== (t = pc[e.memory.role]) && void 0 !== t ? t : sc)(e);
}

var dc = zr("MilitaryBehaviors"), yc = "patrol";
...
var r = Ks(e.room, e.swarmState);
return r && e.creep.pos.getRangeTo(r) > 2 ? (dc.debug("".concat(e.creep.name, " ").concat(t, " moving to collection point at ").concat(r.x, ",").concat(r.y)), 
{
type: "moveTo",
target: r
}) : null;
...
var r = vc(e);
if (r) {
var n = e.creep.pos.getRangeTo(r), a = Rc(e.creep, RANGED_ATTACK), i = Rc(e.creep, ATTACK);
return a && n <= 3 ? {
type: "rangedAttack",
target: r
} : i && n <= 1 ? {
...
var s = vc(e);
if (s) return n = e.creep.pos.getRangeTo(s), a = Rc(e.creep, RANGED_ATTACK), i = Rc(e.creep, ATTACK), 
a && n <= 3 ? {
type: "rangedAttack",
target: s
} : i && n <= 1 ? {
...
var c = hc(e.room), u = gc(e.creep, c);
if (u) return {
type: "moveTo",
target: u
};
...
var l = hc(e.room), m = gc(e.creep, l);
return m ? {
type: "moveTo",
target: m
} : {
...
var i = vc(e);
if (i) {
var s = e.creep.pos.getRangeTo(i), c = Rc(e.creep, RANGED_ATTACK), u = Rc(e.creep, ATTACK);
return c && s <= 3 ? {
type: "rangedAttack",
target: i
} : u && s <= 1 ? {
...
var m = hc(e.room), p = gc(e.creep, m);
if (p) return {
type: "moveTo",
target: p
};
...
if (f.length > 0) {
var d = qo(e.creep, f, "soldier_spawn", 20);
...
var m = Ec(e, "siegeUnit");
if (m) return m;
var p = hc(e.room), f = gc(e.creep, p);
return f ? {
type: "moveTo",
target: f
} : {
...
var u = hc(e.room), l = gc(e.creep, u);
if (l) return {
type: "moveTo",
target: l
};
...
if (a) {
var i = e.creep.pos.getRangeTo(a), s = Rc(e.creep, RANGED_ATTACK), c = Rc(e.creep, ATTACK);
return s && i <= 3 ? {
type: "rangedAttack",
target: a
} : c && i <= 1 ? {
...
if (!t) return Ec(e, "harasser (no target)") || {
type: "idle"
};
if (e.room.name !== t) return {
type: "moveToRoom",
...
var s = Ec(e, "harasser (no targets)");
if (s) return s;
var c = hc(e.room), u = gc(e.creep, c);
return u ? {
type: "moveTo",
...
function Ac(e) {
var t;
return (null !== (t = _c[e.memory.role]) && void 0 !== t ? t : Sc)(e);
}
...
function Uc(e) {
var t = Sn.getEmpire();
if (xa.isExit(e.creep.pos)) return Mc(e.room.name);
...
return n ? e.creep.pos.getRangeTo(n) <= 3 ? (Nc(e.room, t), e.memory.lastExploredRoom = e.room.name, 
delete e.memory.targetRoom, {
type: "idle"
}) : {
type: "moveTo",
target: n
} : (Nc(e.room, t), e.memory.lastExploredRoom = e.room.name, delete e.memory.targetRoom, 
{
type: "idle"
});
}
...
function Pc(e) {
var t;
return (null !== (t = kc[e.memory.role]) && void 0 !== t ? t : Uc)(e);
}
...
function Dc(e) {
var t;
return (null !== (t = Lc[e.memory.role]) && void 0 !== t ? t : Gc)(e);
}

var Fc = zr("StateMachine");
...
var a;
}(o, e)) Fc.info("State completed, evaluating new action", {
...
if (a) return a;
Fc.info("State reconstruction failed, re-evaluating behavior", {
room: e.creep.pos.roomName,
creep: e.creep.name,
meta: {
action: o.action,
...
} else o && (Fc.info("State invalid, re-evaluating behavior", {
room: e.creep.pos.roomName,
creep: e.creep.name,
meta: c({
action: o.action,
...
}(i), Fc.info("Committed new state action", {
room: e.creep.pos.roomName,
creep: e.creep.name,
meta: {
action: i.type,
...
})) : Fc.info("Behavior returned idle action", {
room: e.creep.pos.roomName,
creep: e.creep.name,
meta: {
role: e.memory.role
}
}), i) : (Fc.warn("Behavior returned invalid action, defaulting to idle", {
room: e.creep.pos.roomName,
creep: e.creep.name,
meta: {
role: e.memory.role
...
switch (t.type) {
case "usePower":
(t.target ? e.usePower(t.power, t.target) : e.usePower(t.power)) === ERR_NOT_IN_RANGE && t.target && xa.moveTo(e, t.target);
break;

case "moveTo":
xa.moveTo(e, t.target);
break;
...
case "renewSelf":
e.renew(t.spawn) === ERR_NOT_IN_RANGE && xa.moveTo(e, t.spawn);
break;

case "enableRoom":
(null === (r = e.room) || void 0 === r ? void 0 : r.controller) && e.enableRoom(e.room.controller) === ERR_NOT_IN_RANGE && xa.moveTo(e, e.room.controller);
}
}(e, function(e) {
...
var s = Fo(e.room, FIND_MY_CREEPS, {
filter: function(e) {
...
filter: function(e) {
return e.structureType === STRUCTURE_TOWER && !Ic(e, PWR_DISRUPT_TOWER);
}
})[0];
if (u) return {
type: "usePower",
...
var f = Fo(e.room, FIND_MY_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_TOWER && !Ic(e, PWR_OPERATE_TOWER);
},
...
var d = p(p([], m(e.spawns), !1), [ e.storage, e.terminal ], !1).filter(function(e) {
return void 0 !== e;
});
try {
for (var y = l(d), h = y.next(); !h.done; h = y.next()) {
var g = h.value;
if (g) {
...
return e.structureType === STRUCTURE_TERMINAL && !Ic(e, PWR_DISRUPT_TERMINAL);
});
if (E) return {
type: "usePower",
...
var t = e;
return null !== t.spawning && !Ic(t, PWR_OPERATE_SPAWN);
});
if (r) return {
type: "usePower",
...
}, 0) > 1e3 && e.storage && e.storage.store.getUsedCapacity(RESOURCE_ENERGY) > 1e4 && !Ic(e.storage, PWR_OPERATE_EXTENSION)) return {
type: "usePower",
...
var n = e.labs.find(function(e) {
return 0 === e.cooldown && e.mineralType && !Ic(e, PWR_OPERATE_LAB);
});
if (n) return {
type: "usePower",
...
if (t.includes(PWR_OPERATE_FACTORY) && e.ops >= 100 && e.factory && 0 === e.factory.cooldown && !Ic(e.factory, PWR_OPERATE_FACTORY)) return {
type: "usePower",
power: PWR_OPERATE_FACTORY,
target: e.factory
};
if (t.includes(PWR_OPERATE_STORAGE) && e.ops >= 100 && e.storage && e.storage.store.getUsedCapacity() > .85 * e.storage.store.getCapacity() && !Ic(e.storage, PWR_OPERATE_STORAGE)) return {
type: "usePower",
...
var jc = new Set([ "harvester", "upgrader", "mineralHarvester", "depositHarvester", "factoryWorker", "labTech", "builder" ]), Kc = {
...
function Hc(e) {
var t;
return null !== (t = Kc[e]) && void 0 !== t ? t : fo.MEDIUM;
}
...
var r = t.memory.role, o = Hc(r), n = "creep:".concat(t.name);
Oo.registerProcess({
id: n,
...
if (!t.targetId) return !1;
var r = Game.getObjectById(t.targetId);
return !(!r || !Vc(r) || !e.pos.inRangeTo(r.pos, 3) || "upgrade" === t.action && 0 === e.store.getUsedCapacity(RESOURCE_ENERGY) || "withdraw" === t.action && 0 === e.store.getFreeCapacity(RESOURCE_ENERGY));
}(e, r);
...
if (!t.targetId) return !1;
var r = Game.getObjectById(t.targetId);
return !(!r || !Vc(r) || !e.pos.isNearTo(r.pos) || 0 === e.store.getFreeCapacity());
}(e, r);
...
if (!t.targetId) return !1;
var r = Game.getObjectById(t.targetId);
return !(!r || !Vc(r) || !e.pos.inRangeTo(r.pos, 3) || 0 === e.store.getUsedCapacity(RESOURCE_ENERGY));
}(e, r);
...
if (c) {
var u = Hc(c.memory.role), m = null !== (r = fo[u]) && void 0 !== r ? r : "UNKNOWN";
...
var i, s, c = zc[e], u = null !== (i = n[STRUCTURE_TOWER]) && void 0 !== i ? i : 0, l = null !== (s = n[STRUCTURE_LAB]) && void 0 !== s ? s : 0;
...
var C = new RoomPosition(T, S, e.name), w = cu(e, C, t);
if (w.fits) {
...
function lu(e, t) {
var r, o = tu(t), n = {}, a = e.structures.filter(function(e) {
...
var fu = [ STRUCTURE_EXTENSION, STRUCTURE_ROAD, STRUCTURE_TOWER, STRUCTURE_LAB, STRUCTURE_LINK, STRUCTURE_FACTORY, STRUCTURE_OBSERVER, STRUCTURE_NUKER, STRUCTURE_POWER_SPAWN, STRUCTURE_EXTRACTOR ], du = new Set(fu);
...
return 0 === c.length && (n.boosted = !0, Xr.info("".concat(e.name, " fully boosted (all ").concat(i.boosts.length, " boosts applied)"), {
subsystem: "Boost"
}), !0);
...
try {
for (var c = l(n.boosts), u = c.next(); !u.done; u = c.next()) {
var m = s(u.value);
...
try {
for (var u = l(n.boosts), m = u.next(); !m.done; m = u.next()) c(m.value);
} catch (e) {
r = {
error: e
};
...
if (!(u.length < 3)) {
var m = u.slice(2), p = new Set, f = [ a.getBoostConfig("soldier"), a.getBoostConfig("ranger"), a.getBoostConfig("healer"), a.getBoostConfig("siegeUnit") ].filter(function(e) {
...
var h = y.value;
try {
for (var g = (n = void 0, l(h.boosts)), v = g.next(); !v.done; v = g.next()) {
var R = v.value;
p.add(R);
}
} catch (e) {
...
var E = 0;
try {
for (var T = l(p), S = T.next(); !(S.done || (R = S.value, E >= m.length)); S = T.next()) {
var C = m[E];
...
return Su.set(e.name, o), o;
}

var bu = function() {
function r(e, t) {
void 0 === t && (t = {}), this.roomName = e, this.config = c(c({}, Tu), t);
}
...
this.config.enableEvolution && (Zc.updateEvolutionStage(c, s, t), Zc.updateMissingStructures(c, s)), 
eu.updatePosture(c), this.config.enablePheromones && Ns.updatePheromones(c, s), 
this.config.enableTowers && this.runTowerControl(s, c), this.config.enableConstruction && eu.allowsBuilding(c.posture)) {
var u = Eu(null !== (a = null === (n = s.controller) || void 0 === n ? void 0 : n.level) && void 0 !== a ? a : 1) ? 5 : 10;
...
var n, a, i, s, c, u, f, d, y, h;
if (Game.time % 5 == 0) {
var g = wu(e), v = g.spawns.length + g.towers.length, R = Cu.get(this.roomName);
R && R.lastTick < Game.time && v < R.lastStructureCount && (g.spawns.length < R.lastSpawns.length && Oo.emit("structure.destroyed", {
roomName: this.roomName,
structureType: STRUCTURE_SPAWN,
structureId: "unknown",
source: this.roomName
}), g.towers.length < R.lastTowers.length && Oo.emit("structure.destroyed", {
roomName: this.roomName,
structureType: STRUCTURE_TOWER,
structureId: "unknown",
source: this.roomName
})), Cu.set(this.roomName, {
lastStructureCount: v,
lastSpawns: p([], m(g.spawns), !1),
lastTowers: p([], m(g.towers), !1),
lastTick: Game.time
});
}
...
try {
for (var T = l(E), S = T.next(); !S.done; S = T.next()) {
var C = S.value;
try {
for (var w = (i = void 0, l(C.body)), b = w.next(); !b.done; b = w.next()) {
var x = b.value;
...
var A = Sn.getCluster(r.clusterId);
A && Ns.diffuseDangerToCluster(e.name, O.threatScore, A.memberRooms);
}
Sn.addRoomEvent(this.roomName, "hostileDetected", "".concat(E.length, " hostiles, danger=").concat(_, ", score=").concat(O.threatScore));
try {
for (var N = l(E), M = N.next(); !M.done; M = N.next()) C = M.value, Oo.emit("hostile.detected", {
roomName: this.roomName,
hostileId: C.id,
...
Sn.addRoomEvent(this.roomName, "nukeDetected", "".concat(U.length, " nuke(s) incoming from ").concat(k)), 
r.nukeDetected = !0;
try {
for (var P = l(U), I = P.next(); !I.done; I = P.next()) {
var G = I.value;
...
var n, a, i, s, c = wu(e).towers;
if (0 !== c.length) {
var u = t.safeFind(e, FIND_HOSTILE_CREEPS), m = u.length > 0 ? this.selectTowerTarget(u) : null, p = function(t) {
if (t.store.getUsedCapacity(RESOURCE_ENERGY) < 10) return "continue";
if (m) return t.attack(m), "continue";
var n;
...
if (!eu.isCombatPosture(r.posture) && (n = t.pos.findClosestByRange(FIND_STRUCTURES, {
filter: function(e) {
return e.hits < .8 * e.hitsMax && e.structureType !== STRUCTURE_WALL && e.structureType !== STRUCTURE_RAMPART;
}
}))) return t.repair(n), "continue";
if (!eu.isCombatPosture(r.posture) && 0 === u.length) {
var a = null !== (s = null === (i = e.controller) || void 0 === i ? void 0 : i.level) && void 0 !== s ? s : 1, c = o.calculateWallRepairTarget(a, r.danger), l = t.pos.findClosestByRange(FIND_STRUCTURES, {
filter: function(e) {
...
try {
for (var f = l(c), d = f.next(); !d.done; d = f.next()) p(d.value);
} catch (e) {
n = {
error: e
};
...
var r, n, a, i = wu(e), s = i.constructionSites;
if (!(s.length >= 10)) {
var u = null !== (n = null === (r = e.controller) || void 0 === r ? void 0 : r.level) && void 0 !== n ? n : 1, f = i.spawns[0], d = null == f ? void 0 : f.pos;
if (f) {
var y = pu(e, u);
...
var h = null !== (a = null == y ? void 0 : y.blueprint) && void 0 !== a ? a : mu(u);
if (h && d) {
if (!eu.isCombatPosture(t.posture)) {
...
var n, a, i, s, u, m, p;
void 0 === o && (o = []);
var f = null !== (m = null === (u = e.controller) || void 0 === u ? void 0 : u.level) && void 0 !== m ? m : 1, d = lu(r, f), y = e.getTerrain(), h = [], g = new Map;
try {
...
try {
for (var R = l(r), E = R.next(); !E.done; E = R.next()) {
...
Xr.warn("Failed to calculate exit road for ".concat(f, " in ").concat(e.name, ": ").concat(E), {
subsystem: "RoadNetwork"
});
}
}
...
try {
for (var U = l(M), k = U.next(); !k.done; k = U.next()) O = k.value, g.add(O);
} catch (e) {
u = {
error: e
};
...
for (var u = l(s), m = u.next(); !m.done; m = u.next()) {
var p = m.value;
es(p.pos, t) && i.add("".concat(p.pos.x, ",").concat(p.pos.y));
}
} catch (e) {
r = {
error: e
...
for (var f = l(c), d = f.next(); !d.done; d = f.next()) {
var y = d.value;
es(y.pos, t) && i.add("".concat(y.pos.x, ",").concat(y.pos.y));
}
} catch (e) {
n = {
error: e
...
if (u >= 2 && s.length < 8) {
var E = Eu(u) ? 5 : 3;
(R = o.placeRoadAwarePerimeterDefense(e, d, h.roads, u, E, t.remoteAssignments)).wallsRemoved > 0 && Sn.addRoomEvent(this.roomName, "wallRemoved", "".concat(R.wallsRemoved, " wall(s) removed to allow road passage"));
}
var T = function(e, t, r) {
var o, n, a, i, s, c, u, f, d, y, h, g, v, R, E = null !== (y = null === (d = e.controller) || void 0 === d ? void 0 : d.level) && void 0 !== y ? y : 1, T = lu(r, E), S = e.getTerrain(), C = [];
if (E >= 6) {
...
var x = p(p([], m(T), !1), m(C), !1), O = 0, _ = e.find(FIND_MY_CONSTRUCTION_SITES), A = e.find(FIND_STRUCTURES);
if (_.length >= 10) return 0;
var N = {};
try {
for (var M = l(A), U = M.next(); !U.done; U = M.next()) {
...
try {
for (var P = l(_), I = P.next(); !I.done; I = P.next()) k = I.value.structureType, 
...
var a = Yi(e, t), i = e.getTerrain(), s = e.find(FIND_STRUCTURES, {
filter: function(e) {
return e.structureType === STRUCTURE_ROAD;
}
...
if (!c.has(y) && !u.has(y)) {
var h = m(y.split(","), 2), g = h[0], v = h[1], R = parseInt(g, 10), E = parseInt(v, 10);
...
(C = o.placeRampartsOnCriticalStructures(e, u, t.danger, w)).placed > 0 && Sn.addRoomEvent(this.roomName, "rampartPlaced", "".concat(C.placed, " rampart(s) placed on critical structures"));
}
...
if (t) {
mc.initialize(e.name), Ru.prepareLabs(e, t);
var r = gu.planReactions(e, t);
if (r) {
var o = {
product: r.product,
input1: r.input1,
...
if (mc.areLabsReady(e.name, o)) {
var n = Us.getConfig(e.name), a = null == n ? void 0 : n.activeReaction;
a && a.input1 === r.input1 && a.input2 === r.input2 && a.output === r.product || mc.setActiveReaction(e.name, r.input1, r.input2, r.product), 
gu.executeReaction(e, r);
...
var h = y.value;
this.nodes.has(h.name) || this.nodes.set(h.name, new bu(h.name));
}
} catch (t) {
e = {
error: t
...
try {
for (var E = l(this.nodes.values()), T = E.next(); !T.done; T = E.next()) {
var S = T.value;
try {
S.run(f);
} catch (e) {
...
this.nodes.has(e.name) || this.nodes.set(e.name, new bu(e.name));
...
var n = Game.rooms[o];
r.add(o);
var a = "room:".concat(o), i = Oo.getProcess(a), s = _u(n), c = Au(n);
...
var t, r = _u(e), o = Au(e), n = "room:".concat(e.name), a = this.getRoomIndex(e.name), i = Nu(e, r, a);
Oo.registerProcess({
id: n,
...
var o, n = "room:".concat(e.name), a = this.getRoomIndex(e.name), i = Nu(e, t, a);
...
var u = c.value, m = Game.rooms[u];
if (m) {
var p = _u(m), f = null !== (r = fo[p]) && void 0 !== r ? r : "UNKNOWN";
...
}, Gu = new s.RemotePathCache(Pu, ku), Lu = new s.RemotePathScheduler(ku, Iu, Gu);

new s.RemoteMiningMovement(ku, Pu, Gu, xa.moveTo);
...
!function(e, t) {
Gu.precacheRemoteRoutes(e, t);
}(e, t);
}, e;
}();

new i.PortalManager(new Du, new Fu);

var ju, Ku = new i.PathCacheEventManager(new Fu, new Bu, new Wu, new Vu), Hu = zr("SS2TerminalComms"), qu = function() {
function e() {}
...
if (!p) {
Hu.warn("Missing packet in multi-packet message", {
meta: {
packetId: m,
messageId: i.msgId,
sender: a.sender.username
...
sender: a.sender.username,
message: f
}), this.messageBuffers.delete(s), Hu.info("Received complete multi-packet message from ".concat(a.sender.username), {
meta: {
messageId: i.msgId,
packets: u.length,
totalSize: f.length,
...
return r.length > 0 && Hu.debug("Processed ".concat(Game.market.incomingTransactions.length, " terminal transactions, completed ").concat(r.length, " messages")), 
r;
...
return i ? (this.queuePackets(e.id, t, r, o, a, i), Hu.info("Queued ".concat(a.length, " packets for multi-packet message"), {
meta: {
terminalId: e.id,
messageId: i,
packets: a.length,
...
}), OK) : (Hu.error("Failed to extract message ID from first packet"), ERR_INVALID_ARGS);
...
Hu.debug("Queue processing stopped due to CPU budget limit (".concat(5, " CPU)"));
break;
}
...
Hu.info("Completed sending multi-packet message", {
meta: {
messageId: g,
...
} else h === ERR_NOT_ENOUGH_RESOURCES ? Hu.warn("Not enough resources to send packet, will retry next tick", {
meta: {
queueKey: p,
resource: f.resourceType,
amount: f.amount
}
}) : (Hu.error("Failed to send packet: ".concat(h, ", removing queue item"), {
meta: {
queueKey: p,
result: h
}
}), a.push(p));
} else Hu.warn("No packet at index ".concat(f.nextPacketIndex, ", removing queue item"), {
meta: {
queueKey: p
}
}), a.push(p);
}
} else Hu.warn("Terminal not found for queue item, removing from queue", {
meta: {
queueKey: p,
...
return n > 0 && Hu.debug("Sent ".concat(n, " queued packets this tick")), n;
...
Hu.warn("Queue item timed out after ".concat(n - p.queuedAt, " ticks"), {
meta: {
messageId: f,
queueKey: u,
...
var a = m(n.value, 2), i = a[0], s = a[1];
r - s.receivedAt > this.MESSAGE_TIMEOUT && (Hu.warn("Message timed out", {
meta: {
messageId: s.msgId,
sender: s.sender
}
...
return Hu.error("Error parsing JSON", {
meta: {
error: String(e)
}
}), null;
...
var Xu = new r.RoomVisualizer({}, Sn), Qu = new r.MapVisualizer({}, Sn), Ju = !1, $u = !1;
...
function el() {
var r, a;
$u && Game.time % 10 != 0 || Xr.info("SwarmBot loop executing at tick ".concat(Game.time), {
subsystem: "SwarmBot",
meta: {
systemsInitialized: $u
}
}), $u || (Ir({
level: (a = To()).debug ? Ar.DEBUG : Ar.INFO,
...
if (t && !1 === t.configurable) Is.warn("Cannot wrap PathFinder.search - property is not configurable"); else {
...
Is.warn("Failed to wrap PathFinder.search", {
meta: {
error: String(e)
}
});
...
}(), Gs(r = Creep.prototype, "moveTo", "moveTo"), Gs(r, "move", "move"), Gs(r, "harvest", "harvest"), 
Gs(r, "transfer", "transfer"), Gs(r, "withdraw", "withdraw"), Gs(r, "build", "build"), 
Gs(r, "repair", "repair"), Gs(r, "upgradeController", "upgradeController"), Gs(r, "attack", "attack"), 
Gs(r, "rangedAttack", "rangedAttack"), Gs(r, "heal", "heal"), Gs(r, "dismantle", "dismantle"), 
Gs(r, "say", "say")), Oo.on("structure.destroyed", function(e) {
var t = Sn.getSwarmState(e.roomName);
t && (Ns.onStructureDestroyed(t, e.structureType), Xr.debug("Pheromone update: structure destroyed in ".concat(e.roomName), {
subsystem: "Pheromone",
room: e.roomName
}));
}), Oo.on("remote.lost", function(e) {
var t = Sn.getSwarmState(e.homeRoom);
t && (Ns.onRemoteSourceLost(t), Xr.info("Pheromone update: remote source lost for ".concat(e.homeRoom), {
subsystem: "Pheromone",
room: e.homeRoom
}));
}), Xr.info("Pheromone event handlers initialized", {
subsystem: "Pheromone"
}), Ku.initializePathCacheEvents(), Lu.initialize(t.TaskPriority.MEDIUM), eo.initialize(), 
ea.initialize(), $u = !0), Oo.updateFromCpuConfig(To().cpu), Ju || (Xr.info("Registering all processes with kernel...", {
...
}(Ps, n.terminalManager, n.factoryManager, n.linkManager, Ti, wi, is, n.marketManager, ki, Gi, Ni, Fi, Ki, ea, us, xs, ai, o.evacuationManager, o.defenseCoordinator), 
Xr.info("Registered ".concat(Oo.getProcesses().length, " processes with kernel"), {
subsystem: "ProcessRegistry"
}), Oo.initialize(), Ju = !0), e.unifiedStats.startTick(), "critical" === Oo.getBucketMode() && Game.time % 10 == 0 && Xr.warn("CRITICAL: CPU bucket at ".concat(Game.cpu.bucket, ", continuing normal processing"), {
subsystem: "SwarmBot"
}), _a.clear(), Ra.clear(), vo.startTick();
var i, s = "_ownedRooms", c = "_ownedRoomsTick", u = global, m = u[s], p = u[c];
m && p === Game.time ? i = m : (i = Object.values(Game.rooms).filter(function(e) {
var t;
return null === (t = e.controller) || void 0 === t ? void 0 : t.my;
}), u[s] = i, u[c] = Game.time), xa.preTick(), Sn.initialize(), e.unifiedStats.measureSubsystem("processSync", function() {
Yc.syncCreepProcesses(), Uu.syncRoomProcesses();
...
var a = n.value;
(null === (r = a.controller) || void 0 === r ? void 0 : r.my) && ha(a, Sn.getOrInitSwarmState(a.name));
}
} catch (t) {
e = {
error: t
...
Zu();
}), xa.reconcileTraffic(), Oo.hasCpuBudget() && e.unifiedStats.measureSubsystem("scheduledTasks", function() {
...
var t, r, o, n, a, i, s, c, u = Us.getConfig(e);
...
var v = mc.getLabResourceNeeds(e);
if (v.length > 0) {
m += "\nResource Needs:\n";
try {
for (var R = l(v), E = R.next(); !E.done; E = R.next()) {
...
return mc.setActiveReaction(e, t, r, o) ? "Set active reaction: ".concat(t, " + ").concat(r, " → ").concat(o) : "Failed to set reaction (check lab configuration)";
}, e.prototype.clear = function(e) {
return mc.clearReactions(e), "Cleared active reactions in ".concat(e);
}, e.prototype.boost = function(e, t) {
var r, o, n = Game.rooms[e];
if (!n) return "Room ".concat(e, " not visible");
var a = Ru.areBoostLabsReady(n, t), i = Ru.getMissingBoosts(n, t), s = "=== Boost Status: ".concat(e, " / ").concat(t, " ===\n");
if (s += "Ready: ".concat(a, "\n"), i.length > 0) {
s += "\nMissing Boosts:\n";
try {
...
var e, t, r = Fi.getActiveOperations();
...
return Ki.reassignPowerCreep(e, t) ? "Reassigned ".concat(e, " to ").concat(t) : "Failed to reassign ".concat(e, " (not found)");
...
}(), nl = new tl, al = new rl, il = new ol, sl = function() {
function e() {}
return e.prototype.status = function() {
var e, t, r = null !== (t = null === (e = Game.shard) || void 0 === e ? void 0 : e.name) && void 0 !== t ? t : "shard0", o = ea.getCurrentShardState();
...
return t.includes(e) ? (ea.setShardRole(e), "Shard role set to: ".concat(e.toUpperCase())) : "Invalid role: ".concat(e, ". Valid roles: ").concat(t.join(", "));
}, e.prototype.portals = function(e) {
var t, r, o, n, a, i = null !== (n = null === (o = Game.shard) || void 0 === o ? void 0 : o.name) && void 0 !== n ? n : "shard0", s = ea.getCurrentShardState();
...
var r, o = ea.getOptimalPortalRoute(e, t);
...
return n.includes(e) ? (ea.createTask(e, t, r, o), "Created ".concat(e, " task to ").concat(t).concat(r ? "/".concat(r) : "", " (priority: ").concat(o, ")")) : "Invalid task type: ".concat(e, ". Valid types: ").concat(n.join(", "));
}, e.prototype.transferResource = function(e, t, r, o, n) {
return void 0 === n && (n = 50), ea.createResourceTransferTask(e, t, r, o, n), "Created resource transfer task:\n" + "  ".concat(o, " ").concat(r, " → ").concat(e, "/").concat(t, "\n") + "  Priority: ".concat(n);
}, e.prototype.transfers = function() {
var e, t, r = ra.getActiveRequests();
...
var e, t, r = ea.getCurrentShardState();
...
var e, t, r, o = ea.getActiveTransferTasks();
...
var e = ea.getSyncStatus(), t = e.isHealthy ? "✓ HEALTHY" : "⚠ DEGRADED";
...
return ea.forceSync(), "InterShardMemory sync forced. Check logs for results.";
}, u([ uo({
name: "shard.status",
...
function e(e) {
void 0 === e && (e = {}), this.config = c(c({}, ul), e);
}
...
var o = ml.predictEnergyInTicks(r, t), n = "=== Energy Prediction: ".concat(e, " ===\n");
...
var r = ml.calculateEnergyIncome(t), o = "=== Energy Income: ".concat(e, " ===\n");
...
var t = Game.rooms[e];
if (!t) return "Room ".concat(e, " is not visible");
var r = ml.calculateEnergyConsumption(t), o = "=== Energy Consumption: ".concat(e, " ===\n");
...
var r = Game.rooms[e];
if (!r) return "Room ".concat(e, " is not visible");
var o = ml.getRecommendedSpawnDelay(r, t), n = r.energyAvailable;
...
var a = ml.predictEnergyInTicks(r, o);
...
var M = new Map;
try {
for (var U = l(p), k = U.next(); !k.done; k = U.next()) {
...
return wi.addRemoteRoom(e, t) ? "Added remote ".concat(t, " to ").concat(e) : "Failed to add remote (check logs for details)";
}, e.prototype.removeRemote = function(e, t) {
return wi.removeRemoteRoom(e, t) ? "Removed remote ".concat(t, " from ").concat(e) : "Remote ".concat(t, " not found in ").concat(e);
...
enable: function() {
return xs.enable(), "TooAngel integration enabled";
},
disable: function() {
return xs.disable(), "TooAngel integration disabled";
},
reputation: function() {
var e = ds();
...
return hs(e) ? "Reputation request sent".concat(e ? " from ".concat(e) : "") : "Failed to send reputation request (check logs for details)";
},
quests: function() {
var e, t = Rs(), r = [ "Active Quests:" ];
...
return Ss(e, t, r) ? "Applied for quest ".concat(e).concat(r ? " from ".concat(r) : "") : "Failed to apply for quest (check logs for details)";
},
help: function() {
...
return e ? function(e) {
var r = co.getCommandsByCategory(), o = r.get(e);
...
params: e.metadata.usage ? vl(e.metadata.usage) : void 0
};
});
return t.createHelp({
name: e,
...
var e, r, o = co.getCommandsByCategory(), n = [];
try {
for (var a = l(o), i = a.next(); !i.done; i = a.next()) {
var s = m(i.value, 2), c = s[0], u = s[1].map(function(e) {
var t, r = {
title: e.metadata.description,
functionName: e.metadata.name,
...
return t.createHelp.apply(void 0, p([], m(n), !1));
}();
...
var Rl, El = zr("VisualizationManager"), Tl = function() {
function e() {
...
this.saveConfig(), El.info("Visualization mode set to: ".concat(e));
...
return t.name === e;
}) && !a.isLayerEnabled(t) && (a.enableLayer(t), El.info("Enabled layer ".concat(Jo[t], " via flag")));
}, a = this;
try {
...
a > 10 && El.warn("Visualization using ".concat(a.toFixed(1), "% of CPU budget"));
...
return t.includes(e) ? (Sl.setMode(e), "Visualization mode set to: ".concat(e)) : "Invalid mode: ".concat(e, ". Valid modes: ").concat(t.join(", "));
...
Sl.toggleLayer(r);
var o = Sl.isLayerEnabled(r);
return "Layer ".concat(e, ": ").concat(o ? "enabled" : "disabled");
}, e.prototype.showVisPerf = function() {
var e, t, r = Sl.getPerformanceMetrics(), o = "=== Visualization Performance ===\n";
...
var e, t, r, o = Sl.getConfig(), n = "=== Visualization Configuration ===\n";
...
return Sl.clearCache(e), e ? "Visualization cache cleared for room: ".concat(e) : "All visualization caches cleared";
}, u([ uo({
...
return Mo.clear(ko), "Cache statistics reset";
...
try {
for (var T = l(y), S = T.next(); !S.done; S = T.next()) {
...
try {
for (var k = l(y.slice(0, 10)), P = k.next(); !P.done; P = k.next()) {
var I = P.value;
if (I.cpu > 0) {
...
}(), Al = new Cl, Nl = new wl, Ml = new bl, Ul = new xl, kl = new Ol, Pl = new _l, Il = {}, Gl = {}, Ll = {};

function Dl() {
if (Rl) return Ll;
Rl = 1;
var e = Ll && Ll.__assign || function() {
return e = Object.assign || function(e) {
for (var t, r = 1, o = arguments.length; r < o; r++) for (var n in t = arguments[r]) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
return e;
}, e.apply(this, arguments);
}, t = Ll && Ll.__values || function(e) {
var t = "function" == typeof Symbol && Symbol.iterator, r = t && e[t], o = 0;
if (r) return r.call(e);
if (e && "number" == typeof e.length) return {
next: function() {
...
value: !0
}), Ll.FilterManager = void 0, Ll.createFilter = function(e) {
return new r(e);
};
var r = function() {
function r(e) {
...
if (Fl) return Wl;
Fl = 1;
var e = Wl && Wl.__awaiter || function(e, t, r, o) {
...
}, t = Wl && Wl.__generator || function(e, t) {
var r, o, n, a = {
label: 0,
sent: function() {
if (1 & n[0]) throw n[1];
...
value: !0
}), Wl.PerformanceAssert = Wl.MemoryTracker = Wl.CPUTracker = void 0, Wl.benchmark = function(r, o) {
...
return Wl.PerformanceAssert = n, Wl;
}

function jl() {
if (Bl) return Gl;
Bl = 1;
var e = Gl && Gl.__awaiter || function(e, t, r, o) {
return new (r || (r = Promise))(function(n, a) {
function i(e) {
try {
c(o.next(e));
...
}, t = Gl && Gl.__generator || function(e, t) {
var r, o, n, a = {
label: 0,
sent: function() {
if (1 & n[0]) throw n[1];
...
value: !0
}), Gl.TestRunner = void 0;
var o = Dl(), n = Vl(), a = function() {
function a() {
...
if (Kl) return Hl;
Kl = 1;
var e, t = Hl && Hl.__extends || (e = function(t, r) {
...
return Hl.AssertionError = r, Hl;
}

var Yl, zl, Xl, Ql, Jl, $l = {}, Zl = {}, em = E(Object.freeze({
__proto__: null,
default: {}
})), tm = E(Object.freeze({
__proto__: null,
default: {}
})), rm = {}, om = {}, nm = (Jl || (Jl = 1, function(e) {
var t = Il && Il.__createBinding || (Object.create ? function(e, t, r, o) {
void 0 === o && (o = r);
...
}), r = Il && Il.__exportStar || function(e, r) {
...
r(ql(), e), r(function() {
if (Yl) return $l;
Yl = 1, Object.defineProperty($l, "__esModule", {
value: !0
}), $l.Assert = void 0, $l.expect = function(e) {
return {
toBe: function(r, o) {
...
}), r(Vl(), e), r(Dl(), e), r(function() {
if (zl) return Zl;
zl = 1;
var e, t = Zl && Zl.__createBinding || (Object.create ? function(e, t, r, o) {
void 0 === o && (o = r);
var n = Object.getOwnPropertyDescriptor(t, r);
n && !("get" in n ? !t.__esModule : n.writable || n.configurable) || (n = {
enumerable: !0,
...
void 0 === o && (o = r), e[o] = t[r];
}), r = Zl && Zl.__setModuleDefault || (Object.create ? function(e, t) {
...
e.default = t;
}), o = Zl && Zl.__importStar || (e = function(t) {
...
value: !0
}), Zl.ConsoleReporter = Zl.JSONReporter = void 0;
var i = o(em), s = o(tm), c = function() {
function e(e) {
...
return Zl.ConsoleReporter = u, Zl;
}(), e), r(function() {
if (Xl) return rm;
Xl = 1;
var e, t = rm && rm.__createBinding || (Object.create ? function(e, t, r, o) {
void 0 === o && (o = r);
var n = Object.getOwnPropertyDescriptor(t, r);
n && !("get" in n ? !t.__esModule : n.writable || n.configurable) || (n = {
enumerable: !0,
...
void 0 === o && (o = r), e[o] = t[r];
}), r = rm && rm.__setModuleDefault || (Object.create ? function(e, t) {
Object.defineProperty(e, "default", {
enumerable: !0,
value: t
});
...
e.default = t;
}), o = rm && rm.__importStar || (e = function(t) {
return e = Object.getOwnPropertyNames || function(e) {
var t = [];
for (var r in e) Object.prototype.hasOwnProperty.call(e, r) && (t[t.length] = r);
return t;
...
value: !0
}), rm.PersistenceManager = void 0;
var n = o(em), a = o(tm), i = "1.0.0", s = function() {
function e(e, t) {
...
return rm.PersistenceManager = s, rm;
}(), e), r(function() {
if (Ql) return om;
Ql = 1, Object.defineProperty(om, "__esModule", {
value: !0
}), om.VisualAssert = om.VisualTester = void 0, om.createVisualSnapshot = function(e, t, r) {
return {
roomName: e,
tick: t,
visualData: r || "{}",
...
return om.VisualAssert = t, om;
}(), e);
}(Il)), Il), am = zr("BasicGameStateTest");

nm.describe("Game State Validation", function() {
nm.it("should have access to Game object", function() {
nm.Assert.isNotNullish(Game), nm.Assert.isType(Game, "object");
}), nm.it("should have access to Memory object", function() {
nm.Assert.isNotNullish(Memory), nm.Assert.isType(Memory, "object");
}), nm.it("should track game time", function() {
nm.Assert.isNotNullish(Game.time), nm.Assert.isType(Game.time, "number"), nm.Assert.greaterThan(Game.time, 0);
}), nm.it("should have CPU monitoring available", function() {
nm.Assert.isNotNullish(Game.cpu), nm.Assert.isNotNullish(Game.cpu.limit), nm.Assert.greaterThan(Game.cpu.limit, 0);
}), nm.it("should track CPU usage", function() {
var e = Game.cpu.getUsed();
nm.Assert.isType(e, "number"), nm.Assert.greaterThanOrEqual(e, 0);
}), nm.it("should have CPU bucket available", function() {
nm.Assert.isNotNullish(Game.cpu.bucket), nm.Assert.inRange(Game.cpu.bucket, 0, 1e4);
}), nm.it("should have rooms object", function() {
nm.Assert.isNotNullish(Game.rooms), nm.Assert.isType(Game.rooms, "object");
}), nm.it("should have valid room names", function() {
for (var e in Game.rooms) nm.Assert.isType(e, "string"), nm.Assert.isTrue(/^[WE]\d+[NS]\d+$/.test(e), "Invalid room name: ".concat(e));
});
}), nm.describe("Memory Management", function() {
nm.it("should allow reading from memory", function() {
var e = Object.keys(Memory);
nm.Assert.isTrue(Array.isArray(e));
}), nm.it("should allow writing to memory", function() {
var e = "_testIntegrationWrite";
Memory[e] = {
timestamp: Game.time
}, nm.Assert.isNotNullish(Memory[e]), nm.Assert.equal(Memory[e].timestamp, Game.time), 
delete Memory[e];
}), nm.it("should have creeps memory structure", function() {
nm.Assert.isNotNullish(Memory.creeps), nm.Assert.isType(Memory.creeps, "object");
}), nm.it("should clean up memory for missing creeps", function() {
for (var e in Memory.creeps) Game.creeps[e] || am.debug("Found orphaned creep memory", {
meta: {
creepName: e
}
});
...
}), nm.describe("Main Loop Export", function() {
nm.it("should export a loop function", function() {
nm.Assert.isType(typeof require("../main").loop, "function");
});
}), am.info("Basic game state tests registered");

var im = zr("SpawnSystemTest");

nm.describe("Spawn Management", function() {
nm.it("should have spawns object", function() {
nm.Assert.isNotNullish(Game.spawns), nm.Assert.isType(Game.spawns, "object");
}), nm.it("should have spawns in controlled rooms", function() {
...
}).length > 0 && Game.time > 50 && nm.Assert.greaterThan(e, 0, "Should have at least one spawn in controlled rooms");
}), nm.it("should track spawning status", function() {
for (var e in Game.spawns) {
var t = Game.spawns[e];
nm.Assert.isNotNullish(t.spawning), t.spawning && (nm.Assert.isType(t.spawning, "object"), 
nm.Assert.isNotNullish(t.spawning.name), nm.Assert.greaterThan(t.spawning.remainingTime, 0));
}
}), nm.it("should have spawns with valid energy capacity", function() {
for (var e in Game.spawns) {
var t = Game.spawns[e];
nm.Assert.isNotNullish(t.store), nm.Assert.greaterThanOrEqual(t.store.getCapacity(RESOURCE_ENERGY) || 0, 300);
}
}), nm.it("should have spawns in rooms they control", function() {
for (var e in Game.spawns) {
var t = Game.spawns[e].room;
nm.Assert.isNotNullish(t), nm.Assert.isNotNullish(t.controller), nm.Assert.isTrue(t.controller.my, "Spawn ".concat(e, " should be in a controlled room"));
}
});
}), nm.describe("Spawn Room Context", function() {
nm.it("should have spawns in rooms with sources", function() {
for (var e in Game.spawns) {
var t = Game.spawns[e], r = t.room.find(FIND_SOURCES);
nm.Assert.greaterThan(r.length, 0, "Room ".concat(t.room.name, " should have at least one source"));
}
}), nm.it("should track room controller progress", function() {
for (var e in Game.spawns) {
var t = Game.spawns[e].room.controller;
(null == t ? void 0 : t.my) && (nm.Assert.isNotNullish(t.level), nm.Assert.inRange(t.level, 1, 8), 
nm.Assert.greaterThanOrEqual(t.progress, 0), t.level < 8 && nm.Assert.greaterThan(t.progressTotal, 0));
}
});
}), nm.describe("Controlled Rooms", function() {
nm.it("should track controlled rooms", function() {
var e, t = 0;
for (var r in Game.rooms) {
var o = Game.rooms[r];
(null === (e = o.controller) || void 0 === e ? void 0 : e.my) && (t++, nm.Assert.greaterThan(o.controller.level, 0), 
nm.Assert.inRange(o.controller.level, 1, 8));
}
im.debug("Controlled rooms count", {
meta: {
controlledCount: t
}
});
}), nm.it("should have valid structures in controlled rooms", function() {
var e;
for (var t in Game.rooms) {
var r = Game.rooms[t];
if (null === (e = r.controller) || void 0 === e ? void 0 : e.my) {
var o = r.find(FIND_MY_STRUCTURES);
r.controller.level >= 1 && Game.time > 50 && nm.Assert.greaterThan(o.length, 0, "Room ".concat(t, " should have structures"));
}
}
});
}), im.info("Spawn system tests registered");

var sm = zr("CreepManagementTest");

nm.describe("Creep Lifecycle", function() {
nm.it("should have creeps object", function() {
nm.Assert.isNotNullish(Game.creeps), nm.Assert.isType(Game.creeps, "object");
}), nm.it("should have valid creep properties", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
nm.Assert.isNotNullish(t.name), nm.Assert.isNotNullish(t.body), nm.Assert.isNotNullish(t.memory), 
nm.Assert.isNotNullish(t.room), nm.Assert.isTrue(Array.isArray(t.body));
}
}), nm.it("should track creep hits and health", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
nm.Assert.greaterThan(t.hits, 0), nm.Assert.greaterThan(t.hitsMax, 0), nm.Assert.lessThanOrEqual(t.hits, t.hitsMax);
}
}), nm.it("should have valid body parts", function() {
var e, t;
for (var r in Game.creeps) {
var o = Game.creeps[r];
nm.Assert.greaterThan(o.body.length, 0, "Creep ".concat(r, " should have at least one body part"));
try {
for (var n = (e = void 0, l(o.body)), a = n.next(); !a.done; a = n.next()) {
var i = a.value;
nm.Assert.isNotNullish(i.type), nm.Assert.isNotNullish(i.hits), nm.Assert.greaterThan(i.hits, 0);
}
} catch (t) {
e = {
error: t
...
}), nm.it("should track creep store capacity", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
if (t.store) {
var r = t.store.getCapacity(), o = t.store.getUsedCapacity();
nm.Assert.greaterThanOrEqual(r || 0, 0), nm.Assert.greaterThanOrEqual(o, 0), nm.Assert.lessThanOrEqual(o, r || 0);
}
}
});
}), nm.describe("Creep Roles and Memory", function() {
nm.it("should assign roles to all creeps", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
nm.Assert.isNotNullish(t.memory.role, "Creep ".concat(e, " should have a role assigned"));
}
}), nm.it("should assign rooms to creeps", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
nm.Assert.isNotNullish(t.memory.room, "Creep ".concat(e, " should have a room assigned"));
}
}), nm.it("should maintain working state", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
nm.Assert.isType(typeof t.memory.working, "boolean", "Creep ".concat(e, " should have working state defined"));
}
});
}), nm.describe("Creep Spawning", function() {
nm.it("should track spawning creeps", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
if (t.spawning) {
var r = t.room.find(FIND_MY_SPAWNS);
nm.Assert.greaterThan(r.length, 0, "Spawning creep ".concat(e, " should be in a room with spawns"));
}
}
}), nm.it("should eventually complete spawning", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
t.spawning && t.ticksToLive && nm.Assert.greaterThan(t.ticksToLive, 1400, "Spawning creep ".concat(e, " should have high TTL"));
}
});
}), nm.describe("Creep Movement and Position", function() {
nm.it("should have valid positions", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
nm.Assert.isNotNullish(t.pos), nm.Assert.isType(t.pos.x, "number"), nm.Assert.isType(t.pos.y, "number"), 
nm.Assert.inRange(t.pos.x, 0, 49), nm.Assert.inRange(t.pos.y, 0, 49), nm.Assert.isNotNullish(t.pos.roomName);
}
}), nm.it("should be in the correct room", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
nm.Assert.equal(t.pos.roomName, t.room.name, "Creep ".concat(e, " position should match room"));
}
});
}), nm.describe("Creep Age and Recycling", function() {
nm.it("should track ticksToLive", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
t.ticksToLive && (nm.Assert.greaterThan(t.ticksToLive, 0, "Creep ".concat(e, " should have positive TTL")), 
nm.Assert.lessThanOrEqual(t.ticksToLive, 1500, "Creep ".concat(e, " TTL should not exceed max")));
}
}), nm.it("should consider recycling near-death creeps", function() {
for (var e in Game.creeps) {
var t = Game.creeps[e];
if (t.ticksToLive && t.ticksToLive < 50) {
var r = "recycling" in t.memory && !0 === t.memory.recycling;
sm.debug("Creep near death", {
creep: e,
meta: {
ttl: t.ticksToLive,
recycling: r
...
}), nm.describe("Memory Synchronization", function() {
nm.it("should have consistent creep memory", function() {
for (var e in Game.creeps) nm.Assert.isNotNullish(Memory.creeps[e], "Creep ".concat(e, " should have memory entry"));
}), nm.it("should have valid memory structure", function() {
for (var e in Game.creeps) {
var t = Memory.creeps[e];
nm.Assert.isType(t, "object", "Creep ".concat(e, " memory should be an object"));
}
});
}), sm.info("Creep management tests registered");

var cm = zr("SwarmKernelTest");
...
nm.describe("Kernel Process Management", function() {
nm.it("should have kernel initialized", function() {
nm.Assert.isNotNullish(Oo), nm.Assert.isType(typeof Oo.run, "function"), nm.Assert.isType(typeof Oo.registerProcess, "function"), 
nm.Assert.isType(typeof Oo.unregisterProcess, "function");
}), nm.it("should track registered processes", function() {
var e = Oo.getProcesses();
nm.Assert.isTrue(Array.isArray(e)), cm.debug("Kernel registered processes", {
meta: {
processCount: e.length
}
});
}), nm.it("should have creep processes for active creeps", function() {
var e = Object.keys(Game.creeps).length;
if (e > 0) {
var t = Oo.getProcesses().filter(function(e) {
return e.id.startsWith("creep:");
});
cm.debug("Creep processes", {
meta: {
...
}), nm.it("should have room processes for controlled rooms", function() {
var e, t = 0;
...
}), nm.describe("Kernel Execution", function() {
nm.it("should execute without errors", function() {
nm.Assert.isType(typeof Oo.run, "function");
}), nm.it("should track process execution order", function() {
var e, t, r = Oo.getProcesses();
try {
for (var o = l(r), n = o.next(); !n.done; n = o.next()) {
var a = n.value;
nm.Assert.isNotNullish(a.priority), nm.Assert.isType(a.priority, "number");
}
} catch (t) {
e = {
error: t
...
}), nm.describe("Kernel Configuration", function() {
nm.it("should have valid CPU budget configuration", function() {
"config" in Oo ? cm.debug("Kernel configuration exists") : cm.debug("Kernel configuration structure may vary");
}), nm.it("should respect game CPU limits", function() {
nm.Assert.isNotNullish(Game.cpu.limit), nm.Assert.greaterThan(Game.cpu.limit, 0);
var e = Game.cpu.getUsed();
cm.debug("CPU usage", {
meta: {
cpuUsed: e.toFixed(2),
...
}), cm.info("SwarmBot kernel tests registered");

var mm = zr("PheromoneSystemTest");

nm.describe("Pheromone System", function() {
nm.it("should have pheromone data in memory", function() {
nm.Assert.isNotNullish(Memory), nm.Assert.isType(Memory, "object");
}), nm.it("should track pheromone levels in controlled rooms", function() {
var e, t, r;
for (var o in Game.rooms) if (null === (r = Game.rooms[o].controller) || void 0 === r ? void 0 : r.my) {
var n = um(o, "swarm");
if (n && lm(n, "pheromones")) {
var a = n.pheromones;
nm.Assert.isType(a, "object");
try {
for (var i = (e = void 0, l([ "harvest", "build", "repair", "upgrade", "defense", "war", "expand" ])), s = i.next(); !s.done; s = i.next()) {
var c = s.value;
void 0 !== a[c] && (nm.Assert.isType(a[c], "number"), nm.Assert.greaterThanOrEqual(a[c], 0), 
nm.Assert.lessThanOrEqual(a[c], 100));
}
} catch (t) {
e = {
error: t
...
}), nm.describe("Pheromone Decay", function() {
nm.it("should have bounded pheromone values", function() {
var e;
for (var t in Game.rooms) if (null === (e = Game.rooms[t].controller) || void 0 === e ? void 0 : e.my) {
var r = um(t, "swarm");
if (r && lm(r, "pheromones")) {
var o = r.pheromones;
for (var n in o) {
var a = o[n];
"number" == typeof a && nm.Assert.inRange(a, 0, 100, "Pheromone ".concat(n, " should be between 0 and 100"));
}
}
}
});
}), nm.describe("Pheromone Influence on Behavior", function() {
nm.it("should influence creep role distribution", function() {
var e, t, r = {};
for (var o in Game.creeps) r[s = Game.creeps[o].memory.role] = (r[s] || 0) + 1;
if (Object.keys(r).length > 0) {
mm.debug("Creep role distribution", {
meta: {
roleCounts: r
}
});
...
Object.keys(Game.creeps).length > 0 && nm.Assert.isTrue(n, "Should have at least one economic creep role");
}
});
}), nm.describe("Room State and Pheromones", function() {
nm.it("should correlate pheromones with room needs", function() {
var e;
for (var t in Game.rooms) {
var r = Game.rooms[t];
if (null === (e = r.controller) || void 0 === e ? void 0 : e.my) {
...
if (a && lm(a, "pheromones")) {
var i = a.pheromones;
o.length > 0 && void 0 !== i.build && mm.debug("Room construction sites and build pheromone", {
room: t,
meta: {
constructionSiteCount: o.length,
buildPheromone: i.build
}
}), n.length > 0 && void 0 !== i.repair && mm.debug("Room damaged structures and repair pheromone", {
room: t,
meta: {
...
}), mm.info("Pheromone system tests registered");

var pm = zr("StatsSystemTest");

nm.describe("Stats System", function() {
nm.it("should collect game time statistics", function() {
nm.Assert.isNotNullish(Game.time), nm.Assert.isType(Game.time, "number"), nm.Assert.greaterThan(Game.time, 0), 
pm.debug("Current game time", {
meta: {
gameTime: Game.time
}
});
...
var e = Game.cpu.getUsed();
nm.Assert.isType(e, "number"), nm.Assert.greaterThanOrEqual(e, 0), nm.Assert.lessThanOrEqual(e, 2 * Game.cpu.limit), 
pm.debug("CPU usage", {
meta: {
cpuUsed: e.toFixed(2),
cpuLimit: Game.cpu.limit
...
}), nm.it("should track CPU bucket", function() {
nm.Assert.isNotNullish(Game.cpu.bucket), nm.Assert.inRange(Game.cpu.bucket, 0, 1e4), 
pm.debug("CPU bucket", {
meta: {
bucket: Game.cpu.bucket
...
}), nm.it("should track GCL progress", function() {
nm.Assert.isNotNullish(Game.gcl), nm.Assert.isNotNullish(Game.gcl.level), nm.Assert.greaterThan(Game.gcl.level, 0), 
nm.Assert.greaterThanOrEqual(Game.gcl.progress, 0), nm.Assert.greaterThan(Game.gcl.progressTotal, 0), 
pm.debug("GCL progress", {
meta: {
...
}), nm.it("should track GPL if power is enabled", function() {
Game.gpl && (nm.Assert.isNotNullish(Game.gpl.level), nm.Assert.greaterThanOrEqual(Game.gpl.level, 0), 
nm.Assert.greaterThanOrEqual(Game.gpl.progress, 0), pm.debug("GPL progress", {
meta: {
...
}), nm.describe("Memory Statistics", function() {
nm.it("should store stats in memory", function() {
var e = function(e) {
if (e in Memory) return Memory[e];
}("stats");
e ? (nm.Assert.isType(e, "object"), pm.debug("Stats structure exists in memory")) : pm.debug("Stats structure not yet initialized");
}), nm.it("should track room-level statistics", function() {
var e;
for (var t in Game.rooms) if (null === (e = Game.rooms[t].controller) || void 0 === e ? void 0 : e.my) {
var r = um(t, "stats");
r && pm.debug("Room has stats", {
room: t,
meta: {
...
}), nm.describe("Resource Statistics", function() {
nm.it("should track energy statistics", function() {
var e, t = 0, r = 0;
for (var o in Game.rooms) {
var n = Game.rooms[o];
...
r > 0 && (pm.debug("Total energy across rooms", {
meta: {
roomCount: r,
totalEnergy: t
}
}), nm.Assert.greaterThanOrEqual(t, 0));
}), nm.it("should track creep count by role", function() {
var e = {};
for (var t in Game.creeps) e[r = Game.creeps[t].memory.role] = (e[r] || 0) + 1;
if (Object.keys(e).length > 0) for (var r in pm.debug("Creep counts by role", {
meta: {
roleCounts: e
}
}), e) nm.Assert.greaterThan(e[r], 0);
});
}), nm.describe("Room Statistics", function() {
nm.it("should track room RCL progress", function() {
var e;
for (var t in Game.rooms) {
var r = Game.rooms[t];
if (null === (e = r.controller) || void 0 === e ? void 0 : e.my) if (nm.Assert.inRange(r.controller.level, 1, 8), 
nm.Assert.greaterThanOrEqual(r.controller.progress, 0), r.controller.level < 8) {
nm.Assert.greaterThan(r.controller.progressTotal, 0);
var o = (r.controller.progress / r.controller.progressTotal * 100).toFixed(1);
pm.debug("Room RCL progress", {
room: t,
meta: {
...
}), nm.it("should track room structure counts", function() {
var e;
for (var t in Game.rooms) {
var r = Game.rooms[t];
if (null === (e = r.controller) || void 0 === e ? void 0 : e.my) {
var o = r.find(FIND_MY_STRUCTURES), n = r.find(FIND_MY_CONSTRUCTION_SITES);
nm.Assert.greaterThanOrEqual(o.length, 0), nm.Assert.greaterThanOrEqual(n.length, 0), 
pm.debug("Room structures", {
room: t,
meta: {
...
}), nm.it("should track room energy capacity", function() {
var e;
for (var t in Game.rooms) {
var r = Game.rooms[t];
if (null === (e = r.controller) || void 0 === e ? void 0 : e.my) {
nm.Assert.greaterThan(r.energyCapacityAvailable, 0), nm.Assert.greaterThanOrEqual(r.energyAvailable, 0), 
nm.Assert.lessThanOrEqual(r.energyAvailable, r.energyCapacityAvailable);
var o = (r.energyAvailable / r.energyCapacityAvailable * 100).toFixed(1);
pm.debug("Room energy", {
room: t,
meta: {
...
}), nm.describe("Empire Statistics", function() {
nm.it("should count total controlled rooms", function() {
var e, t = 0;
for (var r in Game.rooms) (null === (e = Game.rooms[r].controller) || void 0 === e ? void 0 : e.my) && t++;
pm.debug("Total controlled rooms", {
meta: {
controlledCount: t
}
}), nm.Assert.greaterThanOrEqual(t, 0), nm.Assert.lessThanOrEqual(t, Game.gcl.level);
}), nm.it("should count total creeps", function() {
var e = Object.keys(Game.creeps).length;
pm.debug("Total creeps", {
meta: {
creepCount: e
}
}), nm.Assert.greaterThanOrEqual(e, 0);
}), nm.it("should count total spawns", function() {
var e = Object.keys(Game.spawns).length;
pm.debug("Total spawns", {
meta: {
spawnCount: e
}
}), nm.Assert.greaterThanOrEqual(e, 0);
});
}), nm.describe("Market Statistics", function() {
nm.it("should track credits if market is available", function() {
Game.market && (nm.Assert.isNotNullish(Game.market.credits), nm.Assert.greaterThanOrEqual(Game.market.credits, 0), 
pm.debug("Market credits", {
meta: {
credits: Game.market.credits
}
}));
}), nm.it("should track active market orders", function() {
if (Game.market) {
var e = Game.market.orders, t = Object.keys(e).length;
pm.debug("Active market orders", {
meta: {
orderCount: t
}
}), nm.Assert.greaterThanOrEqual(t, 0);
...
}), pm.info("Stats system tests registered");

var fm = zr("TestLoader"), dm = zr("Main");

!function(e) {
void 0 === e && (e = !1);
var t = function() {
co.initialize(), lo(Al), lo(Nl), lo(Ml), lo(Ul), lo(kl), lo(Pl), lo(nl), lo(al), 
lo(il), lo(cl), lo(pl), lo(dl), lo(gl), global.tooangel = yl;
var e = global;
e.botConfig = {
getConfig: To,
updateConfig: So
...
configureLogger: Ir
}, e.botVisualizationManager = Sl, e.botCacheManager = Mo, co.exposeToGlobal();
};
e ? (co.initialize(), co.enableLazyLoading(t), co.exposeToGlobal()) : t();
}(To().lazyLoadConsoleCommands);

try {
!function() {
try {
if ("function" != typeof global.describe) return void fm.info("screepsmod-testing not available, skipping test registration");
fm.info("Integration tests loaded successfully");
} catch (e) {
fm.error("Error loading integration tests", {
meta: {
error: String(e)
}
});
}
}(), dm.info("Integration tests loaded successfully");
} catch (Kr) {
dm.debug("Integration tests not loaded: ".concat(String(Kr)));
}

var ym = ao.wrapLoop(function() {
try {
el();
} catch (e) {
throw dm.error("Critical error in main loop: ".concat(String(e)), {
meta: {
stack: e instanceof Error ? e.stack : void 0,
tick: Game.time
}
