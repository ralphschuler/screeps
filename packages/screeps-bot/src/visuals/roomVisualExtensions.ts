...
if (typeof RoomVisual !== "undefined") {
   ...
   */
  RoomVisual.prototype.speech = function (text: string, x: number, y: number, opts: SpeechOpts = {}): void {
   ...
   */
  RoomVisual.prototype.animatedPosition = function (x: number, y: number, opts: AnimatedOpts = {}): void {
   ...
   * Draw resource badge
   */
  RoomVisual.prototype.resource = function (type: ResourceConstant, x: number, y: number, size = 0.25): void {
