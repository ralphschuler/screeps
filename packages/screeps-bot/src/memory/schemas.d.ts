 ...
 */
export type EvolutionStage = "seedNest" | "foragingExpansion" | "matureColony" | "fortifiedHive" | "empireDominance";
/**
 * Room posture (intent)
 */
 ...
 * Economy roles
 */
export type EconomyRole = "larvaWorker" | "harvester" | "hauler" | "builder" | "upgrader" | "queenCarrier" | "mineralHarvester" | "depositHarvester" | "labTech" | "factoryWorker" | "remoteHarvester" | "remoteHauler" | "interRoomCarrier" | "crossShardCarrier";
/**
 * Military roles
 */
 ...
 */
export declare function createDefaultPheromones(): PheromoneState;
/**
 * Create default swarm state
 */
export declare function createDefaultSwarmState(): SwarmState;
/**
 * Create default market memory
 */
export declare function createDefaultMarketMemory(): MarketMemory;
/**
 * Create default empire memory
 */
export declare function createDefaultEmpireMemory(): EmpireMemory;
/**
 * Create default overmind memory
 * @deprecated Use createDefaultEmpireMemory instead. This is kept for backward compatibility.
 */
export declare function createDefaultOvermindMemory(): OvermindMemory;
/**
 * Create default cluster memory
 */
export declare function createDefaultClusterMemory(id: string, coreRoom: string): ClusterMemory;
/**
 * Visualization layer flags (bitfield)
 */
export declare enum VisualizationLayer {
    None = 0,
    Pheromones = 1,
    Paths = 2,
    Traffic = 4,
 ...
 */
export declare function createDefaultCreepMemory(role: CreepRole, family: RoleFamily, homeRoom: string): SwarmCreepMemory;
