...
export function registerAllCaches(): void {
  ...
  cacheCoherence.registerCache("object", globalCache, CacheLayer.L1, {
    priority: 100,
    maxMemory: 5 * 1024 * 1024 // 5MB
  });

  cacheCoherence.registerCache("bodypart", globalCache, CacheLayer.L1, {
    priority: 95,
  ...
  cacheCoherence.registerCache("roomFind", globalCache, CacheLayer.L2, {
    priority: 65,
    maxMemory: 8 * 1024 * 1024 // 8MB
  });

  cacheCoherence.registerCache("role", globalCache, CacheLayer.L2, {
    priority: 60,
    maxMemory: 3 * 1024 * 1024 // 3MB
  });

  cacheCoherence.registerCache("closest", globalCache, CacheLayer.L2, {
    priority: 55,
    maxMemory: 5 * 1024 * 1024 // 5MB
  });
  ...
  cacheCoherence.registerCache("game", globalCache, CacheLayer.L1, {
  ...
  cacheCoherence.registerCache("structures", globalCache, CacheLayer.L2, {
