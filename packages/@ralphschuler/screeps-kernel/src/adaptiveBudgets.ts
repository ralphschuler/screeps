/**
 * Kernel adapter for the shared adaptive CPU budget policy.
 *
 * The policy lives in @ralphschuler/screeps-core so kernel scheduling,
 * telemetry, and dashboard visualizations cannot drift.
 */
