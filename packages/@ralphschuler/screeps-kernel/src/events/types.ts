/**
 * Event payload definitions for the kernel event bus.
 *
 * Keep this module declarative: it should describe events and handlers only,
 * while queueing, CPU bucket policy, and runtime behavior stay in the EventBus
 * facade.
 */
