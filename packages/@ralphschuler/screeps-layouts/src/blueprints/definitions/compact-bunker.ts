 ...
 * - Links for RCL 8 energy logistics and load balancing
 *
 * Space requirements:
...
export const COMPACT_BUNKER_BLUEPRINT: Blueprint = {
  ...
  structures: [
    ...
    // RCL 8 links (full 6-link limit)
    { x: -1, y: -1, structureType: STRUCTURE_LINK },
    { x: 1, y: -1, structureType: STRUCTURE_LINK },
    { x: -2, y: 0, structureType: STRUCTURE_LINK },
    { x: 2, y: 0, structureType: STRUCTURE_LINK },
    { x: -1, y: 2, structureType: STRUCTURE_LINK },
    { x: 1, y: 2, structureType: STRUCTURE_LINK },
