...
/**
 * Memory accessor interface for pixel buying
 * Allows the manager to work with different memory storage strategies
 */
export interface PixelBuyingMemoryAccessor {
...
export class PixelBuyingManager {
  ...
  private lastRun = 0;
  private memoryAccessor: PixelBuyingMemoryAccessor | undefined;

  public constructor(config: Partial<PixelBuyingConfig> = {}, memoryAccessor?: PixelBuyingMemoryAccessor) {
   ...
   * Set memory accessor
   */
  public setMemoryAccessor(accessor: PixelBuyingMemoryAccessor): void {
  ...
  public run(): void {
    ...
    if (this.memoryAccessor) {
      this.memoryAccessor.ensurePixelBuyingMemory();
    }
  ...
  private getPixelBuyingMemory(): PixelBuyingMemory | undefined {
    return this.memoryAccessor?.getPixelBuyingMemory();
  }
