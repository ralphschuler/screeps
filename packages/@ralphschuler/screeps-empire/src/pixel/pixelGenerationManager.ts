...
/**
 * Memory accessor interface for pixel generation
 * Allows the manager to work with different memory storage strategies
 */
export interface PixelGenerationMemoryAccessor {
...
export class PixelGenerationManager {
  ...
  private memoryAccessor: PixelGenerationMemoryAccessor | undefined;

  public constructor(config: Partial<PixelGenerationConfig> = {}, memoryAccessor?: PixelGenerationMemoryAccessor) {
   ...
   * Set memory accessor
   */
  public setMemoryAccessor(accessor: PixelGenerationMemoryAccessor): void {
   ...
   * 
   * Note: Should check every tick for accurate consecutive tick counting
   */
  public run(): void {
    ...
    if (this.memoryAccessor) {
      this.memoryAccessor.ensurePixelGenerationMemory();
    }
  ...
  private getPixelGenerationMemory(): PixelGenerationMemory | undefined {
    return this.memoryAccessor?.getPixelGenerationMemory();
  }
