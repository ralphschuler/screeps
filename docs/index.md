...
- **API Reference** - generated by `npm run docs` into `docs/api/`
...
- [@ralphschuler/screeps-posis](../packages/screeps-posis/README.md) - POSIS architecture
...
- [screeps-roles](../packages/@ralphschuler/screeps-roles/README.md) - Task management
