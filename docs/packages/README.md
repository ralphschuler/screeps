...
| `@ralphschuler/screeps-clusters` | `packages/@ralphschuler/screeps-clusters` | Colony clusters, resource sharing, role-safe defense assignment, defense reinforcement coordination. | core, defense, kernel, memory, spawn, stats | `npm test -w @ralphschuler/screeps-clusters` |
