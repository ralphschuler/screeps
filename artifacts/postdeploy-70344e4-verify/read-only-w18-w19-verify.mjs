...
(async()=>{
  ...
  fs.mkdirSync('artifacts/postdeploy-70344e4-verify',{recursive:true});
  const out = path.join('artifacts/postdeploy-70344e4-verify',`readonly-verify-${new Date().toISOString().replace(/[:.]/g,'-')}.json`);
