...
(async()=>{
  ...
  fs.mkdirSync('artifacts/postdeploy-3f8d91e-verify',{recursive:true});
  const out = path.join('artifacts/postdeploy-3f8d91e-verify',`readonly-verify-${new Date().toISOString().replace(/[:.]/g,'-')}.json`);
